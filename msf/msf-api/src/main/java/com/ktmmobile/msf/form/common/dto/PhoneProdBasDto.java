...
public class PhoneProdBasDto implements Serializable {
    ...
    @JsonBackReference(value="phoneSntyBasDtoListY")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    List<PhoneSntyBasDto> phoneSntyBasDtoListY;

    /** 단품정보리스트 (품절,판매중단 표기 안함) */
    @JsonBackReference(value="phoneSntyBasDtoListOnline")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    ...
    /** 기기 최저가 월 단말요금 */
    private int prodMnthAmt;

    /** 정책 월 개월수 **/
    private int prodMnth;
    ...
    public void setProdMnth(int prodMnth) {
        this.prodMnth = prodMnth;
    }

    public String getProdMnth(){
        return String.valueOf(this.prodMnth);
    }

    public void setProdMnthAmt(int prodMnthAmt) {
        this.prodMnthAmt = prodMnthAmt;
    }

    public int getProdMnthAmt() {
        return this.prodMnthAmt;
    }
    ...
    public String getProdCtgIdLabel() {
        ...
        } else if (prodCtgId.equals("08")) {
            this.prodCtgIdLabel = "5G";
        } else if (prodCtgId.equals("45")) {
            this.prodCtgIdLabel = "LTE+5G";
        }
    ...
    public String getMakrCdEtc() {
        ...
        if (makrCd.equals("0141")) {
            //삼성 전자
            return makrCd;
        } else if (makrCd.equals("0222")) {
            //Apple
            return makrCd;
        } else {
            return "9999";
    ...
    public List<PhoneSntyBasDto> getPhoneSntyBasDtoListY() {
        List<PhoneSntyBasDto> saleYList = new ArrayList<PhoneSntyBasDto>();
    ...
    public List<PhoneSntyBasDto> getPhoneSntyBasDtoListOnline() {
        List<PhoneSntyBasDto> onlineList = new ArrayList<PhoneSntyBasDto>();
        for (PhoneSntyBasDto a : phoneSntyBasDtosList) {
    ...
    public void setRepRate(String rprmRate) {
        this.repRate = rprmRate;
    }
    ...
    public void setRepRateNm(String repRateNm) {
        this.repRateNm = repRateNm;
    }

    public String getRepRateNm() {
        return this.repRateNm;
    }
