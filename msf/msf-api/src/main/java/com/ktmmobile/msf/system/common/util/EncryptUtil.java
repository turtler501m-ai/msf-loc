...
import static com.ktmmobile.msf.system.common.exception.msg.ExceptionMsgConstant.ACE_256_ENC_EXCEPTION;
...
import com.ktmmobile.msf.system.common.controller.OcrController;
    ...
    public static String ace256NoPaddingDec(String key, String iv, String textStr) throws InvalidAlgorithmParameterException, InvalidKeyException {
        ...
        try {
            ...
            try {
                ...
                throw new McpCommonException("ace256NoPaddingDec IllegalBlockSizeException");
            } catch (BadPaddingException e) {
                throw new McpCommonException("ace256NoPaddingDec BadPaddingException");
            }
        } catch (NoSuchAlgorithmException e) {
            throw new McpCommonException("ace256NoPaddingDec NoSuchAlgorithmException");
        } catch (NoSuchPaddingException e) {
            throw new McpCommonException("ace256NoPaddingDec NoSuchPaddingException");
        } finally {
            if (data != null) {
                try {
                    plainText = new String(data, "UTF-8");
