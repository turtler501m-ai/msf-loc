 ...
 */
@Service
public class FormCommRestSvcImpl implements FormCommRestSvc {

    private static final Logger log = LoggerFactory.getLogger(FormCommRestSvcImpl.class);
    ...
    public FormCommRestSvcImpl(FormSendMapper formSendMapper) {
    ...
    public FormSendResVO sendScan(FormSendReqDto req) {
        ...
        try {
            ...
            log.error("[FormCommRest] DB 조회 실패: custReqSeq={}, reqType={}", req.getCustReqSeq(), reqType, e);
        ...
        if (scanUrl == null || scanUrl.isEmpty()) {
            ...
            log.info("[FormCommRest] LOCAL Mock 모드 — scanId={}", mockScanId);
        ...
        try {
            ...
            log.error("[FormCommRest] 서식지 좌표 조회 실패: groupCode={}", groupCode, e);
        ...
        try {
            ...
            log.error("[FormCommRest] XML 생성 실패: custReqSeq={}", req.getCustReqSeq(), e);
        ...
        try {
            ...
            log.error("[FormCommRest] SCAN 전송 실패: custReqSeq={}", req.getCustReqSeq(), e);
        ...
        log.info("[FormCommRest] 완료: reqType={}, custReqSeq={}, scanId={}", reqType, req.getCustReqSeq(), scanId);
    ...
    private void updateScanId(String reqType, String scanId, Long custReqSeq) {
        try {
            ...
            log.warn("[FormCommRest] SCAN_ID DB 업데이트 실패 (무시): reqType={}, scanId={}", reqType, scanId, e);
        }
    }
