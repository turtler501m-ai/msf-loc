...
import com.ktmmobile.msf.common.legacy.join.dto.JoinDto;
//import com.ktmmobile.msf.join.service.JoinSvc;
import com.ktmmobile.msf.form.servicechange.dao.MypageUserDao;
import com.ktmmobile.msf.form.servicechange.dto.AgreeDto;
//import com.ktmmobile.msf.point.dao.MstoreDao;
...
//        userVO.setContractNum(contractNum);
    ...
    public void callMspMrktAgr(String ctn, String personalInfoCollectAgree, String othersTrnsAgree, String mrktAgr, String othersTrnsKtAgree, String othersAdReceiveAgree, String indvLocaPrvAgree, String userId) {
        mypageUserDao.callMspMrktAgr(ctn, personalInfoCollectAgree, othersTrnsAgree, mrktAgr, othersTrnsKtAgree, othersAdReceiveAgree, indvLocaPrvAgree, userId);
    }
