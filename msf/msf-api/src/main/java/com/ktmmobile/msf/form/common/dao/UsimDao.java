...
public interface UsimDao {
    ...
    */
    ...
    /**
    * @Description : USIM 판매정책 리스트 정보 조회 only msp db링크를 통한 조회만 한다.
    * @param
    ...
    */
    ...
    /**
    * @Description : USIM 판매정책코드를 이용한 USIM 상품 리스트 정보 조회 only msp db링크를 통한 조회만 한다.
    * @param usimMspDto
    * @return
    * @Author : ant
    * @Create Date : 2016. 01. 18.
...
//    public List<UsimMspDto> listUsimMspDto(UsimMspDto usimMspDto);
    ...
    */
    ...
    /**
    * @Description : 선후불 여부와 데이터 타입으로 정책 코드 리스트를 가져온다.
    * @param usimMspDto
    * @return
    * @Author : ant
    * @Create Date : 2016. 2. 11.
    */
//    public List<UsimMspDto> listUsimPlcyMspDto(UsimMspDto usimMspDto);
    ...
    */
     ...
     * @return
     */
//    public List<MmobileEtcDto> selectTermlUsimMakr();
     ...
     * @return
     */
//    public List<MmobileEtcDto> selectTermlUsimList(MmobileEtcDto mMobileEtcDto, int skipResult, int maxResult);

    /**
     * 단말별 유심형태 목록 조회 갯수
     * @return
     */
//    public int selectTermlUsimTotalCnt(MmobileEtcDto mMobileEtcDto);
