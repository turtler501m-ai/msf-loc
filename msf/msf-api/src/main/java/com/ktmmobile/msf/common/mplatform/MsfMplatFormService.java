...
import com.ktmmobile.msf.common.dto.MoscRemindSmsDto;
import com.ktmmobile.msf.common.dto.NowDlvryReqDto;
...
import com.ktmmobile.msf.common.mplatform.dto.CommCdInfoRes;
import com.ktmmobile.msf.common.mplatform.dto.CoupInfoDto;
import com.ktmmobile.msf.common.mplatform.dto.InqrCoupInfoRes;
import com.ktmmobile.msf.common.mplatform.dto.InqrUsedCoupListRes;
import com.ktmmobile.msf.common.mplatform.dto.MoscCombChkRes;
import com.ktmmobile.msf.common.mplatform.dto.MoscCombChkResDto;
import com.ktmmobile.msf.common.mplatform.dto.MoscCombDtlResDTO;
import com.ktmmobile.msf.common.mplatform.dto.MoscCombInfoResDTO;
import com.ktmmobile.msf.common.mplatform.dto.MoscCrdtCardAthnInDto;
import com.ktmmobile.msf.common.mplatform.dto.MoscDataSharingResDto;
import com.ktmmobile.msf.common.mplatform.dto.MoscFarPriceChgDto;
import com.ktmmobile.msf.common.mplatform.dto.MoscFarPriceResDto;
import com.ktmmobile.msf.common.mplatform.dto.MoscInqrUsimUsePsblOutDTO;
import com.ktmmobile.msf.common.mplatform.dto.MoscMvnoComInfo;
import com.ktmmobile.msf.common.mplatform.dto.MoscOtpSvcInfoRes;
import com.ktmmobile.msf.common.mplatform.dto.MoscSimplePaySmsRes;
import com.ktmmobile.msf.common.mplatform.dto.MoscSubMstCombChgRes;
import com.ktmmobile.msf.common.mplatform.dto.MoscWireUseTimeInfoRes;
import com.ktmmobile.msf.common.mplatform.dto.MpVirtualAccountNoListDto;
import com.ktmmobile.msf.common.mplatform.dto.NowDlvryResDto;
import com.ktmmobile.msf.common.mplatform.dto.RegSvcChgRes;
import com.ktmmobile.msf.common.mplatform.dto.TrtmCoupUseRes;
import com.ktmmobile.msf.common.mplatform.vo.CommonXmlNoSelfServiceException;
import com.ktmmobile.msf.common.mplatform.vo.CommonXmlVO;
import com.ktmmobile.msf.common.mplatform.vo.MoscBfacChkOmdIntmVO;
import com.ktmmobile.msf.common.mplatform.vo.MoscBillReSendChgOutVO;
import com.ktmmobile.msf.common.mplatform.vo.MoscBillReSendInfoOutVO;
import com.ktmmobile.msf.common.mplatform.vo.MoscBillSendInfoOutVO;
import com.ktmmobile.msf.common.mplatform.vo.MoscCombStatMgmtInfoOutVO;
import com.ktmmobile.msf.common.mplatform.vo.MoscRetvIntmMdlSpecInfoVO;
import com.ktmmobile.msf.common.mplatform.vo.MoscRetvIntmOrrgInfoVO;
import com.ktmmobile.msf.common.mplatform.vo.MoscTrtOmdIntmVO;
...
import com.ktmmobile.msf.common.mplatform.vo.MpBilEmailBillReqInfo;
...
import com.ktmmobile.msf.common.mplatform.vo.MpCustInfoAgreeVO;
import com.ktmmobile.msf.common.mplatform.vo.MpFarChangewayInfoVO;
import com.ktmmobile.msf.common.mplatform.vo.MpFarChgWayChgVO;
import com.ktmmobile.msf.common.mplatform.vo.MpFarMonBillingInfoDto;
import com.ktmmobile.msf.common.mplatform.vo.MpFarMonBillingInfoVO;
import com.ktmmobile.msf.common.mplatform.vo.MpFarMonDetailInfoDto;
import com.ktmmobile.msf.common.mplatform.vo.MpFarMonDetailInfoVO;
...
import com.ktmmobile.msf.common.mplatform.vo.MpMoscBillChgInVO;
...
import com.ktmmobile.msf.common.mplatform.vo.MpNumChgeChgVO;
import com.ktmmobile.msf.common.mplatform.vo.MpNumChgeListVO;
import com.ktmmobile.msf.common.mplatform.vo.MpPcsLostChgVO;
...
import com.ktmmobile.msf.common.mplatform.vo.MpRemindSmsVO;
...
import com.ktmmobile.msf.common.mplatform.vo.MpSvcContIpinVO;
import com.ktmmobile.msf.common.mplatform.vo.MpTelTotalUseTimeDto;
import com.ktmmobile.msf.common.mplatform.vo.MpTelTotalUseTimeMobileDto;
import com.ktmmobile.msf.common.mplatform.vo.MpTelTotalUseTimeMobileVO;
import com.ktmmobile.msf.common.mplatform.vo.MpTelTotalUseTimeVO;
import com.ktmmobile.msf.common.mplatform.vo.MpUsimPukVO;
import com.ktmmobile.msf.common.mplatform.vo.MpVoidTypeVO;
...
public class MsfMplatFormService {
     ...
     * @throws
     */
    public void perAddrChg(String ncn, String ctn, String custId,
                           String addrZip, String adrPrimaryLn, String adrSecondaryLn, String bilCtnDisplay) throws SelfServiceException, SocketTimeoutException {
...
//            mplatFormServerAdapter.callService(param, vo);
     ...
     * @throws
     */
    public MpBilEmailChgVO bilEmailChg(String ncn, String ctn, String custId,
     ...
     * @throws
     */
    public void bilResendChgChge(String ncn, String ctn, String custId,
...
//            mplatFormServerAdapter.callService(param, vo, 3000);
     ...
     * @throws
     */
    public MpTelTotalUseTimeVO telTotalUseTime(String ncn, String ctn, String custId, String useMonth) throws SelfServiceException, SocketTimeoutException {
     ...
     * @throws
     */
    public MpTelTotalUseTimeDto telTotalUseTimeDto(String ncn, String ctn, String custId, String useMonth) throws SelfServiceException, SocketTimeoutException {
     ...
     * @throws
     */
    public MpFarMonBillingInfoVO farMonBillingInfo(String ncn, String ctn, String custId, String productionDate) throws SelfServiceException, SocketTimeoutException {
    ...
    public MpFarMonBillingInfoDto farMonBillingInfoDto(String ncn, String ctn, String custId, String productionDate) throws SelfServiceException, SocketTimeoutException {
...
//            mplatFormServerAdapter.callService(param, vo);
     ...
     * @throws
     */
    public MpFarMonDetailInfoVO farMonDetailInfo(String ncn, String ctn, String custId,
    ...
    public MpFarMonDetailInfoDto farMonDetailInfoDto(String ncn, String ctn, String custId,
                                                     String billSeqNo, String billDueDateList, String billMonth,
                                                     String billStartDate, String billEndDate
    ) throws SocketTimeoutException {
...
//            mplatFormServerAdapter.callService(param, vo);
    ...
    public MpFarPriceInfoDetailItemVO farPriceInfoDetailItem(String ncn, String ctn, String custId,
                                                             String billSeqNo, String billMonth, String messageLine) throws SocketTimeoutException {
...
//            mplatFormServerAdapter.callService(param, vo);
     ...
     * @throws
     */
    public MpFarPaymentInfoVO farPaymentInfo(String ncn, String ctn, String custId, String startDate, String endDate) throws SelfServiceException, SocketTimeoutException {
        MpFarPaymentInfoVO vo = new MpFarPaymentInfoVO();
        HashMap<String, String> param = getParamMap(ncn, ctn, custId, "X22");
...
//            mplatFormServerAdapter.callService(param, vo, 3000);
     ...
     * @throws
     */
    public MpFarChgWayChgVO farChgWayChg(String ncn, String ctn, String custId,
                                         Map<String, String> map) throws SocketTimeoutException {
     ...
     * @throws
     */
    public MpSuspenPosHisVO suspenPosHis(String ncn, String ctn, String custId, String termGubun) throws SelfServiceException, SocketTimeoutException {
     ...
     * @throws
     */
    public MpSuspenPosInfoVO suspenPosInfo(String ncn, String ctn, String custId, String stopRsnCd) throws SelfServiceException, SocketTimeoutException {
     ...
     * @throws
     */
    public MpSuspenChgVO suspenChg(String ncn, String ctn, String custId,
                                   String reasonCode, String userMemo, String cpDateYn, String cpEndDt, String cpStartDt, String cpPwdInsert) throws SocketTimeoutException {
...
//            getVo(29, vo);
     ...
     * @throws
     */
    public MpSuspenCnlChgInVO suspenCnlChgIn(String ncn, String ctn, String custId, String pwdType, String cpPwdInsert) throws SocketTimeoutException {
     ...
     * @throws
     */
    public MpNumChgeChgVO numChgeChg(String ncn, String ctn, String custId,
                                     String resvHkCtn, String resvHkSCtn, String resvHkMarketGubun) throws SocketTimeoutException {
     ...
     * @throws
     */
    public MpPcsLostChgVO  pcsLostChg(String ncn, String ctn, String custId,
                                      String loseType, String guideYn, String cntcTlphNo, String loseCont, String loseLocation, String strPwdInsert) throws SocketTimeoutException {
     ...
     * @throws
     */
    public MpPcsLostCnlChgVO pcsLostCnlChg(String ncn, String ctn, String custId, String strPwdNumInsert, String pwdType) throws SocketTimeoutException {
     ...
     * @throws
     */
    public MpTelTotalUseTimeMobileVO telTotalUseTimeMobile(String ncn, String ctn, String custId) throws SelfServiceException, SocketTimeoutException {
     ...
     * @throws
     */
    public MpTelTotalUseTimeMobileDto telTotalUseTimeMobileDto(String ncn, String ctn, String custId) throws SelfServiceException, SocketTimeoutException {
     ...
     * @throws
     */
    public MpMoscRegSvcCanChgInVO moscRegSvcCanChgSeq(String ncn, String ctn, String custId, String soc, String prodHstSeq) throws SocketTimeoutException {
        MpMoscRegSvcCanChgInVO vo = new MpMoscRegSvcCanChgInVO();
        HashMap<String, String> param = getParamMap(ncn, ctn, custId, "X38");
        param.put("soc", StringUtil.NVL(soc, ""));
     ...
     * @throws
     */
    public MpMoscBillChgInVO kosMoscBillChg(String ncn, String ctn, String custId, String billTypeCd, String status, String billAdInfo, String securMailYn, String ecRcvAgreYn, String sendGubun) throws SocketTimeoutException {
...
//                mplatFormServerAdapter.callServiceNe(param, moscCombChkRes, 30000);
    ...
    public MpCommonXmlVO moscDataSharingSave(String custId, String ncn,
                                             String ctn, String opmdSvcNo
            , String opmdWorkDivCd) throws SocketTimeoutException {
        MpCommonXmlVO vo = new MpCommonXmlVO();
...
//    }
     ...
     * @throws SocketTimeoutException
     */
    public MoscFarPriceChgDto doFarPricePlanRsrvChg(String custId, String ncn, String ctn,
                                                    String soc, String ftrNewParam) throws SocketTimeoutException {
     ...
     * @throws
     */
    public MoscCrdtCardAthnInDto moscCrdtCardAthnInfo(String crdtCardNo, String crdtCardTermDay
            , String brthDate,String custNm) throws SocketTimeoutException {
...
//        	mplatFormServerAdapter.callService(param, vo, 30000);
     ...
     * @throws SocketTimeoutException
     */
    public MoscBillReSendChgOutVO kosMoscBillReSendChg(String ncn, String ctn, String custId,
                                                       String year, String month, String billTypeCd, String billAdInfo) throws SocketTimeoutException {
...
//        	getVoEtc("Y15", vo);
     ...
     * @throws SocketTimeoutException
     */
    public MpCustInfoAgreeVO moscContCustInfoAgreeChg(String ncn, String ctn, String custId, MpCustInfoAgreeVO mpCustInfoAgreeVO) throws SocketTimeoutException {
    ...
    private void putAgreeInfoToParamMap(HashMap<String, String> param, MpCustInfoAgreeVO mpCustInfoAgreeVO) {
        List<String> agreeNames = List.of("othcmpInfoAdvrRcvAgreYn", "othcmpInfoAdvrCnsgAgreYn", "grpAgntBindSvcSbscAgreYn", "cardInsrPrdcAgreYn", "fnncDealAgreeYn", "cnsgInfoAdvrRcvAgreYn", "indvLoInfoPrvAgreeYn");
...
//                responseXml.append("</return>");
                ...
                break;
            case 21://부가서비스신청
                responseXml.append("<return><bizHeader><appEntrPrsnId>INL</appEntrPrsnId><appAgncCd>AA11070</appAgncCd><appEventCd>X21</appEventCd><appSendDateTime>20240311145506</appSendDateTime><appRecvDateTime>20240311145501</appRecvDateTime><appLgDateTime>20240311145501</appLgDateTime><appNstepUserId>91225330</appNstepUserId><appOrderId></appOrderId></bizHeader><commHeader><globalNo>9911100201502061201011234</globalNo><encYn></encYn><responseType>N</responseType><responseCode></responseCode><responseLogcd></responseLogcd><responseTitle></responseTitle><responseBasic></responseBasic><langCode></langCode><filler></filler></commHeader></return>");
...
//           responseXml.append("  <return>    <bizHeader>     <appEntrPrsnId>KIS</appEntrPrsnId>     <appAgncCd>AA00364</appAgncCd>     <appEventCd>X79</appEventCd>     <appSendDateTime>20220127162449</appSendDateTime>     <appRecvDateTime>20220127162424</appRecvDateTime>     <appLgDateTime>20220127162424</appLgDateTime>     <appNstepUserId>91225330</appNstepUserId>     <appOrderId></appOrderId>    </bizHeader>    <commHeader>     <globalNo>9122533020220127162212808</globalNo>     <encYn></encYn>     <responseType>N</responseType>     <responseCode></responseCode>     <responseLogcd></responseLogcd>     <responseTitle></responseTitle>     <responseBasic></responseBasic>     <langCode></langCode>     <filler></filler>    </commHeader>    <outDto>     <resltMsg>69141094682</resltMsg>     <sbscYn>Y</sbscYn>    </outDto>   </return>");
            ...
            case 97://X97
                ...
                responseXml.append("			<paramSbst>STRT_DT=20230729000000|SHARE_SUB_CONTID1=626380439|SHARE_SUB_CONTID2=|SHARE_SUB_CONTID3=|SHARE_SUB_CONTID4=|PRDC_SRL_NO=1|");
                responseXml.append("			</paramSbst>");
                ...
                responseXml.append("		<svcList>");
                responseXml.append("			<effectiveDate>20221221112445</effectiveDate>");
                responseXml.append("			<paramSbst>BLCK_NO1=060|BLCK_TYPE1=3|BLCK_NO2=|BLCK_TYPE2=|BLCK_NO3=|BLCK_TYPE3=|BLCK_NO4=|BLCK_TYPE4=|BLCK_NO5=|BLCK_TYPE5=|BLCK_NO6=|BLCK_TYPE6=|BLCK_NO7=|BLCK_TYPE7=|BLCK_NO8=|BLCK_TYPE8=|BLCK_NO9=|BLCK_TYPE9=|BLCK_NO10=|BLCK_TYPE10=|");
                responseXml.append("			</paramSbst>");
                ...
                responseXml.append("            <paramSbst>STRT_DT=20230818000000|END_DT=20230818235959|SHARE_MAIN_CONTID=626506218|SHARE_MAIN_PROD_HST_SEQ=300001091066712|PRDC_SRL_NO=1|</paramSbst>");
...
//                responseXml.append(" <return><bizHeader><appEntrPrsnId>KIS</appEntrPrsnId><appAgncCd>AA00364</appAgncCd><appEventCd>X87</appEventCd><appSendDateTime>20220408142116</appSendDateTime><appRecvDateTime>20220408142115</appRecvDateTime><appLgDateTime>20220408142115</appLgDateTime><appNstepUserId>91225330</appNstepUserId><appOrderId></appOrderId></bizHeader><commHeader><globalNo>9122533020220408142115206</globalNo><encYn></encYn><responseType>N</responseType><responseCode></responseCode><responseLogcd></responseLogcd><responseTitle></responseTitle><responseBasic></responseBasic><langCode></langCode><filler></filler></commHeader><outDto><combDcTypeNm>알뜰폰 동일명의 결합</combDcTypeNm><combProdNm>(MVNO 결합) 모바일</combProdNm><combTypeNm>MVNO 결합</combTypeNm><engtPerdMonsNum>0년</engtPerdMonsNum><moscCombDtlListOutDTO><combEngtPerdMonsNum>약정없음</combEngtPerdMonsNum><prodNm>실용 USIM 1.7</prodNm><svcContDivNm>Mobile(KIS)</svcContDivNm><svcNo>01097785180</svcNo></moscCombDtlListOutDTO><moscCombDtlListOutDTO><combEngtPerdMonsNum>약정없음</combEngtPerdMonsNum><prodNm>LTE 표준</prodNm><svcContDivNm>Mobile(KIS)</svcContDivNm><svcNo>01027148794</svcNo></moscCombDtlListOutDTO></outDto></return>");
    ...
    private boolean getVoEtc(String param, CommonXmlVO vo) {
        ...
        if("Y42".equals(param)) {
            responseXml.append("<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body><ns2:moscRemindSmsStatMgmtResponse xmlns:ns2=\"http://selfcare.so.itl.mvno.kt.com/\">");
        }else {
            responseXml.append("<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body><ns2:moscPerInfoResponse xmlns:ns2=\"http://selfcare.so.itl.mvno.kt.com/\">");
        }
        if ("D01".equals(param)) {
