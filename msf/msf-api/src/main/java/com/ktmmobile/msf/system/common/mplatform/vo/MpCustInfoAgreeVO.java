...
public class MpCustInfoAgreeVO extends CommonXmlVO{
     ...
     *  개인위치정보제공동의여부(139)
     *   개인위치정보 제3자 제공 동의
     *   MSP_MRKT_AGR_MGMT.INDV_LOCA_PRV_AGREE
     *   MCP_REQUEST.INDV_LOCA_PRV_AGREE
     */
    private String indvLoInfoPrvAgreeYn;

    public MpCustInfoAgreeVO() {}

    public MpCustInfoAgreeVO(String othcmpInfoAdvrRcvAgreYn, String othcmpInfoAdvrCnsgAgreYn, String grpAgntBindSvcSbscAgreYn, String cardInsrPrdcAgreYn, String fnncDealAgreeYn, String cnsgInfoAdvrRcvAgreYn, String indvLoInfoPrvAgreeYn) {
    ...
    public static class MpCustInfoAgreeVOBuilder {
        ...
        public MpCustInfoAgreeVOBuilder indvLoInfoPrvAgreeYn(String indvLoInfoPrvAgreeYn) {
            this.indvLoInfoPrvAgreeYn = indvLoInfoPrvAgreeYn;
            return this;
        }

        public MpCustInfoAgreeVO build() {
            return new MpCustInfoAgreeVO(this.othcmpInfoAdvrRcvAgreYn, this.othcmpInfoAdvrCnsgAgreYn, this.grpAgntBindSvcSbscAgreYn, this.cardInsrPrdcAgreYn, this.fnncDealAgreeYn, this.cnsgInfoAdvrRcvAgreYn, this.indvLoInfoPrvAgreeYn);
        }
    }
    ...
    public void parse() throws UnsupportedEncodingException {
        ...
        this.indvLoInfoPrvAgreeYn = XmlParse.getChildValue(this.body, "indvLoInfoPrvAgreeYn");
    }
    ...
    public String getAgreeYn(String agreeName) {
        switch (agreeName) {
            ...
            case "indvLoInfoPrvAgreeYn":
                return this.indvLoInfoPrvAgreeYn;
            default:
                return null;
        }
    }
