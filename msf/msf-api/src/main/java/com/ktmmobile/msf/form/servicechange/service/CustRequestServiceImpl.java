...
public class CustRequestServiceImpl implements CustRequestService {

    private static final Logger logger = LoggerFactory.getLogger(CustRequestServiceImpl.class);
