...
import com.ktis.msp.rcp.rcpMgmt.mapper.RcpCustPointMapper;
...
@Service
public class RcpCustPointService extends BaseService {

	@Autowired
	private RcpEncService encSvc;

	@Autowired
	private RcpCustPointMapper rcpCustPointMapper;
	...
	/** Constructor */
	public RcpCustPointService() {
		setLogPrefix("[RcpCustPointService] ");
	}
	 ...
	 * @return
	 */
	public List<?> getRcpCustPointList(Map<String, Object> paramMap){
		...
		List<EgovMap> list = (List<EgovMap>) rcpCustPointMapper.getRcpCustPointList(paramMap);
	...
	public List<?> getRcpCustPointListByExcel(Map<String, Object> paramMap){
		...
		List<EgovMap> list = (List<EgovMap>) rcpCustPointMapper.getRcpCustPointListByExcel(paramMap);
		List<EgovMap> result = encSvc.decryptDBMSRcpMngtList(list);
