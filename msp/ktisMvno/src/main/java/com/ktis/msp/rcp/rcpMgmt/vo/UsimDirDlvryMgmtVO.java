 ...
 */
public class UsimDirDlvryMgmtVO extends BaseVo implements Serializable {
    /**
	 * 
	 */
	...
	public List<UsimDirDlvryMgmtVO> getItems() {
		return items;
	}

	public void setItems(List<UsimDirDlvryMgmtVO> items) {
		this.items = items;
	}
