...
@XmlRootElement(name="orgMgmtVO")
public class OrgMgmtVO extends BaseVo implements Serializable {
    ...
    private String mclubYn;	/** 엠클럽점여부*/
    
	private String orgChgDate; /** 변경일자 */
	private String arnoAdr; /** 지번주소 */
	private String roadnAdr; /** 도로명주소 */
	private String mvnoOrgId; /** MVNO조직ID */
	private String sysRdateS; /** 변경일자검색S */
	private String sysRdateE; /** 변경일자검색E */
	...
	public void setMclubYn(String mclubYn) {
		this.mclubYn = mclubYn;
	}
	...
	public void setOrgChgDate(String orgChgDate) {
		this.orgChgDate = orgChgDate;
	}




	public String getArnoAdr() {
		return arnoAdr;
	}
	...
	public void setArnoAdr(String arnoAdr) {
		this.arnoAdr = arnoAdr;
	}




	public String getRoadnAdr() {
		return roadnAdr;
	}
	...
	public void setRoadnAdr(String roadnAdr) {
		this.roadnAdr = roadnAdr;
	}




	public String getMvnoOrgId() {
		return mvnoOrgId;
	}
	...
	public void setMvnoOrgId(String mvnoOrgId) {
		this.mvnoOrgId = mvnoOrgId;
	}
