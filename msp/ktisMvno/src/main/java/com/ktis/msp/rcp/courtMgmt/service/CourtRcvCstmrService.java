...
import com.ktis.msp.rcp.courtMgmt.mapper.CourtRcvCstmrMapper;
...
@Service
public class CourtRcvCstmrService extends BaseService {

    @Autowired
    private RcpEncService encSvc;

    @Autowired
    private CourtRcvCstmrMapper courtRcvCstmrMapper;
    ...
    /** Constructor */
    public CourtRcvCstmrService() {
        setLogPrefix("[CourtRcvCstmrService] ");
    }
    
    @Crypto(encryptName="DBMSEnc", fields = {"searchRrn"})
    public List<?> getCrCstmrList(Map<String, Object> paramMap){
        ...
        List<EgovMap> list = (List<EgovMap>) courtRcvCstmrMapper.getCrCstmrList(paramMap);
    ...
    @Crypto(encryptName="DBMSEnc", fields = {"searchRrn"})
    public List<?> getCrCstmrListByExcel(Map<String, Object> paramMap){
        ...
        List<EgovMap> list = (List<EgovMap>) courtRcvCstmrMapper.getCrCstmrListByExcel(paramMap);
        List<EgovMap> result = encSvc.decryptDBMSRcpMngtList(list);
