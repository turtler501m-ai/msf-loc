...
/**
 * @Class Name : OpenMgmtListExVO
 * @since 2016. 11. 21
 * @version 1.0
 */

public class OpenMgmtListExVO extends BaseVo implements Serializable {
	...
	/**
	 * @return the catchcall
	 */
	public String getCatchcall() {
		return catchcall;
	}
	/**
	 * @param catchcall the catchcall to set
	 */
