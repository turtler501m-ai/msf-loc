...
public class NstepQueryVo {
	...
	public String getJrdcl_agent_rrn() {
		return jrdcl_agent_rrn;
	}
	public void setJrdcl_agent_rrn(String jrdcl_agent_rrn) {
		this.jrdcl_agent_rrn = jrdcl_agent_rrn;
	}
