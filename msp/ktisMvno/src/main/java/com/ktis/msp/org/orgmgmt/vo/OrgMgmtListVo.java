...
/**  
 * @Class Name : OrgMgmtListVo.java
 * @Description : OrgMgmtListVo Class
 * @Modification Information  
 * @
 * @  수정일      수정자     수정내용
 * @ ---------   ---------   -------------------------------
 * @ 2014.09.13   장익준     최초생성(정책에서 사용할 리스트)
 * 
 * @author 장익준
 * @since 2014.09.13
 * @version 1.0
...
@XmlRootElement(name="orgMgmtListVo")
public class OrgMgmtListVo extends BaseVo implements Serializable {
	
	
	/**
	 * serialVersionUID
	 */	
    private static final long serialVersionUID = 8080055000929941379L;
    ...
    private String respnPrsnNm; /** 담당자전화번호 */
	 ...
	 * @return the items
	 */
	public List<OrgMgmtVO> getItems() {
		return items;
	}
	 ...
	 */
	public void setItems(List<OrgMgmtVO> items) {
		this.items = items;
	}
