...
<%
	/**
	 * @Class Name : msp_org_pu_1050.jsp
	 * @Description : K-Note 접점 검색 화면
	 * @
	 * @ 수정일	    수정자 수정내용
	 * @ ---------- ------ -----------------------------
	 * @ 2016.03.03 신희경 최초생성
...
// 						{type : "select",label : "조직 상태",name : "orgnStatCd", width:100,userdata: { lov: 'CMN0005'}},
		...
		onButtonClick : function(btnId) {
			...
			switch (btnId) {
				case "btnSearch":
					PAGE.GRID1.list(ROOT + "/org/orgmgmt/searchKnoteOrgList.json", form);
					break;
			}
		}
	},
	...
	GRID1 : {
		...
		title : "조회결과",
		header : "조직ID,조직명,사업자등록번호,조직유형,조직상태,적용시작일,적용종료일",
		columnIds : "orgnId,orgnNm,bizRegNum,typeNm,orgnStatNm,applStrtDt,applCmpltDt",
		colAlign : "left,left,center,center,center,center,center",
		colTypes : "ro,ro,roXr,ro,ro,roXd,roXd",
		colSorting : "str,str,str,str,str,str,str",
		widths : "120,200,150,100,100,120,120",
		paging:true,
			buttons : {
				center : {
					btnApply : { label : "확인" },
