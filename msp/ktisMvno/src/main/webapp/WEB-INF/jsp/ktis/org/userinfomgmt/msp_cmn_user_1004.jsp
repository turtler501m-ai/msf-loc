...
<%
	/**
	 * @Class Name : msp_cmn_user_1004.jsp
	 * @Description : 잠금상태 초기화 관리 화면
	 * @
	 * @ 수정일	    수정자 수정내용
	 * @ ---------- ------ -----------------------------
	 * @ 2026.01.28 이승국 최초생성
	...
	orgNm = '엠모바일고객센터';
	 ...
	 var DHX = {
				...
				onButtonClick : function(btnId) {
					...
					switch (btnId) {
						...
						case "btnSearch":
								...
								PAGE.GRID1.list(ROOT + "/org/userinfomgmt/getUserLockReset.json", form);
								break;
		...
		GRID1 : {
			...
			title : "조회결과",
			header : "사용자ID,사용자명,조직유형,조직명,휴대폰번호,조직ID,usrId,lockYn",
			columnIds : "usrIdMsk,usrNm,attcSctnNm,orgnNm,mblphnNum,orgnId,usrId,lockYn",
			...
			widths : "130,200,100,230,230,0,0,0",
			hiddenColumns:[5,6,7],
			multiCheckbox : true,
			paging: true,
			pageSize:20,
			...
			onButtonClick : function(btnId, selectedData) {
				switch (btnId) {
					...
					case "btnReset":
						...
						var checkedData = PAGE.GRID1.classifyRowsFromIds(rowIds, "usrId");
						var url = ROOT + "/org/userinfomgmt/updateUserLockReset.json";
