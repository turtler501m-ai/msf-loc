...
<%
  /**
   * @Class Name : hdofc_sttcmgmt_0010.jsp
   * @Description : 본사  통계관리 개통현황
							...
							onButtonClick : function(btnId) {
								...
								switch (btnId) {
									...
									case "btnSearch":
										...
										PAGE.GRID1.list(ROOT + " /pps/hdofc/sttcmgmt/SttcOpenMgmtList.json", form, {
											callback : function () {
												PAGE.FORM1.setItemValue("btnCount1", 0); //로딩 끝나면 초기화 - 조회 버튼
												PAGE.FORM1.setItemValue("btnExcelCount1", 0); //로딩 끝나면 초기화 - 엑셀다운로드버튼
											}
					...
					switch (btnId) {
						...
						case "btnDnExcel":
							...
							if(totCnt>5000)
							{
							 ...
							 mvno.cmn.download('/pps/hdofc/sttcmgmt/SttcOpenMgmtListExcel.json'+"?menuId=PPS1500001",true,{postData:searchData});
