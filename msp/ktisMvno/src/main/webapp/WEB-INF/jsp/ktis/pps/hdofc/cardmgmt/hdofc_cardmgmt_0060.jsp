...
<%
  /**
   * @Class Name : hdofc_cardmgmt_0060.jsp
   * @Description : 본사 선불카드관리 PIN 개통통계
	...
	function setCurrentFirstMonth(form, name)
	{
		...
		var DHX = {
			...
			FORM1 : {
				...
				items : [ 	
							 {type:"block", list:[
								 ...
								 {type : "calendar",dateFormat : "%Y-%m",serverDateFormat: "%Y%m",name : "startDt",label : "개통월",value : "",enableTime : false,calendarPosition : "bottom",inputWidth : 100,value : ""},
						...
						,onButtonClick : function(btnId) {
							...
							switch (btnId) {
								...
								case "btnSearch":
									...
									PAGE.GRID1.list(ROOT + " /pps/hdofc/cardmgmt/PinOpenStatsMgmtList.json", form, {
										callback : function () {
											PAGE.FORM1.setItemValue("btnCount1", 0); //로딩 끝나면 초기화 - 조회 버튼
											PAGE.FORM1.setItemValue("btnExcelCount1", 0); //로딩 끝나면 초기화 - 엑셀다운로드버튼
										}
			...
			GRID1 : {
				...
				title : "조회결과",
				header : "개통관리자, 개통월, 개통수량, 개통금액, 판매금액, 개통취소수량, 개통취소금액",
				columnIds : "opAdminNm,opDate,opCnt,opAmt,slAmt,opCanCnt,opCanAmt",
				widths : "220,100,105,140,140,105,140", //총 1500
				colAlign : "center,center,right,right,right,right,right",
				colTypes : "ro,ro,ron,ron,ron,ron,ron",
				colSorting : "str,str,int,int,int,int,int",
				paging : true,
				pageSize :500,
				pagingStyle :2,
				buttons : {
				...
				onButtonClick : function(btnId) {
					...
					switch (btnId) {
						...
						case "btnDnExcel":
							...
							var url = ROOT +"/pps/hdofc/cardmgmt/PinOpenStatsMgmtListExcel.json";
							 var searchData =  PAGE.FORM1.getFormData(true);

							 	console.log("searchData",searchData);
							
						  		mvno.cmn.download(url+"?menuId=PPS1400006",true,{postData:searchData});
							break;
