...
<%
  /**
   * @Class Name : hdofc_custmgmt_0080.jsp
   * @Description : 본사  실시간이체등록내역
	...
	function goCustInfoData(contractNum)
	{
		...
		var DHX = {
			...
			FORM1 : {
				...
				items : [ 	
							 {type:"block", list:[
								 ...
								 {type : "calendar",dateFormat : "%Y-%m-%d",serverDateFormat: "%Y%m%d",name : "startDt",label : "증빙일자",value : "",enableTime : false,calendarPosition : "bottom",inputWidth : 100,value : ""},
							 ...
							 {type:"block", list:[
								 {type:"settings", position:"label-left", labelAlign:"right", labelWidth:60, blockOffset:0},
								 {type : "select",label : "증빙여부",name : "searchPayinfoFlag",width:100}
							 ]},// 1row
							 {type : "newcolumn", offset:10},
							...
							onButtonClick : function(btnId) {
								...
								switch (btnId) {
									...
									case "btnSearch":
										...
										PAGE.GRID1.list(ROOT + " /pps/hdofc/custmgmt/PpsRealPayinfoList.json", form, {
											callback : function () {
			...
			GRID1 : {
				...
				title : "조회결과",
				header : "계약번호, 구분, 은행명, 예금주명, 회원증빙여부, 회원증빙등록일, 처리자",
				columnIds : "contractNum,cmsChargeTypeNm,cmsBankCodeNm,cmsUserName,payinfoFlag,recDt,recIdNm",
				widths : "100,100,100,200,100,220,130", //총 1500
				colAlign : "center,center,left,left,center,center,center",
				colTypes : "link,ro,ro,ro,ro,ro,ro",
					...
					switch (btnId) {
						...
						case "btnDnExcel":
							...
							if(totCnt>5000)
							{
							 ...
							 mvno.cmn.download('/pps/hdofc/custmgmt/PpsRealPayinfoListExcel.json'+"?menuId=PPS1000011",true,{postData:searchData});
		...
		var PAGE = {
			...
			onOpen : function() {
				...
				var lovCode="PPS_0077";
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd :lovCode  } , PAGE.FORM1, "searchSItem");
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd :"PPS_0078"  } , PAGE.FORM1, "searchPayinfoFlag");
