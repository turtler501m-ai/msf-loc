...
<%
/**
 * @Class Name : hdofc_agentstmmgmt_0070.jsp
 * @Description : 자돋이체 수수료
 ...
 %>
	...
	var DHX = {
			...
			onButtonClick : function(btnId) {
				...
				switch (btnId) {
					...
					case "btnSearchPps":
						...
						PAGE.GRID1.list(ROOT + "/pps/hdofc/agentstmmgmt/AgentStmCmsList.json", form, {
							callback : function () {
		...
		GRID1 : {
			...
			title : "조회결과",
			header : "정산월,계약번호,대리점명,판매점명,요금제,정책설정금액,자동이체금액,자동이체일자,수수료상태,카드수당,현금수당,등록관리자,등록일자,메모,status",
			columnIds : "billMonth,contractNum,agentNm,agentSaleNm,socNm,cmsAmtSetup,cmsAmt,cmsDt,statusNm,cardSd,cashSd,regAdminNm,regDt,remark,status",
			widths : "90,120,100,100,110,110,110,110,110,110,110,110,110,300,0",
			colTypes : "ro,ro,ro,ro,ro,ron,ron,ro,ro,ron,ron,ro,ro,ro,ro",
			colSorting : "str,str,str,str,str,int,int,str,str,int,int,str,str,str,str",
			colAlign : "center,center,center,center,center,right,right,center,center,right,right,center,center,left,center",
			paging : true,
			pageSize :15,
			pagingStyle :2,
			buttons : {
			...
			onButtonClick : function(btnId) {
				...
				switch (btnId) {
					case "btnDnExcel":
						...
						var url = "/pps/hdofc/agentstmmgmt/AgentStmCmsListExcel.json";

						var searchData =  PAGE.FORM1.getFormData(true);
						
						console.log("searchData",searchData);
							
						mvno.cmn.download(url+"?menuId=PPS1910007",true,{postData:searchData});
