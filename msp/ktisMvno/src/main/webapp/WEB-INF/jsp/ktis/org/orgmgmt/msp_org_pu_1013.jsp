...
<%
	/**
	 * @Class Name : msp_org_pu_1013.jsp
	 * @Description : 대리점/판매점 팝업 화면
	 * @
	 * @ 수정일	    수정자 수정내용
	 * @ ---------- ------ -----------------------------
	 * @ 2018.10.17 권성광 최초생성
...
var DHX = {
	...
	FORM1 : {
		...
		onButtonClick : function(btnId) {
			...
			switch (btnId) {
				case "btnSearch":
					PAGE.GRID1.list(ROOT + "/org/orgmgmt/getSalesOrgnList.json", form);
					break;
			}
		}
	},
	...
	GRID1 : {
		...
		title : "조회결과",
		header : "조직ID,조직명,조직유형,조직상태,적용시작일,적용종료일",
		columnIds : "orgnId,orgnNm,typeNm,orgnStatNm,applStrtDt,applCmpltDt",
...
var PAGE = {
		...
		onOpen : function() {
			...
			mvno.cmn.ajax4lov( ROOT + "/cmn/cmnCdMgmtService/getCommCombo.json", {grpId:"CMN0003", etc2:"sales"}, PAGE.FORM1, "typeCd"); // 조직유형
