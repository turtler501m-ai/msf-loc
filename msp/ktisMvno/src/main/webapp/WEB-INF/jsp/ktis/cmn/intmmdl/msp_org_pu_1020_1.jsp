...
var DHX = {
		...
		FORM1 : {
			items : [
				{type:"block", list:[
					...
					{type: 'newcolumn'},
					{type:"input", name:"rprsPrdtIdResult", value:"", width:220, disabled: true},
					{type: 'newcolumn'},
				...
				{type:"block", list:[
					...
					{type: 'newcolumn'},
					{type: 'select', label: '제조사명', name: 'mnfctId', width:100, offsetLeft:154, value:'', labelWidth:60}
				]},
	...
	// ----------------------------------------
		GRID1 : {
			...
			widths : "80,150,150,150,90,90,100,100",
			colAlign : "center,left,left,left,center,center,center,center",
			colTypes : "ro,ro,ro,ro,ro,ro,roXd,roXd",
