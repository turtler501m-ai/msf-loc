...
<%
/**
 * @Class Name : rcpSmsSendListOld.jsp
 * @Description : SMS발송이력
 * @
 * @ 수정일	    수정자 수정내용
 * @ ------------- ------ -----------------------------
		...
		,onButtonClick : function(btnId) {
			...
			switch (btnId) {
				case "btnSearch":
					...
					PAGE.GRID1.list(ROOT + "/rcp/rcpMgmt/getRcpSmsSendListOld.json", form);
					PAGE.FORM2.clear();
					break;
			}
		}
			...
			switch(btnId){
				case "btnSend":
					if(mvno.cmn.isEmpty(form.getItemValue("resNo"))){
						mvno.ui.alert("재전송할 수 없는 SMS입니다.");
						return;
					}
