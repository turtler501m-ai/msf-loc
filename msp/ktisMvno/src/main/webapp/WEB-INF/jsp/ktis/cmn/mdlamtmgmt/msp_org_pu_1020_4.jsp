...
<%
	/**
	 * @Class Name : msp_org_pu_1020_4.jsp
	 * @Description : 대표모델의 중고여부 단말 찾기 팝업 -- 단종모델 포함
	 * @
	 * @ 수정일		수정자 수정내용
	 * @ ---------- ------ -----------------------------
	 * @ 2015.07.31 심정보 최초생성
...
var DHX = {
				...
				onButtonClick : function(btnId) {
					...
					switch (btnId) {
						...
						case "btnSearch":
							...
							PAGE.GRID1.list(ROOT + "/cmn/hndsetamtmgmt/selectRprsHndstOldYnAllHisList.json", form);
							break;
					}
	...
	// ----------------------------------------
		GRID1 : {
			...
			title : "모델리스트",
			header : "대표모델ID,대표모델코드,색상모델ID,색상모델코드,모델명,색상,중고여부,제조사",//,출고단가,모델유형,모델구분,출시일자,단종일자",//,통신사보조금,제조사장려금,정책보조금,보조금상한적용여부,단가적용일시,단가만료일시,비고",//17
			columnIds : "rprsPrdtId,rprsPrdtCode,prdtId,prdtCode,prdtNm,prdtColrNm,oldYnNm,mnfctNm",//,outUnitPric,prdtTypeNm,prdtIndNm,prdtLnchDt,prdtDt",//,newsAgaencySubsidy,mnfctGrant,maxAmt,subsidyMaxYnNm,unitPricApplDttm,unitPricExprDttm,remrk",
			widths : "80,110,80,130,160,110,90,150",//,100,100,80,120,80,80",//,80,80,80,120,120,100",
			colAlign : "center,left,center,left,left,center,center,left",//,right,center,center,left,center,center",//,right,right,right,center,center,left",
			colTypes : "ro,ro,ro,ro,ro,ro,ro,ro",//,ron,ro,ro,ro,roXd,roXd",//,ron,ron,ron,roXdt,roXdt,ro",
