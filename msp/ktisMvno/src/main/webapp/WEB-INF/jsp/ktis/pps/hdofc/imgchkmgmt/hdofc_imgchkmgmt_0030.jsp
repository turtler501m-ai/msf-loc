...
<script type="text/javascript">
	...
	var DHX = {
		...
		FORM1 : {
			items : [ 
					 ...
					 {type : 'hidden', name: "repageReq", value:"Y"},
			...
			,onButtonClick : function(btnId) {
				...
				switch (btnId) {
					case "btnDnExcel":
						...
						var url = "/pps/hdofc/imgchkmgmt/CustImgChkReMgmtListExcel.json";
						var searchData =  PAGE.FORM1.getFormData(true);
	
					  	mvno.cmn.download(url+"?menuId=PPS1940003",true,{postData:searchData});
						break;
	...
	var PAGE = {
		...
		onOpen : function() {
			...
			mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd :"PPS_0137"}, PAGE.FORM1, "searchChkStatus");
