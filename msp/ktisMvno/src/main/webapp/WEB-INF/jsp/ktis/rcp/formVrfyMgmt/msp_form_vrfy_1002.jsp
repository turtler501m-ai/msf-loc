	...
	var DHX = {
		FORM1 : {
			items : [
				...
				, {type:"block", list:[
					{type:"input", label:"대리점", name: "agntId", value:sOrgnId, width:100, offsetLeft:10, readonly:reqFlag}
					, {type:"newcolumn"}
					, {type:"button", value:"검색", name:"btnOrgFind", disabled:reqFlag}
					, {type:"newcolumn"}
					, {type:"input", name: "agntNm", value:sOrgnNm, width:115, readonly: true}
					, {type:"newcolumn"}
			...
			, onButtonClick : function(btnId) {
				...
				switch (btnId) {
					case "btnSearch":
						...
						PAGE.GRID1.list(ROOT + "/rcp/formVrfyMgmt/getFormVrfyAgntList.json", form);
		...
		, GRID1 : {
			...
			, title : "서식지검증목록"
			, header : "상품구분,계약번호,검증결과,고객명,생년월일,나이(만),휴대폰번호,요금제,할인유형,판매정책명,약정개월수,할부개월수,단말모델,단말일련번호,상태,해지사유,모집경로,유입경로,추천인구분,추천인정보,녹취여부,대리점,판매점명,판매자명,판매자ID,기변유형,기변일자,기변모델명,기변대리점,프로모션명,개통유형,할부원금"
			, columnIds : "prodTypeNm,contractNum,vrfyStatNm,cstmrName,birth,age,subscriberNo,fstRateNm,sprtTpNm,salePlcyNm,enggMnthCnt,instMnthCnt,fstModelNm,fstModelSrlNum,subStatusNm,canRsn,onOffTypeNm,openMarketReferer,recommendFlagNm,recommendInfo,recYn,agentNm,shopNm,shopUsrNm,shopUsrId,dvcOperTypeNm,dvcChgDt,dvcModelNm,dvcAgntNm,promotionNm,operTypeNm,modelInstallment"
			, widths : "80,80,100,100,60,60,100,200,80,300,80,80,120,120,60,120,60,60,100,70,60,200,200,80,100,80,80,80,100,200,100,100"
			, colAlign : "center,center,center,center,center,right,center,left,center,left,center,center,left,center,center,left,center,center,center,center,center,left,left,left,left,center,center,left,left,left,center,right"
			, colTypes : "ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ron,ron,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,roXd,ro,ro,ro,ro,ro,ro"
			, colSorting : "str,str,str,str,str,str,str,str,str,str,int,int,str,str,sr,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,int"
			, paging: true
			...
			, onButtonClick : function(btnId) {
				...
				switch (btnId) {
					case "btnExcel":
						...
						mvno.cmn.download(ROOT + "/rcp/formVrfyMgmt/getFormVrfyAgntListByExcel.json?menuId=MSP1007002", true, {postData:searchData}); 
					...
					case "btnVrfy":
						...
						PAGE.FORM2.enableItem("FSTACTRSLT");
						PAGE.FORM2.enableItem("SNDACTRSLT");
						$('#FORM2_btnSave').show();
						
						var param = {contractNum : data.contractNum};
						mvno.cmn.ajax2(ROOT + "/rcp/formVrfyMgmt/getFormVrfyAgntInfo.json", param, function(resultData) {
							var rDate = resultData.result.data;
							
							PAGE.FORM2.setFormData(rDate, true);
							
							if(rDate.fstModifyYn == "N") {
								PAGE.FORM2.disableItem("FSTACTRSLT");
							}
							
							if(rDate.sndModifyYn == "N") {
								PAGE.FORM2.disableItem("SNDACTRSLT");
							}
							...
							mvno.ui.popupWindowById("FORM2", "검증결과확인", 900, 760, {
		...
		, FORM2 : {
			items : [
				...
				,{type: "fieldset", label: "개통정보", name:"OPENINFO", inputWidth:810, disabled:true, list:[
					{type:"block", list:[
						{type:"input", label:"계약번호", name:"contractNum", width:140, userdata:{align:"right"}, offsetLeft:10}
						, {type:"newcolumn"}
						, {type:"input", label:"대리점", name:"agentNm", width:140, userdata:{align:"right"}, offsetLeft:10}
						, {type:"newcolumn"}
						, {type:"input", label:"고객명", name:"cstmrName", width:140, userdata:{align:"right"}, offsetLeft:10}
					]}
					, {type:"block", list:[
						, {type:"input", label:"나이", name:"age", width:140, userdata:{align:"right"}, offsetLeft:10}
						, {type:"newcolumn"}
						, {type:"input", label:"요금제", name:"fstRateNm", width:140, userdata:{align:"right"}, offsetLeft:10}
						, {type:"newcolumn"}
						, {type:"input", label:"할부기간", name:"instMnthCnt", width:140, userdata:{align:"right"}, offsetLeft:10}
					]}
					, {type:"block", list:[
						, {type:"input", label:"할인유형", name:"sprtTpNm", width:140, userdata:{align:"right"}, offsetLeft:10}
						, {type:"newcolumn"}
						, {type:"input", label:"개통유형", name:"operTypeNm", width:140, userdata:{align:"right"}, offsetLeft:10}
						, {type:"newcolumn"}
						, {type:"input", label:"단말모델명", name:"fstModelNm", width:140, userdata:{align:"right"}, offsetLeft:10}
					]}
					, {type:"block", list:[
						, {type:"input", label:"할부원금", name:"modelInstallment", width:140, userdata:{align:"right"}, offsetLeft:10, numberFormat:"0,000,000,000", userdata:{align:"right"}}
						, {type:"newcolumn"}
						, {type:"input", label:"월할부금", name:"monthlyInstallment", width:140, userdata:{align:"right"}, offsetLeft:10, numberFormat:"0,000,000,000", userdata:{align:"right"}}
						, {type:"newcolumn"}
						, {type:"input", label:"월평균할부수수료", name:"monthlyFee", width:140, userdata:{align:"right"}, offsetLeft:10, numberFormat:"0,000,000,000", userdata:{align:"right"}}
					]}
					, {type:"block", list:[
						, {type:"input", label:"월납부액", name:"monthylTotal", width:140, offsetLeft:10, numberFormat:"0,000,000,000", userdata:{align:"right"}}
						, {type:"newcolumn"}
						, {type:"input", label:"총할부수수료", name:"totalFee", width:140, offsetLeft:10, numberFormat:"0,000,000,000", userdata:{align:"right"}}
						, {type:"newcolumn"}
						, {type:"input", label:"판매점", name:"shopNm", width:140, userdata:{align:"right"}, offsetLeft:10}
					]}
					, {type:"block", list:[
						, {type:"input", label:"상태", name:"subStatusNm", width:140, userdata:{align:"right"}, offsetLeft:10}
						, {type:"newcolumn"}
						, {type:"input", label:"해지사유", name:"canRsn", width:140, userdata:{align:"right"}, offsetLeft:10}
						, {type:"newcolumn"}
						, {type:"input", label:"약정개월수", name:"enggMnthCnt", width:140, userdata:{align:"right"}, offsetLeft:10}
					]}
					, {type:"block", list:[
						, {type:"input", label:"심플약정기간", name:"simEnggMnthCnt", width:140, userdata:{align:"right"}, offsetLeft:10}
						, {type:"newcolumn"}
						, {type:"input", label:"생년월일", name:"birth", width:140, userdata:{align:"right"}, offsetLeft:10}
						, {type:"newcolumn"}
						, {type:"input", label:"휴대폰번호", name:"subscriberNo", width:140, userdata:{align:"right"}, offsetLeft:10}
					]}
					, {type:"block", list:[
						, {type:"input", label:"정보/광고 수신 위탁 동의", name:"reqClausePriAdFlagNm", width:140, userdata:{align:"right"}, offsetLeft:10}
						, {type:"newcolumn"}
						, {type:"input", label:"선택형 단체보험 가입여부", name:"insrYn2", width:140, userdata:{align:"right"}, offsetLeft:10}
						, {type:"newcolumn"}
						, {type:"input", label:"선택형 단체보험명", name:"insrNm2", width:140, userdata:{align:"right"}, offsetLeft:10}
					]}
				]}
				,{type: "fieldset", label: "기본정보", name:"BASEINFO", inputWidth:820, disabled:true, list:[
					{type:"block", list:[
				...
				,{type:"newcolumn"}
				,{type: "fieldset", label: "1차 검증", name:"FSTVF", inputWidth:400, disabled:true, list:[
					{type:"block", list:[
				...
				,{type:"newcolumn"}
				,{type: "fieldset", label: "2차 검증", name:"SNDVF", inputWidth:400, disabled:true, offsetLeft:8, list:[
					{type:"block", list:[
				...
				,{type:"newcolumn"}
				,{type: "fieldset", label: "1차 조치결과", name:"FSTACTRSLT", inputWidth:400, list:[
					{type:"block", list:[
				...
				,{type:"newcolumn"}
				,{type: "fieldset", label: "2차 조치결과", name:"SNDACTRSLT", inputWidth:400, offsetLeft:8, list:[
					{type:"block", list:[
				...
				switch (btnId) {
					...
					case "btnSave":
						...
						mvno.ui.confirm("저장하시겠습니까?", function() {
							mvno.cmn.ajax(ROOT + "/rcp/formVrfyMgmt/regFormVrfyAgentRslt.json", form, function(){
