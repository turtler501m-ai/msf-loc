...
<%
/**
 * @Class Name : hdofc_agentstmmgmt_0020.jsp
 * @Description : 개통기본 수수료
 ...
 %>
	...
	var DHX = {
			...
			items : [ 	
					 {type:"block", list:[
						 {type:"settings", position:"label-left", labelAlign:"lfet", labelWidth:60, blockOffset:0}
							...
							,{type : "newcolumn", offset:20}
							,{type : "select",label : "신규/이동",name : "searchMnpGubun",width:100 ,labelWidth:100}
					 ]},// 1row
					 {type:"block", list:[
						 {type:"settings", position:"label-left", labelAlign:"left", labelWidth:60, blockOffset:0},
						 {type : "select",label : "상태(1일)",name : "searchSubStatus1",width:100 ,labelWidth:100}
						 ,{type : "newcolumn", offset:20}
						,{type : "select",label : "USIM수수료상태",name : "searchUsimStatus",width:100 ,labelWidth:100}
						,{type : "newcolumn", offset:20}
					 ...
					 {type:"block", list:[
						 {type:"settings", position:"label-left", labelAlign:"left", labelWidth:60, blockOffset:0},
						 {type : "select",label : "단말결합여부",name : "searchModelFlag15",width:100 ,labelWidth:100}
						 ,{type : "newcolumn", offset:20}
			...
			onButtonClick : function(btnId) {
				...
				switch (btnId) {
					...
					case "btnSearchPps":
						...
						PAGE.GRID1.list(ROOT + "/pps/hdofc/agentstmmgmt/AgentStmBasicList.json", form, {
							callback : function () {
		...
		GRID1 : {
			...
			title : "조회결과",
			header : "정산월,계약번호,고객번호,개통번호,고객명,요금제,모집경로,신규/이동,신분증,개통일,상태(1일),서식지수,3G/LTE,단말결합여부(15일),대리점명,판매점명,중복가입상태,기본수수료상태,기본수수료(카드),기본수수료(현금),유심수수료상태,유심수수료(카드),유심수수료(현금),등록자,등록일,환수여부,환수사유,환수일,메모,subStatus1,agentSaleId1,refundAdmin,basicStatus,usimStatus,soc",
			columnIds : "billMonth,contractNum,customerId,subscriberNo,subLinkName,socNm,onoff,mnpGubunNm,custIdntNoIndCdNm,enterDate,subStatus1Nm,docCnt1,dataType1,modelFlag15,agent1Nm,agentSale1Nm,overlapStatusNm,basicStatusNm,basicCardSd,basicCashSd,usimStatusNm,usimCardSd,usimCashSd,regAdminNm,regDt,refundFlag,refundRsnNm,refundDt,remark,subStatus1,agentSaleId1,refundAdmin,basicStatus,usimStatus,soc",
			widths : "70,90,90,90,120,110,80,80,90,90,70,70,70,130,110,110,90,110,110,110,110,110,110,120,100,70,110,90,300,0,0,0,0,0,0", //총 1500
			colAlign : "center,center,center,center,center,center,center,center,center,center,center,right,center,center,center,center,center,center,right,right,center,right,right,center,center,center,center,center,center,center,center,center,center,center,center",
			colTypes : "ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ron,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro",
			colSorting : "str,str,str,str,str,str,str,str,str,str,str,int,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str",
			paging : true,
			pageSize :15,
			pagingStyle :2,
			buttons : {
			...
			onButtonClick : function(btnId) {
				...
				switch (btnId) {
					case "btnDnExcel":
						...
						var url = "/pps/hdofc/agentstmmgmt/AgentStmBasicListExcel.json";
					...
					case "btnReg":
						...
						mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0093" } , PAGE.FORM11, "status1");
						mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0094" } , PAGE.FORM11, "status2");
						
						PAGE.FORM11.setItemValue("status1",rowData.basicStatus);
						PAGE.FORM11.setItemValue("status2",rowData.usimStatus);
		...
		FORM11: {
			...
			,items : [ 	
					 {type:"block", list:[
						 {type:"settings", position:"label-left", labelAlign:"lfet", labelWidth:60, blockOffset:0}
							,{type : "select",label : "기본수수료상태",name : "status1",width:100 ,labelWidth:100}
					 ]},// 1row
					 {type:"block", list:[
						 {type:"settings", position:"label-left", labelAlign:"left", labelWidth:60, blockOffset:0},
						 {type : "select",label : "USIM수수료상태",name : "status2",width:100 ,labelWidth:100}
					 ]},// 2row
					 {type:"block", list:[
											 {type:"settings", position:"label-left", labelAlign:"left", labelWidth:60, blockOffset:0},
					...
					switch (btnId) {
						case "btnMod":
							...
							if(!data.status1){
				        		...
				        		mvno.ui.notify("기본 수수료 상태는  필수 입력 값입니다.");
				        		return;
				
				        	}
							if(!data.status2){
				        		//this.pushError("data.refundGubun","환수  구분",["ICMN0001"]);
				        		mvno.ui.notify("USIM 수수료 상태는  필수 입력 값입니다.");
				        		return;
	...
	var PAGE = {
			...
			onOpen : function() {
				...
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0110" } , PAGE.FORM1, "searchModelFlag15");
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0092" } , PAGE.FORM1, "searchSubStatus1");
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0093" } , PAGE.FORM1, "searchBasicStatus");
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0094" } , PAGE.FORM1, "searchUsimStatus");
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0108" } , PAGE.FORM1, "searchSItem");
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0123" } , PAGE.FORM1, "searchMnpGubun");
