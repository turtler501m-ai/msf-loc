      ...
      ,onButtonClick : function(btnId) {
        ...
        switch (btnId) {
          case "btnSearch":
            ...
            PAGE.GRID1.list(ROOT + "/rcp/rcpMgmt/getRcpRequestList.json", form, {
              callback : function () {
      ...
      ,onButtonClick : function(btnId, selectedData) {
        ...
        switch (btnId) {
            ...
            if(PAGE.GRID1.getRowsNum() == 0) {
              ...
              if((searchStartDt != null && searchStartDt != '' && searchEndDt != null && searchEndDt != '') || (pSearchGbn != null && pSearchGbn != '' && pSearchName != null && pSearchName != '')){
                mvno.cmn.downloadCallback(function(result) {
                  ...
                  mvno.cmn.ajax(ROOT + "/rcp/rcpMgmt/getRcpRequestListExcelDownload.json?menuId=MSP1000018", PAGE.FORM1.getFormData(true), function(result){
          ...
          case "btnReg" : //신청서 신규등록 버튼 클릭시
            ...
            var param = "?menuId=" + menuId + "&trgtMenuId=MSP1000018";
