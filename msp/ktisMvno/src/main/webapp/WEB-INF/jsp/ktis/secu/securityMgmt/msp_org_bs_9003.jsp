...
<%
  /**
  * @Class Name : msp_org_bs_9003.jsp
  * @Description : 이력관리 - 정지계정
...
//                title : "조회조건",
                ...
                onButtonClick : function(btnId) {
                    ...
                    switch (btnId) {
                        case "btnSearch" :
                        	...
                        	var url = ROOT + "/secu/securityMgmt/stopUserList.json";
            ...
            GRID1 : {
                ...
                title : "정지계정",
                header : "조직ID,조직명,사용자ID,사용자명,계정구분,계정수정일자,계정생성일,마지막로그인일자",
                columnIds : "ORGN_ID,ORGN_NM,USR_ID,USR_NM,ATTC_SCTN_NM,RVISN_DTTM,REGST_DTTM,LAST_LOGIN_DT",
                widths : "120,120,120,120,120,140,140,140",
    			...
    			onButtonClick : function(btnId, selectedData) {
    				switch (btnId) {
    					case "btnExcel" :
    						...
    						mvno.cmn.download(ROOT + "/secu/securityMgmt/stopUserListExcel.json?menuId=MSP9001003", true, {postData:searchData}); 
