	...
	var DHX = {
			FORM1 : {
				...
				onButtonClick : function(btnId) {
					...
					switch (btnId) {
						case "btnSearch" :
							PAGE.GRID1.list(ROOT + "/ptnr/ptnrCalc/getPtnrCalcGiftiList.json", form, {callback : function() {
								mvno.cmn.ajax(ROOT + "/ptnr/ptnrCalc/getPtnrCalcGiftiListSum.json", form, function(resultData) {
			...
			GRID1 : {
				...
				title : "조회결과",
				header : "연동년월,사용년월,고객명,지급포인트,정산금액,지급결과",	//6
				columnIds : "linkYm,usgYm,cusNm,reqPoint,calPoint,resultCd",
				widths : "150,150,230,130,130,150",
				colAlign : "center,center,left,right,right,center",
