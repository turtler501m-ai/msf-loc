...
<%
  /**
  * @Class Name : msp_stat_bs_4002.jsp
  * @Description : 최초요금제별영업실적
				...
				, onButtonClick : function(btnId) {
					...
					switch (btnId) {
						case "btnSearch" :
							...
							var url = ROOT + "/rsk/statMgmt/getFstRateSaleSttcList.json";
				...
				, onButtonClick : function(btnId){
					...
					switch(btnId){
						case "btnExcel" :
							...
							mvno.cmn.download(ROOT + "/rsk/statMgmt/getFstRateSaleSttcListExcel.json?menuId=MSP5003004", true, {postData:searchData}); 
