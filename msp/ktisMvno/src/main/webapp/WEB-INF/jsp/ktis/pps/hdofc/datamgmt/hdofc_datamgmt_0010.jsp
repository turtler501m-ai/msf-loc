				...
				onButtonClick : function(btnId) {
					...
					switch (btnId) {
						...
						case "btnSearchPps":
							...
							PAGE.GRID1.list(ROOT + "/pps/hdofc/datamgmt/DataInfoMgmtList.json", form, {
								callback : function () {
				...
				onButtonClick : function(btnId) {
					...
					switch (btnId) {
						case "btnDnExcel":
							...
							var url = "/pps/hdofc/datamgmt/DataInfoMgmtListExcel.json";
							  var searchData =  PAGE.FORM1.getFormData(true);
							  mvno.cmn.download(url+"?menuId=PPS1600001",true,{postData:searchData});
							break;
					}
				}
			}
