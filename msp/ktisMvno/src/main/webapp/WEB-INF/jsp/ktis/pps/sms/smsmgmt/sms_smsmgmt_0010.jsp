	...
	,FORM4 : {
		...
		,items:[
				...
				{type: "block", list:[
					...
					,{type: "block", list: [
											{type:"newcolumn", offset:100}
											,{type: "upload", label:"파일업로드", name: "file_upload1", width:600, url: "/cmn/board/fileUpLoad.do" ,autoStart: false, userdata: { limitCount : 5, limitsize: 1000, delUrl:"/org/common/deleteFile2.json"} }
					]}			
                 	...
                 	,{type:"block", list:[
						                    {type:"newcolumn", offset:200}	
						                    ,{type:"template", label:"",value:"* 파일 최대 갯수는 5개이며 사이즈는 최대 1000KByte 입니다.",position:"label-left",align: "center",height:30}
						                ]
                 	}
                 	,{type:"block", list:[
											{type:"newcolumn", offset:200}	
											,{type:"template", label:"",value:"* 받는사람의 수신번호는 쉼표(,)를 기준으로 50개까지 전송가능합니다.",position:"label-left",align: "center", height:30}
	               						]
	               	}
                 	,{type:"block", list:[
											{type:"newcolumn", offset:200}	
			...
			switch (btnId) {
				...
				case "btnReg":
					mvno.ui.confirm("문자전송 하시겠습니까?", function() {
					    ...
					    var url = ROOT + "/pps/sms/smsmgmt/smsDumpMmsSend.json";
						mvno.cmn.ajax(
								url, 
								PAGE.FORM4
								, function(results) {
