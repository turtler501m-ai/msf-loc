...
<%
  /**
  * @Class Name : msp_org_bs_9001.jsp
  * @Description : 이력관리 - 접속실패로그
...
//                title : "조회조건",
                ...
                onButtonClick : function(btnId) {
                    ...
                    switch (btnId) {
                        case "btnSearch" :
                        	...
                        	var url = ROOT + "/secu/securityMgmt/accessFailLogList.json";
            ...
            GRID1 : {
                ...
                title : "접속실패로그",
                header : "접속일시,성공실패구분,사용자ID,사용자명,조직ID,조직명",
                columnIds : "LOG_DTTM,SUCC_YN,USR_ID,USR_NM,ORGN_ID,ORGN_NM",
                widths : "140,120,120,120,120,120",
    			...
    			onButtonClick : function(btnId, selectedData) {
    				switch (btnId) {
    					case "btnExcel" :
    						...
    						mvno.cmn.download(ROOT + "/secu/securityMgmt/accessFailLogListExcel.json?menuId=MSP9001001", true, {postData:searchData}); 
