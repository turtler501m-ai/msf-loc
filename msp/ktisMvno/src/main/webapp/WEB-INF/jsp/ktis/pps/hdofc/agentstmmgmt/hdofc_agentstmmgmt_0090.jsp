...
<%
/**
 * @Class Name : hdofc_agentstmmgmt_0090.jsp
 * @Description : 미사용환수 수수료
 ...
 %>
	...
	var DHX = {
			...
			onButtonClick : function(btnId) {
				...
				switch (btnId) {
					...
					case "btnSearchPps":
						...
						PAGE.GRID1.list(ROOT + "/pps/hdofc/agentstmmgmt/AgentStmNoUseList.json", form, {
							callback : function () {
		...
		GRID1 : {
			...
			title : "조회결과",
			header : "정산월,계약번호,전화번호,대리점명,판매점명,고객상태,요금제,개통일자,무료충전,유료충전,총충전금액,유료충전기준금액,기본료,음성,문자,데이터,기타,총사용액,사용액기준금액,수수료상태,무료충전환수액,현금,카드,등록일,등록관리자,메모,status",
			columnIds : "billMonth,contractNum,subscriberNo,agent1Nm,agentSale1Nm,subStatusNm,socNm,enterDate,freeRcg,payRcg,rcgAmt,rcgSetupAmt,useBasic,useVoice,useSms,useData,useEtc,useAmt,useSetupAmt,statusNm,freeRcgAmt,cashSd1,cardSd1,regDt,regAdminNm,remark,status",
			widths : "90,120,120,100,100,110,110,100,110,110,110,110,110,110,110,110,110,110,110,110,110,100,110,110,110,300,0",
			colTypes : "ro,ro,ro,ro,ro,ro,ro,ro,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ro,ro,ro,ro",
			colSorting : "str,str,str,str,str,str,str,str,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,str,str,str,str",
			colAlign : "center,center,center,center,center,center,center,center,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,center,center,left,center",
			paging : true,
			pageSize :15,
			pagingStyle :2,
			buttons : {
			...
			onButtonClick : function(btnId) {
				...
				switch (btnId) {
					case "btnDnExcel":
						...
						var url = "/pps/hdofc/agentstmmgmt/AgentStmNoUseListExcel.json";

						var searchData =  PAGE.FORM1.getFormData(true);
						
						console.log("searchData",searchData);
							
						mvno.cmn.download(url+"?menuId=PPS1910009",true,{postData:searchData});
					...
					case "btnReg":
						...
						mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0102" } , PAGE.FORM11, "status1");
	...
	var PAGE = {
			...
			onOpen : function() {
				...
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0102" } , PAGE.FORM1, "searchStatus");
