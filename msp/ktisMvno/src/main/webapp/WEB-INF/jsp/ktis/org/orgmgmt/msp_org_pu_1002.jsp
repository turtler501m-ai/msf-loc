...
<%
	/**
	 * @Class Name : msp_org_pu_1002.jsp
...
var DHX = {
	...
	FORM1 : {
		...
		onButtonClick : function(btnId) {
			...
			switch (btnId) {
				case "btnSearch":
					PAGE.GRID1.list(ROOT + "/org/orgmgmt/getAgncyOrgnList.json", form);
					break;
			}
		}
	},
	...
	GRID1 : {
		...
		colAlign : "center,left,left,left,center,center,center",
		...
		onButtonClick : function(btnId, selectedData) {
        	switch (btnId) {
				case "btnApply":
                	...
                	mvno.cmn.ajax(ROOT + "/org/orgmgmt/setSessOrgnInfo.json", this.getSelectedRowData(), function(result) {
						mvno.ui.closeWindow(selectedData, true);
					});
