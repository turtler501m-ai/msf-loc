...
<%
  /**
  * @Class Name : msp_org_bs_9004.jsp
  * @Description : 이력관리 - 파일다운로드 로그
                ...
                onButtonClick : function(btnId) {
                    ...
                    switch (btnId) {
                        case "btnSearch" :
                        	...
                        	var url = ROOT + "/secu/securityMgmt/fileDownLogList.json";
    			...
    			onButtonClick : function(btnId, selectedData) {
    				switch (btnId) {
    					case "btnExcel" :
    						...
    						mvno.cmn.download(ROOT + "/secu/securityMgmt/fileDownLogListExcel.json?menuId=MSP9001004", true, {postData:searchData}); 
