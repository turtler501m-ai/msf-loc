...
<script type="text/javascript">
	...
	var DHX = {
			FORM1 : {
				...
				onButtonClick : function(btnId) {
					...
					switch (btnId) {
						case "btnSearch" :
							PAGE.GRID1.list(ROOT + "/ptnr/ptnrCalc/getPtnrCalcJejuList.json", form, {callback : function() {
								mvno.cmn.ajax(ROOT + "/ptnr/ptnrCalc/getPtnrCalcJejuListSum.json", form, function(resultData) {
			...
			GRID1 : {
				...
				title : "조회결과",
				header : "연동년월,고객명,계약번호,지급포인트,정산금액,지급결과",	//6
				columnIds : "billYm,cusNm,contractNum,reqPoint,calPoint,resultCd",
				widths : "150,200,150,130,130,180",
				colAlign : "center,left,center,right,right,left",
				colTypes : "roXdm,ro,ro,ron,ron,ro",
	...
	var PAGE = {
			...
			onOpen : function() {
				...
				mvno.cmn.ajax4lov( ROOT + "/cmn/cmnCdMgmtService/getCommCombo.json", {grpId:"CMN0200",etc1:"jejuair"}, PAGE.FORM1, "resultCd"); // 검색구분
			}
