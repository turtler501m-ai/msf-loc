...
<%
/**
 * @Class Name : hdofc_agentstmmgmt_0080.jsp
 * @Description : 해지 환수
 ...
 %>
	...
	var DHX = {
			...
			items : [ 	
					 {type:"block", list:[
						 {type:"settings", position:"label-left", labelAlign:"lfet", labelWidth:60, blockOffset:0}
							...
							,{type : "select",label:"요금제",name : "searchSoc", width:100, labelWidth:100}
							,{type : "newcolumn",offset:9}
			...
			onButtonClick : function(btnId) {
				...
				switch (btnId) {
					...
					case "btnSearchPps":
						...
						PAGE.GRID1.list(ROOT + " /pps/hdofc/agentstmmgmt/AgentStmRefundList.json", form, {
							callback : function () {
		...
		GRID1 : {
			...
			title : "조회결과",
			header : "정산월,계약번호,전화번호,요금제,대리점명,판매점명,개통일,해지일,해지사유,사용일,무료충전금액,수수료상태,현금환수,카드환수,등록일자,등록관리자,메모,status",
			columnIds : "billMonth,contractNum,subscriberNo,socNm,agent1Nm,agentSale1Nm,enterDate,cancelDate,mvnoCancelRsnNm,useCnt,freeRcgAmt,statusNm,cashSd1,cardSd1,regDt,regAdminNm,remark,status",
			widths : "90,120,120,100,100,100,110,110,110,110,110,110,110,110,110,110,300,0",
			colTypes : "ro,ro,ro,ro,ro,ro,ro,ro,ro,ron,ron,ro,ron,ron,ro,ro,ro,ro",
			colSorting : "str,str,str,str,str,str,str,str,str,int,int,str,int,int,str,str,str,str",
			colAlign : "center,center,center,center,center,center,center,center,center,right,right,center,right,right,center,center,left,center",
			paging : true,
			pageSize :15,
			pagingStyle :2,
			buttons : {
			...
			onButtonClick : function(btnId) {
				...
				switch (btnId) {
					case "btnDnExcel":
						...
						var url = "/pps/hdofc/agentstmmgmt/AgentStmRefundListExcel.json";

						var searchData =  PAGE.FORM1.getFormData(true);
						
						console.log("searchData",searchData);
							
						mvno.cmn.download(url+"?menuId=PPS1910008",true,{postData:searchData});
					...
					case "btnReg":
						...
						mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0101" } , PAGE.FORM11, "status1");
	...
	var PAGE = {
			...
			onOpen : function() {
				...
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0101" } , PAGE.FORM1, "searchStatus");
