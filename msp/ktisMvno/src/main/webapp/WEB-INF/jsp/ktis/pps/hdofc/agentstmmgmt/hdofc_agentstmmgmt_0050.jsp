...
<%
/**
 * @Class Name : hdofc_agentstmmgmt_0050.jsp
 * @Description : 우량고객 수수료
 ...
 %>
	...
	var DHX = {
		FORM1 : {
			...
			items : [ 	
					 ...
					 {type:"block", list:[
							 ...
							 {type : "select",label:"단말결합여부",name : "searchMobelFlag", width:100, labelWidth:100}
		  			            ,{type : "newcolumn",offset:9}
		  			          	,{type : "select",label:"고객구분",name : "searchCustIdntNoIndCd", width:100, labelWidth:100}
		  			            ,{type : "newcolumn", offset:9} 
			...
			onButtonClick : function(btnId) {
				...
				switch (btnId) {
					...
					case "btnSearchPps":
						...
						PAGE.GRID1.list(ROOT + "/pps/hdofc/agentstmmgmt/AgentStmUlList.json", form, {
							callback : function () {
		...
		GRID1 : {
			...
			title : "조회결과",
			header : "정산월,계약번호,전화번호,고객명,대리점명,판매점명,개통일자,상태(15일),요금제,고객구분,단말결합여부,중복개통상태,수수료상태,사용금액,사용횟수,카드수당,현금수당,등록관리자,등록일자,메모,status",
			columnIds : "billMonth,contractNum,subscriberNo,subLinkName,agent15Nm,agentSale15Nm,enterDate,subStatus15Nm,socNm,custIdntNoIndCdNm,modelFlag15,overlapStatusNm,statusNm,useAmt,useCnt,cardSd,cashSd,regAdminNm,regDt,remark,status",
			widths : "90,120,100,150,110,110,110,110,110,110,110,90,110,110,110,110,110,110,110,300,0",
			colTypes : "ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ron,ron,ron,ron,ro,ro,ro,ro",
			colSorting : "str,str,str,str,str,str,str,str,str,str,str,str,str,int,int,int,int,str,str,str,str",
			colAlign : "center,center,center,center,center,center,center,center,center,center,center,center,center,right,right,right,right,center,center,left,center",
			paging : true,
			pageSize :15,
			pagingStyle :2,
			buttons : {
			...
			onButtonClick : function(btnId) {
				...
				switch (btnId) {
					case "btnDnExcel":
						...
						var url = "/pps/hdofc/agentstmmgmt/AgentStmUlListExcel.json";

						var searchData =  PAGE.FORM1.getFormData(true);
						
						console.log("searchData",searchData);
							
						mvno.cmn.download(url+"?menuId=PPS1910005",true,{postData:searchData});
	...
	var PAGE = {
			...
			onOpen : function() {
				...
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0099" } , PAGE.FORM1, "searchStatus");
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0078" } , PAGE.FORM1, "searchMobelFlag");
