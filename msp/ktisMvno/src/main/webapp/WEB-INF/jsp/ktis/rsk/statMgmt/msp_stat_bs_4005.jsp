...
<%
  /**
  * @Class Name : msp_stat_bs_4005.jsp
  * @Description : 대리점별후불영업실적
				...
				, onButtonClick : function(btnId) {
					...
					switch (btnId) {
						case "btnSearch" :
							...
							var url = ROOT + "/rsk/statMgmt/getAgncySaleSttcList.json";
...
// 							break;
			...
			GRID1 : {
				...
				, title : "조회결과"
				, header : "대리점,상품구분,네트워크구분,유지건수,월,#cspan,#cspan,#cspan,#cspan,일,#cspan,#cspan,#cspan,#cspan"
				, header2 : "#rspan,#rspan,#rspan,#rspan,개통,취소,신규,해지,순증,개통,취소,신규,해지,순증"
				, columnIds : "agncyNm,buyType,dataType,keepCnt,mmOpenCnt,mmCanCnt,mmNewCnt,mmTmntCnt,mmNetCnt,openCnt,canCnt,newCnt,tmntCnt,netCnt"
				, widths : "150,80,100,80,80,80,80,80,80,80,80,80,80,80"
				, colAlign : "left,center,center,right,right,right,right,right,right,right,right,right,right,right"
				...
				, onButtonClick : function(btnId){
					...
					switch(btnId){
						case "btnExcel" :
							...
							mvno.cmn.download(ROOT + "/rsk/statMgmt/getAgncySaleSttcListExcel.json?menuId=MSP5003007", true, {postData:searchData}); 
