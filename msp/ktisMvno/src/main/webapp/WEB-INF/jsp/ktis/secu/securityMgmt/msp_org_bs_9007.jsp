...
<%
  /**
  * @Class Name : msp_org_bs_9007.jsp
  * @Description : 이력관리 - 삭제계정
...
/* 					var year = data.searchEndDt.substring(0 , 4);
                ...
                onButtonClick : function(btnId) {
                    ...
                    switch (btnId) {
                        case "btnSearch" :
                        	...
                        	PAGE.GRID1.list(ROOT + "/secu/securityMgmt/mspUsrDelList.json", form);
                            break;
                    }
            ...
            GRID1 : {
                ...
                title : "삭제계정",
                header : "조직ID,조직명,사용자ID,사용자명,계정구분,계정삭제일자,계정생성일자,마지막로그인일자,구분",
                columnIds : "ORGN_ID,ORGN_NM,USR_ID,USR_NM,ATTC_SCTN,RVS_DATE,REG_DATE,LST_DATE,STATUS",
                widths : "100,141,100,140,80,127,127,127,70",
	            ...
	            , onButtonClick : function(btnId){
					...
					switch(btnId){
						case "btnExcel" :
							...
							mvno.cmn.download(ROOT + "/secu/securityMgmt/mspUsrDelListExcel.json?menuId=MSP9001007", true, {postData:searchData}); 
