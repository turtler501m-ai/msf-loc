...
<%
/**
 * @Class Name : hdofc_agentstmmgmt_0060.jsp
 * @Description : 환수 등록
 ...
 %>
	...
	var DHX = {
			...
			items : [ 	
					 {type:"block", list:[
						 {type:"settings", position:"label-left", labelAlign:"lfet", labelWidth:60, blockOffset:0}
							...
							,{type : "newcolumn", offset:9} 
							,{type : "select",label : "환수 구분",name : "searchGubun",width:100, labelWidth:100}
					 ]},// 1row
					 {type:"block", list:[
			...
			onButtonClick : function(btnId) {
				...
				switch (btnId) {
					...
					case "btnSearchPps":
						...
						PAGE.GRID1.list(ROOT + "/pps/hdofc/agentstmmgmt/AgentStmRefundExcelList.json", form, {
							callback : function () {
		...
		FORM10 : {
			items : [
			 		{type:"settings", position:"label-left", labelAlign:"left", labelWidth:80},
			 			{type: 'fieldset', label: '환수 엑셀 등록',  inputWidth:500, offsetLeft:10, list:[
			 			{type: "block", list: [
			 			{type : "select",label : "환수 구분",name : "refundGubun",width:167 }, 
			 			{type : "newcolumn", offset:3},
			 			{type:"block", blockOffset: 0, list: [	
			 					   	{type: "upload", label:"첨부파일" 
			 					   	,name: "file_upload1"
			 					   	,inputWidth: 330 
			 						,url: "/pps/hdofc/agentstmmgmt/uploadRefundExcelFile.do" 
	        ...
	        onButtonClick : function(btnId) {
	            ...
	            switch (btnId) {
					...
					case "btnSave":
						...
						var url = ROOT + "/pps/hdofc/agentstmmgmt/uploadRefundExcelProc.json";
	                ...
	                case "excelSample" :  
	                	var url = "/pps/hdofc/agentstmmgmt/agentStmRefundExcelSample.json";
		...
		GRID1 : {
			...
			title : "조회결과",
			header : "정산월,계약번호,환수구분,대리점명,판매점명,수수료상태,무료충전금액,현금환수,카드환수,등록일자,등록관리자,메모,status,gubun",
			columnIds : "billMonth,contractNum,gubunNm,agent1Nm,agentSale1Nm,statusNm,freeRcgAmt,cashSd1,cardSd1,regDt,regAdminNm,remark,status,gubun",
			widths : "90,120,110,110,110,100,120,110,110,100,110,300,0,0",
			colTypes : "ro,ro,ro,ro,ro,ro,ron,ron,ron,ro,ro,ro,ro,ro",
			colSorting : "str,str,str,str,str,str,int,int,int,str,str,str,str,str",
			colAlign : "center,center,center,center,center,center,right,right,right,center,center,left,center,center",
			paging : true,
			pageSize :15,
			pagingStyle :2,
			buttons : {
			...
			onButtonClick : function(btnId) {
				...
				switch (btnId) {
					case "btnDnExcel":
						...
						var url = "/pps/hdofc/agentstmmgmt/AgentStmRefundExcelListExcel.json";

						var searchData =  PAGE.FORM1.getFormData(true);
						
						console.log("searchData",searchData);
							
						mvno.cmn.download(url+"?menuId=PPS1910006",true,{postData:searchData});
					...
					case "btnReg":
	                   ...
	                   mvno.ui.popupWindowById("FORM10", "환수등록", 600, 220, {
				...
				case "btnMod":
						...
						mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0103" } , PAGE.FORM11, "status1");
						
						PAGE.FORM11.setItemValue("status1",rowData.status);
						PAGE.FORM11.setItemValue("opCode",rowData.gubun);
		...
		FORM11: {
			...
			,items : [ 	
					 {type:"block", list:[
						 {type:"settings", position:"label-left", labelAlign:"left", labelWidth:60, blockOffset:0},
						 {type : "select",label : "수수료상태",name : "status1",width:100 ,labelWidth:100}
					 ]},// 1row
					 {type:"block", list:[
						 {type:"settings", position:"label-left", labelAlign:"left", labelWidth:60, blockOffset:0},
				...
				var form = this;
					switch (btnId) {
						case "btnSave": 
							...
							data.opCode = "REFUND_EXCEL";
							data.gubun = rowData.gubun;
	...
	var PAGE = {
			...
			onOpen : function() {
				...
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0104" } , PAGE.FORM1, "searchGubun");
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0103" } , PAGE.FORM1, "searchStatus");
