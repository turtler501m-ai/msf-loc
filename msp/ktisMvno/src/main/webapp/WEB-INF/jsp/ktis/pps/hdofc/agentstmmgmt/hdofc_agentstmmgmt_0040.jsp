...
<%
  /**
   * @Class Name : hdofc_agentstmmgmt_0040.jsp
   * @Description : 명의변경 수수료
...
%>
	...
	var DHX = {
			...
			items : [ 	
					 {type:"block", list:[
						 {type:"settings", position:"label-left", labelAlign:"lfet", labelWidth:60, blockOffset:0}
							...
							,{type : "select",label : "명의변경구분",name : "searchMbtype",width:100, labelWidth:100}
							 ,{type : "newcolumn",offset:9} 
			...
			onButtonClick : function(btnId) {
				...
				switch (btnId) {
					...
					case "btnSearchPps":
						...
						PAGE.GRID1.list(ROOT + "/pps/hdofc/agentstmmgmt/AgentStmMbList.json", form, {
							callback : function () {
		...
		GRID1 : {
			...
			title : "조회결과",
			header : "정산월,계약번호,전화번호,대리점명,판매점명,고객상태,명변구분,이전고객구분,현재고객구분,명변일자,무료충전금액,유료충전금액,총충전금액,수수료상태,카드수당,현금수당,등록관리자,등록일자,메모,status",
			columnIds : "billMonth,contractNum,subscriberNo,agentNm,agentSaleNm,subStatusNm,gubunNm,custIdntNoIndCdOldNm,custIdntNoIndCdNm,mbDt,rcgFreeAmt,rcgPayAmt,rcgAmt,statusNm,cardSd,cashSd,regAdmin,regDt,remark,status",
			widths : "90,120,100,100,110,110,110,110,110,110,110,110,110,110,110,110,110,110,300,0",
			colTypes : "ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ron,ron,ron,ro,ron,ron,ro,ro,ro,ro",
			colSorting : "str,str,str,str,str,str,str,str,str,str,int,int,int,str,int,int,str,str,str,str",
			colAlign : "center,center,center,center,center,center,center,center,center,center,right,right,right,center,right,right,center,center,left,center",
			paging : true,
			pageSize :15,
			pagingStyle :2,
			buttons : {
			...
			onButtonClick : function(btnId) {
				...
				switch (btnId) {
					case "btnDnExcel":
						...
						var url = "/pps/hdofc/agentstmmgmt/AgentStmMbListExcel.json";

						var searchData =  PAGE.FORM1.getFormData(true);
						
						console.log("searchData",searchData);
							
						mvno.cmn.download(url+"?menuId=PPS1910004",true,{postData:searchData});
					...
					case "btnReg":
						...
						mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0098" } , PAGE.FORM11, "status1");
	...
	var PAGE = {
			...
			onOpen : function() {
				...
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0097" } , PAGE.FORM1, "searchMbtype");
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0098" } , PAGE.FORM1, "searchStatus");
