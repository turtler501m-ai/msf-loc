...
<%
/**
 * @Class Name : hdofc_agentstmmgmt_0130.jsp
 * @Description : 재충전 수수료
 ...
 %>
	...
	var DHX = {
			...
			items : [ 	
					 {type:"block", list:[
						 {type:"settings", position:"label-left", labelAlign:"lfet", labelWidth:60, blockOffset:0}
							,{type : "calendar",dateFormat : "%Y-%m",serverDateFormat: "%Y%m",name : "startDt",label : "정산월",value : "",enableTime : false,calendarPosition : "bottom",inputWidth : 100,value : "", labelWidth:80}
							...
							,{type : "newcolumn", offset:10}
							,{type : "select",label : "요금제",name : "searchFeatures",width:100, labelWidth:80}
					 ]},// 1row
					 {type:"block", list:[
						 {type:"settings", position:"label-left", labelAlign:"left", labelWidth:60, blockOffset:0},
	  			          	{type : "select",label:"수수료상태",name : "searchStatus", width:100, labelWidth:80}
	  			            ,{type : "newcolumn",offset:10}
							,{type : "select",label:"검색",name : "searchSItem", width:100, labelWidth:80} 	
			...
			onButtonClick : function(btnId) {
				...
				switch (btnId) {
					...
					case "btnSearchPps":
						...
						PAGE.GRID1.list(ROOT + "/pps/hdofc/agentstmmgmt/AgentStmRcgList.json", form, {
							callback : function () {
		...
		GRID1 : {
			...
			title : "조회결과",
			header : "정산월,계약번호,대리점명,판매점명,요금제,선불카드충전,선불카드수수료율,가상계좌충전,가상계좌수수료율,자동이체금액,자동이체수수료,신용카드금액,신용카드수수료,편의점충전,편의점수수료율,예치금충전,예치금수수료율,재충전(카드),재충전(현금),수수료상태,등록관리자,등록일자,메모",
			columnIds : "billMonth,contractNum,agentNm,agentSaleNm,socNm,ppsAmt,ppsRate,vacAmt,vacRate,cmsAmt,cmsRate,ccdAmt,ccdRate,posAmt,posRate,depAmt,depRate,cardSd,cashSd,statusNm,regAdminNm,regDt,remark",
			widths : "90,100,120,100,100,110,110,110,110,110,110,110,110,110,110,110,110,110,110,110,110,110,300",
			colTypes : "ro,ro,ro,ro,ro,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ro,ro,ro,ro",
			colSorting : "str,str,str,str,str,int,int,int,int,int,int,int,int,int,int,int,int,int,int,str,str,str,str",
			colAlign : "center,center,center,center,center,right,right,right,right,right,right,right,right,right,right,right,right,right,right,center,center,center,left",
			paging : true,
			pageSize :15,
			pagingStyle :2,
			buttons : {
			...
			onButtonClick : function(btnId) {
				...
				switch (btnId) {
					case "btnDnExcel":
						...
						var url = "/pps/hdofc/agentstmmgmt/AgentStmRcgListExcel.json";

						var searchData =  PAGE.FORM1.getFormData(true);
						
						console.log("searchData",searchData);
							
						mvno.cmn.download(url+"?menuId=PPS1910011",true,{postData:searchData});
					...
					case "btnReg":
						...
						mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0106" } , PAGE.FORM11, "status1");
	...
	var PAGE = {
			...
			onOpen : function() {
				...
				mvno.cmn.ajax4lov(ROOT + "/pps/hdofc/commonmgmt/PpsCodeComboList.json",{searchLovCd : "PPS_0106" } , PAGE.FORM1, "searchStatus");
