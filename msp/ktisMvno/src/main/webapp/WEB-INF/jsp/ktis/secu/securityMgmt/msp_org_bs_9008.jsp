...
<%
  /**
  * @Class Name : msp_org_bs_9008.jsp
  * @Description : 이력관리 - 전체계정
...
/* 					var year = data.searchEndDt.substring(0 , 4);
                ...
                onButtonClick : function(btnId) {
                    ...
                    switch (btnId) {
                        case "btnSearch" :
                        	...
                        	PAGE.GRID1.list(ROOT + "/secu/securityMgmt/mspAllUsrMgmtList.json", form);
                            break;
                    }
            ...
            GRID1 : {
                ...
                title : "전체계정",
                header : "조직ID,조직명,사용자ID,사용자명,계정구분,계정생성일자,마지막로그인일자",
                columnIds : "ORG_ID,ORGN_NM,USR_ID,USR_NM,ATTC_SCTN,REG_DATE,LST_DATE",
                widths : "105,190,105,190,100,130,130",
	            ...
	            , onButtonClick : function(btnId){
					...
					switch(btnId){
						case "btnExcel" :
							...
							mvno.cmn.download(ROOT + "/secu/securityMgmt/mspAllUsrMgmtExcel.json?menuId=MSP9001008", true, {postData:searchData}); 
