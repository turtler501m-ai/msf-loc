	...
	try {
		...
		if (argNames != null) {
			for (i = 0; i < argNames.length; i++) {
				...
				if(argNames[i].equals("reporttitle")) reporttitle = ubiEformData.getArgument(argNames[i]);
			}
		}
		log.append(NL);
		
		String saveFileName = "";
		if(reporttitle.equals("")) saveFileName = "ubieform_" + System.currentTimeMillis() + ".pdf";
		else saveFileName = reporttitle + ".pdf";
