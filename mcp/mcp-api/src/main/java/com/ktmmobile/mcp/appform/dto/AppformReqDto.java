...
import static com.ktmmobile.mcp.cmmn.constants.Constants.*;
...
public class AppformReqDto implements Serializable {
    ...
    */
    ...
    public void setCstmrForeignerPn(String cstmrForeignerPn) {
        if (StringUtils.isBlank(cstmrForeignerPn)) {
    ...
    public void setCstmrForeignerRrn(String cstmrForeignerRrn) {
        if (StringUtils.isBlank(cstmrForeignerRrn)) {
            this.cstmrForeignerRrn = "";
        } else {
            if (StringUtils.isNumeric(cstmrForeignerRrn)) {
    ...
    public void setCstmrAddrDtl(String cstmrAddrDtl) {
        this.cstmrAddrDtl = org.springframework.web.util.HtmlUtils.htmlUnescape(cstmrAddrDtl);
    }
    ...
    public void setOthersPaymentRrn(String othersPaymentRrn) {
        if (StringUtils.isBlank(othersPaymentRrn)) {
    ...
    public void setJrdclAgentRrn(String jrdclAgentRrn) {
        if (StringUtils.isBlank(jrdclAgentRrn)) {
            this.jrdclAgentRrn = "";
        } else {
    ...
    public void setEntrustResRrn(String entrustResRrn) {
        if (StringUtils.isBlank(entrustResRrn)) {
            this.entrustResRrn = "";
        } else {
    ...
    public void setMinorSelfIssuNum(String minorSelfIssuNum) {
        if (StringUtils.isBlank(minorSelfIssuNum)) {
    ...
    public void setDlvryAddrDtl(String dlvryAddrDtl) {
        this.dlvryAddrDtl = org.springframework.web.util.HtmlUtils.htmlUnescape(dlvryAddrDtl);
    }
    ...
    public void setReqAccountRrn(String reqAccountRrn) {
        if (StringUtils.isBlank(reqAccountRrn)) {
            this.reqAccountRrn = "";
        } else {
    ...
    public void setReqCardRrn(String reqCardRrn) {
         if (StringUtils.isBlank(reqCardRrn)) {
             this.reqCardRrn = "";
         } else {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====>"+ StringUtils.isNumeric("7412191709510"));
        System.out.println("====>"+ StringUtils.isNumeric("9912191709510"));
