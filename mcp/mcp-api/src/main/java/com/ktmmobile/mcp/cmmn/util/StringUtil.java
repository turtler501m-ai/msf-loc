...
import com.ktmmobile.mcp.app.controller.AppController;
...
public class StringUtil extends StringUtils{
    ...
    public static boolean passwordPatternCheck(String pw) {
        ...
        boolean checkPw1=  Pattern.matches(Passwrod_PATTERN_8, pw);
        boolean checkPw2=  Pattern.matches(Passwrod_PATTERN_TEXT_NUM10, pw);
        boolean checkPw3=  Pattern.matches(Passwrod_PATTERN_NUM_SPECIAL10, pw);
        boolean checkPw4=  Pattern.matches(Passwrod_PATTERN_TEXT_SPECIAL10, pw);
