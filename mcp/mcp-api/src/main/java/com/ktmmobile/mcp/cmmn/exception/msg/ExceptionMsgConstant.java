package com.ktmmobile.mcp.cmmn.exception.msg;
...
public final class ExceptionMsgConstant {
    ...
    public static final String NO_FAIL_SESSION_EXCEPTION = "SESSION 정보가 없거나 인증번호가 상이합니다. ";

    public static final String NO_ADMIN_SESSION_EXCEPTION = "관리자 로그인 정보가 없습니다 ";

    public static final String AUTH_NUM_DIFFERENT_EXCEPTION = "인증번호가 상이 합니다.\n인증번호를 다시 입력 하시기 바랍니다. ";

    public static final String AUTH_NUM_TIMER_EXCEPTION = "인증번호가 입력 3분 초과 하였습니다.\nSMS 재발송 하시기 바랍니다. ";

    public static final String ADMIN_FIRST_PASS_SET_EXCEPTION = "최초 로그인시 패스워드를 다시 설정 바랍니다.";

    public static final String ADMIN_PASS_CHG_90DAY_OVER_EXCEPTION = "패스워드 변경 90일 경과 패스워드를 다시 설정 바랍니다.";
    ...
    public static final String ADMIN_NO_MATCHE_PASSWORD_PATTERN = "패스워드 패턴을 확인해 주시기 바랍니다.";
    ...
    public static final String CHANGE_AUT_EXCEPTION = "기기변경 휴대폰 번호가 인증한 정보와 상이 합니다.";
    ...
    public static final String INVALID_PRICE_EXCEPTION = "가격정보가 상이 합니다. ";
    ...
    public static final String UPDATE_REQUEST_DATA_EXCEPTION = "서식지 정보를 UPDATE 실패 하였습니다. ";
    ...
    public static final String NO_MATCHE_PASSWORD_PATTERN = "비밀번호 패턴을 확인해 주시기 바랍니다.";

    //SocketTimeoutException
    public static final String SOCKET_TIMEOUT_EXCEPTION = "처리중인 업무가 있습니다. 잠시 후 다시 시도해 주시기 바랍니다."; //"서비스 점검중입니다. 잠시후 다시 이용해 주시기 바랍니다."; //"서버(M-Platform) 점검중 입니다. 잠시후 다시 시도 하기기 바랍니다.(SocketTimeout)";
   ...
   //SocketTimeoutException  responseXml.isEmpty()) M-PlatForm
    public static final String MPLATFORM_RESPONEXML_EMPTY_EXCEPTION = "처리중인 업무가 있습니다. 잠시 후 다시 시도해 주시기 바랍니다."; //"서비스 점검중입니다. 잠시후 다시 이용해 주시기 바랍니다."; // "서버(M-Platform) 점검중 입니다. 잠시후 다시 시도 하기기 바랍니다.(XML EMPTY)";

    //numberView01
    public static final String NUMBER_CHANGE_TIME_EXCEPTION = "번호변경 가능한 시간은 평일 오전10시~오후8시까지 가능합니다. (주말 공휴일은 변경불가)";


    public static final String TIME_OVERLAP_EXCEPTION = "처리중인 업무가 있습니다. 잠시 후 다시 시도해 주시기 바랍니다.";
