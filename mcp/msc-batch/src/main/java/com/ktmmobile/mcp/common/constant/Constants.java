package com.ktmmobile.mcp.common.constant;
...
public final class Constants {
  ...
  //############################# 외부 서식지 관련 ##############################################
    ...
    /** CSS_VERSION  */
    public static final String CSS_VERSION = "231107";
    ...
    /**  A'CEN 해피콜 유형코드 - 신규개통 유심없음 */
    public static final String NAC_NOSIM_01 = "NEW_NOSIM_01";
    public static final String NAC_NOSIM_02 = "NEW_NOSIM_02";
    public static final String NAC_NOSIM_03 = "NEW_NOSIM_03";

    /**  A'CEN 해피콜 유형코드 - 신규개통 유심있음 */
    public static final String NAC_SIM_01 = "NEW_SIM_01";
    public static final String NAC_SIM_02 = "NEW_SIM_02";

    /**  A'CEN 해피콜 유형코드 - 번호이동 유심없음 */
    public static final String MNP_NOSIM_01 = "MNP_NOSIM_01";
    public static final String MNP_NOSIM_02 = "MNP_NOSIM_02";
    public static final String MNP_NOSIM_03 = "MNP_NOSIM_03";

    /**  A'CEN 해피콜 유형코드 - 번호이동 유심있음 */
    public static final String MNP_SIM_01 = "MNP_SIM_01";
    public static final String MNP_SIM_02 = "MNP_SIM_02";
    public static final String MNP_SIM_03 = "MNP_SIM_03";

    /**  A'CEN 해피콜 유형코드 - 신규개통 유심없음-바로배송 */
    public static final String NAC_NOSIM_NOW_DLVRY_01 = "NEW_NOSIM_01_NOW_DLVRY";

    /**  A'CEN 해피콜 유형코드 - 셀프개통고객 본인확인 */
    public static final String SLF_CST_IDT = "SLF_CST_IDT";

    /* 현행화 예약 관리 - 항목 코드 */
    public static final String RENEW_RESERVE_CD_RATE_ADSVC_GDNC = "01";
    public static final String RENEW_RESERVE_CD_EVENT_ORDER = "02";

    /** EVENT_CODE 유심무상교체 접수내역 전송 (T02) */
    public static final String EVENT_CODE_REPLACE_USIM_RCP_SEND = "T02";
