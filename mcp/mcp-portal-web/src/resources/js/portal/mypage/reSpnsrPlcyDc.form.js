        ...
        ,function(jsonObj){
            if (AJAX_RESULT_CODE.SUCCESS ==  jsonObj.RESULT_CODE) {
                if (pageObj.sbscYnCode ==  jsonObj.SBSC_YN) {
                    ...
                    ,function(jsonObj){
                        ...
                        if (jsonObj.saleSubsdMst != null && jsonObj.saleSubsdMst.totalVatPriceDC != null && jsonObj.saleSubsdMst.totalVatPriceDC > 0) {
                            ...
                            var tempHtml = "<p class='c-text c-text--fs17 u-co-gray-9 u-mb--16'>요금할인 재약정이 불가능합니다.<br>재약정 대상 요금제가 아닙니다.</p><span class='c-bullet c-bullet--fyr u-co-sub-4'>고객센터(가입휴대폰에서 114) 통하여 재약정 문의가 가능합니다. </span>"
                    ...
                    if (resultMsg ==null || resultMsg =="" ) {
                        ...
                        tempHtml = "<p class='c-text c-text--fs17 u-co-gray-9 u-mb--16'>요금할인 재약정이 불가능합니다.<br>재약정 대상 요금제가 아닙니다.</p><span class='c-bullet c-bullet--fyr u-co-sub-4'>고객센터(가입휴대폰에서 114) 통하여 재약정 문의가 가능합니다. </span>"
                    } else if (resultMsg == "스폰서 고객이므로 심플할인(알뜰폰)에 가입할 수 없습니다." ) {
                        resultMsg = "요금할인 재약정이 불가능합니다.<br/><br/>요금할인 재약정 대상자가 아닙니다.";
                        tempHtml = "<p class='c-text c-text--fs17 u-co-gray-9 u-mb--16'>요금할인 재약정이 불가능합니다.<br>요금할인 재약정 대상자가 아닙니다.</p><span class='c-bullet c-bullet--fyr u-co-sub-4'>고객센터(가입휴대폰에서 114) 통하여 재약정 문의가 가능합니다. </span>"
                    } else if (resultMsg == "심플할인(알뜰폰) 가입 고객입니다. 수동해지 가능합니다." ) {
                        resultMsg = "요금할인 재약정이 불가능합니다.<br/><br/>요금할인 재약정에 이미 가입되어 있습니다.";
                        tempHtml = "<p class='c-text c-text--fs17 u-co-gray-9 u-mb--16'>요금할인 재약정이 불가능합니다.<br>요금할인 재약정에 이미 가입되어 있습니다.</p><span class='c-bullet c-bullet--fyr u-co-sub-4'>고객센터(가입휴대폰에서 114) 통하여 재약정 문의가 가능합니다. </span>"
                    } else if (resultMsg == "정지 중 고객이므로 심플할인(알뜰폰)에 가입할 수 없습니다." ) {
                        resultMsg = "요금할인 재약정이 불가능합니다.<br/><br/>정지 상태에서는 가입이 불가합니다.";
                        tempHtml = "<p class='c-text c-text--fs17 u-co-gray-9 u-mb--16'>요금할인 재약정이 불가능합니다.<br>정지 상태에서는 가입이 불가합니다.</p><span class='c-bullet c-bullet--fyr u-co-sub-4'>고객센터(가입휴대폰에서 114) 통하여 재약정 문의가 가능합니다. </span>"
                    } else {
                        resultMsg = "요금할인 재약정이 불가능합니다.<br/><br/>요금할인 재약정 대상 요금제가 아닙니다. <br/>고객센터(가입휴대폰에서 114)를 통하여 재약정 문의가 가능합니다.";
                        tempHtml = "<p class='c-text c-text--fs17 u-co-gray-9 u-mb--16'>요금할인 재약정이 불가능합니다.<br>요금할인 재약정 대상 요금제가 아닙니다.</p><span class='c-bullet c-bullet--fyr u-co-sub-4'>고객센터(가입휴대폰에서 114) 통하여 재약정 문의가 가능합니다. </span>"
                    }
                    //MCP.alert(resultMsg);
                ...
                if (resultMsg ==null || resultMsg =="" ) {
                    ...
                    tempHtml = "<p class='c-text c-text--fs17 u-co-gray-9 u-mb--16'>요금할인 재약정이 불가능합니다.</p><span class='c-bullet c-bullet--fyr u-co-sub-4'>고객센터(가입휴대폰에서 114) 통하여 재약정 문의가 가능합니다. </span>"
...
function openResultModal(){
    ...
    var el = document.querySelector("#contract-result-modal");
    var modal = KTM.Dialog.getInstance(el) ? KTM.Dialog.getInstance(el) : new KTM.Dialog(el);
    modal.open();

}

function modalDisplaySet(mode){
    $("#modalResultArea").hide();
    $("#modalResultNoArea").hide();
    if(mode == 'no'){
        $("#modalResultNoArea").show();
    }else if(mode == 'yes'){
        $("#modalResultArea").show();
    }
    openResultModal();
...
function goMosc(){
    ...
    document.frm.svcCntrNo.value = $("#selSvcCntrNo").val();
    document.frm.submit();
