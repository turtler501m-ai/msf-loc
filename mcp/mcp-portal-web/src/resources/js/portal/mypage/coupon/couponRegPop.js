	    ...
	    ,function(data){
	    	...
	    	if(rtnCode=="999999"){
	    		...
	    		if( coupInfoList !=null && coupInfoList.length > 0 ){
	        		...
	        		couponHtml += "<div class='c-table u-mt--32'>";
	        		couponHtml += "	<table>";
	        		couponHtml += "		<caption>쿠폰명, 회선 번호, 등록 유효기간, 사용가능 기간을 포함한 쿠폰 정보</caption>";
	        		couponHtml += "		<colgroup>";
	        		couponHtml += "			<col style='width: 33%'>";
	        		couponHtml += "			<col>";
	        		couponHtml += "		</colgroup>";
	        		couponHtml += "		<tbody class='c-table__left'>";
	        		couponHtml += "			<tr>";
	        		couponHtml += "				<th scope='row'>쿠폰명</th>";
	        		couponHtml += "				<td>"+coupNm+"</td>";
	        		couponHtml += "			</tr>";
	        		couponHtml += "			<tr>";
	        		couponHtml += "				<th scope='row'>회선번호</th>";
	        		couponHtml += "				<td>"+mobileNo+"</td>";
	        		couponHtml += "			</tr>";
	        		couponHtml += "			<tr>";
	        		couponHtml += "				<th scope='row'>등록 유효기간</th>";
	        		couponHtml += "				<td>"+useStrtDt+"~"+useEndDt+"</td>";
	        		couponHtml += "			</tr>";
	        		couponHtml += "			<tr>";
	        		couponHtml += "				<th scope='row'>사용가능 기간</th>";
	        		couponHtml += "				<td>신청 즉시</td>";
	        		couponHtml += "			</tr>";
	        		couponHtml += "		</tbody>";
	        		couponHtml += "	</table>";
	        		couponHtml += "</div>";
	        		...
	        		couponHtml += "	<i class='c-icon c-icon--nodata-coupon' aria-hidden='true'></i>";
	        		couponHtml += "	<p class='c-nodata__text'>유효하지 않은 쿠폰번호 입니다.</p>";
	        		couponHtml += "</div>";
