...
$(document).ready(function (){
    ...
    ajaxCommon.getItemNoLoading({
        ...
        ,cache:false
        ,url:'/termsPop.do'
        ,data: "cdGroupId1=TERMSCOM&cdGroupId2=combinePlusNoticePC"
        ,dataType:"json"
    } ,function(jsonObj){
        var inHtml = unescapeHtml(jsonObj.docContent);
        $('.combine-notice1').html(inHtml);
        KTM.initialize();
    });
    ...
    $("#btnPrint").click(function(){
        ...
        // } ,function(jsonObj){
        //     var inHtml = unescapeHtml(jsonObj.docContent);
        //     $('.combine-notice1').html("");
        //     $('.combine-notice2').html(inHtml);
        //     KTM.initialize();
        // });
    });
    ...
    //     });
    //     //1047  1005
    //     openPage('eventPop', "/event/eventDetailViewAjax.do?ntcartSeq=1005", parameterData);
    // });
                    ...
                    ,function(jsonObj){
                        ...
                        if (AJAX_RESULT_CODE.SUCCESS ==  jsonObj.RESULT_CODE) {
                            if (jsonObj.combList != null && jsonObj.combList.length > 0) {
                                ...
                                arr.push('  <table>\n');
                                arr.push('  <colgroup>\n');
                                arr.push('      <col style="width: 6rem">\n');
                                arr.push('      <col>\n');
                                arr.push('      <col style="width: 22.0625rem">\n');
                                arr.push('  </colgroup>\n');
                                arr.push('  <thead>\n');
                                arr.push('      <tr>\n');
                                ...
                                arr.push('  </table>\n');
                                arr.push('</div>\n');
                                arr.push('<p class="u-co-gray u-fs-15 u-mt--17">');
                                arr.push('    <span>※현재 사용중인 KT상품이 조회되지 않을 경우 KT고객센터를 통해 MVNO 정보제공동의 후 다시 조회 해 주세요.</span>');
                                arr.push('</p>');
                                arr.push('<p class="u-co-gray u-fs-15 u-mt--8">');
                                arr.push('    <span>※인터넷 상품의 경우 조회일 기준 전월 개통한 상품만 보여집니다.</span>');
                                arr.push('</p>');

                                // 결합상품 인터넷일때 약정기간 노출
                                if (svcNoTypeCdVal == 'IT') {
                                    arr.push('<div class="c-form-wrap u-mt--20">\n');
                                    arr.push('    <div class="c-form-group" role="group" aria-labelledby="sameCustInfo">\n');
                                    arr.push('        <h4 class="c-group--head u-fs-20 u-mt--m4" id="sameCustInfo">약정기간을 선택해 주세요.</h4>\n');
                                    arr.push('        <div class="c-checktype-row c-col3">\n');
                                ...
                                arr.push('<div class="combine-result-possible no-combine">\n');
                                arr.push('	<p class="u-co-red">결합 가능한 상품이 없습니다.</p>\n');
                                arr.push('	<p class="possible__subtxt">만약 상품이 조회되지 않을 경우 KT 고객센터로 MVNO제공동의 여부를 확인하시기 바랍니다.</p>\n');
                                arr.push('	<img src="/resources/images/portal/product/combine_impossible.png" alt="" aria-hidden="true">\n');
                                arr.push('</div>\n');
                                arr.push('<p class="u-co-gray u-fs-15 u-mt--17">');
                                arr.push('    <span>※현재 사용중인 KT상품이 조회되지 않을 경우 KT고객센터를 통해 MVNO 정보제공동의 후 다시 조회 해 주세요.</span>');
                                arr.push('</p>');
                ...
                ajaxCommon.getItem({
                    ...
                    ,function(jsonObj){
                        if (AJAX_RESULT_CODE.SUCCESS ==  jsonObj.RESULT_CODE) {
                            ...
                            ajaxCommon.createForm({
                                method:"post"
                                ,action:"/content/combineKtComplete.do"
                            });
                            ...
                            /*
                            $("._serviceNm").html(pageObj.adsvcNm);
                            $("._regForm").hide();
                            $("._completeForm").show();
