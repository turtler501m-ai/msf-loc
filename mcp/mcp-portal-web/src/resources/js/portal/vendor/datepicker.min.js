//https://github.com/mymth/vanillajs-datepicker/tree/master/dist/js
!(function () {
  'use strict';
  function e(e, t) {
  ...
  const D = {
      ...
      m(e, t, i) {
        ...
        if (isNaN(a)) {
          ...
          if (((a = i.monthsShort.findIndex(s)) < 0 && (a = i.months.findIndex(s)), a < 0))
            return NaN;
        }
        return (
          s.setMonth(a),
  ...
  function q(t, s) {
    ...
    if (a.language) {
      ...
      if (
        ...
        o = n.language = e;
        const t = c || r[T];
        (c = Object.assign({ format: j, weekStart: H }, r[T])),
          o !== T && Object.assign(c, r[o]),
          (n.locale = c),
    ...
    if (
      (void 0 !== a.minDate &&
        ((y = null === a.minDate ? l(0, 0, 1) : R(a.minDate, d, c, y)), delete a.minDate),
      void 0 !== a.maxDate &&
        ((k = null === a.maxDate ? void 0 : R(a.maxDate, d, c, k)), delete a.maxDate),
      k < y
    ...
    if (
      (a.daysOfWeekDisabled &&
        ((n.daysOfWeekDisabled = a.daysOfWeekDisabled.reduce($, [])), delete a.daysOfWeekDisabled),
    ...
    let D = p;
    void 0 !== a.pickLevel && ((D = I(a.pickLevel, 2)), delete a.pickLevel),
      D !== p && (p = n.pickLevel = D);
    let v = u;
    void 0 !== a.maxView && ((v = I(a.maxView, u)), delete a.maxView),
      (v = p > v ? p : v) !== u && (u = n.maxView = v);
    let b = g;
    if (
      (void 0 !== a.startView && ((b = I(a.startView, b)), delete a.startView),
      b < p ? (b = p) : b > u && (b = u),
      b !== g && (n.startView = b),
      a.prevArrow)
    ) {
    ...
    if (
      (void 0 !== a.disableTouchKeyboard &&
        ((n.disableTouchKeyboard = 'ontouchstart' in document && !!a.disableTouchKeyboard),
  ...
  class G extends X {
    ...
    setOptions(t) {
      ...
      void 0 !== t.showDaysOfWeek &&
        (t.showDaysOfWeek
          ? (_(this.dow), this.calendarWeeks && _(this.calendarWeeks.dow))
  ...
  class Z extends X {
    ...
    init(e, t = !0) {
      t &&
        ...
        this.grid.appendChild(Y(r('span', 12, { 'data-month': e => e })))),
        super.init(e);
    }
    setOptions(t) {
    ...
    render() {
      ...
      Array.from(this.grid.children).forEach((n, r) => {
        ...
        if (
          ...
          (t || (i && r < this.minMonth) || (s && r > this.maxMonth)) && d.add('disabled'),
          a)
        ) {
          const [e, t] = a;
          r > e && r < t && d.add('range'),
        ...
        e.includes(r) && d.add('selected'),
          ...
          this.beforeShow && this.performBeforeHook(n, r, o);
      });
    }
    refresh() {
      const e = this.selected[this.year] || [],
    ...
    init(e, t = !0) {
      ...
      t &&
        ...
        (this.beforeShowOption = `beforeShow${
          ((i = this.cellClass), [...i].reduce((e, t, i) => (e += i ? t : t.toUpperCase()), ''))
        }`),
        (this.grid = this.element),
        this.element.classList.add(this.name, 'datepicker-grid'),
        this.grid.appendChild(Y(r('span', 12)))),
        super.init(e);
    }
    setOptions(t) {
      if (
        (e(t, 'minDate') &&
          (void 0 === t.minDate
            ...
            : ((this.minYear = m(t.minDate, this.step)), (this.minDate = l(this.minYear, 0, 1)))),
        e(t, 'maxDate') &&
          (void 0 === t.maxDate
            ? (this.maxYear = this.maxDate = void 0)
            : ((this.maxYear = m(t.maxDate, this.step)), (this.maxDate = l(this.maxYear, 11, 31)))),
  ...
  function re(t, i) {
    if (
      (void 0 !== i.title &&
        (i.title
          ? ((t.controls.title.textContent = i.title), _(t.controls.title))
    ...
    if (
      ...
      void 0 !== i.todayBtn && (i.todayBtn ? _(t.controls.todayBtn) : W(t.controls.todayBtn)),
  ...
  function oe(e, t) {
    ...
    switch (
      ...
      s.getMonth() !== i.getMonth() && te(e.datepicker, 'changeMonth'),
      a)
    ) {
      case 0:
        return t < r || t > d;
  ...
  class le {
    constructor(e) {
      ...
      i.classList.add(`datepicker-${p}`),
          ...
          [
            ...
            function (e, t) {
              ...
              a
                ...
                : ne(e, 1 === s ? Number(i.dataset.month) : Number(i.dataset.year));
            }.bind(null, e),
          ],
          [
            f.viewSwitch,
        ...
        (this.views = [
          ...
          new ee(this, { id: 3, name: 'decades', cellClass: 'decade', step: 10 }),
        ]),
    ...
    place() {
      ...
      a === document.body
        ? ((p = window.scrollY), (g = l + window.scrollX), (m = h + p))
        : ((g = l - d), (m = h - o + (p = a.scrollTop))),
        'auto' === w &&
          (g < 0
            ? ((w = 'left'), (g = 10))
            : (w = g + n > c ? 'right' : 'rtl' === ce(s) ? 'right' : 'left')),
        'right' === w && (g -= n - u),
        'auto' === y && (y = m - r < p ? 'bottom' : 'top'),
        'top' === y ? (m -= r) : (m += f),
        e.remove(
        ...
        e.add(`datepicker-orient-${y}`, `datepicker-orient-${w}`),
        (t.top = m ? `${m}px` : m),
        (t.left = g ? `${g}px` : g);
    }
  ...
  function he(e, t, i, s) {
    ...
    switch (r.id) {
      case 0:
        (l = s ? h(l, 7 * i) : t.ctrlKey || t.metaKey ? f(l, i) : h(l, i)),
          (o = h),
          (c = e => r.disabled.includes(e));
        break;
      case 1:
        (l = u(l, s ? 4 * i : i)),
          (o = u),
  ...
  function fe(e, t, i = !1) {
    ...
    return 0 !== o.length
      ? (s.multidate &&
        ...
        s.maxNumberOfDates && o.length > s.maxNumberOfDates ? o.slice(-1 * s.maxNumberOfDates) : o)
      : void 0;
  }
  ...
  function ge(e, t, i) {
    ...
    r &&
      (r.toString() !== e.dates.toString()
        ? ((e.dates = r), pe(e, a ? 3 : 1), te(e, 'changeDate'))
        : pe(e, 1),
      n && e.hide());
  }
  class me {
    ...
    setDate(...e) {
      ...
      'object' != typeof a ||
        ...
        ge(this, Array.isArray(i[0]) ? i[0] : i, s);
    }
    update(e) {
    ...
    refresh(e, t = !1) {
      ...
      e && 'string' != typeof e && ((t = e), (e = void 0)),
        pe(this, (i = 'picker' === e ? 2 : 'input' === e ? 1 : 3), !t);
    }
    enterEditMode() {
      this.inline ||
        !this.picker.active ||
    ...
    (window.DateRangePicker = class {
      constructor(e, t = {}) {
        ...
        Object.defineProperty(this, 'datepickers', { get: () => n }),
          ye(this, s, this.inputs[0], a),
          ye(this, s, this.inputs[1], a),
          Object.freeze(n),
          n[0].dates.length > 0
            ? ke(this, { target: this.inputs[0] })
            : n[1].dates.length > 0 && ke(this, { target: this.inputs[1] });
      }
      get dates() {
      ...
      setDates(e, t) {
        ...
        (this._updating = !0),
          ...
          s.dates[0] !== a[1]
            ...
            : i.dates[0] !== a[0] && ke(this, { target: this.inputs[0] });
      }
    });
})();
