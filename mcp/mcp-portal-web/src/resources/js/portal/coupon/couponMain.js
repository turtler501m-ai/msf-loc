...
window.onpopstate = function (event){
    location.href = "/coupon/couponMain.do";
}*/
...
$(document).ready(function (){
    ...
    document.addEventListener('UILoaded', function() {
       KTM.swiperA11y('#swiperOpenMarket', {
         loop: true,
         navigation : {
              nextEl : '.coupon-pager.swiper-button-next',
              prevEl : '.coupon-pager.swiper-button-prev',
            },
         autoplay: {
           delay: 3000,
...
function showDtl(coupnCtgCd){
    ...
    openPage('pullPopup', '/coupon/couponDetailPop.do', parameterData, '0');
}
