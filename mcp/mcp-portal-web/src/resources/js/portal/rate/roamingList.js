...
function mainTabAllClick(){
    ...
    url = "/rate/roamingAllListPanel.do";
    //페이지 호출
        ...
        , function (data) {
            if (data.isLogin == false) {
                ...
                if (data.userDivision == "00") {
                    ...
                    //팝업 띄우기
                    openPage('pullPopup', '/rate/roamingPop.do', parameterData, 1);
                }
              }
            }
        });
