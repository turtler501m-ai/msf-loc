...
$(document).ready(function () {
    ...
    $("#cstmrName,#cstmrForeignerRrn01,#cstmrForeignerRrn02,#cstmrNativeRrn01,#cstmrNativeRrn02, #minorAgentTel").keyup(function(){
        isValidateNonEmptyStep1();
    });
    ...
    var getGiftRowTemplate = function (obj) {
        ...
        if("C" == obj.prmtType){
            ...
            arr.push("    <h5 class='gift-free-tit'>" + obj.prmtNm + "</span></h5>\n");
