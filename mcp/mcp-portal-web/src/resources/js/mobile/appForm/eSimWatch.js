...
$(document).ready(function() {
    $("#btnAuthCstmr").click(function(){
        ...
        if (validator.validate()) {
            var varData = ajaxCommon.getSerializedData({
                ...
                ,cstmrMobile : $.trim($("#cstmrMobile").val())
    ...
    $("#reSetBtn").click(function(){
        $("#eidTxt").val("").parent().removeClass("has-value");
        $("#imeiTxt").val("").parent().removeClass("has-value");
    });
    ...
    $("._ocrEidRecord").click(function(){
        ...
        var eidVal = $.trim($("#eid").val());
        var imei1Val = $.trim($("#imei1").val());
    ...
    ajaxCommon.getItemNoLoading({
        ...
        ,function(result){
            ...
            if(result.returnCode == '0000' && jsonObj.status == 0){
                ...
                $("#layerEid").html(pageObj.eid);
                $("#layerImei").html(pageObj.imei1);

                if (pageObj.eid == "-" || pageObj.imei1 == "-") {
