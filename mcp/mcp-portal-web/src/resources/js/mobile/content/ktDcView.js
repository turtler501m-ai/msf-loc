...
$("#ctn").on("change", function() {

    ajaxCommon.createForm({
        method:"post"
        ,action:"/m/content/ktDcView.do"
    });
...
function discountSearch() {
    ...
    ajaxCommon.getItem({
        ...
        ,cache:false
        ,url:'/m/content/discountSearchAjax.do'
        ,data: varData
        ,dataType:"json"
     }
     ,function(jsonObj){
         ...
         $('input[name="tripleDcItem"]').each(function() {
          ...
          var varData = ajaxCommon.getSerializedData({
            ...
            ajaxCommon.getItem({
                id:'ktDcViewAjax'
                ,cache:false
                ,url:'/m/content/insertKtDcAjax.do'
                ,data: varData
                ,dataType:"json"
             }
             ,function(jsonObj){
...
function goBack() {
    location.href = "/m/content/ktDcView.do?doneReturn=Y";
}
