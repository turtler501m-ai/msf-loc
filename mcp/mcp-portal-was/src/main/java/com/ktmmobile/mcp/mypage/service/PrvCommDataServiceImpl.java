...
@Service
public class PrvCommDataServiceImpl implements PrvCommDataService{

    private static final Logger logger = LoggerFactory.getLogger(PrvCommDataServiceImpl.class);
