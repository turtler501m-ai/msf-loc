...
import com.ktmmobile.mcp.app.service.AppPushSvc;
 ...
 */
@Controller
public class MyOllehController {

    private static Logger logger = LoggerFactory.getLogger(MyOllehController.class);
...
//    @Autowired
//    private  PayInfoService payInfo;
...
//    }
   ...
   */
   ...
   public String moscSdsSvcRegView(HttpServletRequest request, ModelMap model,@ModelAttribute("searchVO") MyPageSearchDto searchVO, String engtPerd)  {
       ...
       List<NmcpCdDtlDto> presentList = NmcpServiceUtils.getCodeList(com.ktmmobile.mcp.common.constants.Constants.GROUP_CODE_PRESENT_CODE);
