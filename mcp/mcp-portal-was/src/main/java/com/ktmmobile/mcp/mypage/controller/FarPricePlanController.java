...
import com.ktmmobile.mcp.common.mplatform.dto.MoscFarPriceChgDto.M_messageDto;
...
import com.ktmmobile.mcp.common.mplatform.vo.MpCustInfoAgreeVO;
...
@Controller
public class FarPricePlanController {

    private static final Logger logger = LoggerFactory.getLogger(FarPricePlanController.class);
