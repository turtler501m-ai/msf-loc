...
public class MypageUserServiceImpl implements MypageUserService{
    ...
    private static final Logger logger = LoggerFactory.getLogger(MypageUserService.class);
    ...
    */
    ...
    @Override
    public String prodUserSms(String name, String phone1, String phone2,
...
//        userVO.setPost(userVO.getPost1());
        ...
        if (result == 1 && userVO.getPersonalInfoCollectAgree() != null) {
            ...
            //restTemplate.postForObject(apiInterfaceServer + "/mypage/callMcpMrktAgr", joinDto, JoinDto.class);
            /*
             * mypageUserDao.callMcpMrktAgr(userVO.getUserid(), userVO.getEmailRcvYn(),
             * userVO.getSmsRcvYn());
             */
        }
...
//      map.put("name", name);
//      map.put("mobileNo", mobileNo.toString());
...
//      return mypageUserDao.selectContractNum(map);
    ...
    public void callMspMrktAgr(String ctn, String personalInfoCollectAgree, String othersTrnsAgree, String mrktAgr, String othersTrnsKtAgree, String othersAdReceiveAgree, String userId) {
        mypageUserDao.callMspMrktAgr(ctn, personalInfoCollectAgree, othersTrnsAgree, mrktAgr, othersTrnsKtAgree, othersAdReceiveAgree, userId);
    }
