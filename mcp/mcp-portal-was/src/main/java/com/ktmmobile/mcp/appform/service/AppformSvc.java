...
//    public boolean inicisMobileIsoPay(InipayDto inipayDto) ;
    ...
    MSimpleOsstXmlSt1VO sendOsstSt1Service(Map<String, String> osstParam, String eventCd) throws SelfServiceException, SocketTimeoutException, McpMplatFormException;
