...
import com.ktmmobile.mcp.appform.dto.*;
import com.ktmmobile.mcp.appform.service.AppformSvc;
import com.ktmmobile.mcp.appform.service.EsimSvc;
import com.ktmmobile.mcp.appform.service.EventCodeSvc;
import com.ktmmobile.mcp.appform.service.ScanSvc;
...
import com.ktmmobile.mcp.common.dto.db.*;
import com.ktmmobile.mcp.common.exception.*;
...
import com.ktmmobile.mcp.common.mplatform.dto.MoscCrdtCardAthnInDto;
import com.ktmmobile.mcp.common.mplatform.dto.MoscInqrUsimUsePsblOutDTO;
...
import com.ktmmobile.mcp.etc.dto.GiftPromotionDtl;
...
import static com.ktmmobile.mcp.appform.util.AppformUtil.isSuccessOP2;
import static com.ktmmobile.mcp.common.constants.Constants.*;
import static com.ktmmobile.mcp.common.constants.Constants.JEHU_AGENT_LIST;
...
//        }
        ...
        if (exceptionPrice != null) {
            rtnMap.put("RESULT_CODE", AJAX_SUCCESS);
            rtnMap.put("RESULT_MSG", "예외 요금제 입니다. 셀프개통 신규 개통 가능 합니다.");
            return rtnMap;
        }
        ...
        if (rtnAppformReq == null) {
            ...
            rtnMap.put("RESULT_CODE", "-1");
            rtnMap.put("RESULT_MSG", "셀프개통한 정보가 있습니다. \n셀프개통이 불가능 합니다. ");
...
//        }
    ...
    public String appJehuFormDesignView(HttpServletRequest request
        ...
        appformReqDto.setEnggMnthCnt(Long.valueOf(mspSalePlcyMstDtoList.get(0).getAgrmTrm()));
