...
import static com.ktmmobile.mcp.common.exception.msg.ExceptionMsgConstant.ACE_256_DECRYPT_EXCEPTION;
import static com.ktmmobile.mcp.common.exception.msg.ExceptionMsgConstant.SCAN_SERVER_SEND_EXCEPTION;
import static com.ktmmobile.mcp.common.exception.msg.ExceptionMsgConstant.SCAN_XML_SAVE_EXCEPTION;
            ...
            if("Y".equals(requestData.get("CLAUSE_INSR_PROD_FLAG"))){
                ...
                for (int i = 0; i < insrProdAppPointInfoList.size(); i++) {
                    ...
                    if ("CSTMR_NAME".equals(appPointInfo.get("COLUMN_NAME"))) {
                        if (!(StringUtil.isEmpty(requestData.get("MINOR_AGENT_NAME")))) {
                            continue;
                        }
                    }
