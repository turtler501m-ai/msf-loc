...
public class PaywayDto implements Serializable {
    ...
    private String myslAthnTypeCd; //본인인증타입 코드


    public String getPayBizCd() {
        return payBizCd;
    }
    public void setPayBizCd(String payBizCd) {
        this.payBizCd = payBizCd;
    }
    ...
    public String getCycleDueDay() {
        return cycleDueDay;
    }
    public void setCycleDueDay(String cycleDueDay) {
        this.cycleDueDay = cycleDueDay;
    }
    ...
    public String getBlpymTmsIndCd() {
        return blpymTmsIndCd;
    }
    public void setBlpymTmsIndCd(String blpymTmsIndCd) {
        this.blpymTmsIndCd = blpymTmsIndCd;
    }
