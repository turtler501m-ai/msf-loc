...
public class PrepaidController {
	...
	private static Logger logger = LoggerFactory.getLogger(PrepaidController.class);
     ...
     *
     */
    @RequestMapping("/mypage/prepaidList.do")
    public String ppList(
        ...
        checkOverlapDto.setRedirectUrl("/mypage/prepaidList.do");
        ...
        if( !this.checkUserType(searchVO, cntrList, userSession) ){
            ...
            responseSuccessDto.setRedirectUrl("/mypage/updateForm.do");
