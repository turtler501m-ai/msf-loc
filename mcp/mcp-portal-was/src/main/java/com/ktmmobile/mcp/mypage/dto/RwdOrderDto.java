...
public class RwdOrderDto implements Serializable {
    ...
    private MultipartFile[] file;       /* 자급제 보상서비스 증빙 서류 */
    ...
    private String onlineAuthType;      /* 본인인증 수단 */
    private String authCstmrName;       /* 본인인증에 사용한 고객명 */
    private String authBirthDate;       /* 본인인증에 사용한 생년월일 (주민번호 앞자리) */

    private String clauseRwdRegFlag;            /* 서비스 가입 동의 (필수) */
    private String clauseRwdPaymentFlag;        /* 지급기준 이행 동의 (필수) */
    private String clauseRwdRatingFlag;         /* 평가 기준 동의 (필수) */
    private String clauseRwdPrivacyInfoFlag;    /* 개인정보 수집ㆍ이용에 대한 동의 (필수) */
    private String clauseRwdTrustFlag;          /* 개인정보 수집ㆍ이용ㆍ제공ㆍ위탁 동의서 (필수) */
    ...
    public String getBuyPric() {return buyPric;}

    public void setBuyPric(String buyPrice) {
        this.buyPric = buyPrice;
    }
    ...
    public String getAuthCstmrName() {
        return authCstmrName;
    }

    public void setAuthCstmrName(String authCstmrName) {
        this.authCstmrName = authCstmrName;
    }

    public String getAuthBirthDate() {
        return authBirthDate;
    }

    public void setAuthBirthDate(String authBirthDate) {
        this.authBirthDate = authBirthDate;
    }
    ...
    public String getClauseRwdRegFlag() {
        return clauseRwdRegFlag;
    }

    public void setClauseRwdRegFlag(String clauseRwdRegFlag) {
        this.clauseRwdRegFlag = clauseRwdRegFlag;
    }

    public String getClauseRwdPaymentFlag() {
        return clauseRwdPaymentFlag;
    }

    public void setClauseRwdPaymentFlag(String clauseRwdPaymentFlag) {
        this.clauseRwdPaymentFlag = clauseRwdPaymentFlag;
    }

    public String getClauseRwdRatingFlag() {
        return clauseRwdRatingFlag;
    }

    public void setClauseRwdRatingFlag(String clauseRwdRatingFlag) {
        this.clauseRwdRatingFlag = clauseRwdRatingFlag;
    }

    public String getClauseRwdPrivacyInfoFlag() {
        return clauseRwdPrivacyInfoFlag;
    }

    public void setClauseRwdPrivacyInfoFlag(String clauseRwdPrivacyInfoFlag) {
        this.clauseRwdPrivacyInfoFlag = clauseRwdPrivacyInfoFlag;
    }

    public String getClauseRwdTrustFlag() {
        return clauseRwdTrustFlag;
    }

    public void setClauseRwdTrustFlag(String clauseRwdTrustFlag) {
        this.clauseRwdTrustFlag = clauseRwdTrustFlag;
    }

    public String getOrgScanId() {
        return orgScanId;
    }

    public void setOrgScanId(String orgScanId) {
        this.orgScanId = orgScanId;
    }
    ...
    public void setScanFileId(String scanFileId) {
