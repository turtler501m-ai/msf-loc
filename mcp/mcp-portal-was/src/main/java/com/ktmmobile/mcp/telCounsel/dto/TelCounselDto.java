...
public class TelCounselDto implements Serializable {
    ...
    /** 사업자 등록번호 */
    private String juridicalNumber;
	...
	public String getFullTextForMsp() {
        fullTextForMsp = getRateNm() +"/"+ getOperType() +"/"+ getReqUsimSn()+ "/" + getMoveMobileNo()+ "/" + getJuridicalNumber()+ "/" + getAgentNm();
    ...
    public String getJuridicalNumber() {
		return juridicalNumber;
	}

	public void setJuridicalNumber(String juridicalNumber) {
		this.juridicalNumber = juridicalNumber;
	}
