...
public class AlliCardContDtoXML {
	...
	private String cprtCardItemCdNm;
	private String cprtCardItemDesc;
	private String cprtCardBnfitItemNm;
	...
	private String linkUrlMo;	/* 링크URL*/
	private String linkUrlTarget;	/* 링크URL*/
	private String linkUrlTargetMo;	/* 링크URL*/
	...
	public void setLinkUrlTarget(String linkUrlTarget) {
		this.linkUrlTarget = linkUrlTarget;
	}
	public String getLinkUrlTargetMo() {
		return linkUrlTargetMo;
	}
	public void setLinkUrlTargetMo(String linkUrlTargetMo) {
		this.linkUrlTargetMo = linkUrlTargetMo;
	}
	...
	@XmlElement
	public void setCprtCardItemCdNm(String cprtCardItemCdNm) {
		this.cprtCardItemCdNm = cprtCardItemCdNm;
	}
	public String getCprtCardItemCdNm() {
		return cprtCardItemCdNm;
	}
	...
	public String getCprtCardBnfitItemNm() {
		return cprtCardBnfitItemNm;
	}

	@XmlElement
	public void setCprtCardBnfitItemNm(String cprtCardBnfitItemNm) {
		this.cprtCardBnfitItemNm = cprtCardBnfitItemNm;
	}
