package com.ktmmobile.mcp.common.mplatform;
...
//            mplatFormServerAdapter.callService(param, vo);
    ...
    public MpFarPriceInfoDetailItemVO farPriceInfoDetailItem(String ncn, String ctn, String custId,
        ...
        if ("LOCAL".equals(serverLocation)) {
            if (param.get("messageLine").toString().equals("DCNOR")) {//할인전부가세
//                getVo(171, vo);
                mplatFormServerAdapter.callService(param, vo);
            } else if (param.get("messageLine").toString().equals("PY000")) {//소액결제
//                getVo(172, vo);
                mplatFormServerAdapter.callService(param, vo);
            } else if (param.get("messageLine").toString().equals("MA000")) {
//                getVo(173, vo);
                mplatFormServerAdapter.callService(param, vo);
            } else {
//                getVo(17, vo);
...
//        	getVoEtc("Y15", vo);
    ...
    private void putAgreeInfoToParamMap(HashMap<String, String> param, MpCustInfoAgreeVO mpCustInfoAgreeVO) {
        List<String> agreeNames = List.of("othcmpInfoAdvrRcvAgreYn", "othcmpInfoAdvrCnsgAgreYn", "grpAgntBindSvcSbscAgreYn", "cardInsrPrdcAgreYn", "fnncDealAgreeYn", "cnsgInfoAdvrRcvAgreYn");
