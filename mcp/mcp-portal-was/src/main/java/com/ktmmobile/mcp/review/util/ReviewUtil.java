package com.ktmmobile.mcp.review.util;
...
public class ReviewUtil {
    ...
    public static boolean validateImgFile(MultipartFile file) {
    ...
    public static ReviewDto getReviewInsertDto(ReviewDto reviewDto) {
        ReviewDto insertReviewDto = new ReviewDto();
        String reviewType = reviewDto.getReviewType();
        String reviewTypeDtl = reviewDto.getReviewTypeDtl();
        String contractNum = reviewDto.getContractNum();
        String userId = reviewDto.getUserId();
        String regstId = reviewDto.getRegstId();
        String regstNm = reviewDto.getRegstNm();
        String rip = reviewDto.getrIp();
        String reviewContent = reviewDto.getReviewContent();
        reviewContent = ParseHtmlTagUtil.parseTag(filterText(reviewContent));
        String snsInfo = reviewDto.getSnsInfo();
        snsInfo = ParseHtmlTagUtil.parseTag(snsInfo);

        insertReviewDto.setContractNum(contractNum);
        insertReviewDto.setUserId(userId);
        insertReviewDto.setReviewContent(reviewContent);
        insertReviewDto.setReviewType(reviewType);
        insertReviewDto.setReviewTypeDtl(reviewTypeDtl);
        insertReviewDto.setSnsInfo(snsInfo);
        insertReviewDto.setNotiYn("N");
        insertReviewDto.setPrizeRnk("");
        insertReviewDto.setUseYn("Y");
        insertReviewDto.setrIp(rip);
        insertReviewDto.setRegstNm(regstNm);
        insertReviewDto.setRegstId(regstId);

        return insertReviewDto;
    }
