...
import static com.ktmmobile.mcp.common.constants.Constants.PAY_INFO_CREATEYN_FAIL;
import static com.ktmmobile.mcp.common.constants.Constants.PAY_INFO_CREATEYN_REQ;
import static com.ktmmobile.mcp.common.constants.Constants.PAY_INFO_CREATEYN_TIMEOUT;
...
import com.ktmmobile.mcp.common.mplatform.dto.MoscSimplePaySmsRes;
...
public class PaywayServiceImpl implements PaywayService {
    ...
    private static Logger logger = LoggerFactory.getLogger(PaywayServiceImpl.class);
