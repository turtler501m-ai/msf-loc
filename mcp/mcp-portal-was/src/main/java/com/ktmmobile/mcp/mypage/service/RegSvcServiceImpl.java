...
import com.ktmmobile.mcp.rate.dto.RateAdsvcGdncProdXML;
...
public class RegSvcServiceImpl implements RegSvcService{
    ...
    private static Logger logger = LoggerFactory.getLogger(RegSvcService.class);
