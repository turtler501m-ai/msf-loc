...
public class MspRateMstDto implements Serializable {
    ...
    public String getXmlDataCnt() {
        return xmlDataCnt;
    }

    public void setXmlDataCnt(String xmlDataCnt) {
        this.xmlDataCnt = xmlDataCnt;
    }

    public String getXmlQosCnt() {
        return xmlQosCnt;
    }

    public void setXmlQosCnt(String xmlQosCnt) {
        this.xmlQosCnt = xmlQosCnt;
    }

    public String getXmlCallCnt() {
        return xmlCallCnt;
    }

    public void setXmlCallCnt(String xmlCallCnt) {
