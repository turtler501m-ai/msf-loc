...
public class MyinfoController {
    ...
    public Map<String, Object> setMktAgrYnAjax(HttpServletRequest request,
        ...
        try {
            mypageUserService.callMspMrktAgr(cntrInfo.getCntrMobileNo(), personalInfoCollectAgree, othersTrnsAgree, mktAgrYn, othersTrnsKtAgree, othersAdReceiveAgree, userSession.getUserId());
        } catch(Exception e) {
            throw new McpCommonJsonException("E", "정보/광고 수신동의 설정이 변경에 실패했습니다.");
        }
