...
<t:insertDefinition name="mlayoutDefaultTitle">
    <t:putAttribute name="scriptHeaderAttr">
        <script type="text/javascript" src="/resources/js/mobile/appForm/withoutUsim.js?version=26-02-19"></script>
    </t:putAttribute>
    <t:putAttribute name="contentAttr">
        ...
        <div class="ly-content" id="main-content">
            ...
            <div class="c-tabs c-tabs--type2 c-tabs--usim">
		        <div class="c-tabs__list" id="withoutUsim-tab" data-tab-list>
		            <button class="c-tabs__button" data-tab-header="#tabpanel1" aria-controls="tabpanel1" data-name="esim"><p>eSIM</p><span>QR코드 개통</span></button>
		            <button class="c-tabs__button" data-tab-header="#tabpanel2" aria-controls="tabpanel1" data-name="usim"><p>USIM</p><span>실물 유심 개통</span></button>
		        </div>
		        <div class="c-tabs__panel" id="tabpanel1">
		        	<div class="esim-now-banner">
						<div class="esim-now-banner-wrap">
							<img class="esim-now-banner-effect" src="/resources/images/mobile/esim/esim_now_effect1.png" alt="">
							<img class="esim-now-banner-effect" src="/resources/images/mobile/esim/esim_now_effect2.png" alt="">
							<img class="esim-now-banner-effect" src="/resources/images/mobile/esim/esim_now_effect3.png" alt="">
							<img class="esim-now-banner-effect" src="/resources/images/mobile/esim/esim_now_effect4.png" alt="">
							<img class="esim-now-banner-effect" src="/resources/images/mobile/esim/esim_now_effect5.png" alt="">
							<div class="c-button-wrap">
			                  <button class="c-button c-button--full c-button--primary" id="step3">eSIM 셀프개통 하기</button>
			                </div>
			                <img src="/resources/images/mobile/esim/esim_now_banner.png" alt="바로 eSIM 바로 개통, 쉽고 싸고 빠르게!">
						</div>
					</div>
					<div class="esim-now-content">
						<div class="esim-now-wrap">
							<img src="/resources/images/mobile/esim/esim_now_content1.png" alt="바로 eSIM 바로 개통, eSIM은 스마트폰 본체에 내장된 SIM으로 휴대폰에 장착할 필요 없이 SIM을 다운로드해 사용하는 방식입니다.">
						</div>
						<div class="esim-now-wrap">
							<img src="/resources/images/mobile/esim/esim_now_content2.png" alt="클릭 한 번으로 착! 쉽고! eSIM은 SIM을 꽂을 필요 없이 QR코드 다운으로 설치 및 이용이 쉽습니다.">
						</div>
						<div class="esim-now-wrap">
							<img src="/resources/images/mobile/esim/esim_now_content3.png" alt="유심보다 저렴하게! 싸고! eSIM은 USIM 보다 약 69% 저렴해 합리적으로 이용 가능합니다. 69% SAVE, eSIM 2,750원, USIM 6,600원">
						</div>
						<div class="esim-now-wrap">
							<img src="/resources/images/mobile/esim/esim_now_content4.png" alt="5분이면 개통 끝! 빠르게! eSIM은 카드 구매, 배송 기다릴 필요 없이 휴대폰만 있으면 빠르게 개통 가능합니다.">
						</div>
						<div class="esim-now-wrap">
							<img src="/resources/images/mobile/esim/esim_now_content5.png" alt="">
						</div>
						<div class="esim-now-wrap">
							<img src="/resources/images/mobile/esim/esim_now_fast.png" alt="얼마나 빠를까? eSIM vs USIM">
						</div>
						<div class="esim-now-wrap esim-fast" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="0">
							<img class="esim-fast__item" src="/resources/images/mobile/esim/esim_now_fast_step1.png" alt="eSIM USIM">
							<img class="esim-fast__item" src="/resources/images/mobile/esim/esim_now_fast_step2.png" alt="eSIM : 1분, *#06# 입력 후 기기정보 캡쳐, USIM : 1분, 유심카드 선택">
							<img class="esim-fast__item" src="/resources/images/mobile/esim/esim_now_fast_step3.png" alt="eSIM : 2분, 요금제 선택 후 셀프개통 시작!, USIM : 2분 주문 완료">
							<img class="esim-fast__item" src="/resources/images/mobile/esim/esim_now_fast_step4.png" alt="eSIM : 2분, QR코드 스캔 후 eSIM 활성화하면 끝!, USIM : 2분, 배송 준비중">
							<img class="esim-fast__item" src="/resources/images/mobile/esim/esim_now_fast_step5.png" alt="eSIM : 셀프개통  5분 완성, USIM : 1시간, 배송 출발, 2일 뒤, 드디어 유심 도착! 셀프개통 이제 시작">
						</div>
						<div class="esim-now-wrap">
							<img src="/resources/images/mobile/esim/esim_now_join.png" alt="5분 완성! eSIM 가입방법">
						</div>
						<div class="esim-now-wrap">
							<img src="/resources/images/mobile/esim/esim_now_join_guide.png" alt="1. 개통 전 기기 정보를 준비합니다. 통화창에 *#06# 입력 후 고유식별 번호 EID와 IMEI가 포함된 화면을 캡처해 주세요. 2. 원하는 요금제 선택 후 가입 신청서 내 휴대폰 정보를 등록합니다. 이미지 등록 버튼 클릭 후 캡처한 이미지를 업로드해 주세요. 3. 화면의 QR 코드 스캔 후 eSIM 활성화하면 끝! 정상적인 사용을 위해서는 휴대폰에 eSIM을 반드시 발급받으셔야 합니다.">
						</div>
						<div class="esim-now-wrap esim-now--gray u-plr--20">
							<div class="c-button-wrap c-button-wrap--column u-pb--40 u-mt--0">
			                  <button class="c-button c-button--full c-button--primary" data-dialog-trigger="#esimPhone">eSIM 지원 휴대폰 확인하기</button>
			                  <button class="c-button c-button--full c-button--primary" data-dialog-trigger="#eidNumber">고유번호(EID/IMEI) 확인방법</button>
			                </div>
						</div>
						<div class="esim-now-wrap">
							<img src="/resources/images/mobile/esim/esim_now_issuance.png" alt="eSIM 발급 가이드 반드시 단말기가 Wi-Fi 또는 셀룰러 망 (5G/LTE)에 연결되어 있어야 합니다. eSIM으로 개통 시, 개통 신청한 단말에 eSIM 발급(상세정보 추가 입력)이 필요합니다.">
						</div>
						<div class="esim-now-wrap u-plr--20">
				                            ...
				                            <div class="c-accordion__panel expand" id="acc_content_03" aria-labelledby="acc_header_03">
				                                <div class="c-accordion__inside">
				                                    ...
				                                    <div class="esim-qr-img">
				                                        <img src="/resources/images/mobile/esim/esim_now_issuance_qr.png" alt="eSIM 발급 시 스캔하는 QR코드 예시">
				                                    </div>
				                                </div>
				                            </div>
				                        </li>
						...
						<div class="esim-now-wrap">
							<img src="/resources/images/mobile/esim/esim_now_notice.png" alt="eSIM 취급상의 유의사항 eSIM은 본체로부터 분리가 불가합니다. 휴대폰 분실/파손 또는 eSIM을 삭제한 경우 eSIM재발행(유상)이 필요합니다. eSIM의 재발행은 고객센터를 통해서만 가능합니다.">
						</div>
						<div class="esim-now-wrap">
							<img src="/resources/images/mobile/esim/esim_now_time.png" alt="eSIM 개통 가능 시간 셀프개통(번호이동): 10:00 ~ 19:50 (일요일, 신정·설·추석 당일 제외) 셀프개통(신규): 08:00 ~ 21:50 상담사 개통: 09:00 이후 순차 진행 ※ 외국인·미성년자는 상담사 개통만 가능">
						</div>
						<div class="esim-now-wrap">
							<img src="/resources/images/mobile/esim/esim_now_review.png" alt="98% 고객이 만족하는 eSIM">
							<div class="swiper esim-now-review-swiper">
							  <div class="swiper-wrapper">
							    <div class="swiper-slide"><img src="/resources/images/mobile/esim/esim_now_review_list1.png" alt="생각보다 쉬워서 놀랐어요. 비 오는 날이었는데 밖에 나갈 필요도 없고 집에서 다 해결됐어요, 5G 모두다 맘껏 70GB+(밀리의 서재), 박**"></div>
							    <div class="swiper-slide"><img src="/resources/images/mobile/esim/esim_now_review_list2.png" alt="급하게 개통해야 했는데 배송 기다릴 필요 없이 바로 쓸 수 있어서 좋았어요. 전체 과정이 생각보다 간편했습니다, 모두다 맘껏 100GB+(CU 20%할인), 윤**"></div>
							    <div class="swiper-slide"><img src="/resources/images/mobile/esim/esim_now_review_list3.png" alt="유심비용보다 저렴한데다 빠르고 쉬워서 다음에도 eSIM 쓸 것 같아요. 매장 방문 없이 집에서 가능해서 더 편했습니다. 모두다 맘껏 100GB+(밀리의 서재 FREE) 김**"></div>
							    <div class="swiper-slide"><img src="/resources/images/mobile/esim/esim_now_review_list4.png" alt="설명대로 따라하니까 금방 개통됐어요. 복잡한 과정 없이 써서 좋았습니다. 5G 모두다 맘껏 14GB+ 백**"></div>
							    <div class="swiper-slide"><img src="/resources/images/mobile/esim/esim_now_review_list5.png" alt="처음 써보는 eSIM 이라 걱정했는데 어렵지 않았어요. 빠르고 간편해서 만족합니다. 5G 모두다 맘껏 안심 8GB+ 송**"></div>
							  </div>
							</div>
						</div>
						<div class="esim-now-wrap">
							<img src="/resources/images/mobile/esim/esim_now_qna.png" alt="자주 묻는 질문">
						</div>
						<div class="esim-now-wrap esim-now--gray u-plr--20">
							<div class="c-accordion c-accordion--single qna u-pb--50">
			                    <ul class="c-accordion__box">
			                        <li class="c-accordion__item">
			                            <div class="c-accordion__head">
			                            ...
			                            <div class="c-accordion__panel" id="acc_qna_01" aria-labelledby="acc_qna_header_01">
			                                <div class="c-accordion__inside">
			                                    <div class="esim-now-qna-wrap">
			                        ...
			                        <li class="c-accordion__item">
			                            ...
			                            <div class="c-accordion__panel" id="acc_qna_02" aria-labelledby="acc_qna_header_02">
			                                <div class="c-accordion__inside">
			                                    <div class="esim-now-qna-wrap">
				                                    <span class="esim-now-answer">A</span>
			                        ...
			                        <li class="c-accordion__item">
			                            ...
			                            <div class="c-accordion__panel" id="acc_qna_03" aria-labelledby="acc_qna_header_03">
			                                <div class="c-accordion__inside">
			                                    <div class="esim-now-qna-wrap">
				                                    <span class="esim-now-answer">A</span>
	            ...
	            <div class="c-tabs__panel" id="tabpanel2">
	            	<div class="usim-now-banner">
						<div class="usim-now-banner-wrap">
							<img class="usim-now-banner-effect" src="/resources/images/mobile/usim/without_usim_effect.png" alt="">
							<div class="c-button-wrap">
			                  <button class="c-button c-button--full c-button--primary" href="javascript:void(0);" onclick="selfTimeChk();">USIM 셀프개통 하기</button>
			                </div>
			                <img src="/resources/images/mobile/usim/without_usim_banner.png" alt="USIM이 없다면? 당일 배송, 당일 개통">
						</div>
					</div>
					<div class="usim-now-content">
						<div class="usim-now-wrap">
							<img src="/resources/images/mobile/usim/without_usim_content1.png" alt="유심 이렇게 구매할 수 있어요!">
							<a class="usim-now-link" href="/m/appForm/reqSelfDlvry.do" title="바로배송 유심 신청 페이지 이동">
								<img src="/resources/images/mobile/usim/without_usim_content2.png" alt="바로배송 유심, 2시간 내 바로 도착! 유심 받고 즉시 개통하세요.">
							</a>
							<img src="/resources/images/mobile/usim/without_usim_content3.png" alt="">
							<a class="usim-now-link" href="/m/direct/storeInfo.do" title="편의점/마트 신청 페이지 이동">
								<img src="/resources/images/mobile/usim/without_usim_content4.png" alt="편의점 · 마트, 집 근처에서 바로 구매! 기다림 없이 개통하세요.">
							</a>
							<img src="/resources/images/mobile/usim/without_usim_content5.png" alt="">
							<a class="usim-now-link" href="/m/direct/openMarketInfo.do" title="오픈마켓 신청 페이지 이동">
								<img src="/resources/images/mobile/usim/without_usim_content6.png" alt="온라인 마켓, 온라인으로 간편 주문! 도착 즉시 바로 개통하세요.">
							</a>
							<img src="/resources/images/mobile/usim/without_usim_content7.png" alt="">
						</div>
						<div class="usim-now-wrap">
							<img src="/resources/images/mobile/usim/without_usim_esim.png" alt="잠깐! eSIM은 어떠세요? eSIM은 USIM보다 더 저렴하고, 배송 기다릴 필요 없어요! 쉽고! SIM 꽂을 필요 없이 QR코드 다운로드만 하면 끝! 싸고! 기존 USIM보다 약 69% 더 저렴하게, 부담 없이! 빠르게! 구매·배송 기다릴 필요 없이 휴대폰만 있으면 즉시 개통!">
						</div>
						<div class="usim-now-wrap usim-now--blue u-plr--20">
							<div class="c-button-wrap c-button-wrap--column u-pb--50 u-mt--0">
			                  <button class="c-button c-button--full c-button--primary" id="step4">eSIM 셀프개통 하기</button>
			                </div>
						</div>
						<div class="usim-now-wrap">
							<img src="/resources/images/mobile/usim/without_usim_type.png" alt="USIM vs eSIM 어떤 방식이 나에게 맞을까? 두 가지 방식을 자세히 비교해 보고, 내 휴대폰 사용 패턴에 맞는 개통 방법을 선택하세요!">
							<div class="sr-only">
		                        <table>
		                            <caption>
						...
						<div class="usim-now-wrap">
							<img src="/resources/images/mobile/usim/without_usim_qna.png" alt="자주 묻는 질문 TOP 5">
						</div>
						<div class="usim-now-wrap usim-now--gray u-plr--20">
							<div class="c-accordion c-accordion--single qna u-pb--50">
			                    <ul class="c-accordion__box">
			                        <li class="c-accordion__item">
			                            <div class="c-accordion__head">
		...
		<div class="c-modal" id="eidNumber" role="dialog" tabindex="-1" aria-describedby="#eidNumberTitle">
		  <div class="c-modal__dialog c-modal__dialog--full" role="document">
		    <div class="c-modal__content">
		      ...
		      <div class="c-modal__body u-pa--0">
				<img src="/resources/images/mobile/esim/esim_now_modal2.png" alt="고유번호(EID/IMEI) 확인방법, 신청서 내 이미지 업로드 시 자동으로 기기 정보가 입력됩니다. 캡처 이미지 외 다른 이미지 업로드 시 기기 정보가 오 등록 될 수 있으므로 반드시 가이드를 준수 바랍니다.">
		      </div>
		    </div>
		  </div>
		</div>
