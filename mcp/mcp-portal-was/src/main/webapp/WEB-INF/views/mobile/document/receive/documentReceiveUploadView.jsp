...
<t:insertDefinition name="mlayoutNoGnbFotter">
	...
	<t:putAttribute name="scriptHeaderAttr">
		...
		<script type="module" src="/resources/js/mobile/document/receive/documentReceiveUploadView.js?version=25.11.11"></script>
	</t:putAttribute>
	...
	<t:putAttribute name="contentAttr">
        ...
        <div class="ly-content" id="main-content" style="padding-top: 0px;">
            ...
            <div class="file-upload-title-wrap">
                ...
                <button class="file-upload-title-btn" id="addFileBtn">
                    <span>서류첨부 추가</span><i class="c-icon c-icon--plus-type2" aria-hidden="true"></i>
                </button>
            </div>
                ...
                <li class="file-upload-list__item">
                    <div class="file-upload-list__select">
                        ...
                        <select class="c-select" id="select001">
                            <option label="명의자신분증" selected>명의자신분증</option>
                            <option label="명의자신분증2">명의자신분증2</option>
                            <option label="명의자신분증3">명의자신분증3</option>
                            <option label="명의자신분증4">명의자신분증4</option>
                            <option label="명의자신분증5">명의자신분증5</option>
                        </select>
                    </div>
                    <div class="file-upload-list__attachment">
                        <div class="file-upload-wrap">
                            <input type="text" class="file-name" id="fileName" placeholder="첨부" readonly>
            ...
            <ul class="c-text-list c-bullet c-bullet--hyphen u-fs-16 u-mt--18">
            ...
            <div class="c-button-wrap u-mt--28">
                <button id="sendBtn" class="c-button c-button--full c-button--primary">확인</button>
            </div>
        </div>
	</t:putAttribute>
</t:insertDefinition>