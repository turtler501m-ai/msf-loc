        ...
        <div class="ly-content" id="main-content">
            ...
            <div class="ktdc-banner">
                <div class="ktdc-banner__wrap">
                    <strong>KT인터넷 이용하고 할인은 더 크게</strong>
                    <p>KT상품을 더하면 커지는 할인혜택</p>
                    <a class="u-mr--8" href="https://m.shop.kt.com:444/m/display/olhsPlan.do?plnDispNo=2181" target="_blank">
                        KT인터넷 상담 신청
                        <i class="c-icon" aria-hidden="true"></i>
                    </a>
                    <a href="/m/content/ktDcView.do">
                           트리플할인 신청
                        <i class="c-icon" aria-hidden="true"></i>
                    </a>
                </div>
                <div class="ktdc-banner__image">
                    <img src="/resources/images/mobile/product/ktdc_banner.png" alt="">
                </div>
            </div>
            <div class="ktdc-content">
                ...
                <ul class="ktdc-benefit__list">
                    <li class="ktdc-benefit__item">
                        <div class="ktdc-benefit__item-head">
                            ...
                            <p>사은품/할인</p>
                            <p class="ktdc-benefit__item-text">인터넷 신규+TV 가입시</p>
                        </div>
                        <div class="ktdc-benefit__item-img">
                            <img src="/resources/images/mobile/product/ktdc_Benefit_01.png" alt="최대 93만원 사은품/할인, 인터넷 신규+TV 가입 시 사은품">
                        </div>
                    </li>
                    <li class="ktdc-benefit__item">
                        <div class="ktdc-benefit__item-head rate">
                            <p class="ktdc-benefit__item-title">최대 <span>13.2</span>만원</p>
                            <p>요금할인</p>
                            <p class="ktdc-benefit__item-text">kt M모바일 1회선 24개월</p>
                        </div>
                        <div class="ktdc-benefit__item-img">
                            <img src="/resources/images/mobile/product/ktdc_Benefit_02.png" alt="최대 5,500원 요금할인, kt M모바일 1회선 24개월 사은품">
                        </div>
                    </li>
                </ul>
                <div class="ktdc-title">
                ...
                <div class="ktdc-taget">
                    <ul class="ktdc-taget__list">
                        <li class="ktdc-taget__item">
                            ...
                            <img src="/resources/images/mobile/product/ktdc_icon_01.png" alt="">
                            <p>“KT인터넷 상담신청”을 통해 KT인터넷을 가입</p>
                            <a href="https://m.shop.kt.com:444/m/display/olhsPlan.do?plnDispNo=2181" title="KT인터넷 상담 신청 바로가기 새창열림" target="_blank">인터넷 상담신청 바로가기</a>
                        </li>
                        <li class="ktdc-taget__item">
                            <span class="step-list">STEP 2</span>
                            <img src="/resources/images/mobile/product/ktdc_icon_02.png" alt="">
                            <p>마이페이지에서 트리플할인 신청</p>
                            <a href="/m/content/ktDcView.do" title="트리플할인 신청 바로가기">트리플할인 신청 바로가기</a>
                        </li>
                    </ul>
                </div>
                <div class="ktdc-title">
                    <em>Why</em>
                    <h3>왜 kt M모바일을 통해 KT인터넷을 가입해야 하나요?</h3>
                    ...
                    <div class="ktdc-example-wrap">
                        <div class="ktdc-example__head-wrap">
                            <div class="ktdc-example__head">
                                <img src="/resources/images/mobile/product/ktdc_icon_03.png" alt="">
                                <p class="ktdc-example__title">여기서 잠깐!<br />kt M모바일의 할인금액을 알아볼게요.</p>
                        ...
                        <div class="ktdc-example__detail">
                            ...
                            <div class="ktdc-example__ktdc-info">
                                <dl>
                                    <dt>최대 혜택 금액</dt>
                                    <dd><p class="ktdc-example__ktdc-price">113<span>만원</span></p></dd>
                                </dl>
                            </div>
                            <div class="c-accordion c-accordion--type4">
                                <ul class="c-accordion__box" id="accktDcExample">
                                    <li class="c-accordion__item">
                                        <div class="c-accordion__panel expand open" id="accktDcInfo">
                                        ...
                                        <div class="c-accordion__head is-active" data-acc-header="#accktDcInfo">
                                              <button class="c-accordion__button c-accordion__button_type1" type="button" aria-expanded="false">
                                                ...
                                                <img src="/resources/images/mobile/product/ktdc_icon_06.png" alt="">
                                              </button>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <p class="ktdc-example__detail-fyr u-mt--14">※ 인터넷 에센스 이상+지니 TV에센스 이상 요금제 기준</p>
                ...
                <div class="ktdc-title">
                    <em>How</em>
                    <h3>추가 할인을 받으려면 어떻게 해야하나요?</h3>
                </div>
                <div class="ktdc-title u-mt--0">
                    <h3 class="ktdc-title--type2">사용하시는 인터넷과 M모바일 결합 시 인터넷에서 추가할인을 받으실 수 있습니다.</h3>
                    <div class="c-table">
                        <table>
                            <caption>KT 인터넷, 결합할인(3년 약정 기준) 항목이 포함된 표</caption>
                              <colgroup>
                                <col>
                                <col>
                              </colgroup>
                ...
                <div class="ktdc-title">
                    <h3 class="ktdc-title--type2">만약 하기 <span>요금제에 가입하고 인터넷과 결합 시</span>에는 매월 최대 20GB 데이터가 추가로 제공!</h3>
                    <div class="c-table">
                        <table>
                ...
                <div class="ktdc-title">
                    ...
                    <div class="c-button-wrap c-button-wrap--column">
                          <a class="c-button c-button--full c-button--primary" href="https://m.shop.kt.com:444/m/display/olhsPlan.do?plnDispNo=2181" title="KT인터넷 상담 신청 바로가기 새창열림" target="_blank">KT인터넷 상담 신청</a>
                          <a class="c-button c-button--full c-button--gray u-mt--12" href="/m/content/ktDcView.do" title="트리플할인 신청 바로가기">트리플할인 신청</a>
                    </div>
                </div>
            ...
            <div class="c-modal__dialog c-modal__dialog--full" role="document">
                  <div class="c-modal__content">
                    <div class="c-modal__header">
                          <h1 class="c-modal__title" id="ktDcRateModalTitle">${formDtl.dtlCdNm}</h1>
