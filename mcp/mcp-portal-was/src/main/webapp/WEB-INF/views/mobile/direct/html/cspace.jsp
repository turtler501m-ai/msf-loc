	...
	<t:putAttribute name="contentAttr">
		<div class="ly-content" id="main-content">
	      <div class="ly-page-sticky">
	        <h2 class="ly-page__head">편의점 찾기(씨스페이스)<button class="header-clone__gnb"></button>
	        </h2>
	      </div>
	      <div class="cvs-m-wrap">
	        <div class="cvs-m-wrap__image c-expand">
	          <img src="../../resources/images/mobile/cvs/cspace/img_01.jpg" alt="쉽고 빠른 씨스페이스 유심 가입하기">
	          <img src="../../resources/images/mobile/cvs/cspace/img_02.jpg" alt="씨스페이스 개통방법">
	          <img src="../../resources/images/mobile/cvs/cspace/img_03.jpg" alt="전국 씨스페이스에서 유심 구매 가능, 상담없이 직접 하는 셀프개통!">
	          <table>
	            <tbody>
	              <tr>
	                <td>
	                  <a href="/m/direct/storeInfo.do">
	                    <img src="../../resources/images/mobile/cvs/cspace/img_04_01.png" alt="편의점 찾기">
	                  </a>
	                </td>
	                <td>
	                  <a href="#" onclick="selfTimeChk()">
	                    <img src="../../resources/images/mobile/cvs/cspace/img_04_02.png" alt="셀프개통">
	                  </a>
	                </td>
	              </tr>
	            </tbody>
	          </table>
	          <img src="../../resources/images/mobile/cvs/cspace/img_05.jpg" alt="공백">
	          <img src="../../resources/images/mobile/cvs/cspace/img_06.jpg" alt="구매부터 개통까지 특별한 혜택">
	          <img src="../../resources/images/mobile/cvs/cspace/img_07.jpg" alt="편의점 구매고객의 솔직한 사용후기">
	        </div>
