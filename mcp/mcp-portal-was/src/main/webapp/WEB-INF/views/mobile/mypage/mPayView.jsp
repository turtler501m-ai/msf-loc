...
<t:insertDefinition name="mlayoutDefault">
    ...
    <t:putAttribute name="scriptHeaderAttr">
	    ...
	    <script type="text/javascript" src="/resources/js/mobile/mypage/mPayView.js"></script>
	    <script type="text/javascript">
		history.pushState(null, null,"/m/mypage/mPayView.do");
		window.onpopstate = function (event){
			history.go("/m/mypage/mPayView.do");
		}
	    </script>
    </t:putAttribute>
   ...
   <t:putAttribute name="contentAttr">
    ...
    <div class="ly-content" id="main-content">
      ...
      <div class="ly-page-sticky">
        <h2 class="ly-page__head">소액결제 조회 및 한도변경<button class="header-clone__gnb"></button>
        </h2>
      </div>
	  ...
	  <div class="c-flex--between">
        ...
        <div class="phone-line-wrap u-mt--0 u-w70p">
          ...
          <select class="u-width--120 u-ml--8" id="mPayStatus" onchange="searchFilterHistory();" style="text-align:center;">
      ...
      <div class="c-table">
        <table>
          ...
          <tbody id="mPayListBody">
            ...
            <tr>
              <td>배달의민족</td>
              <td>2022-05-22 20:01:24</td>
              <td>35,000원</td>
              <td>
              	<button class="c-button c-button--underline u-co-sub-4 fs-13" data-dialog-trigger="#micropay-detail_dialog">상세</button>
              </td>
            </tr>
            <tr>
              <td>월정액</td>
              <td>2022-05-05 20:01:24</td>
              <td>5,000원</td>
              <td>
              	<button class="c-button c-button--underline u-co-sub-4 fs-13" data-dialog-trigger="#micropay-detail_dialog">상세</button>
              </td>
