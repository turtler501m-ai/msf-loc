...
<t:insertDefinition name="mlayoutOutFormFotter">
    ...
    <t:putAttribute name="scriptHeaderAttr">
        ...
        <script type="text/javascript" src="/resources/js/mobile/appForm/appAgentForm.js?ver=${jsver}"></script>
        ...
        <div class="ly-content" id="main-content">
            ...
            <div id="step1" class="_divStep">
                ...
                <div class="c-form u-mt--24">
                    <div class="c-check-wrap">
                        ...
                        <div class="c-chk-wrap">
                            <input class="c-radio c-radio--button c-radio--button--type2 c-radio--button--icon2" id="cstmrType2" type="radio" name="cstmrType" value="${Constants.CSTMR_TYPE_NM}" desc="19세 미만 미성년자" <c:if test="${AppformReq.cstmrType eq Constants.CSTMR_TYPE_NM }" > checked </c:if> disabled>
                        ...
                        <div class="c-chk-wrap">
                            <input class="c-radio c-radio--button c-radio--button--type2 c-radio--button--icon2" id="cstmrType3" type="radio" name="cstmrType" value="${Constants.CSTMR_TYPE_FN}" desc="외국인" <c:if test="${AppformReq.cstmrType eq Constants.CSTMR_TYPE_FN }" > checked </c:if>disabled>
                ...
                <c:if test="${AppformReq.cstmrName ne null and !empty AppformReq.cstmrName }">
                    <div class="c-form _isDefaultText">
            ...
            <div id="step5" style="display:none" class="_divStep" >
                ...
                <div class="c-form">
                    ...
                    <ul class="c-text-list c-bullet c-bullet--dot c-bullet--type2">
                        <li class="c-text-list__item _isCommon">이메일, 모바일(MMS) 명세서를 선택하시면 청구내역을 빠르고 정확하게 받아보실 수 있습니다.</li>
                        <li class="c-text-list__item _isTeen">미성년의 경우 MMS명세서 선택이 불가합니다. 희망하시는 경우 개통 후 고객센터로 문의 부탁드립니다.</li>
                    </ul>
                </div>
