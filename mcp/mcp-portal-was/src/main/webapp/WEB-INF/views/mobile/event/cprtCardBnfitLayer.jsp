...
<div class="c-modal__content card-benefit">
	<div class="c-modal__header">
		...
		<button class="c-button" data-dialog-close>
			<i class="c-icon c-icon--close u-mr--0" aria-hidden="true"></i> <span class="c-hidden">팝업닫기</span>
		</button>
	</div>
	<div class="c-modal__body">
			...
			<c:if test="${!empty prodList}">
				<c:forEach var="prodInfo" items="${prodList}" varStatus="status">
					...
					<li class="card-benefit__item">
						<div class="card-benefit__item-wrap">
							<div class="card-benefit__img">
								<a href="#" href="#" onclick="initCprtCard('${prodInfo.cprtCardCtgCd}');">
									<img src="${prodInfo.cprtCardThumbImgNm}" alt="${prodInfo.cprtCardGdncNm}">
								</a>
							</div>
		...
		<ul class="c-text-list c-bullet c-bullet--dot u-mt--10">
