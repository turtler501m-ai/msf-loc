...
<t:insertDefinition name="mlayoutDefault">
    <t:putAttribute name="scriptHeaderAttr">
        <script type="text/javascript" src="/resources/js/mobile/rate/rateComp.js?version=25-12-30"></script>
    </t:putAttribute>
    <t:putAttribute name="contentAttr">
      ...
      <div class="ly-page-sticky">
        <h2 class="ly-page__head">요금제 비교<button class="header-clone__gnb"></button>
        </h2>
      </div>
