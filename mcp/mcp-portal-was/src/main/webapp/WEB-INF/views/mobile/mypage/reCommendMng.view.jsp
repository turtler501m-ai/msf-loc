...
<t:insertDefinition name="mlayoutDefault">
    <t:putAttribute name="scriptHeaderAttr">
        ...
        <script type="text/javascript" src="/resources/js/portal/mypage/reCommendMng.view.js"></script>
    </t:putAttribute>
        ...
        <div class="ly-content" id="main-content">
            ...
            <div class="c-tabs c-tabs--type2" data-tab-active="0">
                ...
                <div class="c-tabs__list c-expand sticky-header" data-tab-list="">
                    <button class="c-tabs__button" id="btnReCommendState">친구초대 현황</button>
                    <button class="c-tabs__button is-active" id="btnReCommendMng">추천 링크 관리</button>
                </div>
            </div>
            ...
            <div class="friend-invite-content">
                ...
                <div >
                    ...
                    <div class="c-button-wrap u-mt--27">
                        <button class="c-button c-button--full c-button--primary" id="btnfrndUpdateMypage">
                            <span>내 초대 링크 저장하기</span>
                        </button>
                    </div>
                    <div class="c-button-wrap c-button-wrap--share u-mt--27">
                        ...
                        <button class="c-button c-button--full c-button--share" id="btnLinkCopy" data-page="mng" >
