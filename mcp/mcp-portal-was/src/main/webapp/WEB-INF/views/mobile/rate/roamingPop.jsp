...
<script type="text/javascript" src="/resources/js/mobile/rate/roamingPop.js"></script>
...
<div class="c-modal__content">
        ...
        <div class="u-mt--16 c-table c-table--product">
            ...
            <div class="c-form__input-group">
                <div class="c-form__input c-form__input-division" name="roamPhone">
                    <input class="c-input--div3 roamPhone onlyNum" id="roamPhone1" type="text" placeholder="숫자입력" title="연락처 앞자리 입력" maxlength="3" onkeyup="nextFocus(this, 3, 'roamPhone2');">
                    <span>-</span>
                    <input class="c-input--div3 roamPhone onlyNum" id="roamPhone2" type="text" placeholder="숫자입력" title="연락처 중간자리 입력" maxlength="4" onkeyup="nextFocus(this, 4, 'roamPhone3');">
                    <span>-</span>
                    <input class="c-input--div3 roamPhone onlyNum" id="roamPhone3" type="text" placeholder="숫자입력" title="연락처 뒷자리 입력" maxlength="4">
            ...
            <c:choose>
                ...
                <c:when test="${joinPop.lineType eq 'S'}">
                    <p class="u-mt--24 u-fw--medium u-fs-16 addPhoneTitle">서브 번호<span class="u-mt--24 u-fw--medium u-fs-14 addPhoneDesc"> (신청자 본인 회선 입력)</span></p>
                </c:when>
            </c:choose>
            <div id="addPhone">
    ...
    <div class="c-modal__footer c-button-wrap u-mt--48">
        ...
        <button class="c-button c-button--primary c-button--full" id="checkBtn">확인</button>
    </div>
</div>
