...
<t:insertDefinition name="mlayoutDefaultTitle">
    <t:putAttribute name="scriptHeaderAttr">
        <script type="text/javascript" src="/resources/js/mobile/appForm/eSimInfo.js?version=06-02-12"></script>
    </t:putAttribute>
    <t:putAttribute name="contentAttr">
        <div class="ly-content" id="main-content">
            ...
            <div class="esim-now-banner">
				<div class="esim-now-banner-wrap">
					...
					<div class="c-button-wrap">
	                  <a class="c-button c-button--full c-button--primary" id="step3" title="eSIM 셀프개통 페이지 이동">eSIM 셀프개통 하기</a>
	                </div>
			...
			<div class="esim-now-content">
				...
				<div class="esim-now-wrap sticky-target">
