...
<t:insertDefinition name="mlayoutDefault">
    ...
    <script type="text/javascript" src="/resources/js/mobile/mypage/farPricePlanView.js?version=25-12-11"></script>
 ...
 <t:putAttribute name="contentAttr">
     <div class="ly-content" id="main-content">
      <div class="ly-page-sticky">
        <h2 class="ly-page__head">요금제 변경<button class="header-clone__gnb"></button></h2>
      </div>
