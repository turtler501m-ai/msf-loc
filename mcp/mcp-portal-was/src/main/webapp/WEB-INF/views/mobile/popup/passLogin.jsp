...
<script type="text/javascript" src="/resources/js/mobile/popup/passLogin.js"></script>
					...
					<div class="inner">
						...
						<div class="input_row"><!-- 오류시 error 추가 -->
							<div class="col">
								...
								<span><input type="tel" id="phone_num" class="form_control onlyNum"  maxlength="8" placeholder="휴대폰 번호"  autocomplete="off"></span>
							</div>
