...
<t:insertDefinition name="mlayoutDefaultTitle">
    <t:putAttribute name="titleAttr">편의점/마트 유심칩 구매</t:putAttribute>
    <t:putAttribute name="scriptHeaderAttr">
        <script type="text/javascript" src="/resources/js/mobile/usim/storeInfo.js"></script>
    ...
    <div class="ly-content" id="main-content">
      <div class="ly-page-sticky">
        <h2 class="ly-page__head">편의점/마트 구매하기<button class="header-clone__gnb"></button>
        </h2>
      </div>
      <div class="upper-banner__box upper-banner__box--type3">
        <div class="c-swiper swiper-container" ${empty topBannerList ? 'hidden' : ''}>
          ...
          <c:forEach var="topList" items="${topBannerList}">
              <div class="swiper-slide" onclick="insertBannAccess('${topList.bannSeq}', '${topList.bannCtg}')"  style="${empty topList.linkUrlAdr ? 'pointer-events:none;' : ''}">
              <div class="c-hidden">
                <p>${topList.bannNm}</p>
              </div>
              <a href="${empty topList.mobileLinkUrl ? 'javascript:void(0)' : topList.mobileLinkUrl}" target="${topList.linkTarget eq 'Y' ? '_blank' : '_self'}">
...
<%--        <h3 class="c-heading c-heading--type3 u-mt--0">편의점/마트 유심 판매처</h3>--%>
        <h3 class="c-heading c-heading--type3 u-mt--0 u-mb--8">편의점/마트 유심 판매처</h3>
        <p class="u-mb--24">※ 편의점 위치를 확인하세요.</p>
        <ul class="c-store__list">
          <c:forEach var="midList" items="${midBannerList}">
            ...
            <a href="${empty midList.mobileLinkUrl ? 'javascript:void(0)' : midList.mobileLinkUrl}" target="${midList.linkTarget eq 'Y' ? '_blank' : '_self'}" style="${empty midList.mobileLinkUrl ? 'cursor:auto;' : ''}">
              <dl class="c-hidden">
                <dt>${midList.bannNm}</dt>
              </dl>
      ...
      <div class="c-button-wrap" style="display: none">
        <a class="c-button c-button--full c-button--mint" href="javascript:openPage('pullPopup','/m/direct/searchStoreHtml.do','');">판매처 찾기</a>
      </div>
      <!--[$2021-11-29] 문구 수정=================================-->
      <hr class="c-hr c-hr--type1 c-expand">
      <div class="banner-guide__box">
        <h3 class="ad-headline ad-headline--type2">전국 제휴 편의점에서
          <br>kt M모바일 유심 구매 가능!
        </h3>
        <p class="ad-text ad-text--type2"> 편의점 유심 구매했다면? 바로 개통해보세요.</p>
        <ul class="c-step__list">
          <li>
            ...
            <dl>
              <dt>편의점 찾기</dt>
              <dd>
                <img src="../../resources/images/mobile/common/ico_cvs.svg" alt="">
                <p>가까운 편의점을 찾아주세요.</p>
              </dd>
            </dl>
            <!--[$2021-11-29] 문구 수정=================================-->
      ...
      <div class="c-button-wrap c-button-wrap--column u-mt--48">
        <button class="c-button c-button--full c-button--mint" onclick="selfTimeChk('${orgnId}')">셀프개통 하기</button>
        <a class="c-button c-button--full c-button--mint" href="/m/cs/faqList.do">자주 묻는 질문 바로가기</a>
      </div>

      <!-- <hr class="c-hr c-hr--type1 c-expand">
      <div class="banner-guide__box">
        <h3 class="ad-headline ad-headline--type2">편의점 유심구매 혜택</h3>
  ...
  <%-- <c:if test="${fn:length(topBannerList) > 1}"> --%>
