...
<t:insertDefinition name="mlayoutDefault">
	<t:putAttribute name="scriptHeaderAttr">
		<script type="text/javascript" src="/resources/js/mobile/mypage/billWayReSend.js?version=${jsver}"></script>
	</t:putAttribute>
			...
			<div class="c-tabs c-tabs--type2" data-tab-active="0">
				...
				<div class="c-tabs__panel" id="Fbill01-panel">
					...
					<ul class="c-text-list c-bullet c-bullet--dot u-mt--16">
						...
						<li class="c-text-list__item u-co-gray">명세서를 받지 못한 경우 확인해 주세요
