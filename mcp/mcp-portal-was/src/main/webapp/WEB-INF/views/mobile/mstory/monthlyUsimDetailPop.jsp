...
<c:if test="${'new' eq key }">
		<div class="c-modal__content">
			<div class="c-modal__header">
				<h1 class="c-modal__title" id="month_usim_title">월간 M</h1>
							...
							<c:forEach var="list" items="${mstoryListDto.mstoryDetailList}" varStatus="status">
								...
								<c:if test="${list.mm ne mstoryListDto.mstoryDto.mm}">
									<div class="swiper-slide" onclick="setNewPopData(${list.ntcartSeq})">
										<a href="#n"> 
										<img src="${list.thumbImgNm}" alt="${list.thumbImgDesc}"> 
										<strong class="u-block fs-14 u-co-gray-7 u-ta-center">${list.mm}월</strong>
										</a>
									</div>
								</c:if>
							</c:forEach>
