...
<t:insertDefinition name="mlayoutDefault">
    <t:putAttribute name="scriptHeaderAttr">
        <script type="text/javascript" src="/resources/js/mobile/event/eventJoin.js?version=24-01-26"></script>
        <script type="text/javascript" src="/resources/js/mobile/event/wordCheck.js?version=24-01-26"></script>
    ...
    <div class="ly-content" id="main-content">
        ...
        <input type="hidden" id="eventSaveFalg" value="N"/>
        <c:choose>
       ...
       <div class="c-row c-row--lg">
        ...
        <div class="c-form u-mt--40">
            <div class="c-form__group" role="group" aria-labelledby="inpG">
               ...
               <div id="formYn">
                <span class="c-form__title" id="selPostType">이벤트 참여하기</span>
                      ...
                      <div class="c-accordion__panel expand" id="acc_agreeA1">
                        <div class="c-accordion__inside">
                            <div class="c-agree__item">
                              ...
                              <label class="c-label" for="priAgree">본인확인을 위한 개인정보 수집 및 이용 동의<span class="u-co-gray">(필수)</span>
                              </label>
                            ...
                            <div class="c-agree__item">
                              ...
                              <label class="c-label" for="priEventAgree">이벤트 참여를 위한 개인정보 수집 및 이용 동의<span class="u-co-gray">(필수)</span>
                              </label>
                            ...
                            <div class="c-agree__item">
                              ...
                              <label class="c-label" for="priMarketingAgree">마케팅활용을 위한 개인정보 수집 및 이용 동의<span class="u-co-gray">(선택)</span>
                              </label>
                            ...
                            <div class="c-agree__item">
                              ...
                              <label class="c-label" for="priAdAgree">광고성 정보 수신 동의<span class="u-co-gray">(선택)</span>
                              </label>
                ...
                <div class="c-button-wrap">
                    <button id="validationChk" class="c-button c-button--full c-button--primary" id="certifyPopBut" data-dialog-trigger="#userPromotionJoinModal">댓글 작성하고 선물 받기</button>
                </div>
             </div>
            </div>
        ...
        <div class="c-button-wrap">
            <button class="c-button c-button--full" id="moreBtn">
                더보기
                <span class="c-button__sub"><span id="reViewCurrent"></span>/<span id="reViewTotal"></span></span>
    ...
    <div class="event-sharing-wrap">
        <div class="event-sharing">
            <button id="btnCompareView" data-dialog-trigger="#sns-share_dialog">
    ...
    <!-- 본인확인을 위한 개인정보 수집 및 이용 동의 팝업 팝업 -->
    <div class="c-modal" id="priAgreeModal" role="dialog" tabindex="-1" aria-describedby="priAgreeModalTitle">
        <div class="c-modal__dialog c-modal__dialog--full" role="document">
            <div class="c-modal__content">
                <div class="c-modal__header">
                    <h1 class="c-modal__title" id="priAgreeModalTitle">본인확인을 위한 개인정보 수집 및 이용 동의 (필수)</h1>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><b>이벤트<br/>종료일로부터<br/><span class="u-co-red">12개월까지</span></b></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <ul class="c-text-list c-bullet c-bullet--fyr u-fs-13 u-mt--16">
                ...
                <div class="c-modal__footer">
                    <button class="c-button c-button--full c-button--primary" onclick="agreeClose(1)" data-dialog-close>동의 후 닫기</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="c-modal" id="priEventAgreeModal" role="dialog" tabindex="-1" aria-describedby="priEventAgreeModalTitle">
        <div class="c-modal__dialog c-modal__dialog--full" role="document">
            <div class="c-modal__content">
                <div class="c-modal__header">
                    <h1 class="c-modal__title" id="priEventAgreeModalTitle">이벤트 참여를 위한 개인정보 수집 및 이용 동의 (필수)</h1>
                    <button class="c-button" data-dialog-close>
                        <i class="c-icon c-icon--close" aria-hidden="true"></i>
                        <span class="c-hidden">팝업닫기</span>
                    </button>
                    ...
                    <div class="one-source">
                        ...
                        <div class="c-table u-mt--16">
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        <td>이벤트 응모, 본인 게시글 확인, 참여고객 분석, 참여고객 경품 증정</td>
                                        <td>성명, 휴대폰번호, 통신사, 생년월일, CI, DI</td>
                                        <td><b>이벤트<br/>종료일로부터<br/><span class="u-co-red">12개월까지</span></b></td>
                                    </tr>
                                </tbody>
                ...
                <div class="c-modal__footer">
                    <button class="c-button c-button--full c-button--primary" onclick="agreeClose(2)" data-dialog-close>동의 후 닫기</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="c-modal" id="priMarketingAgreeModal" role="dialog" tabindex="-1" aria-describedby="priMarketingAgreeModalTitle">
        <div class="c-modal__dialog c-modal__dialog--full" role="document">
            <div class="c-modal__content">
                <div class="c-modal__header">
                    <h1 class="c-modal__title" id="priMarketingAgreeModalTitle">마케팅활용을 위한 개인정보 수집 및 이용 동의 (선택)</h1>
                    <button class="c-button" data-dialog-close>
                        <i class="c-icon c-icon--close" aria-hidden="true"></i>
                        <span class="c-hidden">팝업닫기</span>
                    </button>
                ...
                <div class="c-modal__footer">
                    <button class="c-button c-button--full c-button--primary" onclick="agreeClose(3)" data-dialog-close>동의 후 닫기</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- 광고성 정보 수신 동의 팝업 -->
    <div class="c-modal" id="priAdAgreeModal" role="dialog" tabindex="-1" aria-describedby="priAdAgreeModalTitle">
        <div class="c-modal__dialog c-modal__dialog--full" role="document">
            <div class="c-modal__content">
                <div class="c-modal__header">
                    <h1 class="c-modal__title" id="priAdAgreeModalTitle">광고성 정보 수신 동의 (선택)</h1>
                    <button class="c-button" data-dialog-close>
                        <i class="c-icon c-icon--close" aria-hidden="true"></i>
                        <span class="c-hidden">팝업닫기</span>
                    </button>
                ...
                <div class="c-modal__footer">
                    <button class="c-button c-button--full c-button--primary" onclick="agreeClose(4)" data-dialog-close>동의 후 닫기</button>
                </div>
            </div>
        </div>
    </div>
                  ...
                  <div class="c-modal__content">
                    ...
                    <div class="c-modal__body">
                          ...
                          <div class="c-button-wrap u-mt--48">
                            ...
                            <button href="javascript:void(0)" id="certifyPopBut" class="c-button c-button--full c-button--primary" data-dialog-close>휴대폰인증</button>
                          </div>
                      </div>
                </div>
            </div>
