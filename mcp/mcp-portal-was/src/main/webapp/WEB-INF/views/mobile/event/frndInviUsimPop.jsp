...
<script type="text/javascript" src="/resources/js/mobile/event/frndInviUsimPop.js"></script>
<style>
						...
						<td>
							<div class="c-form__group" role="group" aria-labeledby="inpG">
								<div class="c-input-wrap">
									<input id="frndPost" name="frndPost" class="c-input" type="text" placeholder="우편번호" title="우편번호 입력" readonly="">
									<button class="c-button c-button--sm c-button--underline _btnAddr" addrflag="1">우편번호 찾기</button>
								</div>
								<input id="frndAddr" name="frndAddr" class="c-input" type="text" placeholder="주소 입력" title="주소 입력" readonly="">
								<input id="frndAddrDtl" name="frndAddrDtl" class="c-input" type="text" placeholder="상세 주소 입력" title="상세 주소 입력" maxlength="100">
							</div>
						</td>
					</tr>
				</table>
...
<!-- 					</div> -->
	...
	<div class="c-modal__footer">
		<div class="c-button-wrap">
			<button class="c-button c-button--lg c-button--white c-button--full" id="btnCancel">취소</button>
			<button class="c-button c-button--lg c-button--primary c-button--full" id="btnApply">등록하기</button>
		</div>
	</div>
</div>
