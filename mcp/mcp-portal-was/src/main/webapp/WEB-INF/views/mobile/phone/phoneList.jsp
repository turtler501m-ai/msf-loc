    ...
    <form id="phonelistfrm" name="phonelistfrm" method="post" action="./phoneList.do">
		...
		<div class="ly-content" id="main-content">
	      <div class="ly-page-sticky">
			  ...
			  <c:choose>
				  <c:when test="${prodType eq '06'}">
					  <h2 class="ly-page__head">리퍼폰<button class="header-clone__gnb"></button></h2>
				  </c:when>
				  <c:otherwise>
					  <h2 class="ly-page__head">새 휴대폰 구매하기<button class="header-clone__gnb"></button></h2>
				  </c:otherwise>
			  </c:choose>
	      ...
	      <div class="c-side-badge">
	        ...
	        <span class="in-box">
	          <!-- 아래 span 태그와 icon class num{0}을 비교함에 개수와 맞추어 주세요. -->
	          <span class="c-hidden">0</span>
	      ...
	      <div class="phone">
			  ...
			  <c:choose>
				  ...
				  <c:otherwise>
					  <div class="c-check-wrap u-mt--24 u-mb--16 c-hidden">
						  <span class="u-fs-14 u-fw--medium u-mt--2 u-mr--8">제조사</span>
						  <input type="checkbox" class="c-checkbox c-checkbox--type3" id="chkProduct_0" value="0000" name="chkProduct" checked >
						  <label class="c-label u-pl--28 u-mr--8" for="chkProduct_0">전체</label>
						  <input type="checkbox" class="c-checkbox c-checkbox--type3" id="chkProduct_1" value="0141" name="chkProduct" checked >
	        ...
	        <div class="phone__item-wrap c-expand phone-list-wrap ">
	          <div class="phone__sort" style="display:none;">
	          	<button type="button" class="c-button c-button--full c-flex c-flex--jfy-center" data-dialog-trigger="#bsSortList" id="orderButton"><span class="u-mr--4 fs-14">추천 순</span><i class="c-icon c-icon--sort" aria-hidden="true"></i></button>
	          </div>
			  <ul id="product_list">
