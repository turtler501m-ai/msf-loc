...
<script type="text/javascript" src="/resources/js/mobile/mypage/billWayReSendPop.js?version=${jsver}"></script>
	...
	<div class="c-modal__body">
		...
		<div class="c-form__group" role="group">
			...
			<div class="c-form moArea" style="display:none;">
				...
				<input class="c-input" id="mobileNo" type="text" title="휴대폰 번호" readonly="readonly" value="${mobileNo}">
