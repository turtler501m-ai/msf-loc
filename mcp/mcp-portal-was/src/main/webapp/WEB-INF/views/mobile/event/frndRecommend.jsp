...
<t:insertDefinition name="mlayoutDefault">
    <t:putAttribute name="scriptHeaderAttr">
        ...
        <script type="text/javascript" src="/resources/js/mobile/event/frndRecommend.js?version=26.02.12"></script>
    </t:putAttribute>
    <t:putAttribute name="contentAttr">
        <div class="ly-content" id="main-content">
            ...
            <div class="ly-page-sticky">
                <h2 class="ly-page__head">친구초대<button class="header-clone__gnb"></button>
                </h2>
            </div>
            <div class="friend-banner-container">
                ...
                <div class="friend-banner__image">
                    <img src="/resources/images/mobile/event/friend_banner_2.png" alt="">
                </div>
            </div>
            <div class="friend-invite-content">
                <div class="friend-wrap">
                    <div class="friend-recom-point">
                        <img src="/resources/images/mobile/event/friend_recommend_point.png" alt="">
                ...
                <div class="friend-wrap c-expand">
                    <h4 class="friend__title">친구초대 추천 링크 만들기</h4>

                    <%@ include file="/WEB-INF/views/mobile/mypage/sendCertSms.jsp"%>

                    <p class="u-fs-15 u-mt--48">친구초대 ID 발급을 위해서는 개인정보 제공을 위한 동의 및 가입 여부의 확인이 필요하니, 동의하여 주시기 바랍니다.</p>
                    <div class="c-agree agree-friend">
                        <div class="c-agree__item">
                            <input class="c-checkbox" id="chkAgreeA" type="checkbox" name="chkAgreeA">
                            <label class="c-label" for="chkAgreeA">
                                해당 개인정보 이용 및 책임에 대한 내용을 확인 하였으며, 이에 동의합니다.
                    ...
                    <div class=" c-agree agree-friend">
                        <div class="c-agree__item">
                            ...
                            <button type="button" class="c-button c-button--xsm" onclick="fnSetEventId('chkMstoreAgree');openPage('termsPop','/termsPop.do','cdGroupId1=FormEtcCla&amp;cdGroupId2=FrndMstoreAgree2');">
                    ...
                    <div class="c-check-wrap c-check-wrap--column u-mt--14">
                        <div class="c-chk-wrap">
                            <input class="c-radio c-radio--button" name="linkTypeCd" value="01" id="linkTypeCd_01" type="radio"  >
                            <label class="c-label" for="linkTypeCd_01"><span>기본 추천 링크 만들기</span></label>
                        </div>
                        <div class="c-chk-wrap">
                            <input class="c-radio c-radio--button" name="linkTypeCd" value="99" id="linkTypeCd_02" type="radio" checked>
                            <label class="c-label" for="linkTypeCd_02">
                                <span class="friend-invite__lable">
                                    ...
                                    <p class="u-fs-13">(이 링크 하나면 초대가 쉬워져요!)</p>
                                </span>
                            </label>
                        </div>
                    </div>
                    <div id="divLinkType_02" style="display:block;">
                        <div class="c-form">
                            ...
                            <div class="c-check-wrap c-check-wrap--type2 u-mt--20">
                                <div class="c-chk-wrap">
                                ...
                                <span class="friend-invite__lable">
	                         		<em>eSIM 셀프개통</em>
	                         		<p class="u-fs-13">(실물유심 없이 즉시개통)</p>
	                         	</span>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="c-form">
                            <h4 class="friend__title-link">
                                <span class="friend__title-link-circle">2</span><b>친구에게 맞는 요금제 3개를 선택해 주세요!<br /><em>(데이터 / 통화량 필터를 통해 검색하면 쉬워요!)</em></b>
                            </h4>
                    ...
                    <div id="divRecommend" style="display:none" >
                        ...
                        <ul class="c-text-list u-fs-13 u-co-sub-4 u-mt--14">
                            <li class="c-text-list__item">※ 전달한 친구초대 URL을 통해 접속하셨을 경우 신규 가입 신청서에 추천인ID가 신청서에 자동 기입됩니다.</li>
                            <li class="c-text-list__item u-mt--8">※ 전용 URL을 사용하지않을 경우 발급받으신 친구초대ID를 피추천인이 신청서에 직접 입력하셔야 혜택을 받으실 수 있습니다.</li>
                        </ul>
                    </div>
                    <div class="c-button-wrap u-mt--24">
                        <button class="c-button c-button--full c-button--primary" id="btnfrndUpdate">
                            <span>내 초대 링크 저장하기</span>
                        </button>
                    </div>
                    <div class="c-button-wrap c-button-wrap--share u-mt--16">
                        <button class="c-button c-button--full c-button--kakao" id="btnfrndKakaoShare">
                            <i class="c-icon c-icon--balloon-brown" aria-hidden="true"></i>카카오톡 공유
                        </button>
                        <button class="c-button c-button--full c-button--share" id="btnLinkCopy" data-page="form" >
                            <i class="c-icon c-icon--share" aria-hidden="true"></i>추천 링크 복사
                        </button>
                    </div>
                </div>
                <div class="friend-wrap">
                    <div class="friend-guide">
                        ...
                        <p class="friend__text">추천해 준 친구를 위해 신청서에 전달받은 친구의 ID를 반드시 입력 해 주세요.</p>
                        <p class="friend__text">친구초대ID는 ‘친구 초대하기’ 페이지에서 카카오톡 이나 문자로 발급 받을 수 있습니다. </p>
                        <div class="friend-guide-box">
                            <ul class="friend-guide__list">
                                <li class="friend-guide__item">
                                    ...
                                    <img src="/resources/images/mobile/event/friend_guide_03.png" alt="친구초대 ID를 확인하세요.">
                                </li>
                                <li class="friend-guide__item">
                                    <span class="friend-guide__label--point">초대받은 친구 </span>
                                    <p>공유 받은 링크 접속 후 가입신청서 작성</p>
                                    <img src="/resources/images/mobile/event/friend_guide_04.png" alt="ID 입력 확인">
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="c-notice__box">
                        ...
                        <hr class="c-hr c-hr--type3 u-mb--0">

                        <div class="c-accordion c-accordion--type1 u-pb--32">
                            <!-- 관리자 관리 HTML START-->
                            ${noticeContent}
                            <!-- 관리자 관리 HTML END-->
                        </div>
    ...
    <t:putAttribute name="popLayerAttr">
        ...
        <!-- 필터 팝업 -->
        <div class="c-modal c-modal--rate-comparison" id="rateComparisonModal" role="dialog" tabindex="-1" aria-describedby="rateComparisonModalTitle">
            <div class="c-modal__dialog c-modal__dialog--full" role="document">
                <div class="c-modal__content">
                    <div class="c-modal__header">
                        <h1 class="c-modal__title" id="rateComparisonModalTitle">필터 <i class="c-icon c-icon--sort" aria-hidden="true"></i></h1>
