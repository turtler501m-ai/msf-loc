...
<t:insertDefinition name="mlayoutNoGnbFotter">
	...
	<t:putAttribute name="scriptHeaderAttr">
		...
		<script type="text/javascript" src="/resources/js/personal/mobile/pRealTimePaymentView.js?version=25.07.22"></script>
	</t:putAttribute>
	...
	<t:putAttribute name="contentAttr">
		...
		<div class="ly-content" id="main-content">
			...
			<div class="c-form payCard">
				<span class="c-form__title" id="inpC">납부 정보 입력</span>
