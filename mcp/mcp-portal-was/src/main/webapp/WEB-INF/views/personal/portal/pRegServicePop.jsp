...
<script type="text/javascript" src="/resources/js/personal/portal/pRegServicePop.js?version=25.07.22"></script>

<div class="c-modal__content">

    <input type="hidden" name="ncn" id="ncn" value="${ncn}"/>
    <input type="hidden" name="rateAdsvcCd" id="rateAdsvcCd" value="${rateAdsvcCd}"/>
    <input type="hidden" name="aSocAmnt" id="aSocAmnt" value="${instAmt}"/>
    <input type="hidden" name="tSocAmnt" id="tSocAmnt" value="${baseAmt}"/>
    <input type="hidden" name="jehuProdType" id="jehuProdType" value="${jehuProdType}"/>
    <input type="hidden" name="jehuProdName" id="jehuProdName" value="${jehuProdName}"/>
    <input type="hidden" name="isActivatedThisMonth" id="isActivatedThisMonth" value="${isActivatedThisMonth}"/>
    <input type="hidden" name="isFarPriceThisMonth" id="isFarPriceThisMonth" value="${isFarPriceThisMonth}"/>
        ...
        <div class="c-form-wrap ${termsMargin}">
            <div class="c-agree c-agree--type2">
                <div class="c-agree__item">
                    ...
                    <label class="c-label" for="chkAgreeA2">요금제 제공량 날짜계산 및 기타 안내사항을 모두 확인 하였으며, 변경 진행에 동의합니다.</label>
                </div>
            </div>
        </div>
