...
<t:insertDefinition name="layoutNoGnbDefault">
  ...
  <t:putAttribute name="scriptHeaderAttr">
    ...
    <script type="text/javascript" src="/resources/js/personal/portal/pRealTimePaymentView.js?version=25.06.10"></script>
  </t:putAttribute>
  ...
  <t:putAttribute name="contentAttr">
    ...
    <div class="ly-content" id="main-content">
      <div class="ly-page--title">
        <h2 class="c-page--title">개인화 URL (즉시납부)</h2>
      </div>
      <div class="c-row c-row--lg">
        ...
        <p class="c-text c-text--fs18 u-ta-center u-mt--56 payKakao" style="display: none;">
          ...
          <b>카카오톡</b>또는<b>카카오페이 앱</b>을 실행하여<br/>
