			...
			<ul class="c-list c-list--inp-number addNumber">
				<li class="c-list__item numberAddView">
					<div class="c-input-wrap c-input-wrap--flex u-mt--0">
						<input class="c-input c-input--h34 u-ta-center numOnly" id="phone1_1" type="tel" maxlength="3" placeholder="앞자리" title="앞자리 입력">
						<input class="c-input c-input--h34 u-ta-center numOnly" id="phone2_1" type="tel" maxlength="4" placeholder="중간자리" title="중간자리 입력">
						<input class="c-input c-input--h34 u-ta-center numOnly" id="phone3_1" type="tel" maxlength="4" placeholder="뒷자리" title="뒷자리 입력">
					</div>
				</li>
			</ul>
