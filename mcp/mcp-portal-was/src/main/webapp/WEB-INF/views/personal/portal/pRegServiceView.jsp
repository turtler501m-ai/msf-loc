...
<t:insertDefinition name="layoutNoGnbDefault">
  ...
  <t:putAttribute name="scriptHeaderAttr">
    ...
    <script type="text/javascript" src="/resources/js/personal/portal/pRegServiceView.js?version=25.07.22"></script>
  </t:putAttribute>
  ...
  <t:putAttribute name="contentAttr">
    ...
    <div class="ly-content" id="main-content">
      <div class="ly-page--title">
        <h2 class="c-page--title">개인화 URL (부가서비스 신청/해지)</h2>
      </div>

      <div class="c-tabs c-tabs--type1">
        <div class="c-tabs__list" role="tablist">
          <button class="c-tabs__button tab-height" id="tab1" role="tab" aria-controls="tabB1panel" aria-selected="true">조회/변경<br>(부가서비스)</button>
          <button class="c-tabs__button tab-height" id="tab2" role="tab" aria-controls="tabB2panel" aria-selected="false">신청<br>(부가서비스)</button>
          <button class="c-tabs__button tab-height" id="roamingTab1">조회/변경<br>(로밍)</button>
          <button class="c-tabs__button tab-height" id="roamingTab2">신청<br>(로밍)</button>
        </div>
      </div>
