...
<script type="text/javascript" src="/resources/js/personal/portal/pBillWayReSendPop.js?version=25.06.10"></script>
      ...
      <div class="c-form-group" role="group" aira-labelledby="inpDepInfoTitle">
        ...
        <div class="c-form-row c-col2">
          ...
          <div class="c-form moArea" style="display:none;">
            ...
            <input class="c-input" id="mobileNo" name="mobileNo" type="text" value="${searchVO.ctn}" readonly="readonly">
          </div>
        </div>
