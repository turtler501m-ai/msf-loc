...
<t:insertDefinition name="mlayoutNoGnbFotter">
    ...
    <t:putAttribute name="scriptHeaderAttr">
      ...
      .tab-style{
        ...
        <script type="text/javascript" src="/resources/js/personal/mobile/pRegServiceView.js?version=25.07.22"></script>
    </t:putAttribute>
    ...
    <t:putAttribute name="contentAttr">
        ...
        <div class="ly-content" id="main-content">
            <div class="ly-page-sticky">
                <h2 class="ly-page__head">개인화 URL (부가서비스 신청/해지)<button class="header-clone__gnb"></button>
                </h2>
            </div>

            <div class="c-tabs c-tabs--type2" data-tab-active="0">
                <div class="c-tabs__list c-expand sticky-header" data-tab-list="">
                    <button class="c-tabs__button tab-style" id="tab1" data-tab-header="#tabB1-panel" onclick="btn_tab('1')">조회/변경<br>(부가서비스)</button>
                    <button class="c-tabs__button tab-style" id="tab2" data-tab-header="#tabB2-panel" onclick="btn_tab('2')">신청<br>(부가서비스)</button>
                    <button class="c-tabs__button tab-style" id="roamingTab1" onclick="goRoamingView('1')">조회/변경<br>(로밍)</button>
                    <button class="c-tabs__button tab-style" id="roamingTab2" onclick="goRoamingView('2')">신청<br>(로밍)</button>
                </div>
                ...
                <div class="c-tabs__panel border-none" id="tabB1-panel">
                    <div class="c-nodata regSvcYn" style="display: none;">
                        ...
                        <p class="c-noadat__text">이용중인 부가서비스가 없습니다.</p>
                    </div>
                ...
                <div class="c-tabs__panel border-none" id="tabB2-panel">
                    ...
                    <h4 class="c-heading c-heading--type3 u-mt--40 u-mb--32">가입 가능한 무료 부가서비스</h4>
                    ...
                    <h4 class="c-heading c-heading--type3 u-mt--40 u-mb--32">가입 가능한 유료 부가서비스</h4>
