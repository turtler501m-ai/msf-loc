...
<t:insertDefinition name="mlayoutNoGnbFotter">
	...
	<t:putAttribute name="scriptHeaderAttr">
		<script type="text/javascript" src="/resources/js/personal/mobile/pBillWayChgView.js?version=25.06.10"></script>
	</t:putAttribute>
			...
			<div class="c-tabs c-tabs--type2" data-tab-active="1">
				...
				<div class="c-tabs__panel" id="Fbill02-panel">
					...
					<div class="c-button-wrap u-mt--48">
						<button class="c-button c-button--full c-button--primary" onclick="changeSubmit();" id="change-submit" disabled>변경</button>
					</div>
				</div>
			</div>
		</div>
