...
<t:insertDefinition name="mlayoutNoGnbFotter">
	...
	<t:putAttribute name="scriptHeaderAttr">
		...
		<script type="text/javascript" src="/resources/js/personal/mobile/pPaywayView.js?version=25.07.22"></script>
	...
	<t:putAttribute name="contentAttr">
		...
		<div class="ly-content" id="main-content">
			<div class="ly-page-sticky">
				<h2 class="ly-page__head">개인화 URL (납부방법 변경)<button class="header-clone__gnb"></button>
				</h2>
			</div>
			<div class="c-form">
			...
			<div id="card" style="display:none;">
				<div class="c-form">
					<span class="c-form__title u-fs-20" id="inpC">납부 정보 입력</span>
					<div class="c-form__group" role="group" aria-labelledby="inpC">
			...
			<div id="payCo" style="display:none;">
				<h3 class="c-heading c-heading--type2 u-fs-20">페이코 자동납부 신청방법</h3>
				<ul class="c-step-list u-mb--32">
					<li class="c-step-list__step">
						<dl>
							<dt>SMS전송</dt>
							<dd>
								...
								<p class="c-bullet c-bullet--fyr u-co-mint u-mt--16 u-ta-left">전송된 SMS내의 링크를 통해 페이코 자동 납부 신청이 가능합니다.</p>
							</dd>
						</dl>
					</li>
					<li class="c-step-list__step">
