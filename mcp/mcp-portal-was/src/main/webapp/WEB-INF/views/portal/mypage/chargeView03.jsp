...
<t:insertDefinition name="layoutGnbDefault">
    ...
    <t:putAttribute name="scriptHeaderAttr">
        <script type="text/javascript" src="/resources/js/portal/mypage/chargeView03.js?version=${jsver}"></script>
    </t:putAttribute>

    <t:putAttribute name="contentAttr">
        <div class="ly-content" id="main-content">
            <div class="ly-page--title">
                <h2 class="c-page--title">실시간 요금조회</h2>
            </div>
            ...
            <div class="c-tabs__panel u-block">
                <div class="c-row c-row--lg">
                    ...
                    <div class="pay-summary">
                        <div class="pay-summary__chart">
                            <div class="c-indicator">
                                <span class="mark mark-red" id="dateViewStyle" style="width:${grapWidth}%">
                                    <span class="c-balloon c-balloon--center">${useDay} 일</span>
                                </span>
                            </div>
                            <div class="pay-summary__chart-range">
                                <b class="start-date">1일</b> <b class="end-date">${useTotalDay} 일</b>
                            </div>
                        </div>
                        <div class="pay-summary__price">
                            <span class="c-hidden">1일부터 오늘까지 사용한 누적 이용</span>
                            <span class="c-text c-text--fs17 u-mr--20">실시간요금</span>
                            <span class="c-text c-text--fs15 u-co-red">
                                <b class="u-fs-26">${sumAmt} </b>원
                            </span>
                        </div>
                    </div>
                    <hr class="c-hr c-hr--title">
                    <div class="u-flex-between u-mt--48">
                        ...
                        <span class="c-text c-text--fs14 u-co-gray">${searchTime}</span>
                    </div>
                    <c:choose>
                        <c:when test="${realFareVOList ne null and !empty realFareVOList}">
                            <div class="pay-detail pay-detail--type2 u-mt--16">
                                <c:forEach var="realFareVOList" items="${realFareVOList}">
                                    <dl class="pay-detail__item">
                                        <dt class="u-co-gray u-fw--regular">${realFareVOList.gubun}</dt>
