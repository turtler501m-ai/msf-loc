...
<t:insertDefinition name="layoutGnbDefault">
    ...
    <t:putAttribute name="titleAttr">해외 로밍 신청/해지</t:putAttribute>

    <t:putAttribute name="scriptHeaderAttr">
        <script type="text/javascript"  src="/resources/js/portal/mypage/roamingView.js"></script>
    ...
    <t:putAttribute name="contentAttr">
        ...
        <div class="ly-content" id="main-content">
            <div class="ly-page--title">
                <h2 class="c-page--title">해외 로밍 신청/해지</h2>
            </div>
            ...
            <div class="c-row c-row--lg">
                ...
                <hr class="c-hr c-hr--title" id="listHr">
            </div>
            ...
            <div class="c-tabs__panel u-mt--0" id="tabB2panel" role="tabpanel" aria-labelledby="tab2" tabindex="-1">
                <div class="c-row c-row--lg">
