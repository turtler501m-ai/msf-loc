...
<t:insertDefinition name="layoutNoGnbNoFooter">
    <t:putAttribute name="titleAttr">요금제 상세</t:putAttribute>

    <t:putAttribute name="contentAttr">
        <div class="rate-layer-detail">
                                           ...
                                           <c:forEach var="requestReview" items="${requestReviewList}" varStatus="status">
                                            <li class="c-accordion__item">
                                                <div class="c-accordion__head">
                                                    ...
                                                    <button class="runtime-data-insert c-accordion__button" id="acc_header_c${status.count}" type="button" aria-expanded="false" aria-controls="acc_content_c${status.count}" href="javascript:void(0);" onclick="increaseHit(this, ${requestReview.requestKey}); return false;">
