    ...
    <t:putAttribute name="contentAttr">
        ...
        <div class="ly-content" id="main-content">
            ...
            <div class="c-row c-row--sm">
                ...
                <div class="login-sns u-mt--64">
                    <div class="login-sns__item">
                        <a class="c-button" href="javascript:void(0);" onclick="loginWithFacebook();">
                            <img src="/resources/images/portal/common/ico_sns_facebook.svg" alt="페이스북">
                        </a>
                    ...
                    <div class="login-sns__item">
                        <a class="c-button" href="javascript:void(0);" onclick="loginWithKakao();">
                            <img src="/resources/images/portal/common/ico_sns_kakao.svg" alt="카카오">
                        </a>
                    ...
                    <div class="login-sns__item">
                        <a class="c-button" href="javascript:void(0);" onclick="loginWithNaver();">
                            <img src="/resources/images/portal/common/ico_sns_naver.svg" alt="네이버">
                        </a>
                    ...
                    <div class="login-sns__item">
                        <a class="c-button" href="javascript:void(0);" onclick="loginWithApple();">
                            APPLE 로그인
                        </a>
                    </div>
                </div>
