...
<script type="text/javascript" src="/resources/js/portal/event/promotionPop.js"></script>
<style>
...
<div class="c-modal__content" id="promotionPopup">
            ...
            <div class="board_detail_table promo_check_info_box">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input title="이름" id="name" name="name" type="text" value="" class="width_full margin_right_7"/></td>
                    </tr>
                    <tr>
                ...
                <table>
                    <caption class="tit text_align_left">기타정보<label class="red" style="font-weight:normal;">※선택 사항</label></caption>
                    <colgroup>
                        <col />
                        <col />
                    </colgroup>
              ...
              <div class="c-accordion__box">
                <div class="c-accordion__item">
                  ...
                  <div class="c-accordion__panel expand" id="acc_agreeA1" aria-labelledby="acc_agree_headerA1" aria-hidden="true">
                    <div class="c-accordion__inside u-pt--8 u-pb--24 u-pl--36 u-pr--36">
                        <div class="c-accordion c-accordion--type1 promotion u-mt--0">
                          <div class="c-accordion__box">
                            <div class="c-accordion__item">
                              <div class="c-accordion__head">
                                <button class="runtime-data-insert c-accordion__button" id="acc_agree_headerB1" type="button" aria-expanded="false" aria-controls="acc_agreeB1">
                                  <span class="c-hidden">본인확인을 위한 개인정보 수집 및 이용 동의(필수) 상세 열기</span>
                                </button>
                                <div class="c-accordion__check">
                              ...
                              <div class="c-accordion__panel expand" id="acc_agreeB1" aria-labelledby="acc_agree_headerB1" aria-hidden="true">
                        ...
                        <div class="c-accordion c-accordion--type1 promotion">
                          <div class="c-accordion__box">
                            <div class="c-accordion__item">
                              <div class="c-accordion__head">
                                <button class="runtime-data-insert c-accordion__button" id="acc_agree_headerB2" type="button" aria-expanded="false" aria-controls="acc_agreeB2">
                              ...
                              <div class="c-accordion__panel expand" id="acc_agreeB2" aria-labelledby="acc_agree_headerB2" aria-hidden="true">
                                <div class="c-accordion__inside">
                                    ${docContent2}
                                </div>
                              </div>
                        ...
                        <div class="c-accordion c-accordion--type1 promotion">
                          <div class="c-accordion__box">
                            <div class="c-accordion__item">
                              <div class="c-accordion__head">
                                <button class="runtime-data-insert c-accordion__button" id="acc_agree_headerB3" type="button" aria-expanded="false" aria-controls="acc_agreeB3">
                              ...
                              <div class="c-accordion__panel expand" id="acc_agreeB3" aria-labelledby="acc_agree_headerB3" aria-hidden="true">
                                <div class="c-accordion__inside">
                                    ${docContent3}
                                </div>
                              </div>
                        ...
                        <div class="c-accordion c-accordion--type1 promotion">
                          <div class="c-accordion__box">
                            <div class="c-accordion__item">
                              <div class="c-accordion__head">
                                <button class="runtime-data-insert c-accordion__button" id="acc_agree_headerB4" type="button" aria-expanded="false" aria-controls="acc_agreeB4">
                                ...
                                <div class="c-accordion__check">
                                  ...
                                  <label class="c-label u-mt--12" for="priAdAgree">
                                      광고성 정보 수신 동의<span class="u-co-gray">(선택)</span>
                                    <p class="u-fs-15 u-co-gray u-mt--m4 u-pl26">※ 본 선택 동의는 거부 하실수 있으나, 미동의시 이벤트 응모에 참여 하실수 없습니다.</p>
                                  </label>
                                </div>
                              </div>
                              <div class="c-accordion__panel expand" id="acc_agreeB4" aria-labelledby="acc_agree_headerB4" aria-hidden="true">
                                <div class="c-accordion__inside">
                                    ${docContent4}
                                </div>
                              </div>
    ...
    <div class="c-modal__footer">
        <div class="c-button-wrap">
            <button class="c-button c-button--lg c-button--primary c-button--full c-button--w460" id="prePromotionBtn" data-dialog-trigger="#userPromotionJoinModal">등록하기</button>
        </div>
    </div>
</div>
...
<div class="c-modal__content" id="promotionModal" style="display:none;">
    ...
    <div class="c-modal__footer">
        <div class="c-button-wrap">
            <button class="c-button c-button--lg c-button--gray c-button--full c-button--w220" id="promotionCancelbtn">취소</button>
            <button class="c-button c-button--lg c-button--primary c-button--full c-button--w220" id="promotionNiceAuthBtn">휴대폰인증</button>
        </div>
    </div>
</div>