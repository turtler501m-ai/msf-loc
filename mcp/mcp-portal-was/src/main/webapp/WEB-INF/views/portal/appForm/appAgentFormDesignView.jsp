...
<t:insertDefinition name="layoutOutFormGnbDefault">
  ...
  <t:putAttribute name="scriptHeaderAttr">
    <script type="text/javascript" src="/resources/js/portal/appForm/appAgentFormDesignView.js?ver=${jsver}"></script>
    ...
    <script type="text/javascript" src="/resources/js/sns.js?ver=${jsver}"></script>
    ...
    <div class="ly-content" id="main-content">
      ...
      <div class="c-row c-row--lg">
        ...
        <div class="c-form-wrap" >
          <div class="c-form-group" role="group" aira-labelledby="radOpenType">
            ...
            <div class="c-checktype-row c-col2 u-mt--0">
              <input class="c-radio c-radio--button" id="radOpenType1" type="radio" name="radOpenType" value="5" checked>
              <label class="c-label" for="radOpenType1">셀프개통(유심있음)</label>
            </div>
          </div>
        </div>

        <c:if test="${addInfoTxt eq 'Y'}">
          <div class="c-box c-box--type1 c-box--bullet">
            <ul class="c-text-list c-bullet c-bullet--dot">
              ...
              <li class="c-text-list__item">유심 구매처 안내
                <span class="c-text u-co-sub-3 u-ml--4">다이렉트몰</span>
                <span class="c-text u-co-sub-3 u-ml--4">편의점/마트</span>
                <span class="c-text u-co-sub-3 u-ml--4">오픈마켓</span>
              </li>
        ...
        <div class="c-form-wrap">
          <div class="c-form-group" role="group" aira-labelledby="radJoinType">
            <h3 class="c-form__title--type2" id="radJoinType">가입유형</h3>
            <div class="c-checktype-row c-col2 u-mt--0">
      ...
      <div class="c-row c-row--lg">
        ...
        <div class="c-button-wrap u-mt--56">
          <button class="c-button c-button--lg c-button--red u-width--460 nextStepBtn" onclick="fnSelfClick();">가입하기</button>
        </div>
      </div>


      <!--하단 플로팅바-->
      <div class="c-bs-compare no-banner" id="bottom_sheet">
