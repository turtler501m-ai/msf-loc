...
<t:insertDefinition name="layoutGnbDefault">
    ...
    <t:putAttribute name="scriptHeaderAttr">
        ...
        <script type="text/javascript" src="/resources/js/portal/content/combineKt.js?version=23.12.12"></script>
    </t:putAttribute>
    ...
    <t:putAttribute name="contentAttr">
        ...
        <div class="ly-content" id="main-content">
            <div class="ly-page--title">
                <h2 class="c-page--title">아무나 가족결합+</h2>
            </div>
            <div class="kt-combine-banner _regForm">
              <div class="kt-combine-banner__wrap">
                  <h3 class="c-headline">가족이든 혼자든<br /><span>KT와 함께하면 할인</span>도 데이터도 “+”</h3>
                  <div class="c-button-wrap c-button-wrap--left u-mt--24">
                      <button class="c-button" data-scroll-top=".combine-self|120">
                          <span>결합 신청 바로가기</span>
                          <i class="c-icon c-icon--anchor-white" aria-hidden="true"></i>
                      </button>
                  </div>
                  <img class="c-headline--deco" src="/resources/images/portal/product/kt_combine_banner.png" alt="">
                </div>
            </div>
            <div class="kt-combine-content _regForm" >
                <div class="kt-combine-head">
                  <p class="kt-combine__title">아무나 가족결합+ 란?</p>
                  <p class="kt-combine__text">kt M모바일을 사용하는 고객이 KT인터넷 또는 KT모바일 상품과 결합하여<br />추가혜택(무료 데이터 및 요금할인)을 받는 서비스입니다.</p>
                  <p class="kt-combine__subtext">단, KT상품과 M모바일의 회선 명의가 같거나 가족관계인 경우에만 결합 할 수 있습니다.</p>
                </div>
                <div class="kt-combine-wrap">
                    <h4 class="kt-combine-title u-mt--80"><i class="c-icon c-icon--home" aria-hidden="true"></i>결합 대상</h4>
                ...
                <div class="kt-combine-wrap">
                    ...
                    <ul class="kt-combine-product-box">
                        <li class="kt-combine-product-box__item">
                            ...
                            <ul class="c-text-list c-bullet c-bullet--dot u-fs-16">
				                        <li class="c-text-list__item u-co-gray">요금제에 따라 <span>매월 무료 데이터 제공</span></li>
				                    </ul>
                        ...
                        <li class="kt-combine-product-box__item">
                            ...
                            <ul class="c-text-list c-bullet c-bullet--dot u-fs-16">
                                <li class="c-text-list__item u-co-gray"><span>월 요금 할인 적용</span></li>
				                    </ul>
                            <p class="kt-combine-product-box__text">
                                <i class="c-icon c-icon--bang--gray2 u-mr--4 u-mt--m2" aria-hidden="true"></i>일부 요금제는 무료 데이터 제공 없음
                            </p>
                          ...
                          <div class="c-accordion__inside">
                            <div class="kt-combine-adv-box">
                              <div class="kt-combine-adv__item">
                                 ...
                                 <div class="kt-combine-adv__answer">
                                   <span>A</span>
                                   <p>KT고객의 정보를 M모바일(MVNO)로 제공함을 동의하는 절차입니다.<br />해당 동의가 있어야만 결합 서비스 신청이 가능하며, 미동의 시 결합 서비스 신청이 불가합니다. 정보제공동의<br />방법은 신청절차를 참고해 주세요.</p>
                                 </div>
                              </div>
                              <div class="kt-combine-adv__item">
                                 <div class="kt-combine-adv__question">
                ...
                <div class="combine-self">
                    <!-- 본인인증 방법 선택 -->
                    <div id="divStep1" <c:if test="${nmcp:hasLoginUserSessionBean()}">style="display: none"</c:if> >
                        <p class="u-fw--bold u-fs-40 u-ta-center">결합 신청하기</p>
                        <p class="u-fs-18 u-ta-center u-mt--20">정보 확인을 위해 인증 방법을 선택 후 결합을 신청하세요.</p>
                ...
                <div id="divStep2" class="combine-info" <c:if test="${!nmcp:hasLoginUserSessionBean()}">style="display: none"</c:if> >
                    ...
                    <div class="combine-checklist">
                        ...
                        <ul class="combine-checklist__list">
                            <li>KT인터넷은 신규 가입고객만 kt M모바일 회선과 결합이 가능하여, KT인터넷 가입일 기준 익월 말 이내에 아무나 가족 결합+ 신청을 하셔야 KT인터넷에 요금할인이 적용됩니다. (ex. 3월 1일에 KT상품을 가입한 고객은 4월 30일까지 결합 신청을 해야 함)</li>
                            ...
                            <li>KT인터넷 또는 KT모바일과 kt M모바일 회선과 결합 시, KT고객은 KT고객센터를 통해 『MVNO정보제공동의』가 필요합니다.<button type="button" class="c-text-link--bluegreen" data-dialog-trigger="#combinInfoAgree">자세히 보기</button></li>
                            <li>결합 신청 완료 후, 가족명의 결합의 경우 구비서류(결합신청자 신분증, 결합대상자 신분증, 가족관계증명서 ※미성년자의 경우 법정대리인 신분증 제출)를<br/>이메일(ktm.vit@kt.com) 또는 팩스(070-4275-2483)로 신청일 기준 3일이내로 전달 주셔야 합니다. ※신분증은 주민번호 뒷자리 마스킹필수</li>
                    ...
                    <div class="c-form-wrap">
                        <div class="c-form-group" role="group" aria-labelledby="combineMyinfo">
                            <div class="c-group--head">
                                <h4 class="u-fs-20" id="combineMyinfo">내 정보</h4>
                                <button id="btnCombiSvcList" type="button" class="c-button c-button--underline" >결합내역 조회</button>
                            </div>
                            <div class="combine-myinfo">
                                <div class="c-form-row c-col2">
                                    ...
                                    <button type="button" id="btnCheckCombine" class="combine-check is-disabled">조회</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="divChild" class="combine-form" style="display: none" >
                        ...
                        <div class="c-form-wrap">
                            <div class="c-form-group" role="group" aria-labelledby="sameCustInfo">
                                <h3 class="c-form__title--type2 u-mt--46" id="sameCustInfo">1. 결합 명의 선택</h3>
                                <div class="c-checktype-row c-col2 u-mt--0">
                                    <input class="c-radio c-radio--button" id="sameCustYn01" type="radio" name="sameCustYn" value="Y" >
                                    <label class="c-label" for="sameCustYn01">본인명의</label>
                                    <input class="c-radio c-radio--button" id="sameCustYn02" type="radio" name="sameCustYn" value="N">
                                    <label class="c-label" for="sameCustYn02">가족명의</label>
                                </div>
                            </div>
                        </div>

                        <div class="c-form-wrap">
                            <div class="c-form-group" role="group" aria-labelledby="combineInfo">
                                <h3 class="c-form__title--type2 u-mt--46" id="combineInfo">2. 결합 상품 선택</h3>
                                <p class="c-notice--red">
                                    <span><i class="c-icon c-icon--bang--red" aria-hidden="true"></i></span>
                                    <span>결합을 위해서는 정보제공동의가 필요합니다.<button type="button" class="c-text-link--red" data-dialog-trigger="#combinInfoAgree">정보제공동의란?</button></span>
                                </p>
                                <div class="c-checktype-row c-col2 u-mt--18">
                                    <input class="c-radio c-radio--button" id="svcNoTypeCd01" type="radio" name="svcNoTypeCd" value="MB" >
                                    <label class="c-label" for="svcNoTypeCd01">KT모바일결합</label>
                                    <input class="c-radio c-radio--button" id="svcNoTypeCd02" type="radio" name="svcNoTypeCd" value="IT">
                                    <label class="c-label" for="svcNoTypeCd02">KT인터넷결합</label>
                                </div>

                                <!-- 본인 명의일때 - 회선 리스트 -->
                                <div class="c-row c-row--lg u-mt--32" id="ktList"style="display: none">
                                </div>
                                ...
                                <div id="svcNoTypeCd_MB" class="_svcNoTypeCd" style="display: none">
                                    <div class="combine-target">
                                        <div class="combine-target__wrap">
                                            <div class="combine-target__info">
                                                <div class="c-form-field">
                                                    <div class="c-form__input">
                                                        <input type="text" class="c-input" id="combUserNm" name="combUserNm"  maxlength="50" placeholder="이름 입력" >
                                                        <label class="c-form__label" for="combUserNm">이름</label>
                                                    </div>
                                                </div>
                                                <div class="c-form-field">
                                                    <div class="c-form__input">
                                                        <input type="text" class="c-input numOnly u-width--185" id="svcIdfyNo" name="svcIdfyNo" placeholder="ex) 19821120" maxlength="8"  aria-invalid="true">
                                                ...
                                                <div class="c-form-field">
                                                    <div class="c-form__input">
                                                        <input type="text" class="c-input u-width--297 numOnly" id="ctn" name="ctn" value="" placeholder="휴대폰 번호 입력" maxlength="11" aria-invalid="true">
                                                        <label class="c-form__label" for="ctn">휴대폰 번호</label>
                                                    </div>
                                                    <p class="c-form__text"  style="display: none">휴대폰 번호가 올바르지 않습니다.</p>
                                                </div>
                                            </div>
                                            <button type="button" id="btnChildCertify"  class="combine-check">조회</button>
                                        </div>
                                        <div class="combine-target__result">

                                            <div class="c-form-field">
                                                <div class="c-form__input">
                                                    <input type="number" class="c-input" id="authNum" name="authNum" maxlength="6"   placeholder="인증번호 입력">
                                                    <label class="c-form__label" for="authNum">인증번호</label>
                                                    <button id="bthAuthSms" class="c-button c-button--sm c-button--underline u-fs-15">인증번호 확인</button>
                                                </div>
                                                <!-- case1 : 인증번호 확인 전-->
                                    ...
                                    <div class="combine-target">
                                        <div class="combine-target__wrap">
                                            <div class="combine-target__info">
                                                ...
                                                <div class="c-form-field">
                                                    <div class="c-form__input">
                                                        <input type="text" class="c-input numOnly u-width--185" id="svcIdfyNo2" name="svcIdfyNo2" placeholder="ex) 19821120" aria-invalid="true" maxlength="8">
                                                ...
                                                <div class="c-form-field">
                                                    <div class="c-form__input">
                                                        <input type="text" class="c-input u-width--169" id="ctn2" name="ctn2" placeholder="인터넷  서비스 ID" aria-invalid="true">
                                            ...
                                            <button type="button" id="btnChildCertify2" class="combine-check">조회</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- 주의사항 영역 -->
                        <div id="divCheck" class="combine-checklist u-mt--48" style="display: none">
                        ...
                        <div class="c-accordion c-accordion--type1 acc-agree" data-ui-accordion="">
                            <span class="c-form__title--type2 u-mt--42 ">3. 약관동의</span>
                            <div class="c-accordion__box">
                                <div class="c-accordion__item">
                                    <div class="c-accordion__head">
                                        <button class="runtime-data-insert c-accordion__button" id="acc_agree_headerA1" type="button" aria-expanded="false" aria-controls="acc_agreeA1">
                                            <span class="c-hidden">이용약관, 개인정보 수집/이용 및 선택동의 항목에 모두 동의합니다. ※ 고객님의 편의를 위한 모든 약관에 일괄동의 하시겠습니까?</span>
                                        </button>
                                        <div class="c-accordion__check">
                                            <input class="c-checkbox" id="btnStplAllCheck" type="checkbox">
                                            <label class="c-label u-fs-16" for="btnStplAllCheck">이용약관, 개인정보 수집/이용 및 선택동의 항목에 모두 동의합니다.<br /><span class="u-co-red _allcheck">※ 고객님의 편의를 위한 모든 약관에 일괄동의 하시겠습니까?</span></label>
                                        </div>
                                    </div>
                                    <div class="c-accordion__panel expand" id="acc_agreeA1" aria-labelledby="acc_agree_headerA1" aria-hidden="true">
                                        <div class="c-accordion__inside">
                                            ...
                                            <div class="c-accordion__sub-check">
                                                ...
                                                <input type="checkbox" class="c-checkbox c-checkbox--type2 _agree" id="chkAgree" name="chkAgree">
                                            ...
                                            <div class="c-accordion__sub-check">
                                                <button class="c-button c-button--xsm" onclick="fnSetEventId('chkAgree2');openPage('termsPop','/termsPop.do','cdGroupId1=TERMSCOM&cdGroupId2=TERMSCOM03',0);">
                                                    <span class="c-hidden">개인정보 수집 및 이용에 관한 동의 (필수) 상세보기</span>
                                                    <i class="c-icon c-icon--arrow-right" aria-hidden="true"></i>
                                                </button>
                                                <input type="checkbox" class="c-checkbox c-checkbox--type2 _agree" id="chkAgree2" name="chkAgree2">
                                            ...
                                            <div class="c-accordion__sub-check">
                                                <button class="c-button c-button--xsm" onclick="fnSetEventId('chkAgree3');openPage('termsPop','/termsPop.do','cdGroupId1=TERMSCOM&cdGroupId2=TERMSCOM04',0);">
                                                    <span class="c-hidden">개인정보 제 3자 정보제공 동의 (필수) 상세보기</span>
                                                    <i class="c-icon c-icon--arrow-right" aria-hidden="true"></i>
                                                </button>
                                                <input type="checkbox" class="c-checkbox c-checkbox--type2 _agree" id="chkAgree3" name="chkAgree3">
                                            ...
                                            <div class="c-accordion__sub-check">
                                                <button class="c-button c-button--xsm" onclick="fnSetEventId('chkAgree4');openPage('termsPop','/termsPop.do','cdGroupId1=TERMSCOM&cdGroupId2=TERMSCOM05',0);">
                                                    <span class="c-hidden">KT이용약관 확인 동의 (필수) 상세보기</span>
                                                    <i class="c-icon c-icon--arrow-right" aria-hidden="true"></i>
                                                </button>
                                                <input type="checkbox" class="c-checkbox c-checkbox--type2 _agree" id="chkAgree4" name="chkAgree4">
                        ...
                        <p class="combine-sign__txt u-fs-18 u-fw--bold u-mt--54">※결합신청 버튼을 누른 후 결합완료까지 시간이 다소 걸릴 수 있습니다.</p>
                    </div>

                    <!-- 결합 신청 버튼 영역 -->
                    <div class="combine-sign u-mt--18" style="display: none" >
                        <button id="btnRegCombin" type="button" class="is-disabled">결합 신청</button>
                    </div>
                </div>

                <!-- 알려드립니다 영역 -->
                <div class="combine-notice1">
            ...
            <div class="combine-complete _completeForm" style="display: none">
                ...
                <!-- 결합 완료(가족결합 제외) 노출 영역 -->
                <div id="divResult_01" class="combine-complete__wrap"  style="display: none">
                    ...
                    <div class="c-table">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="_serviceNm"></td>
                            </tr>
                            <tr>
                                <th scope="row">요금제</th>
                                <td colspan="3" class="_rate"></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    <t:putAttribute name="popLayerAttr">
        ...
        <!-- KT인터넷 ID 확인 방법 팝업 -->
        <div class="c-modal c-modal--xlg" id="ktInternetIdModal" role="dialog" aria-labelledby="ktInternetIdModalTitle">
            <div class="c-modal__dialog" role="document">
                <div class="c-modal__content">
                    <div class="c-modal__header">
                        <h2 class="c-modal__title" id="ktInternetIdModalTitle">KT인터넷 ID 확인 방법</h2>
                        <button class="c-button" data-dialog-close>
                            <i class="c-icon c-icon--close" aria-hidden="true"></i>
                            <span class="c-hidden">팝업닫기</span>
                        </button>
        ...
        <!-- 구비서류 확인하기 팝업 -->
        <div class="c-modal c-modal--md" id="documentModal" role="dialog" aria-labelledby="documentModalTitle">
          <div class="c-modal__dialog" role="document">
              <div class="c-modal__content">
                  <div class="c-modal__header">
                      <h2 class="c-modal__title" id="documentModalTitle">구비서류 안내</h2>
                      <button class="c-button" data-dialog-close>
                          <i class="c-icon c-icon--close" aria-hidden="true"></i>
                          <span class="c-hidden">팝업닫기</span>
                      </button>
                  ...
                  <div class="c-modal__body">
                    <h3 class="c-heading c-heading--fs17">① 결합 신청자 및 결합 대상자의 신분증</h3>
	                  <p class="u-fs-15 u-co-gray u-ml--20">(단, 미성년자의 경우 법정대리인 신분증으로 대체 제출)</p>
	                  <div class="combine-checklist u-mt--8 u-mb--32 c-box--type3">
										...
										<h3 class="c-heading c-heading--fs17">② 가족관계 증빙 서류</h3>
										<div class="combine-checklist u-mt--8 u-mb--32 c-box--type3">
										<div class="combine-notice u-mt--0">
										  <ul class="combine-notice__list u-mt--0">
										    <li>
            ...
            <div class="c-modal__dialog" role="document">
                <div class="c-modal__content">
                    <div class="c-modal__header">
                        ...
                        <button class="c-button no-print" data-dialog-close id="btnPrintClose">
                            <i class="c-icon c-icon--close" aria-hidden="true"></i>
                            <span class="c-hidden">팝업닫기</span>
                        </button>
                    </div>
                    <div class="c-modal__body combine-print">
                        ...
                        <div class="u-mt--48">
                            <div class="combine-notice2 u-mt--0">
        ...
        <%--결합 할인 팝업--%>
        <div class="c-modal c-modal--md" id="combineSale" role="dialog" aria-labelledby="#combine_sale_title">
            <div class="c-modal__dialog" role="document">
                <div class="c-modal__content">
                    <div class="c-modal__header">
                        <h2 class="c-modal__title" id="combine_sale_title">결합 할인</h2>
                        <button class="c-button" data-dialog-close>
                            <i class="c-icon c-icon--close" aria-hidden="true"></i>
                            <span class="c-hidden">팝업닫기</span>
                        </button>
        ...
        <%--데이터 제공 요금제 팝업--%>
        <div class="c-modal c-modal--md" id="provideSoc" role="dialog" aria-labelledby="#provide_soc_title">
            <div class="c-modal__dialog" role="document">
                <div class="c-modal__content">
                    <div class="c-modal__header">
                        <h2 class="c-modal__title" id="provide_soc_title">데이터 제공 요금제</h2>
                        <button class="c-button" data-dialog-close>
                            <i class="c-icon c-icon--close" aria-hidden="true"></i>
                            <span class="c-hidden">팝업닫기</span>
                        </button>
        ...
        <div class="c-modal c-modal--xlg" id="modalContent" role="dialog" tabindex="-1" aria-labelledby="#modalContentTitle">
            <div class="c-modal__dialog" role="document">
                <div class="c-modal__content">
                    <div class="c-modal__header">
                        <h2 class="c-modal__title" id="modalContentTitle">신청 절차</h2>
                        <button class="c-button" data-dialog-close>
                            <i class="c-icon c-icon--close" aria-hidden="true"></i>
                            <span class="c-hidden">팝업닫기</span>
                        </button>
