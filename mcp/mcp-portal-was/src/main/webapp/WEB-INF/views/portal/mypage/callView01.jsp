...
<t:insertDefinition name="layoutGnbDefault">
    ...
    <t:putAttribute name="scriptHeaderAttr">
        <script type="text/javascript" src="/resources/js/portal/mypage/callView01.js"></script>
    </t:putAttribute>

    <t:putAttribute name="contentAttr">
        <div class="ly-content" id="main-content">
            <div class="ly-page--title">
                <h2 class="c-page--title">이용량 조회</h2>
            </div>
            <div class="c-row c-row--lg">
                                    ...
                                    <c:forEach items="${data}" var="dataList" varStatus="vs">
                                        ...
                                        <li class="usage-chart__item">
                                            <div class="c-indicator-arc">
                                                ...
                                                <span class="indicator-state">${dataList.strSvcName} <br>
                                        ...
                                        <c:if test="${dataLen > 0 and dataLen mod 3 eq 1}"></ul><ul class="usage-chart u-mt--32"></c:if>
                                            <li class="usage-chart__item">
                                                <div class="c-indicator-arc">
                                                    ...
                                                    <span class="indicator-state">${voiceList.strSvcName} <br>
                                        ...
                                        <c:if test="${dataLen > 0 and dataLen mod 3 eq 1}"></ul><ul class="usage-chart u-mt--32"></c:if>
                                            <li class="usage-chart__item">
                                                <div class="c-indicator-arc">
                                                    ...
                                                    <span class="indicator-state">${smsList.strSvcName} <br>
                ...
                <div class="c-button-wrap u-mt--56">
                    <a class="c-button c-button--lg c-button--white c-button--w460 link" href="javascript:;" url="/mypage/chargeView03.do" title="실시간 요금 페이지로 이동하기">실시간 요금조회</a>
                    <c:if test="${!empty vo.itemTelList and !useTimeSvcLimit}">
                        <a class="c-button c-button--lg c-button--primary c-button--w460 link" href="javascript:;" url="/mypage/pullData01.do"  title="데이터당겨쓰기 페이지로 이동하기">데이터 당겨쓰기</a>
                    </c:if>
                </div>
