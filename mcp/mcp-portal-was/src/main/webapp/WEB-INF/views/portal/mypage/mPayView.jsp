...
<t:insertDefinition name="layoutGnbDefault">
    ...
    <script type="text/javascript" src="/resources/js/portal/mypage/mPayView.js"></script>
    <script type="text/javascript">
    history.pushState(null, null,"/mypage/mPayView.do");
    window.onpopstate = function (event){
        history.go("/mypage/mPayView.do");
    }
    </script>
    </t:putAttribute>
   ...
   <t:putAttribute name="contentAttr">
    ...
    <div class="ly-content" id="main-content">
      <div class="ly-page--title">
        <h2 class="c-page--title">소액결제 조회 및 한도변경</h2>
      </div>
          ...
          <table class="micropay">
            ...
            <!--
              <tr>
                ...
                <td>네네소떡소떡외 3</td>
                <td>다날</td>
                <td class="u-fs-13">2022-05-22<br/>20:01:24</td>
                <td>35,000원</td>
                <td>결제</td>
              </tr>
              <tr>
                ...
                <td>월정액</td>
                <td>모빌리언스</td>
                <td class="u-fs-13">2022-05-05<br/>20:01:24</td>
                <td>5,000원</td>
                <td>결제</td>
              </tr>
               -->
