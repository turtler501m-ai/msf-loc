...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$(document).on("click", ".setAddr1", function() {
			...
			$("#setAddr2").data(data);
			$("#addr1Text").html('<span class="c-text-label c-text-label--mint">도로명</span>' + roadAddrPart1);
			$("#zipText").html('<span class="c-hidden">우편번호</span>' + zipNo);
			$("#addrDetail").val("");
			stepFn(2, 1);
			stepFn(3, 0);
		});
...
<div class="c-modal__content">
	<div class="c-modal__header">
		<h2 class="c-modal__title" id="search-addr-modal__title">주소검색</h2>
	...
	<div class="c-modal__body">
		<div class="c-form c-form--search">
			<div class="c-form__input">
				<input class="c-input" id="keyword" type="text" placeholder="도로명주소, 건물명 또는 지번입력" maxlength="20" style="ime-mode:active;"> 
				<label class="c-form__label c-hidden" for="keyword">도로명주소, 건물명 또는 지번 입력</label>
				<button class="c-button c-button--reset">
					<span class="c-hidden">초기화</span> 
					<i class="c-icon c-icon--reset" aria-hidden="true"></i>
				</button>
				<button class="c-button c-button-round--sm c-button--primary" id="searchBtn">검색</button>
			</div>
		</div>
		<!-- case1 - 주소 검색 초기-->
		...
		<dl class="u-mt--32 step1">
			<dt class="u-mt--12">
				<strong class="c-text c-text--fs14">도로명 + 건물번호 입력</strong>
			</dt>
			<dd class="u-mt--8">
				<p class="c-text c-text--fs13 u-co-sub-3">예) 반포대로 58</p>
			</dd>
			<dt class="u-mt--12">
				<strong class="c-text c-text--fs14">도로명 + 건물번호 입력</strong>
			</dt>
		...
		<h3 class="c-heading c-heading--fs17 c-heading--regular u-mt--32 step2" style="display:none;">
			도로명주소 검색 결과<b class="u-co-sub-4 u-ml--6" id="addrCnt"></b>
		</h3>
		...
		<ul class="addr-result step3" style="display:none;">
			<li class="addr-result__item bd-none">
				<a class="addr-result__anchor" href="#"> 
					...
					<p class="addr-result__text" id="addr1Text"></p>
				</a>
			</li>
		</ul>
	...
	<div class="c-modal__footer">
		...
		<div class="c-button-wrap u-mt--0">
			<button class="c-button c-button--lg c-button--primary c-button--w460" id="searchBtn">검색</button>
		</div>
		 -->
	</div>
	<div class="c-modal__footer step3" style="display:none;">
		<!-- case1 - 주소 검색 초기화면일 경우 버튼 문구 '검색' / case3 - 상세 주소 입력일 경우 버튼 문구 '주소 입력' -->
		<div class="c-button-wrap u-mt--0">
			<button class="c-button c-button--lg c-button--primary c-button--w460 is-disabled" id="setAddr2">주소입력</button>
		</div>
	</div>
</div>
