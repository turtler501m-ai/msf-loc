...
<script type="text/javascript">
	...
	<div class="c-modal__content">
        ...
        <div class="c-modal__body">
          <h3 class="c-heading c-heading--fs20 u-mb--40">결합 현황</h3><!-- 데이터 있는 경우-->
	          ...
	          <div class="c-table">
	       	 ...
	       	 <h3 class="c-heading c-heading--fs20 u-mt--40 u-mb--40">결합 중인 회선</h3>
	         <p class="c-bullet c-bullet--fyr u-co-sub-4 u-mb--16"> 최근 3개월 이내 데이터 받기 서비스가 해지된 이력이 있을 경우 데이터 받기 대상요금제로 변경하더라도 데이터 받기 결합신청 불가합니다.</p><!-- 데이터 있는 경우-->
	          <div class="c-table">
	            <table>
