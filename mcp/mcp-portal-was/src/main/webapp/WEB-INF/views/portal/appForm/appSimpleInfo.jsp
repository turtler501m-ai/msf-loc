...
<t:insertDefinition name="layoutGnbDefault">
    ...
    <t:putAttribute name="titleAttr">셀프개통하기</t:putAttribute>
    <t:putAttribute name="scriptHeaderAttr">
        <script type="text/javascript" src="/resources/js/portal/appForm/appSimpleInfo.js"></script>
    </t:putAttribute>

    <t:putAttribute name="contentAttr">
        <div class="ly-content" id="main-content">
            <div class="ly-page--title">
                <h2 class="c-page--title">셀프개통하기</h2>
            </div>
