...
<script type="text/javascript" src="/resources/js/portal/mypage/myinfo/mktAgrPop.js?ver=${jsver}"></script>
...
<div class="c-modal__content">
	...
	<div class="c-modal__body" style="scrollbar-gutter: stable;">
		<h3 class="c-heading--fs22">고객 혜택 제공 동의 (선택)</h3>
		<div class="c-accordion c-accordion--nested">
			<div class="c-accordion__box">
				<div class="c-accordion__item">
					<div class="c-accordion__head">
						<button class="runtime-data-insert c-accordion__button" id="head5" type="button" aria-expanded="false" aria-controls="agree5"></button>
						...
						<div class="c-accordion__inside">
							<div class="c-accordion c-accordion--nested__sub">
								<div class="c-accordion__box">
									<div class="c-accordion__item">
										<div class="c-accordion__head">
											<button class="runtime-data-insert c-accordion__button" id="head5_1" type="button" aria-expanded="false" aria-controls="agree5_1"></button>
											<div class="c-accordion__check">
										...
										<div class="c-accordion__panel expand" id="agree5_1" aria-labelledby="head5_1" aria-hidden="true">
											<div class="c-accordion__inside">
												<div class="box-content">${personalInfoCollectAgree.unescapedDocContent}</div>
											</div>
										</div>
									</div>
									<div class="c-accordion__item">
										<div class="c-accordion__head">
											<button class="runtime-data-insert c-accordion__button" id="head5_2" type="button" aria-expanded="false" aria-controls="agree5_2"></button>
											<div class="c-accordion__check">
										...
										<div class="c-accordion__panel expand" id="agree5_2" aria-labelledby="head5_2" aria-hidden="true">
											<div class="c-accordion__inside">
												<div class="box-content">${mrkAgrYn.unescapedDocContent}</div>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="c-accordion__item">
					<div class="c-accordion__head">
						<button class="runtime-data-insert c-accordion__button" id="head6" type="button" aria-expanded="false" aria-controls="agree6"></button>
						<div class="c-accordion__check">
							<input class="c-checkbox c-checkbox--type5 agreeWrap" id="agreeWrap6" name="agreeChk" type="checkbox" onclick="handleOptionalAgreeWrapClick(this)">
						...
						<div class="c-accordion__inside">
							<div class="c-accordion c-accordion--nested__sub">
								<div class="c-accordion__box">
									<div class="c-accordion__item">
										<div class="c-accordion__head">
											<button class="runtime-data-insert c-accordion__button" id="head6_1" type="button" aria-expanded="false" aria-controls="agree6_1"></button>
											<div class="c-accordion__check">
										...
										<div class="c-accordion__panel expand" id="agree6_1" aria-labelledby="head6_1" aria-hidden="true">
											<div class="c-accordion__inside">
												<div class="box-content" id="othersTrnsAgreesBox">${othersTrnsAllAgree.unescapedDocContent}</div>
											</div>
										</div>
									</div>
									<div class="c-accordion__item">
										<div class="c-accordion__head">
											<button class="runtime-data-insert c-accordion__button" id="head6_2" type="button" aria-expanded="false" aria-controls="agree6_2"></button>
											<div class="c-accordion__check">
										...
										<div class="c-accordion__panel expand" id="agree6_2" aria-labelledby="head6_2" aria-hidden="true">
											<div class="c-accordion__inside">
												<div class="box-content">${othersAdReceiveAgree.unescapedDocContent}</div>
											</div>
										</div>
									</div>
								</div>
	...
	<div class="c-modal__footer">
		<div class="c-button-wrap">
			<button class="c-button c-button--lg c-button--primary c-button--w460" id="setMktArgBtn">확인</button>
		</div>
	</div>
</div>
