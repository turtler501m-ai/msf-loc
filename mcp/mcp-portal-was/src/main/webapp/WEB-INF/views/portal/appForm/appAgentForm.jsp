...
<t:insertDefinition name="layoutOutFormGnbDefault">
    ...
    <t:putAttribute name="scriptHeaderAttr">
        ...
        <script type="text/javascript" src="/resources/js/portal/appForm/appAgentForm.js?version=${jsver}"></script>
    </t:putAttribute>
        ...
        <div class="ly-content" id="main-content">
            ...
            <div id="step1" class="c-row c-row--lg _divStep">
                ...
                <div class="c-form-wrap u-mt--24">
                    <div class="c-form-group" role="group" aira-labelledby="cstmrTitle">
                        <div class="c-checktype-row c-col3 u-mt--0">
                            ...
                            <input class="c-radio c-radio--button c-radio--button--type1" id="cstmrType2" type="radio" name="cstmrType" value="${Constants.CSTMR_TYPE_NM}" <c:if test="${AppformReq.cstmrType eq Constants.CSTMR_TYPE_NM }" > checked </c:if> disabled>
                            <label class="c-label" for="cstmrType2">
                                <i class="c-icon c-icon--type-kid" aria-hidden="true"></i>
                                <span>19세 미만 미성년자</span>
                            </label>
                            <input class="c-radio c-radio--button c-radio--button--type1" id="cstmrType3" type="radio" name="cstmrType" value="${Constants.CSTMR_TYPE_FN}" <c:if test="${AppformReq.cstmrType eq Constants.CSTMR_TYPE_FN }" > checked </c:if> disabled>
                ...
                <div class="c-form-wrap">
                    ...
                    <c:if test="${AppformReq.cstmrName ne null and !empty AppformReq.cstmrName }">
                        <div class="c-box c-box--type1 c-box--bullet _isDefaultText">
                    ...
                    <div class="c-form-wrap reservation u-mt--32 _self">
                        <div class="c-form-group" role="group" aira-labelledby="inpReservNumHead">
                            <div class="c-flex c-flex--jfy-between">
                                ...
                                <span id="searchCnt" class="u-co-point-4 u-fs-15">조회 가능 횟수 <b>20회</b></span>
                            </div>
            ...
            <div id="step4" class="_divStep" style="display:none">
                ...
                <div class="c-row c-row--lg">
                    ...
                    <h4 class="c-heading c-heading--fs20 c-heading--medium u-mt--56 _insrProdForm">
                        휴대폰안심보험 신청
                        <span class="u-co-gray u-fs-16 u-ml--4">(선택)</span>
                    </h4>
            ...
            <div id="step5" class="c-row c-row--lg _divStep" style="display:none" >
                ...
                <div class="c-form-wrap">
                    <div class="c-form-group" role="group" aira-labelledby="radReceiveTypeTitle">
                        ...
                        <p class="c-bullet c-bullet--dot u-co-gray u-fs-16 u-mt--16 _isCommon">이메일, 모바일(MMS) 명세서를 선택 하시면 청구내역을 빠르고 정확하게 받아보실 수 있습니다.</p>
                        <p class="c-bullet c-bullet--dot u-co-gray u-fs-16 u-mt--16 _isTeen">미성년의 경우 MMS명세서 선택이 불가합니다. 희망하시는 경우 개통 후 고객센터로 문의 부탁드립니다.</p>
