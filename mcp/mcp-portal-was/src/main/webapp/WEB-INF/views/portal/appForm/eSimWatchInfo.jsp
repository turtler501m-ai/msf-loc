...
<t:insertDefinition name="layoutGnbDefaultTitle">
    ...
    <t:putAttribute name="titleAttr">워치 개통 신청</t:putAttribute>

    <t:putAttribute name="scriptHeaderAttr">
        <script type="text/javascript" src="/resources/js/portal/appForm/eSimInfo.js?version=2004-08-02"></script>
    </t:putAttribute>

    <t:putAttribute name="contentAttr">
        <div class="ly-content" id="main-content">
            <div class="ly-page--title">
                <h2 class="c-page--title">워치 개통 신청</h2>
            </div>
            <div class="watch-banner">
                <div class="watch-banner__wrap">
                    <h3>엠모바일 사용고객 한정!<br />이젠 워치도 저렴하게 사용하자!</h3>
                    <div class="watch-banner__button">
                        <a href="/appForm/eSimWatch.do" title="워치 신청서 작성 바로가기">
                            <span>워치 신청서 작성</span>
                            <i class="c-icon c-icon--anchor-black" aria-hidden="true"></i>
                        </a>
                    </div>
                    <img src="/resources/images/portal/esim/watch_banner.png" alt="">
                </div>
            </div>
            <div class="watch-info-wrap">
                <div class="watch-step__title u-mt--64">
                    <div class="watch-step__head">
                        STEP1 <span>신청 준비</span>
                    </div>
                    <div class="watch-step__sub">워치 개통 시 하기 사항을 사전에 확인/준비 해 주세요.</div>
                </div>
                <h4 class="watch-info__title u-mt--36">사용중인 kt M모바일 휴대폰</h4>
                <hr class="c-hr">
                <p>워치 개통을 위해서는 kt M모바일에 동일 명의로 가입되어 있는 회선이 필요합니다.</p>
                <div class="watch-info__table">
                    <div class="c-table">
                        <table>
                            <caption>구분, 이용기준을 포함한 워치 원넘버 부가서비스 정보</caption>
                            <colgroup>
                                <col style="width: 15.625rem">
                                <col>
                            </colgroup>
                            <thead>
                                <tr>
                ...
                <h4 class="watch-info__title">휴대폰(워치) 정보 등록</h4>
                <hr class="c-hr">
                <p>
                    ...
                    <ul class="c-accordion__box">
                        <li class="c-accordion__item">
                            <div class="c-accordion__head">
                                <strong class="c-accordion__title">애플 워치 가이드</strong>
                                <button class="runtime-data-insert c-accordion__button" id="watch_guide_header_01" type="button" aria-expanded="false" aria-controls="watch_guide_01"></button>
                            </div>
                            <div class="c-accordion__panel expand" id="watch_guide_01" aria-labelledby="watch_guide_header_01">
                                            ...
                                            <div class="watch-guide__list--group">
                                                <div class="watch-guide__list__item">
                                                    <span class="Number-label--type2">
                                                        <em>1</em>
                                                          아이폰-워치 연결 팝업 선택<br />아이폰에 팝업이 나타나지 않을 경우<br />Watch(워치) 앱 선택
                                                    </span>
                                                </div>
                                                <div class="watch-guide__list__item">
                                                    <span class="Number-label--type2">
                        ...
                        <li class="c-accordion__item">
                            <div class="c-accordion__head">
                                <strong class="c-accordion__title">갤럭시 워치 가이드</strong>
                                <button class="runtime-data-insert c-accordion__button" id="watch_guide_header_02" type="button" aria-expanded="false" aria-controls="watch_guide_02"></button>
                            </div>
                            <div class="c-accordion__panel expand" id="watch_guide_02" aria-labelledby="watch_guide_header_02">
                                <div class="c-accordion__inside">
                                    <ul class="watch-guide__list--wrap">
                                        <li>
                                            <div class="watch-guide__list--group">
                ...
                <ul class="watch-info__list--fyr u-co-gray">
                    <li class="u-mt--9">‘상담사 개통 신청’ 으로 신청서를 작성하시면 순차적으로 상담사가 전화로 본인 확인 후 개통이 진행되며 지속 부재 시 자동으로 취소됩니다.</li>
                </ul>
                ...
                <iframe class="u-mt--24" src="https://www.youtube.com/embed/9Gq5AG0ezvE" width="940" height="529" title="알뜰폰 eSIM으로 쉽고 간편한 스마트워치 셀프개통!ㅣkt M모바일ㅣ서비스 퀵 가이드" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                <div class="c-button-wrap u-mt--45">
                    <a id="btnWatchStart" class="c-button c-button-round--md c-button--mint u-width--460"  title="워치 신청서 작성 바로가기"  >워치 셀프개통 시작</a>
                </div>
                ...
                <p class="c-notice--red u-mt--38">
                    <span><i class="c-icon c-icon--bang--red" aria-hidden="true"></i></span>
                    <span>반드시 단말기가 Wi-Fi 또는 셀룰러 망(5G/LTE)에 연결되어 있어야 합니다.</span>
                </p>
                <p class="u-mt--10">워치 셀프개통 시 eSIM 발급 비용 2,750원(VAT포함)이 청구됩니다.</p>
                <div class="c-accordion c-accordion--type3" data-ui-accordion>
                    <ul class="c-accordion__box">
                        <li class="c-accordion__item">
                            <div class="c-accordion__head">
                                <strong class="c-accordion__title">애플 워치 eSIM 발급</strong>
                                <button class="runtime-data-insert c-accordion__button" id="watch_esim_header_01" type="button" aria-expanded="false" aria-controls="watch_esim_01"></button>
                            </div>
                            <div class="c-accordion__panel expand" id="watch_esim_01" aria-labelledby="watch_esim_header_01">
                                <div class="c-accordion__inside">
                                    <ul class="watch-guide__list--wrap">
                                        <li>
                                            <div class="watch-guide__list--group">
                        ...
                        <li class="c-accordion__item">
                            <div class="c-accordion__head">
                                <strong class="c-accordion__title">갤럭시 워치 eSIM 발급</strong>
                                <button class="runtime-data-insert c-accordion__button" id="watch_esim_header_02" type="button" aria-expanded="false" aria-controls="watch_esim_02"></button>
                            </div>
                            <div class="c-accordion__panel expand" id="watch_esim_02" aria-labelledby="watch_esim_header_02">
                                <div class="c-accordion__inside">
                                    <ul class="watch-guide__list--wrap">
                                        <li>
                                            <div class="watch-guide__list--group">
                                                <div class="watch-guide__list__item">
                                                    <span class="Number-label--type2">
                                                        <em>1</em>
                                                          Galaxy Wearable 앱 실행<br />개통 완료 후 앱 > 워치 설정 > 모바일 요금제<br />선택
                                                    </span>
                                                </div>
                                                <div class="watch-guide__list__item">
                                                    <span class="Number-label--type2">
