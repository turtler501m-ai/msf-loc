...
<t:insertDefinition name="layoutGnbDefault">
    <t:putAttribute name="metaTagAttr">
      ...
      <meta id="meta_og_description" content="" property="og:description" />
        ...
        <meta name="keywords" content="${nmcp:getCodeDesc('MetaKeywords','01')}, ${ eventDto.eventKeyword}">
        <meta name="description" content="${empty eventDto.eventDescription ? nonAdDescription :  eventDto.eventDescription}">
    </t:putAttribute>

    <t:putAttribute name="titleAttr">
        ${empty eventDto.eventTitle ? (empty eventDto.eventHeaderTitle ? '이번달 이벤트' : eventDto.eventHeaderTitle) : eventDto.eventTitle}
    </t:putAttribute>
...
<script type="text/javascript" src="/resources/js/portal/event/eventDetail.js?version=2025-12-30"></script>
        ...
        <div>
          <div class="c-board c-board--type2">
            ...
            <div class="c-button-wrap u-mt--56">
              <a href="javascript:;" class="c-button c-button--lg c-button--white c-button--w460" onclick="showList('/event/eventBoardList.do');">목록보기</a>
            </div>
          </div>
        <!-- </div> -->
