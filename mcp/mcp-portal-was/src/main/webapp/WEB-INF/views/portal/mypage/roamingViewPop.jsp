...
<script type="text/javascript" src="/resources/js/portal/mypage/roamingViewPop.js?version=25.07.22"></script>


<div class="c-modal__content" >
    <div class="c-modal__header">
        <h2 class="c-modal__title" id="modalSMSTitle">로밍상품 신청</h2>
    ...
    <div class="c-modal__footer">
        <div class="c-button-wrap">
            ...
            <button class="c-button c-button--lg c-button--primary u-width--220" id="checkBtn"  type="button" >확인</button>
        </div>
    </div>
</div>
</div>
