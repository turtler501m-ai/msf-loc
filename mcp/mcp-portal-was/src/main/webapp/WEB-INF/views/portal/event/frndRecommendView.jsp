...
<t:insertDefinition name="layoutMainDefault">
    <t:putAttribute name="scriptHeaderAttr">
		<script type="text/javascript" src="/resources/js/portal/event/frndRecommendView.js"></script>
    </t:putAttribute>
    <t:putAttribute name="contentAttr">
	   	<div class="ly-content" id="main-content">
	      <div class="ly-page--title">
	        <h2 class="c-page--title">친구초대 올인원</h2>
	      </div>

	      <div class="friend-all-banner">
	          <div class="friend-all-banner__wrap">
	          	  <!-- 이름 위 포인트 스크립트는 하단에 있음 -->
	              <h3><span class="friend-name-wrap">${custNM}</span>님이<br />직접 써보고 추천하는<br /><b>kt M모바일</b></h3><!-- 필수 -->



				  <hr class="friend-all-hr c-hr--type3">
	              <p>[ 초대 ID ]입력 후 가입 시<br /><span>친구도 나도 <b>’포인트 증정’</b></span></p>
	              <img src="/resources/images/portal/event/friend_all_banner.png" alt="친구초대 이벤트 M 마켓 포인트 증정" aria-hidden="true">
	      ...
	      <div class="friend-all-content">
				...
				<ul class="friend-all-join">
				    <li class="friend-all-join__item">
				    	<span class="friend-all-circle">1</span>
				    	 <div class="friend-all-join__img">
				    	 	<img src="/resources/images/portal/event/friend_all_join1.png" alt="">
				    	 </div>
	                ...
	                <li class="friend-all-join__item">
				    	<span class="friend-all-circle">2</span>
				    	 <div class="friend-all-join__img">
				    	 	<img src="/resources/images/portal/event/friend_all_join2.png" alt="">
				    	 </div>
	                    <div class="friend-all-join__desc">
	                        <p class="u-mt--9">친구가 추천해준 요금제로<br /><b>5분만에 [셀프]로 개통하기!</b></p>
	                ...
	                <li class="friend-all-join__item">
				    	<span class="friend-all-circle">3</span>
				    	 <div class="friend-all-join__img">
				    	 	<img src="/resources/images/portal/event/friend_all_join3.png" alt="">
				    	 </div>
	                    <div class="friend-all-join__desc">
	                        <p>휴대폰에 유심만 바꿔끼면<br />친구도 나도 포인트 혜택</p>
	                    </div>
	                </li>
	                <li class="friend-all-join__item">
				    	<span class="friend-all-circle">4</span>
				    	 <div class="friend-all-join__img">
				    	 	<img src="/resources/images/portal/event/friend_all_join4.png" alt="">
				    	 </div>
	                    <div class="friend-all-join__desc">
	                        <p>KT인터넷까지 가입하면<br />M모바일 요금제+KT인터넷+TV<br />할인 금액에 이용 가능!</p>
	                    </div>
	                </li>
				</ul>
			</div>
	      	<div class="friend-all-wide">
		      	<div class="friend-all-wrap w1100">
		      		<div class="friend-all-title">
					...
					<ul class="friend-all-usim">
		                ...
		                <li class="friend-all-usim__item ${recommend.openMthdCd eq '04' ? 'is-active' : ''}">
					    	...
					    	<a class="friend-all-usim__info" href="/appForm/eSimSelfView.do" title="eSIM(실물유심 배송없이 즉시 개통) 페이지 이동">
						    	<div class="friend-all-usim__img">
						    	 	<img src="/resources/images/portal/event/friend_all_usim4.png" alt="">
						    	</div>
			                    <div class="friend-all-usim__desc">
			                        <p>eSIM</p>
			                        <span>(실물유심 배송없이<br />즉시 개통)</span>
			                    </div>
		                    </a>
		                </li>
	      	...
	      	<div class="friend-all-wide friend-all-wide--gray">
		      	<div class="friend-all-wrap">
		      		<div class="friend-all-title">
					...
					<div class="c-button-wrap friend-all-rate">
	                	<a class="c-button" href="/rate/rateList.do" title="요금제 페이지 이동">더 많은 요금제 보러가기<i class="c-icon c-icon--arrow-light" aria-hidden="true"></i></a>
	              	</div>
		      	</div>
	      	</div>
