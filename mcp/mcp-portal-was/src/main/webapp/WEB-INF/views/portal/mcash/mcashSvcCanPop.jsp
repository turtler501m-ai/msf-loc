...
<div class="c-modal__content">
  <div class="c-modal__header">
    <h2 class="c-modal__title" id="mcashServiceCnlTitle">M쇼핑할인 서비스 해지</h2>
  ...
  <div class="c-modal__footer">
    <div class="c-button-wrap">
      ...
      <button class="c-button c-button--lg c-button--primary u-width--220" onclick="mcashSvcCan();">해지</button>
    </div>
  </div>
</div>