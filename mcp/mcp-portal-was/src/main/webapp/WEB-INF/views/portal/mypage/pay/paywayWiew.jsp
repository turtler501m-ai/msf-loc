...
<t:insertDefinition name="layoutGnbDefault">
    ...
    <t:putAttribute name="scriptHeaderAttr">
        ...
        <script type="text/javascript" src="/resources/js/portal/mypage/pay/paywayView.js?version=23-11-23"></script>
    ...
    <t:putAttribute name="contentAttr">
        <div class="ly-content" id="main-content">
            <div class="ly-page--title">
                <h2 class="c-page--title">납부방법 변경</h2>
            </div>
                ...
                <div class="c-form-wrap">
                    ...
                    <div id="bank">
                        <div class="c-form-group u-mt--48" role="group" aria-labelledby="inpcardInfoHead">
                            <h4 class="c-group--head u-fs-20" id="inpcardInfoHead">계좌 정보 입력</h4>
                            <div class="c-form-row c-col2">
                                ...
                                <div class="c-form-field">
                                    <div class="c-form__input u-mt--0">
                                        <input class="c-input numOnly" id="bankAcctNo" name="bankAcctNo" maxlength='20' placeholder="'-'없이 입력">
                        ...
                        <div class="c-box c-box--type1 c-box--bullet u-mt--20">
                            <ul class="c-text-list c-bullet c-bullet--dot">
                                ...
                                <li class="c-text-list__item">등록하신 자동이체로 결제된 내역은 취소되지 않습니다.</li>
                            </ul>
                        </div>
                    ...
                    <div id="auth">
                        ...
                        <script defer type="text/javascript" src="/resources/js/portal/popup/niceAuth.js?version=24.10.16"></script>
                        ...
                        <div class="c-button-wrap u-mt--56">
                            <a class="c-button c-button--lg c-button--gray u-width--220 cancelBtn" href="javascript:;">취소</a>
                        ...
                        <ul class="c-step-list c-step-list--type3 col-3">
                            <li class="c-step-list__item">
                                ...
                                <div class="c-button-wrap u-mt--24">
                                    <a class="c-button c-button--md c-button--gray cancelBtn" href="javascript:;">취소</a>
                    ...
                    <div id="payCo" style="display: none;">
                        <h4 class="c-heading c-heading--fs20 u-mt--48">페이코로 자동납부 신청방법</h4>
