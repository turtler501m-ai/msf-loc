...
<t:insertDefinition name="layoutMainDefault">
	<t:putAttribute name="scriptHeaderAttr">
		<script type="text/javascript" src="/resources/js/portal/mypage/billWayChgView.js?version=${jsver}"></script>
			...
			<div class="c-tabs__panel u-block">
				<div class="c-row c-row--lg">
					...
					<div class="c-button-wrap u-mt--56">
						<button class="c-button c-button--lg c-button--primary u-width--460" onclick="changeSubmit()" id="change-submit">변경</button>
					</div>
				</div>
			</div>
		</div>
