...
<div class="review_detail">
	<c:choose>
			...
			<c:forEach var="requestReviewDtoList" items="${requestReviewDtoList}">
				...
				<div class="review_fold foldArea">
					<div class="review_text">
						...
						<a href="javascript:;" class="viewMore"><span class="more">더보기</span></a>
					</div>
					...
					<div class="review_photo" >
						<c:if test="${selectUsimRequestReviewIngList !=null and !empty selectUsimRequestReviewIngList}">
							<a href="javascript:;" class="viewMore">
								<span>${fn:length(selectUsimRequestReviewIngList)}</span>
								<img src="${selectUsimRequestReviewIngList[0].filePathNm}" onerror="this.src='/resources/images_bak/requestReview/noimage.png'"  alt="">
							</a>
						</c:if>
					</div>
				...
				<div class="review_orgn orgnArea" style="display:none;">
					<div class="review_text">
						...
						<div class="del">
							<a href="javascript:;" class="btn_intable delBtn" contractNum="${requestReviewDtoList.contractNum}">삭제</a>
						</div>
		...
		<c:otherwise>
			<div class="default">아직 작성된 사용후기가 없습니다.</div>
		</c:otherwise>
	</c:choose>
</div>