    ...
    <t:putAttribute name="contentAttr">
        <div class="ly-content" id="main-content">
            ...
            <div class="c-row c-row--lg u-mt--64">
                ...
                <div class="friend-invite-content u-mt--64">
                    <div class="friend-wrap">
                        ...
                        <div class="c-form-wrap">
                            <div class="c-form-group" role="group">
                                <div class="c-checktype-row c-col2 u-mt--26">
                                    <input class="c-radio c-radio--button c-radio--button--type1" name="linkTypeCd" value="01" id="linkTypeCd_01" type="radio" checked>
                                    <label class="c-label" for="linkTypeCd_01"><span>기본 추천 링크 만들기</span></label>

                                    <input class="c-radio c-radio--button c-radio--button--type1" name="linkTypeCd" value="99" id="linkTypeCd_02" type="radio">
                        ...
                        <div class="c-button-wrap u-mt--52">
                            <button class="c-button c-button-round--md c-button--primary u-width--220" id="btnfrndUpdateMypage">
                            ...
                            <button class="c-button c-button-round--md c-button--share u-width--220" id="btnLinkCopy" data-page="mng">
