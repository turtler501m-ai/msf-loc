...
<script type="text/javascript" src="/resources/js/portal/mypage/addSvcViewPop.js"></script>
 ...
 <div class="c-modal__content">
    ...
    <div class="c-modal__body">
      ...
      <h3 class="c-heading c-heading--fs20 c-heading--regular u-mt--64">수신차단 번호 입력<span class="c-text c-text--fs14 u-co-gray-8 u-ml--4"> (<em class="u-co-point-4 u-fw--medium" id="numCount" >1</em>/ 50)</span>
      </h3>
      <ul class="c-list c-list--inp-number u-mt--32 addNumber">
        <li class="c-list__item numberAddView">
          <div class="c-input-wrap c-input-wrap--flex u-mt--0">
            <input class="c-input numOnly" type="text" id="phone1_1"  maxlength="3" placeholder="앞자리" title="앞자리 입력">
            <input class="c-input numOnly" type="text" id="phone2_1"  maxlength="4" placeholder="중간자리" title="중간자리 입력">
            <input class="c-input numOnly" type="text" id="phone3_1"  maxlength="4" placeholder="뒷자리" title="뒷자리 입력">
          </div>
