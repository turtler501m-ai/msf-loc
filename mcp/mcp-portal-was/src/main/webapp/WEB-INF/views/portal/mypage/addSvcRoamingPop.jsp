 ...
 KTM.datePicker('#range.flatpickr-input', {
   ...
   <div class="c-modal__content">
     ...
     <div class="c-modal__body">
       ...
       <h3 class="c-heading c-heading--fs20 c-heading--regular u-mt--48">이용기간 설정<span class="c-text c-text--fs14 u-co-gray-8 u-ml--4">(한국시간 기준)</span>
       </h3>
           ...
           <div class="c-form-row c-col2 u-mt--0">
             <div class="c-form">
               <div class="c-input-wrap u-width--320">
                 ...
                 <span class="c-button c-button--icon" type="button" title="날짜입력창 버튼" tabindex="-1">
