...
<script type="text/javascript" src="/resources/js/portal/mypage/addSvcViewPop.js?version=23-03-21"></script>
...
<div class="c-modal__content" >
 ...
 <div class="c-modal__footer">
   <div class="c-button-wrap">
     ...
     <button class="c-button c-button--lg c-button--primary u-width--220" type="button" onclick="btn_reg();"  >확인</button>
      </div>
    </div>
  </div>
</div>
