...
<t:insertDefinition name="layoutGnbDefault">
    ...
    <script type="text/javascript" src="/resources/js/portal/mypage/farPricePlanView.js?version=25-12-11"></script>
    ...
    <div class="ly-content" id="main-content">
      <div class="ly-page--title">
        <h2 class="c-page--title">요금제 변경</h2>
      </div>
      ...
      <div class="c-row c-row--lg">
        ...
        <div class="c-select-search">
          ...
          <div class="c-form c-form--line">
            <label class="c-label c-hidden" for="ncn">회선 선택</label>
            <select class="c-select" id="ncn">
          ...
          <button class="c-button c-button-round--xsm c-button--primary u-ml--10" onclick="btn_search();">조회</button>
        </div>
        ...
        <form name="frm" id="frm">
          <input id="soc" name="soc" type="hidden">
          ...
          <input type="hidden" id="aSocAmnt" name="aSocAmnt" value="${myPriceInfo.instMnthAmt}">
        ...
        <div class="total-charge u-mt--16">
          ...
          <dl class="total-charge__price" border=1 >
            ...
            <dd>
              ...
              <span class="total-charge__text" id="instAmt"><fmt:formatNumber value="${mcpFarPriceDto.instMnthAmt}" type="number"/>원</span>
            </dd>
          </dl>
        </div>
        ...
        <h3 class="c-heading c-heading--fs20 c-heading--regular u-mt--64 u-mb--24">변경 가능한 요금제</h3><!-- [2022-02-10] 카테고리 분류 탭 추가(마크업 수정) 시작-->
