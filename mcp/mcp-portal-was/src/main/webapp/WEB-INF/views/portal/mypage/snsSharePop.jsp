...
<%@ taglib prefix="nmcp" uri="nmcp.tag" %>
        ...
        <script type="text/javascript" src="/resources/js/portal/mypage/snsSharePop.js"></script>
       ...
       <div class="c-modal__body u-ta-center">
         ...
         <div class="c-button-wrap c-flex u-mt--32">
           <a class="c-button" href="#">
             ...
             <i class="c-icon c-icon--kakao" aria-hidden="true" href="javascript:void(0);" onclick="kakaoShare(); return false;"></i>
           </a>
           <a class="c-button" href="#">
             <span class="c-hidden">line</span>
             <i class="c-icon c-icon--line" aria-hidden="true" href="javascript:void(0);" onclick="lineShare(); return false;"></i>
           </a>
           <a class="c-button" href="#">
             <span class="c-hidden">URL 복사하기</span>
             <i class="c-icon c-icon--link" aria-hidden="true" href="javascript:void(0);" onclick="clip(); return false;"></i>
           </a>
         </div>
