...
<t:insertDefinition name="layoutOutFormGnbDefault">
    ...
    <t:putAttribute name="scriptHeaderAttr">
        <script type="text/javascript" src="/resources/js/portal/appForm/appAgentFormComplete.js?ver=${jsver}"></script>
        <!-- 카카오 광고 분석  -->
            ...
            <div class="ly-page--title">
                <c:choose>
                    <c:when test="${addInfoTxt eq 'Y'}">
                        <h2 class="c-page--title">셀프개통 가입신청서</h2>
                    </c:when>
                    <c:otherwise>
                        <h2 class="c-page--title">대리점 셀프개통 가입신청서</h2>
                    </c:otherwise>
                </c:choose>
            </div>
