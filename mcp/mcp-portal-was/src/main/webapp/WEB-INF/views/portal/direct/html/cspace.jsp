	...
	<t:putAttribute name="contentAttr">
		<div class="ly-content" id="main-content">
	      <div class="ly-page--title">
	        <h2 class="c-page--title">편의점 조회(씨스페이스)</h2>
	      </div>
	      <div class="c-row c-row--xlg">
	        <div class="cvs-wrap cvs-wrap__cspace">
	          <img src="../../resources/images/portal/cvs/cspace/img_01.jpg" alt="쉽고 빠른 씨스페이스 유심 가입하기">
	          <img src="../../resources/images/portal/cvs/cspace/img_02.jpg" alt="씨스페이스 개통방법">
	          <img src="../../resources/images/portal/cvs/cspace/img_03.jpg" alt="전국 씨스페이스에서 유심 구매 가능, 상담없이 직접하는 셀프개통!">
	          <table>
	            <tbody>
	              <tr>
	                <td>
	                  <a href="/direct/storeInfo.do">
	                    <img src="../../resources/images/portal/cvs/cspace/img_04_01.jpg" alt="편의점 찾기">
	                  </a>
	                </td>
	                <td>
	                <button class="c-button c-button c-button--white" data-dialog-trigger="#join-info-modal" id="selfBtn" style="display:none;">셀프개통 가능 시간 안내 popup 호출</button>
	                  <a href="#" onclick="selfTimeChk()">
	                    <img src="../../resources/images/portal/cvs/cspace/img_04_02.jpg" alt="셀프개통">
	                  </a>
	                </td>
	              </tr>
	            </tbody>
	          </table>
	          <img src="../../resources/images/portal/cvs/cspace/img_05.jpg" alt="공백">
	          <img src="../../resources/images/portal/cvs/cspace/img_06.jpg" alt="구매부터 개통까지 특별한 혜택">
	          <img src="../../resources/images/portal/cvs/cspace/img_07.jpg" alt="편의점 구매 고객의 솔직한 사용후기">
				...
				<div class="c-modal__content">
					<div class="c-modal__body">
						...
						<div class="c-button-wrap u-mt--48">
							<a class="c-button c-button--full c-button--primary" href="/appForm/appFormDesignView.do?orgnId=NZA0000240" id="movBtn" style="display:none;">확인</a>
