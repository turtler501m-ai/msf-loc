...
<head>
    ...
    <script type="text/javascript" src="/resources/js/portal/naver/naverLoginCallBack.js"></script>
...
<input type="hidden" id="nearoCallBackUrl" name="nearoCallBackUrl" value="${nmcp:getServerInfo()}<spring:eval expression="@propertiesForJsp['NEARO_PC_LOGIN_CALLBACK_URL']" />"/>
