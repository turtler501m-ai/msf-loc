...
<t:insertDefinition name="layoutGnbDefault">
    ...
    <t:putAttribute name="scriptHeaderAttr">
       <script type="text/javascript" src="/resources/js/portal/policy/privacyView.js"></script>
    <script>
                    ...
                    <div class="c-row c-row--lg">
                        <div class="c-board">
                            ...
                            <div class="c-board__content">
                                <article class="c-editor">${viewDto.stpltSbst}</article>
                            </div>
                        ...
                        <div class="c-button-wrap u-mt--56">
                            <a class="c-button c-button--lg c-button--white c-button--w460" href="javascript:;" id="viewList">이전 개인정보처리방침 보기</a>
                        </div>
                    </div>
                </div>
