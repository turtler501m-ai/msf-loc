...
<t:insertDefinition name="layoutGnbDefault">
    ...
    <script type="text/javascript" src="/resources/js/portal/event/userPromotion.js?version=24-04-11"></script>
    ...
    <t:putAttribute name="contentAttr">
         ...
         <input type="hidden" id="promoFinish" value="${promoFinish}" />
          ...
          <c:otherwise>
            ...
            <div class="ly-page--title">
                <h2 class="c-page--title">홈 회원가입 이벤트</h2>
            </div>
            ...
            <div class="c-row c-row--lg">
                ...
                <ul class="c-text-list c-bullet c-bullet--fyr u-fs-15 u-mt--20">
                  ...
                  <div class="c-modal__content">
                    ...
                    <div class="c-modal__body">
                          <div class="u-ta-center">
                            <p class="u-fs-20 u-fw--medium">본 이벤트 참여를 위해서는<br />회원가입 및 정보/광고 수신 동의가 필요하며,<br />회원가입 완료 시 자동 응모됩니다.</p>
                          </div>
                    </div>
                    <div class="c-modal__footer">
                          <div class="c-button-wrap">
                            <button class="c-button c-button--lg c-button--gray u-width--220" data-dialog-close>취소</button>
                            <button class="c-button c-button--lg c-button--primary u-width--220" data-dialog-close onclick="pop_nice()">휴대폰인증</button>
                          </div>
                    </div>
                  </div>
            </div>
        ...
        <!-- 이벤트 참여 완료 -->
        <div class="c-modal c-modal--md" id="userPromotionCompleteModal" role="dialog" aria-labelledby="userPromotionCompleteTitle">
            <div class="c-modal__dialog" role="document">
                  <div class="c-modal__content">
                    <div class="c-modal__header">
                          <h2 class="c-modal__title" id="userPromotionCompleteTitle">이벤트 참여</h2>
                          <button class="c-button" data-dialog-close>
                            <i class="c-icon c-icon--close" aria-hidden="true"></i>
                            <span class="c-hidden">팝업닫기</span>
                          </button>
                    ...
                    <div class="c-modal__body">
                          <div class="u-ta-center">
                            <p class="u-fs-20 u-fw--bold">회원가입 및 응모가 완료되었습니다.</p>
                            <p class="u-fs-15 u-co-gray u-mt--8">정보/광고 수신 동의일자(<span id="agreeDate"></span>)</p>
                            <p class="u-fs-15 u-co-gray u-mt--32">※ 정보/광고동의는 마이페이지에서 수정 가능하나<br />수정 시 이벤트혜택 지급이 불가합니다.</p>
                          </div>
                    </div>
                    <div class="c-modal__footer">
                          <div class="c-button-wrap">
