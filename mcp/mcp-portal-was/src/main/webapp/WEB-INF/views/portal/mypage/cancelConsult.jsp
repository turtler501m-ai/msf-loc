...
<t:insertDefinition name="layoutGnbDefault">
    ...
    <t:putAttribute name="scriptHeaderAttr">
        ...
        <script type="text/javascript" src="/resources/js/portal/mypage/cancelConsult.js?version=25.09.30"></script>
    </t:putAttribute>
    ...
    <t:putAttribute name="contentAttr">
        ...
        <div class="ly-content" id="main-content">
            <div class="ly-page--title">
                <h2 class="c-page--title">해지 상담 신청</h2>
            </div>
            <div class="c-tabs c-tabs--type1" data-ui-tab>
                <div class="c-tabs__list" role="tablist">
                    <button class="c-tabs__button" id="tab1" role="tab" aria-controls="tab1panel" aria-selected="false" tabindex="-1">해지예약 접수</button>
                    <button class="c-tabs__button" id="tab2" role="tab" aria-controls="tab2panel" aria-selected="false" tabindex="-1">접수이력 확인하기</button>
                </div>
            </div>
            <div class="c-tabs__panel" id="tab1panel" role="tabpanel" aria-labelledby="tab2" tabindex="-1">
                <div class="c-row c-row--lg">
                    <!-- 해지 상담 신청 시작 -->
                    <div class="cancel-reason-content">
                        <div class="cancel-reason-info">
                            <h3 class="c-form__title--type2 u-mt--0">해지 신청 안내</h3>
                            <ul class="c-text-list c-bullet c-bullet--dot u-mt--24">
                                <li class="c-text-list__item">해지 접수 시 고객님께 안내 전화를 드리며, 본인 여부 및 할인반환금(위약금) 등 최종 확인 후 처리됩니다. <span>(해지 신청 접수는 본인 명의의 회선만<br />가능합니다.)</span></li>
                                ...
                                <li class="c-text-list__item">일거양득/데이터쉐어링/워치 요금제를 통해 회선을 함께 이용중이신 경우 모회선 해지 시 자회선 이용이 불가하며 일거양득의 경우 모회선<br />해지일부터 자회선의 요금이 부과됩니다.<span>(자회선 해지가 필요할 경우 추가 해지 접수 필요)</span></li>
                            </ul>
                            <ul class="cancel-reason-step">
                                <li class="cancel-reason-step__item">
                                    <em>1</em>
                                    <p>필수 확인사항 동의,<br/>본인인증</p>
                                </li>
                                <li class="cancel-reason-step__item">
                                    <em>2</em>
                                    <p>해지 신청 접수</p>
                            ...
                            <p class="c-bullet c-bullet--fyr u-fs-15 u-co-gray u-mt--37">본인인증이 불가하거나, 미성년자 또는 명의자 외 대리인이 해지를 원하실 경우 고객센터로 문의 부탁드립니다.</p>
                            <h3 class="c-form__title--type2 u-mt--42">해지 전 필수 확인 사항</h3>
                            <div class="c-accordion c-accordion--type1 acc-agree u-mt--0" data-ui-accordion>
                                <div class="c-accordion__box">
                                    <div class="c-accordion__item">
                                        <div class="c-accordion__head">
                                            <button class="runtime-data-insert c-accordion__button is-active" id="acc_agree_headerA1" type="button" aria-expanded="true" aria-controls="acc_agreeA1">
                                                <span class="c-hidden">본인은 해지 시 혜택 소멸 및 하기 안내사항에 모두 동의합니다.</span>
                                            </button>
                                            <div class="c-accordion__check">
                                                <input class="c-checkbox" id="btnStplAllCheck" type="checkbox">
                                                <label class="c-label" for="btnStplAllCheck">본인은 해지 시 혜택 소멸 및 하기 안내사항에 모두 동의합니다.<br /><span class="u-co-red _allcheck">※ 전체동의는 해당 개별 항목의 상세 내용을 모두 읽어야 가능합니다.</span></label>
                                            </div>
                                        </div>
                                        <div class="c-accordion__panel expand" id="acc_agreeA1" aria-labelledby="acc_agree_headerA1" aria-hidden="false">
                                            <div class="c-accordion__inside">
                                                <div class="c-accordion__sub-check">
                                                    <button class="c-button c-button--xsm" data-dialog-trigger="#modalTerms1">
                                                        <span class="c-hidden">혜택 소멸(필수) 상세 팝업 열기</span>
                                                        <i class="c-icon c-icon--arrow-right" aria-hidden="true"></i>
                                                     </button>
                                                     <input class="c-checkbox c-checkbox--type2 _agree" id="benefitAgreeFlag" type="checkbox" value="Y">
                                                     <label class="c-label" for="benefitAgreeFlag">혜택 소멸<span class="u-co-gray">(필수)</span></label>
                                                </div>
                                                <div class="c-accordion__sub-check">
                                                    <button class="c-button c-button--xsm" data-dialog-trigger="#modalTerms2">
                                                        <span class="c-hidden">해지 고객 정보 삭제(필수) 상세 팝업 열기</span>
                                                        <i class="c-icon c-icon--arrow-right" aria-hidden="true"></i>
                                                     </button>
                                                     <input class="c-checkbox c-checkbox--type2 _agree" id="clauseCntrDelFlag" type="checkbox" value="Y">
                                                     <label class="c-label" for="clauseCntrDelFlag">해지 고객 정보 삭제<span class="u-co-gray">(필수)</span></label>
                                                </div>
                                                <div class="c-accordion__sub-check">
                                                    <button class="c-button c-button--xsm" data-dialog-trigger="#modalTerms3">
                                                        <span class="c-hidden">기타 안내(필수) 상세 팝업 열기</span>
                                                        <i class="c-icon c-icon--arrow-right" aria-hidden="true"></i>
                                                     </button>
                                                     <input class="c-checkbox c-checkbox--type2 _agree" id="etcAgreeFlag" type="checkbox" value="Y">
                                                     <label class="c-label" for="etcAgreeFlag">기타 안내<span class="u-co-gray">(필수)</span></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="c-accordion c-accordion--type1 acc-agree">
                                <div class="c-accordion__box">
                                    <div class="c-accordion__item">
                                        <div class="c-accordion__head">
                                            <div class="c-accordion__check">
                                                ...
                                                <label class="c-label" for="chkAgree">
                                                          온라인 해지 접수는 <span class="u-co-red u-fs-16">당일 해지가 불가능하며, 처리가 지연될 수 있습니다.</span><br>
                            ...
                            <div class="c-accordion c-accordion--type1 payway u-mt--0" data-ui-accordion>
                                <div class="c-accordion__box">
                                    <div class="c-accordion__item">
                                        <div class="c-accordion__head">
                                             <button class="runtime-data-insert c-accordion__button is-active" id="acc_headerA1" type="button" aria-expanded="true" aria-controls="acc_contentA1">
                                                 <span class="c-hidden">본인인증 절차 동의 상세열기</span>
                                             </button>
                                             <div class="c-accordion__check">
                                                 <input class="c-checkbox" id="niceChkAgree" type="checkbox" name="niceChkAgree">
                                                 <label class="c-label" for="niceChkAgree">본인인증 절차 동의</label>
                                             </div>
                                        </div>
                                        <div class="c-accordion__panel expand" id="acc_contentA1" aria-labelledby="acc_headerA1" aria-hidden="false">
                                            <div class="c-accordion__inside">
                        ...
                        <div class="cancel-reason-form" style="display: none;">
                            <h3 class="c-form__title--type2" id="inpNameCertiTitle">해지 신청 정보 입력</h3>
                                        ...
                                        <div class="c-form-field" >
                                            <div class="c-form__input-group is-readonly">
                                                <div class="c-form__input c-form__input-division">
                                                    <input class="c-input--div2 onlyNum" id="cstmrNativeRrn01" type="text" autocomplete="false" maxlength="6" placeholder="주민등록번호 앞자리" title="주민등록번호 앞자리" value="${birthday}" readonly>
                                                    <span>-</span>
                                                    <input class="c-input--div2" id="cstmrNativeRrn02" type="text" autocomplete="false" maxlength="7" placeholder="주민등록번호 뒷자리" title="주민등록번호 뒷자리" value="${gender}●●●●●●" readonly>
                                    ...
                                    <div class="c-form-row c-col2">
                                        <div class="c-form-field u-width--460">
                                            <div class="c-form__input-group u-mt--0">
                                                <div class="c-form__input c-form__input-division">
                                                    <input class="c-input--div3 onlyNum" aria-labelledby="receiveMobileNoLabel" name="receiveMobileNo1" id="receiveMobileNo1" type="text" maxlength="3" placeholder="숫자입력" onkeyup="nextFocus(this, 3, 'receiveMobileNo2');" autocomplete="off"> <span aria-hidden="true">-</span>
                                                    <label class="c-form__label" for="receiveMobileNo1" id="receiveMobileNoLabel1">연락가능 연락처</label>
                                                    <input class="c-input--div3 onlyNum" aria-labelledby="receiveMobileNoLabel2" name="receiveMobileNo2" id="receiveMobileNo2" type="text" maxlength="4" placeholder="숫자입력" onkeyup="nextFocus(this, 4, 'receiveMobileNo3');" autocomplete="off"> <span aria-hidden="true">-</span>
                                                    <label class="c-form__label sr-only" for="receiveMobileNo2" id="receiveMobileNoLabel2">연락처 중간자리</label>
                                                    <input class="c-input--div3 onlyNum" aria-labelledby="receiveMobileNoLabel3" name="receiveMobileNo3" id="receiveMobileNo3" type="text" maxlength="4" placeholder="숫자입력" autocomplete="off">
                                                    <label class="c-form__label sr-only" for="receiveMobileNo3" id="receiveMobileNoLabel3">연락처 뒷자리</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <p class="c-bullet c-bullet--fyr u-fs-15 u-co-red">명의자 분과 통화 가능한 국내 전화번호를 남겨주세요.<br/>상담사 전화(1899-5000번)을 받지 못하신 경우 접수가 취소될 수 있습니다.</p>
                            </div>
                            <div class="c-form-wrap">
                                <div class="c-form-group" role="group" aria-labelledby="inpAddInfoHead">
                                    <div class="c-form-row c-col2">
                                        ...
                                        <!-- 직접 입력 영역 -->
                                        <div class="c-form-field" id="cancelMobileNoInputArea" style="display:none;">
                                            <div class="c-form__input-group u-mt--0">
                                                <div class="c-form__input c-form__input-division">
                                                    <input class="c-input--div3 onlyNum" name="cancelMobileNo1" id="cancelMobileNo1" type="text" maxlength="3"
                                                           placeholder="숫자입력" onkeyup="nextFocus(this, 3, 'cancelMobileNo2');" autocomplete="off">
                                                    <span aria-hidden="true">-</span>
                                                    <label class="c-form__label" for="cancelMobileNo1">해지 신청 번호</label>

                                                    <input class="c-input--div3 onlyNum" name="cancelMobileNo2" id="cancelMobileNo2" type="text" maxlength="4"
                                                           placeholder="숫자입력" onkeyup="nextFocus(this, 4, 'cancelMobileNo3');" autocomplete="off">
                                                    <span aria-hidden="true">-</span>
                                                    <label class="c-form__label sr-only" for="cancelMobileNo2">연락처 중간자리</label>

                                                    <input class="c-input--div3 onlyNum" name="cancelMobileNo3" id="cancelMobileNo3" type="text" maxlength="4"
                                                           placeholder="숫자입력" autocomplete="off">
                                                    <label class="c-form__label sr-only" for="cancelMobileNo3">연락처 뒷자리</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="cancel-reason__list">
                                                    ...
                                                    <div class="c-checktype-column">
                                                        ...
                                                        <div class="cancel-reason-message" style="display:none;">
                                                            ...
                                                            <div class="c-button-wrap u-mt--15">
                                                                <a class="c-button c-button--h48 c-button--mint" href="/rate/rateList.do" title="요금제 소개 바로가기">요금제 소개 바로가기</a>
                                                                <a class="c-button c-button--h48 c-button--mint" href="/rate/rateComp.do" title="요금제 비교 바로가기">요금제 비교 바로가기</a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="cancel-reason-message" style="display:none;">
                                                            ...
                                                            <div class="c-button-wrap u-mt--15">
                                                                <a class="c-button c-button--h48 c-button--mint u-width--396" href="/content/combineSelf.do" title="아무나 SOLO 결합 바로가기">아무나 SOLO 결합 바로가기</a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="c-form u-fs-0" style="display:none;">
                                                            ...
                                                            <textarea class="c-textarea u-mb--6" id="survey1Text" placeholder="자유롭게 적어주세요.(100자 이내)"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <li class="cancel-reason__item">
                                            ...
                                            <div class="c-form u-fs-0">
                                                ...
                                                <textarea class="c-textarea" id="surveySuggestion" name="surveySuggestion" placeholder="자유롭게 적어주세요.(100자 이내)"></textarea>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="c-button-wrap u-mt--56">
                                <button class="c-button c-button--lg c-button--gray u-width--220">취소</button>
                                <button class="c-button c-button--lg c-button--primary u-width--220 is-disabled" id="btnCancelConsult">해지신청</button>
                            </div>
                        </div>
                        <!-- 본인인증 완료 후 나오는 영역 끝 -->
                    </div>
            ...
            <div class="c-tabs__panel" id="tab2panel" role="tabpanel" aria-labelledby="tab2" tabindex="-1">
                <div class="c-row c-row--lg">
                    <div class="cancel-reason-content">
                        <div class="cancel-reason-info">
                            <h3 class="c-heading c-heading--fs20">접수 상태가 <b class="u-co-sub-4">'처리 중'</b>이면, 상담원이 해지 접수를 받아 처리하고 있는 중입니다.</h3>
                                ...
                                <table>
                                    ...
                                    <c:when test="${!empty cancelConsultList}">
                                        <c:forEach var="cancelConsultItem" varStatus="status" items="${cancelConsultList}">
                                            <tr>
                                                <td>${cancelConsultItem.cstmrName}</td>
                                                <td>${cancelConsultItem.cancelMobileNo}</td>
                                                <td><fmt:formatDate value="${cancelConsultItem.regstDttm}" pattern="yyyy-MM-dd"/></td>
                                                <td>
                                                    <c:choose>
                                    ...
                                    <c:otherwise>
                                        <tr>
                                            <td colspan="4"><p class="nodata">접수이력이 없습니다.</p></td>
                                        </tr>
                                    </c:otherwise>
                                    </c:choose>
                                    </tbody>
        ...
        <!-- 약관동의 팝업, 셀프개통 약관창 참고 함 -->
        <!-- 혜택 소멸 (필수) -->
        <div class="c-modal c-modal--lg" id="modalTerms1" role="dialog" tabindex="-1" aria-describedby="modalTerms1Title" aria-modal="true">
            <div class="c-modal__dialog" role="document">
                <div class="c-modal__content">
                    ...
                    <div class="c-modal__footer">
                        <button class="c-button c-button--full c-button--primary" data-dialog-close data-agree-btn disabled>동의 후 닫기</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- 해지 고객 정보 삭제 (필수) -->
        <div class="c-modal c-modal--xlg" id="modalTerms2" role="dialog" tabindex="-1" aria-describedby="modalTerms2Title" aria-modal="true">
            <div class="c-modal__dialog" role="document">
                <div class="c-modal__content">
                    <div class="c-modal__header">
        ...
        <!-- 기타 안내 (필수) -->
        <div class="c-modal c-modal--xlg" id="modalTerms3" role="dialog" tabindex="-1" aria-describedby="modalTerms3Title" aria-modal="true">
            <div class="c-modal__dialog" role="document">
                <div class="c-modal__content">
                    <div class="c-modal__header">
        ...
        <!-- 페이지 진입 시 팝업 -->
        <div class="c-modal c-modal--lg" id="startModal" role="dialog" tabindex="-1" aria-modal="true">
            <div class="c-modal__dialog" role="document">
                <div class="c-modal__content">
                    <div class="c-modal__header">
                        <h1 class="c-modal__title c-hidden" id="startModalTitle">일시정지 신청</h1>
                        <button class="c-button" data-dialog-close="">
                            <i class="c-icon c-icon--close" aria-hidden="true"></i>
                            <span class="c-hidden">팝업닫기</span>
                        </button>
                    ...
                    <div class="c-modal__body u-ta-center">
                        <h3 class="c-heading c-heading--fs24">
                            <b>해지 전 잠시 <span class="u-co-sub-4">일시정지</span> 해두시는건 어떠세요?</b>
                        </h3>
                        <p class="c-text c-text--fs18 u-mt--40">
                              당분간 휴대폰 사용이 어려우시다면, <b class="u-co-sub-4">일시정지</b>를 신청하세요!
                        </p>
                        <p class="c-text c-text--fs18 u-mt--4">
                                 고객센터 통화 없이 온라인에서 즉시 신청이 가능합니다.
                        </p>
                        <a class="c-button c-button-round--md c-button--mint u-width--220 u-mt--32 u-mb--8" href="/mypage/suspendView01.do">일시정지 신청하기</a>
                    </div>
                    <div class="c-modal__footer">
                        <div class="c-button-wrap">
                            <button class="c-button c-button--full c-button--primary" data-dialog-close>해지 예약 계속</button>
                            <a class="c-button c-button--full c-button--gray" href="/main.do">해지 예약 취소</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- 미성년자 신청불가 팝업 -->
        <div class="c-modal c-modal--md" id="modalMinorNotAllowed" role="dialog" tabindex="-1" aria-modal="true">
            <div class="c-modal__dialog" role="document">
                <div class="c-modal__content">
                    <div class="c-modal__body">
                        <div class="complete u-ta-center">
                            ...
                            <p class="c-text c-text--fs18 u-mt--32">제출 서류 등 안내를 위해<br/>고객센터(114)로 연락부탁드립니다.</p>
                        </div>
                        <p class="c-bullet c-bullet--fyr u-fs-16 u-mt--32">확인버튼 클릭 시 가입정보 페이지로 이동합니다.</p>
                    </div>
                    <div class="c-modal__footer">
                        <div class="c-button-wrap">
                            <a class="c-button c-button--full c-button--primary" href="/mypage/myinfoView.do">확인</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- 신청완료 팝업 -->
        <div class="c-modal c-modal--md" id="modalCancelRequestComplete" role="dialog" tabindex="-1" aria-modal="true">
            <div class="c-modal__dialog" role="document">
                <div class="c-modal__content">
                    <div class="c-modal__body">
                        <div class="complete u-ta-center">
                            ...
                            <p class="c-text c-text--fs18 u-mt--32">해지 절차 및 동의사항 안내를 위해 D+1일(영업일)이내 연락 드리며,<br />1899-5000번으로 발신 예정이니 수신 부탁드립니다.</p>
                        </div>
                        <ul class="c-text-list c-bullet c-bullet--fyr u-fs-15 u-mt--32">
                    ...
                    <div class="c-modal__footer">
                        <div class="c-button-wrap">
                            <a class="c-button c-button--full c-button--primary" href="/main.do">확인</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- 이미 접수 완료 팝업 -->
        <div class="c-modal c-modal--md" id="modalAlreadyRequested" role="dialog" tabindex="-1" aria-modal="true">
            <div class="c-modal__dialog" role="document">
                <div class="c-modal__content">
                    <div class="c-modal__body">
                        <div class="complete u-ta-center">
                            ...
                            <p class="c-text c-text--fs18 u-mt--32">신청 내역 확인 후<br/>상담사가 연락드리도록 하겠습니다.</p>
                        </div>
                        <p class="c-bullet c-bullet--fyr u-fs-16 u-mt--32">상담전화를 받지 못하신 경우 접수가 취소될 수 있습니다.</p>
                    </div>
                    <div class="c-modal__footer">
                        <div class="c-button-wrap">
