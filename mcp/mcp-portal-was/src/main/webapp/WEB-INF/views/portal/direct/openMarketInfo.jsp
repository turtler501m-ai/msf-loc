...
<t:insertDefinition name="layoutMainDefault">
	<t:putAttribute name="scriptHeaderAttr">
		...
		<script type="text/javascript" src="/resources/js/portal/usim/openMarketInfo.js"></script>
		<script>
	...
	<t:putAttribute name="contentAttr">
		...
		<div class="ly-content" id="main-content">
	      <div class="ly-page--title">
	        <h2 class="c-page--title">오픈마켓 구매하기</h2>
	      </div>
	      <div class="ly-content--wrap">
	        <div class="swiper-container" id="swiperOpenMarket" ${empty topBannerList ? 'hidden' : ''}>
	          <ul class="swiper-wrapper">
	             <c:forEach var="topList" items="${topBannerList}">
	             	<c:if test="${empty topList.linkUrlAdr}">
	             		<li class="swiper-slide" tabindex="-1" aria-label="" style="background-color: ${topList.bgColor}; ${empty topList.linkUrlAdr ? 'pointer-events:none;' : ''};" href="javascript:void(0);">
	             	</c:if>
	             	<c:if test="${not empty topList.linkUrlAdr}">
	             		<li class="swiper-slide" tabindex="-1" aria-label="" style="background-color: ${topList.bgColor}; ${empty topList.linkUrlAdr ? 'pointer-events:none;' : ''};" href="javascript:void(0);"  onclick="insertBannAccess('${topList.bannSeq}', '${topList.bannCtg}')">
		            </c:if>

			              <div class="u-box--w1100 u-margin-auto">
			                <a href="${empty topList.linkUrlAdr ? '' : topList.linkUrlAdr}" target="${topList.linkTarget eq 'Y' and not empty topList.linkUrlAdr ? '_blank' : '_self'}" title="${topList.linkTarget eq 'Y' ? '새창열림' : ''}">
	      ...
	      <div class="c-row c-row--lg" ${empty midBannerList ? 'hidden' : ''}>
	        <h3 class="c-heading c-heading--fs20 c-heading--regular u-mt--64">오픈마켓 유심 판매처</h3>
	        <hr class="c-hr c-hr--title">
	        <ul class="market-list">
	          <c:forEach var="midList" items="${midBannerList}">
	          	<c:if test="${empty midList.linkUrlAdr}">
		          	<li class="market-list__item" href="javascript:void(0);">
		        </c:if>
		        <c:if test="${not empty midList.linkUrlAdr}">
		        	<li class="market-list__item" href="javascript:void(0);" onclick="insertBannAccess('${midList.bannSeq}', '${midList.bannCtg}')">
		        </c:if>
		            <a class="market-list__anchor" href="${midList.linkUrlAdr}" target="${midList.linkTarget eq 'Y' ? '_blank' : '_self'}" title="${midList.linkTarget eq 'Y' ? midList.bannNm : ''}${midList.linkTarget eq 'Y' ? '새창열림' : ''}" style="${empty midList.linkUrlAdr ? 'pointer-events:none;' : ''}">
	      ...
	      <div class="ly-content--wrap u-mt--64 u-bk--light-mint">
	        <div class="c-row c-row--lg">
	          <div class="market-box">
	            <h4 class="c-heading c-heading--fs20">오픈마켓에서 kt M모바일 유심 구매 가능!</h4>
	            <p class="c-text c-text--fs17 u-co-gray u-mt--16">오픈마켓 유심 구매했다면? 바로 개통해보세요.</p>
	            <ul class="c-step-list">
	              <li class="c-step-list__item">
	                ...
	                <i class="c-step-list__image" aria-hidden="true">
	                  <img src="/resources/images/portal/common/ico_find_market.svg" alt="">
	                </i>
	                <strong class="c-step-list__title">오픈마켓 찾기</strong>
	                <p class="c-step-list__text">선호하는 오픈마켓을 찾아주세요</p>
	              </li>
	              <li class="c-step-list__item">
	            ...
	            <div class="c-button-wrap u-mt--40">
	              <button class="c-button c-button-round--md c-button--mint c-button--w460" onclick="selfTimeChk()">셀프개통 하기</button>
	      ...
	      <div class="c-row c-row--lg">
	      	...
	      	<!-- <h3 class="c-heading c-heading--fs20 c-heading--regular u-mt--64">오픈마켓 유심 구매 혜택</h3>
            <hr class="c-hr c-hr--title">
	        ...
	        <div class="c-accordion c-accordion--type3" data-ui-accordion>
	          <ul class="c-accordion__box" id="terms-accordion">
	            <li class="c-accordion__item">
	              <div class="c-accordion__head">
	                ...
	                <button class="runtime-data-insert c-accordion__button" id="acc_header_c1" type="button" aria-expanded="false" aria-controls="acc_content_c1">
	                  <!-- <span class="c-hidden">오픈마켓 셀프개통 상세열기</span> -->
	                </button>
	              </div>
	            ...
	            <li class="c-accordion__item">
	              <div class="c-accordion__head">
	                ...
	                <button class="runtime-data-insert c-accordion__button" id="acc_header_c2" type="button" aria-expanded="false" aria-controls="acc_content_c2">
	                  <!-- <span class="c-hidden">공통 상세열기</span> -->
	                </button>
	              </div>
