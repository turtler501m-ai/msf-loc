		...
		<c:when test="${privacyEtcBoardList ne null and !empty privacyEtcBoardList}">
			<ul class="c-list c-list--type1">
				<c:forEach var="privacyEtcBoardList" items="${privacyEtcBoardList}">
					<li class="c-list__item"><strong class="c-list__title">${privacyEtcBoardList.boardSubject}</strong>
						<a class="c-list__anchor" href="${privacyEtcBoardList.boardContents}" target="_blank" title="${privacyEtcBoardList.boardSubject} 새창 열림">바로가기
