...
<html>
	<head>
        ...
        <script type="text/javascript" src="/resources/js/portal/naver/nearoCallBack.js"></script>
	...
	<body>
		...
		<input type="hidden" id="nearoCallBackUrl" name="nearoCallBackUrl" value="${nmcp:getServerInfo()}<spring:eval expression="@propertiesForJsp['NEARO_PC_CALLBACK_URL']" />"/>
