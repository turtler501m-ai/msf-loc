...
<t:insertDefinition name="layoutGnbDefault">
    ...
    <t:putAttribute name="scriptHeaderAttr">
        <script type="text/javascript" src="/resources/js/portal/mypage/coupon/couponUsedDataList.js"></script>
    </t:putAttribute>
                            ...
                            <div class="c-card-col c-card-col--3 u-mt--4">
                                        ...
                                        <div class="c-card c-card--coupon">
                                            ...
                                            <div class="c-card__bottom">
                                                <div class="c-card__date">
                                                    ...
                                                    <span class="sub-code">
                                                        <fmt:formatDate value="${rgstStrtDt}" pattern="yyyy.MM.dd" />
                                                    </span>
                                                </div>
                                                <span class="c-text-label c-text-label--darkgray">${coupInfo.coupStatCdNm}</span>
                                            </div>
                                        </div>
                                    </c:forEach>
                                </c:if>
                                <c:if test="${usedCoupInfoList ne null and !empty usedCoupInfoList}">
                                    <c:forEach var="usedCoupInfo" items="${usedCoupInfoList}">
                                        <div class="c-card c-card--coupon">
                                            <span class="c-card__title">${usedCoupInfo.coupnCtgNm}</span>
                                            <div class="c-card__sub">
                                                <p class="c-text">
                                                    <span class="sub-title">쿠폰번호</span>
                                                    <span class="sub-code">
                                                        ${usedCoupInfo.coupnNo}
                                                    </span>
                                                </p>
                                            </div>
                                            <div class="c-card__bottom">
                                                <div class="c-card__date">
                                                    ...
                                                    <span class="sub-code">
                                                        ${usedCoupInfo.pstngStartDate} ~ ${usedCoupInfo.pstngEndDate}
                                                    </span>
                                                </div>
                                                <span class="c-text-label c-text-label--darkgray">사용완료</span>
                                            </div>
                                        </div>
                                    </c:forEach>
                                </c:if>
