...
<t:insertDefinition name="mlayoutNoGnb">
...
<!-- 						
							<div class="notice_tit_pc">
								<img class="notice_img" src="/resources/images/mobile/notice/notice_tit_pc.jpg" class="notice_img" alt="공지사항 이미지 ">				
							</div>			
 -->
							<div class="notice_tit_mo">
								<img class="notice_img" src="/resources/images/mobile/notice/notice_tit_mo.jpg" class="notice_img" alt="공지사항 이미지 ">				
							</div>																							
	...
	<t:putAttribute name="contentAttr">
	    <div class="ly-content" id="main-content">
	      <div class="error u-ta-center">
	        ...
	        <p class="error__text">${nmcp:convertHtmlchars(alertMsg)}</p>
	      </div>
	    </div>
	</t:putAttribute>
 --%>
