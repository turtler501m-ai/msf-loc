...
$(document).ready(function(){
    ...
    $("#applyBtn").click(function(){
        ...
        ajaxCommon.createForm({
            method:"post"
            ,action:"/m/cs/csInquiryInt.do"
        });
        ajaxCommon.formSubmit();
    });

    // 체크박스
    $("#chkA1").change(function(){
    ...
    $("#nextTab").click(function(){
        ...
        location.href="/m/cs/csInquiryIntHist.do";
    });
    ...
    ajaxCommon.getItem({
        ...
        if(rtnList !=null){
            for(var i=0; i<rtnList.length; i++){
                ctgHtml +="<option value='"+rtnList[i].dtlCd+"' cdGroupId='"+rtnList[i].cdGroupId+"'>"+rtnList[i].dtlCdNm+"</option>";
            }
        }*/
