...
var pageMessage = {
   F_LOGIN_REQ: '<p class="u-mt--12"><strong class="u-fw--bold">회원정보와 가입정보가<br>일치하지 않습니다.</strong></p><p class="u-mt--12">다른 명의로 신청을 원하실 경우 로그아웃 후 이용 해 주시기 바랍니다.</p>'
  ,F_LOGIN: '<p class="u-mt--12"><strong class="u-fw--bold">회원정보와 본인인증 정보가<br>일치하지 않습니다.</strong></p><p class="u-mt--12">다른 명의로 신청을 원하실 경우 로그아웃 후 이용 해 주시기 바랍니다.</p>'
  ,F_MEMBER: '<p class="u-mt--12"><strong class="u-fw--bold">kt M모바일 가입 정보를 확인할 수 없습니다. 입력 내용을 다시 확인 후 시도해 주세요.</strong></p><p class="u-mt--12">가입되어 있으나 인증이 실패한 경우<br>고객센터로 문의해 주세요.</p>'
  ,F_AUTH: '<p class="u-mt--12"><strong class="u-fw--bold">본인인증 정보가 일치하지 않습니다.</strong></p><p class="u-mt--12">입력하신 정보를 확인 후 다시 시도해 주시기 바랍니다.</p>'
  ,F_AGE: '<p class="u-mt--12"><strong class="u-fw--bold">만 19세 미만 사용자는 온라인 신청이 제한됩니다.</strong></p><p class="u-mt--12">신청을 원하실 경우 법정대리인께서 고객센터로 문의해 주세요.</p>'
}
...
$(document).ready(function(){
  ...
  $("#btnSmsAuth").click(function(){
    ...
    if(pollingPageUrl != ""){
      openPage('outLink', pollingPageUrl + '&mType=Mobile', '');
    }
  });
    ...
    ajaxCommon.getItem({
      ...
      ,function(jsonObj){
        ...
        if(jsonObj.RESULT_CODE == AJAX_RESULT_CODE.SUCCESS){
          MCP.alert('<p class="u-mt--12"><strong class="u-fw--bold">배송 신청이 접수되었습니다.</strong></p><p class="u-mt--12">유심을 수령하신 후<br>안내 문자에 포함된 URL 또는 마이페이지에서 유심변경을 진행해 주세요.</p>', function(){
            location.href = "/m/apply/replaceUsimView.do";
          });
...
function drawCntrInfoTable(replaceUsimSubDtos){
  ...
  for(var i = 0; i < replaceUsimSubDtos.length; i++){
    ...
    tableHtml += '<div class="c-table c-table--row u-mt--16">';
    tableHtml += '  <table>';
    tableHtml += '    <caption>번호, 신청가능 여부, 불가사율로 구성된 정보</caption>';
    tableHtml += '    <colgroup>';
    tableHtml += '      <col style="width: 24%"/>';
    tableHtml += '      <col/>';
    tableHtml += '    </colgroup>';
    tableHtml += '    <tbody>';
    tableHtml += '      <tr>';
    tableHtml += '        <th scope="row">번호</th>';
    tableHtml += '        <td class="u-ta-left">' + item.mskMobileNo + '</td>';
    tableHtml += '      </tr>';
    tableHtml += '      <tr>';
    tableHtml += '        <th scope="row">신청</th>';
    tableHtml += '        <td class="u-ta-left">' + (resultCd == "00" ? "가능" : "불가능") + '</td>';
    tableHtml += '      </tr>';
    tableHtml += '      <tr>';
    tableHtml += '        <th scope="row">사유</th>';
