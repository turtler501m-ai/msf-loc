...
function btn_pointReg(){
 ...
 function btn_numAdd(){
	...
	if(50 > count){
		...
		html +='<input class="c-input c-input--h34 u-ta-center onlyNum" type="text"  id="phone1_'+num+'"  maxlength="3" placeholder="앞자리" title="앞자리 입력">';
		html +='<input class="c-input c-input--h34 u-ta-center onlyNum" type="text"  id="phone2_'+num+'"  maxlength="4" placeholder="중간자리" title="중간자리 입력">';
		html +='<input class="c-input c-input--h34 u-ta-center onlyNum" type="text"  id="phone3_'+num+'"  maxlength="4" placeholder="뒷자리" title="뒷자리 입력">';
		html +='</div>';
						    ...
						    , success : function(jsonObj) {
								if (jsonObj.returnCode == "00") {
									MCP.alert("부가서비스 신청이 완료되었습니다.", function (){
										$('.c-icon--close').trigger('click');
										location.href = '/m/rate/adsvcGdncList.do';
									});
									//
								}else {
