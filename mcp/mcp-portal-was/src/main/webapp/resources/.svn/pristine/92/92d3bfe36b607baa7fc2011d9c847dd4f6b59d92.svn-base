VALIDATE_NOT_EMPTY_MSG.cstmrTel = "휴대폰 번호를 입력해 주세요.";
VALIDATE_COMPARE_MSG.cstmrTel = "휴대폰 번호가 형식에 맞지 않습니다.";
...
$(document).ready(function (){
    ...
    $("#btnMyCoupon").click(function(){
        location.href = "/m/mypage/couponList.do";
        this.close();
    });
    ...
    $('#btnDown').click(function(){
        ...
        validator.config['cstmrTel'] = 'isNonEmpty';
        validator.config['cstmrTel'] = 'isPhone';
        ...
        if(validator.validate()){
            ...
            var phoneNum = $("#cstmrTel").val(); //휴대폰번호
            var parameterData = {
                smsRcvNo : phoneNum,
