...
var btn_numAdd = function(){
  ...
  html += '    <input class="c-input numOnly" type="text" id="phone1_' + num + '" maxlength="3" placeholder="앞자리" title="앞자리 입력">';
  html += '    <input class="c-input numOnly" type="text" id="phone2_' + num + '" maxlength="4" placeholder="중간자리" title="중간자리 입력">';
  html += '    <input class="c-input numOnly" type="text" id="phone3_' + num + '" maxlength="4" placeholder="뒷자리" title="뒷자리 입력">';
  html += '  </div>';
...
var btn_roamReg = function(){
  ...
  var roamDay = $("#range").val();  // yyyy-mm-dd~yyyy-mm-dd
  var timeSel = $("#timeSel").val();
  var roamDayS = roamDay.split("~");

  if(roamDay == null || roamDay == "" || roamDayS.length != 2){
  ...
  var startDt = roamDayS[0].trim().replace(/\-/gi, "");
  var endDt = roamDayS[1].trim().replace(/\-/gi, "");
