...
$(document).ready(function() {
	...
	pJoinProdCorp = $("#pJoinProdCorp").val();
	pJoinProdCd = $("#pJoinProdCd").val();
	pJoinProdDtlSeq = $("#pJoinProdDtlSeq").val();
    	...
    	,function(jsonObj) {
    		if (jsonObj.RESULT_CODE == "00000") {
    	        ...
    	        ajaxCommon.createForm({
    	            method:"post"
    	            ,action:"/wire/wireProdJoinComplete.do" 
...
var getAllProdList = function() {     	 
	...
	,function(jsonObj){
		...
		$("#joinCorp").val(pJoinProdCorp).trigger("change");
		$("#joinProdCd").val(pJoinProdCd).trigger("change");    
		$("#joinProdDtlSeq").val(pJoinProdDtlSeq).trigger("change"); 
    });
