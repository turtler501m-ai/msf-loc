$(document).ready(function(){
	...
	$("#applyBtn").click(function(){
		...
		ajaxCommon.createForm({
		    method:"post"
		    ,action:"/m/cs/csInquiryIntHist.do"
		});
	...
	$("#prvTab").click(function(){
		...
		location.href="/m/cs/csInquiryInt.do";
...
var viewDesc = function(totalCount,inquiryList,listCount){
	...
	if(inquiryList !=null && inquiryList.length>0 ){
		...
		for(var i=0; i<inquiryList.length; i++){
			...
			ansContent = ajaxCommon.isNullNvl(inquiryList[i].ansContent,"");
