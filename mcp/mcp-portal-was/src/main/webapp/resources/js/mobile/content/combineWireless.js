...
$(document).ready(function (){
            ...
            ,function(jsonObj){
                if (AJAX_RESULT_CODE.SUCCESS ==  jsonObj.RESULT_CODE) {
                    ...
                    if (serviceCd == "EMPTY") {
                        ...
                        arr.push("    <p class='possible__subtxt'>※상대 회선의 결합 데이터 제공 여부는 자세히보기(아무나 결합 혜택 대상 요금제)를 통해 확인해주세요</p>\n");
                        $("._completeForm .combine-complete__txt").html("<span class=\"u-co-mint\">결합이 완료 되었습니다.</span><br/>kt M모바일 회선에 무료결합데이터("+serviceNm+")이 제공되었습니다.");
                        ...
                        if (AJAX_RESULT_CODE.SUCCESS ==  jsonObj.RESULT_CODE) {
                            ...
                            */
                            ...
                            ajaxCommon.createForm({
                                method:"post"
                                ,action:"/m/content/combineWirelessComplete.do"
                            });
        ...
        ajaxCommon.getItemNoLoading({
            ...
            ,function(jsonObj){
                if (AJAX_RESULT_CODE.SUCCESS ==  jsonObj.RESULT_CODE) {
                    ...
                    if ( jsonObj.RESULT_LIST.length < 1 && jsonObj.RESULT_LIST2.length < 1 ) {
                        $("#divCombinHistory").hide();
                        $("#divCombinHistory2").hide();
                        $("#divCombinHistoryNodata").show();
                        $("._serviceNm").html("-");
    ...
    //     });
    //     //1047  1005
    //     openPage('eventPop', "/m/event/eventDetailViewAjax.do?ntcartSeq=1379", parameterData);
    // });
