...
VALIDATE_NOT_EMPTY_MSG.cstmrReceiveTel = "사진전송을 위한 연락처를 입력해 주세요.";
VALIDATE_COMPARE_MSG.cstmrReceiveTel = "사진전송을 위한 연락처를 올바르게 입력해 주세요. ";
...
history.pushState(null, null, "/m/mypage/reqInsr.do");
window.onpopstate = function (event){
    history.go("/m/mypage/reqInsr.do");
}
    ...
    $("#btnRequest").click(function(){
        ...
        if(validator.validate()){
            ...
            if(pageObj.insrType == "C"){
                ...
                pageObj.smsPhoneNum = $.trim($("#cstmrReceiveTel").val());
