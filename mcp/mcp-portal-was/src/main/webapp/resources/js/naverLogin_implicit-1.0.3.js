 ...
 */
	this.init_naver_id_login = function ()
	{
		...
		{
			MCP.alert("id 가 naver_id_login 인 div tag 가 존재해야 합니다.");
			return false;
		}
		...
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor' title='새창'><img src='http://static.nid.naver.com/oauth/button_"+color+".PNG' border='0' alt='네이버 아이디로 로그인' width='"+this.button_height+"' height='"+this.button_height+"'></a> ";
		}
		else if (this.button_type == BANNER_SMALL_TYPE)
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor' title='새창'><img src='http://static.nid.naver.com/oauth/small_"+color+"_in.PNG' border='0' alt='네이버 아이디로 로그인' width='"+(this.button_height*656/250)+"px' height='"+this.button_height+"'></a> ";
		}
		else
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor' title='새창'><img src='http://static.nid.naver.com/oauth/big_"+color+".PNG' border='0' alt='네이버 아이디로 로그인' width='"+(this.button_height*185/40)+"px' height='"+this.button_height+"px'></a> ";
		}
 ...
 */
	...
	this.get_naver_userprofile = function(callback_func1) {
		...
		success: function (result) {
			console.log(this.oauthParams);
			console.log(result);
			console.log(callback_func1);
		...
		error: function (xhr, ajaxOptions, thrownError) {
			//에러 처리는 적절히
			MCP.alert(xhr.status + ' : ' + thrownError);
		}
		});
	}
/*
