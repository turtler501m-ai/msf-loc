history.pushState(null, null,location.href);
    window.onpopstate = function (event){
        //history.go("/appForm/reqSelfDlvry.do");
...
$(document).ready(function (){
          ...
          ajaxCommon.getItem({
           ...
           ,function(jsonObj){
               if (AJAX_RESULT_CODE.SUCCESS ==  jsonObj.RESULT_CODE) {
                   ...
                   $("#btnAutAccount").hide();
                   $(".divBankAut1").hide();
                   $('#divBankAutFooter').attr( "style", "display: none !important;" )
                   $(".divBankAut2").show();
          ...
          ajaxCommon.getItem({
           ...
           ,function(jsonObj){
               if (AJAX_RESULT_CODE.SUCCESS ==  jsonObj.RESULT_CODE) {
                   ...
                   $('.divBankAut2').hide();
                   $('#divBankAut2Footer').attr( "style", "display: none !important;" )
                   $('.divBankAut3').show();
    ...
    $('input[name=onlineAuthType]').on('change', function (){
       ...
       // $('#btnNiceAuth,#btnNiceAuth2,#btnNiceAuth3,#btnNiceAuth4,#btnNiceAuth5,#btnNiceAuth6').removeClass('is-complete');
...
function fnNiceCert(prarObj) {
    ...
    if (pageObj.niceType == NICE_TYPE.CUST_AUTH) {
        ...
        const authInfoJson = {cstmrName: cstmrName, cstmrNativeRrn: cstmrNativeRrn01, authType: prarObj.authType};
