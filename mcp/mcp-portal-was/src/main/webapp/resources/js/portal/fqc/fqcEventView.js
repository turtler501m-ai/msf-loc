...
var SIMPLE_FQC_DLT_MSG = {
    MSN_01_RCODE_00: {
        MSG: "<b class='u-fs-22'>고객님께서는 아직 개통회선이 없거나,<br/>정회원 인증을 하지 않으셨습니다!</b><br/><br/>개통을 완료했지만 5천원 미만 요금제를 사용중이시라면,<br/>개통완료 스탬프는 적립이 불가합니다.<br/><br/>개통 전이시라면<br/><span class='u-co-red'><b>[kt M모바일 홈페이지]에서 요금제 가입,</b></span><br/>정회원 인증 전이라면 <span class='u-co-red'><b>[마이페이지]에서<br/> 정회원 인증</b></span>을 해주세요!",
        OPEN_TYPE: "simpleDialog",
        SHOW_BUTTOM:"divMSN_01_RCODE_00"
    },
    MSN_01_RCODE_01: {
        MSG: "<b class='u-fs-22'>고객님께서는 kt M모바일 홈페이지를 통해 가입하지 않아,<br/>스탬프 적립이 되지 않습니다!</b><br/><br/><br/>*스탬프를 받으시려면kt M모바일 홈페이지에서<br/> 추가 회선을 가입 후 대표회선으로 변경해주세요!",
        OPEN_TYPE: "simpleDialog",
    ...
    MSN_02_RCODE_01: {
        MSG: "<b class='u-fs-22'>이벤트 공유하기</b><br/><br/>친구에게 이벤트를 공유해 보세요<br/>바로 스탬프 적립해 드려요!<br/><br/><i class='c-icon c-icon--kakao' aria-hidden='true'></i>",
        OPEN_TYPE: "simpleDialog",
    ...
    MSN_03_RCODE_01: {
        MSG: "<b class='u-fs-22'>마케팅 정보 수신에 동의하고 <br/>kt M모바일만의 혜택을 <br/>놓치지 마세요!</b><br/><br/>* 정보수정 선택 후 정보/광고 수신 동의에 동의하셔야 스템프가 적립됩니다.",
        OPEN_TYPE: "simpleDialog",
    ...
    MSN_04_RCODE_00: {
        MSG: "<b class='u-fs-22'>고객님께서는 아직 개통회선이 없거나,<br/>정회원 인증을 하지 않으셨습니다!</b><br/><br/>개통 전이시라면<br/><span class='u-co-red'><b>[kt M모바일 홈페이지]에서 요금제 가입,</b></span><br/>정회원 인증 전이라면 <span class='u-co-red'><b>[마이페이지]에서<br/> 정회원 인증</b></span>을 해주세요!",
        OPEN_TYPE: "simpleDialog",
        SHOW_BUTTOM:"divMSN_01_RCODE_00"
    },
    MSN_04_RCODE_01: {
        MSG: "<b class='u-fs-22'>요금제 사용 리뷰를 남기고<br/>스탬프를 받아보세요.<br/>리뷰만 써도 미션 달성!</b>",
        OPEN_TYPE: "simpleDialog",
    ...
    MSN_05_RCODE_01: {
        MSG: "<b class='u-fs-22'>친구를 초대하고<br/>스탬프를 받아보세요.<br/><br/>공유한ID로 친구가 가입하면<br/>스탬프를 받을 수 있어요.</b>",
        OPEN_TYPE: "simpleDialog",
