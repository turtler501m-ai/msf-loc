...
$(document).ready(function (){
    ...
    document.addEventListener('UILoaded', function() {
        KTM.swiperA11y('#combineSelfGuide .swiper-container', {
            navigation : {
                nextEl : '#combineSelfGuide .swiper-button-next',
                prevEl : '#combineSelfGuide .swiper-button-prev',
            },
        });
    });
  ...
  //아무나솔로 결합 가능 요금제
    ...
    $("#btnLogin").click(function(){
        ...
        ajaxCommon.attachHiddenElement("uri","/content/combineSelf.do#combineSelf");
        ...
        if($("#certifyYn").val() != 'Y'){
            ...
            ,function(jsonObj){
                if (AJAX_RESULT_CODE.SUCCESS ==  jsonObj.RESULT_CODE) {
                    ...
                    $("#divRate").show();
                    $("#spMoCtn").html("1");
                    $("#rateNm").val(dataObj.rateNm);   //-- rateNm  prvRateId
    ...
    var getRateInfo = function() {
        ...
        ajaxCommon.getItemNoLoading({
            ...
            ,function(jsonObj){
                if (AJAX_RESULT_CODE.SUCCESS ==  jsonObj.RESULT_CODE) {
                    $("#rateNm").val(jsonObj.RESULT_RATE_NM);   //-- rateNm  prvRateId
                    $("#divRate").show();
                    checkCombineSelf();
        ...
        ,function(jsonObj){
            ...
            if (AJAX_RESULT_CODE.SUCCESS ==  jsonObj.RESULT_CODE) {
                ...
                if (jsonObj.IS_COMBIN) {
                    ...
                    arr.push("	<p>\n");
                    arr.push("        결합은 가능하나 <b class='u-co-black'>결합 혜택이 추가로 제공되지 않습니다.</b>\n");
                    arr.push("    </p>\n");
                    arr.push("	<p class='combine-self-success__subtxt'>“아무나 결합/아무나 가족결합”의 데이터제공 혜택은 중복으로 제공이 불가합니다.</p>\n");
                    arr.push("	<img src='/resources/images/portal/product/combine_possible.png' aria-hidden='true' alt=''>\n");
                    arr.push("</div>\n");
                } else {
                    arr.push("<div class='combine-self-success'>\n");
                    arr.push("	<p>\n");
                ...
                arr.push("		<img src='/resources/images/portal/product/combine_impossible.png' aria-hidden='true' alt=''>\n");
                arr.push("	</div>\n");
                arr.push("	<div class='c-button-wrap u-mt--56'>\n");
                arr.push("		<a class='c-button c-button--lg c-button--primary c-button--w460' href='/mypage/myCombineList.do' title='결합 내역 조회 페이지 바로가기'>결합 내역 조회</a>\n");
                arr.push("	</div>\n");
                ...
                arr.push("	<div class='combine-self-fail'>\n");
                arr.push("		<p>\n");
                arr.push("			현재 사용하시는 요금제는 <b>아무나 SOLO 결합 대상 요금제가 아닙니다.</b>\n");
                arr.push("		</p>\n");
                arr.push("		<p class='combine-self-fail__subtxt'>아무나 SOLO 결합을 원하실 경우 대상요금제로 변경 후 다시 시도 해 주세요.</p>\n");
                arr.push("		<img src='/resources/images/portal/product/combine_impossible.png' aria-hidden='true' alt=''>\n");
                arr.push("	</div>\n");
                arr.push("	<div class='c-button-wrap u-mt--56'>\n");
                arr.push("		<a class='c-button c-button--lg c-button--primary c-button--w460' href='/mypage/farPricePlanView.do' title='요금제 변경 페이지 바로가기'>요금제 변경 바로가기</a>\n");
                arr.push("	</div>\n");
                ...
                ajaxCommon.getItem({
                    ...
                    ,function(jsonObj){
                        if (AJAX_RESULT_CODE.SUCCESS ==  jsonObj.RESULT_CODE) {
                            ...
                            MCP.alert(alertMessage + "<br/>다시 시도해 주시기 바랍니다.");
                        }
                    });
                return ;
            });
    ...
    $("._complete").click(function(){
        ...
        if (pageObj.isComBin) {
            arr.push("<div class='combine-self-success'>\n");
            arr.push("	<p>\n");
            arr.push("        결합을 완료 하였습니다. <b class='u-co-black'>결합 혜택이 추가로 제공되지 않습니다.</b>\n");
            arr.push("   </p>\n");
            arr.push("	<p class='combine-self-success__subtxt'>“아무나 결합/아무나 가족결합”의 데이터제공 혜택은 중복으로 제공이 불가합니다.</p>\n");
            ...
            arr.push("<div class='combine-self-success'>\n");
            arr.push("	<p>\n");
            arr.push("		아무나 SOLO 결합을 완료 하였습니다. <br /><b>“<em>" + jsonObj.RESULT_SERVICE_NM + "</em>”이 제공됩니다.</b>\n");
            arr.push("	</p>\n");
            arr.push("	<img src='/resources/images/portal/product/combine_possible.png' aria-hidden='true'>\n");
            arr.push("</div>\n");
        }
    ...
    ,function(result){
        if(result.result.length > 0){
            for(var i = 0; i < result.result.length; i ++){
                ...
                html += '<a class="swiper-banner__anchor" href="#">';
            ...
            if(result.result.length == 1){
                $("#swiperCombineSelf .swiper-button-next,.swiper-button-prev").hide();
            }
              KTM.swiperA11y("#swiperCombineSelf .swiper-container", {
                navigation: {
                  nextEl: "#swiperCombineSelf .swiper-button-next",
                  prevEl: "#swiperCombineSelf .swiper-button-prev",
                },
              });
