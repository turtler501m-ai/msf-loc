---
name: ktm-smartform(msf)
description: KTM 스마트서식지 프로젝트
---

# 스마트서식지(msf) 프로젝트 개발 스킬 가이드

> 작성 기준: 현재 소스 분석(2026.03.17) 기준 — msf-web(Vue 3) + msf-api(Spring Boot 2.7)
...
| 아이콘 | lucide-vue-next, FontAwesome 7 | - | 아이콘 |
