...
# 실행
cd mform-api && mvn spring-boot:run
# 또는
...
| 목적 | 파일 경로 |
|------|-----------|
| M플랫폼 전체 연동 | `mform-api/.../common/mplatform/MplatFormSvc.java` |
| 휴대폰 인증 로직 | `mform-api/.../formComm/service/JoinInfoSvcImpl.java` |
| 서비스변경 고객 화면 | `mform-web/src/components/change/ChangeTypeCust.vue` |
| 서비스변경 상품 화면 | `mform-web/src/components/change/ChangeProd.vue` |
| 서비스변경 동의 화면 | `mform-web/src/components/change/ChangeAgree.vue` |
