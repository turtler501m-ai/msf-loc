 ...
 */
@Component
public class UnpayBondDtlExcelExecutor extends BaseSchedule {
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			LOGGER.debug("=================================================================");
			LOGGER.debug("청구수미납상세 리스트 엑셀 저장 START.");
			LOGGER.debug("Request PARAM = {}", batchCommonVO.getExecParam());
			LOGGER.debug("=================================================================");
			
			unpayBondMgmtService.getUnpayBondDtlListEx(batchCommonVO);
...
//			bondMgmtService.callPayCheck();
			...
			result = BatchConstants.BATCH_RESULT_NOK;
			MvnoServiceException ex = new MvnoServiceException("ERSK1010");
