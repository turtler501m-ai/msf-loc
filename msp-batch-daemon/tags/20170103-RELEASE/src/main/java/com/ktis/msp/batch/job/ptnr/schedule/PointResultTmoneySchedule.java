 ...
 */
@Component
public class PointResultTmoneySchedule extends BaseSchedule {
     ...
     * 생성자
     */
	public PointResultTmoneySchedule() {
//		LOGGER.debug("Modified Date: " + MODDATE + ", Desc: " + MODDESC);
	 ...
	 * @throws Exception
	 */
	@Scheduled(cron="${pointResultTmoneySchedule}")
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			// 결과 파일 다운로드
			pointService.downloadPointFile(PointConstants.STR_TMONEY, "");
			
			//  파일 읽기
			pointService.readFile(PointConstants.STR_TMONEY, "");
			// ========== BATCH MAIN ==================
