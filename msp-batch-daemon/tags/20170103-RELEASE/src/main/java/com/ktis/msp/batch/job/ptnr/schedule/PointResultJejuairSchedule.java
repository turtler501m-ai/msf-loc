 ...
 */
@Component
public class PointResultJejuairSchedule extends BaseSchedule {
     ...
     * 생성자
     */
	public PointResultJejuairSchedule() {
//		LOGGER.debug("Modified Date: " + MODDATE + ", Desc: " + MODDESC);
	 ...
	 * @throws Exception
	 */
	@Scheduled(cron="${pointResultJejuairSchedule}")
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			// 결과 파일 다운로드
			pointService.downloadPointFile(PointConstants.STR_JEJUAIR, "");
			
			//  파일 읽기
			pointService.readFile(PointConstants.STR_JEJUAIR, "");
			// ========== BATCH MAIN ==================
