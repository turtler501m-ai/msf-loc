...
/**
 * USIM 수납금액 여신부활처리
 * 매월 15일 실행 ( 전월 수납자료를 전부 수신후에 실행해야하기 때문 )
 */
@Component
public class CrdtLoanUsimRvlSchedule extends BaseSchedule {
	 ...
	 * @throws Exception
	 */
//	@Scheduled(cron="${crdtLoanUsimRvlSchedule}")
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			int procCnt = service.setUsimPymCrdtLoanRvl(param);
