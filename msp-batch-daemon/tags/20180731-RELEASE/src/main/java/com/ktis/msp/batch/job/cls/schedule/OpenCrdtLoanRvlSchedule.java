...
/**
 * 전일 개통건에 대하여 여신 부활 처리
 * 매일 0시 10분 실행
 */
@Component
public class OpenCrdtLoanRvlSchedule extends BaseSchedule {
	 ...
	 * @throws Exception
	 */
//	@Scheduled(cron="${openCrdtLoanRvlSchedule}")
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			int procCnt = service.setCrdtLoanRvl(param);
