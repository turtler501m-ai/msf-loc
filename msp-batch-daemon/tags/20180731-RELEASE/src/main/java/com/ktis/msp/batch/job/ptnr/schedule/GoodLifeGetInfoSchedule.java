...
/**
 * 좋은라이프 가입 및 수납여부 수신 스케줄러
 * 
 * 1.FTP 서버에서 GOODLIFE_002_YYYYMM.DAT 다운로드한다.
 * 2.다운로드한 파일을 읽어서 결과를 업데이트 한다.
 * 
 */
@Component
public class GoodLifeGetInfoSchedule extends BaseSchedule {
     ...
     * 생성자
     */
	public GoodLifeGetInfoSchedule() {
	 ...
	 * @throws Exception
	 */
//	@Scheduled(cron="${goodLifeGetInfoSchedule}")
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			param.put("ifNo", PointConstants.GOODLIFE_002);
