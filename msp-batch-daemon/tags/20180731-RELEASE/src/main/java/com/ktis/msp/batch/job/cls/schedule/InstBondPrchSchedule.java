...
import com.ktis.msp.batch.job.cls.prchmgmt.serivce.InstBondPrchService;
 ...
 */
@Component
public class InstBondPrchSchedule extends BaseSchedule {
	
	@Autowired
	private InstBondPrchService service;
	 ...
	 * @throws Exception
	 */
//	@Scheduled(cron="${instBondPrchSchedule}")
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			service.setInstBondPrchReg(param);
			// ========== BATCH MAIN ==================
