...
//	private RcpEncService encSvc;
	...
	public void selectPayInfoListExcel(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			// db
			payInfo.selectPayInfoListExcel(searchVO, new ExcelDataListResultHandler(sw, styles, strHead, strValue, intLen, getMaskFields(), paramMap));
	...
	public void selectPayInfoKtListExcel(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			// db
			payInfo.selectPayInfoKtListExcel(searchVO, new ExcelDataListResultHandler(sw, styles, strHead, strValue, intLen, getMaskFields(), paramMap));
