...
@Component
public class DongbuSmsSendSchedule extends BaseSchedule {
	 ...
	 * @throws Exception
	 */
	@Scheduled(cron="${dongbuSmsSendSchedule}")
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			// ========== BATCH MAIN ==================
			LOGGER.info("--- 동부화재 -- SMS 전송 스케줄러 시작 ---");
			
			// 동부화재 SMS 발송처리
			pointService.setDonguSmsSend();
