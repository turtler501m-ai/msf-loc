...
public interface MplatformOpenMapper {
	...
	//당일접수건 개통대상조회
	public List<MplatformOpenResVO> getMplatformOpenTrgtList();
	
	//전일번호예약 미개통 재처리대상
	public List<MplatformOpenResVO> getMplatformOpenRetryList();
	 ...
	 * @return
	 */
	List<MplatformOpenResVO> getOpenAddSvcList(MplatformOpenReqVO vo);
	
	/**
	 * 부가서비스 처리여부 update
	 * @param vo
	 */
	void updateRequestAddition(MplatformOpenResVO vo);
