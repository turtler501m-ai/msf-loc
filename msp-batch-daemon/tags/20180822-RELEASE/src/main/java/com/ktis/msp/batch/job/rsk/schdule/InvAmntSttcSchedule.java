...
/**
 * 청구수납 집계 생성을 위한 스케줄러
 * 매월 20일 05시 30분에 실행되며, 전월 사용량 데이터 추출하여 통계 테이블에 생성한다.
 */
@Component
public class InvAmntSttcSchedule extends BaseSchedule {
	 ...
	 * @throws Exception
	 */
	@Scheduled(cron="${invAmntSttcSchedule}")
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			statService.setInvAmntSttc(param);
			// ========== BATCH MAIN ==================
