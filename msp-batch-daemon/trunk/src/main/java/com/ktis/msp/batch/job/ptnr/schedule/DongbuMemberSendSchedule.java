...
import com.ktis.msp.batch.job.ptnr.ptnrmgmt.service.DongbuSettleService;
...
public class DongbuMemberSendSchedule extends BaseSchedule {
	 ...
	 */
	@Autowired
	private DongbuSettleService dongbuService;
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			LOGGER.info("---- 동부화재 정산보험료 파일 저장 ----- ");
			// 동부화재 정산보험료 파일 저장
			dongbuService.saveInsrMemberList();
			LOGGER.info("---- 동부화재 정산보험료 저장된 파일 업로드 ----- ");
			// 저장된 파일 업로드
