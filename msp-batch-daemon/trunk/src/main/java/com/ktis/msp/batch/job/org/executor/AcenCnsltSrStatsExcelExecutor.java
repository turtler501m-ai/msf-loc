...
@Component
public class AcenCnsltSrStatsExcelExecutor extends BaseSchedule {
    ...
    public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
        ...
        try {
            ...
            LOGGER.debug("=================================================================");
            LOGGER.debug("A'Cen 상담이력(SR) SR 월 통계 목록 엑셀 저장 START.");
            LOGGER.debug("Return Vo [AcenCnsltSrVO] = {}", batchCommonVO.getExecParam());
            LOGGER.debug("=================================================================");

            acenCnsltSrService.selectAcenCnsltSrStatsListExcel(batchCommonVO);
