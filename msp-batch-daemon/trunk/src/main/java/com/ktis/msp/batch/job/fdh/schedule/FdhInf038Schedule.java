...
@Component
public class FdhInf038Schedule extends BaseSchedule {
   ...
   private FdhTransmitService fdhTransmitService;
	 ...
	 * @throws Exception
	 */
	@Scheduled(cron="${fdhInf038Schedule}")
	...
	/**
	 * M전산 > 무료렌탈 > 월정산내역
	 * 월정산내역 MSP_RNTL_BASE_INFO 테이블 연동
	 * @throws MvnoServiceException 
	 * @throws Exception
	 */
	@Override
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			// ========== BATCH MAIN ==================
			fdhTransmitService.getFdhInf038(); //월정산내역
			// ========== BATCH MAIN ==================
