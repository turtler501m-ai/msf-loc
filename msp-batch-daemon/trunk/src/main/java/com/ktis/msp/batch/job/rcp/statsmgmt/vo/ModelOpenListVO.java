...
public class ModelOpenListVO extends BaseVo  {
    ...
    private String lstChgRateDt;
    
   private String beforeModel;
    
    
	public String getLstChgRateDt() {
	return lstChgRateDt;
}

public void setLstChgRateDt(String lstChgRateDt) {
	this.lstChgRateDt = lstChgRateDt;
}
