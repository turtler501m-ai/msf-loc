...
public interface StatMgmtMapper {
	 ...
	 * @return
	 */
	public void callSaleRsltSttc(Map<String, Object> param);

	/**
	 * 현재요금제 영업실적
	 * @return
	 */
	public void callSaleRsltRateSttc(Map<String, Object> param);
	
	/**
	 * 계약별요금제사용일수집계
	 * @return
	 */
	public void callCntrUsgDtSttc(Map<String, Object> param);
	
	/**
	 * 일마감집계
	 * @return
	 */
	public void callDailyCloseSttc(Map<String, Object> param);
	
	/**
	 * 청구수납자료생성
	 * @return
	 */
	public void callAcntDataSttc(Map<String, Object> param);
	
	
	public String selectBillDatFile(StatMgmtVO vo);
	
	public void callTmpBillPymnData(Map<String, Object> param);
