 ...
 */
@Component
public class PartnerUsgPointDailySchedule extends BaseSchedule {
     ...
     * 생성자
     */
	public PartnerUsgPointDailySchedule() {
//		LOGGER.debug("Modified Date: " + MODDATE + ", Desc: " + MODDESC);
	 ...
	 * @throws Exception
	 */
	@Scheduled(cron="${partnerUsgPointDailySchedule}")
...
//				cal.add(cal.MONTH, -1);
			...
			pointService.callPartnerUsgPointDaily(param);
			// ========== BATCH MAIN ==================
