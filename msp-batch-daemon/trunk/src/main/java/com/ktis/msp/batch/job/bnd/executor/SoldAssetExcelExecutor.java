...
/**
 * 단말유동화>채권판매관리> 판매채권자산명세서 엑셀 다운로드
 */
@Component
public class SoldAssetExcelExecutor extends BaseSchedule {
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			LOGGER.debug("=================================================================");
			LOGGER.debug("단말유동화>채권판매관리> 판매채권자산명세서 리스트 엑셀 저장 START.");
			LOGGER.debug("Return Vo [BondMgmtVO] = {}", batchCommonVO.getExecParam());
			LOGGER.debug("=================================================================");
			
			bondMgmtService.saveExcelSoldAsset(batchCommonVO);
