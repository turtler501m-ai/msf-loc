...
@Component
public class UsimDlvryCanDeleteSchedule extends BaseSchedule {
     ...
     */
    @Scheduled(cron="${usimDlvryCanDeleteSchedule}")
    ...
    public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
        ...
        try {
            ...
            // ========== BATCH MAIN ==================
            Map<String, Integer> resultMap = usimDlvryCanService.procUsimDlvryCanDelete();
