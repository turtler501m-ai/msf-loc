...
/**
 * 롯데멤버스 프로모션 정산파일 업로드 스케줄러
 */

@Component
public class PointSendLPointPrmSchedule extends BaseSchedule {
	 ...
	 * @throws Exception
	 */
	@Scheduled(cron="${pointSendLPointPrmSchedule}")
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			// ========== BATCH MAIN ==================
			LOGGER.info("--- 롯데멤버스 -- 프로모션정산파일 저장 및 업로드 시작 ---");
			
			// 정산요청 포인트 파일 저장
			pointService.savePointFile(PointConstants.STR_LPOINT_PRM);
			
			// 저장된 파일 업로드
			ftpService.uploadPointFile(PointConstants.STR_LPOINT_PRM, "");
			// ========== BATCH MAIN ==================
