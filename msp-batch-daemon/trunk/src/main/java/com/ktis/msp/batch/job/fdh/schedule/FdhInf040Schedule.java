...
@Component
public class FdhInf040Schedule extends BaseSchedule {
   ...
   private FdhTransmitService fdhTransmitService;
	 ...
	 * @throws Exception
	 */
	@Scheduled(cron="${fdhInf040Schedule}")
	 ...
	 * 보험상품가입목록 MSP_INTM_INSR_MST 테이블 연동
	 * @throws MvnoServiceException 
	 * @throws Exception
	 */
	@Override
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			// ========== BATCH MAIN ==================
			fdhTransmitService.getFdhInf040(); //보험상품가입목록
			// ========== BATCH MAIN ==================
