...
@Component
public class FdhInf037Schedule extends BaseSchedule {
   ...
   private FdhTransmitService fdhTransmitService;
	 ...
	 * @throws Exception
	 */
	@Scheduled(cron="${fdhInf037Schedule}")
	...
	/**
	 * M전산 > 무료렌탈 > 월정산내역
	 * 월정산내역 MSP_RNTL_AMNT_INFO 테이블 연동
	 * @throws MvnoServiceException 
	 * @throws Exception
	 */
	@Override
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			// ========== BATCH MAIN ==================
			fdhTransmitService.getFdhInf037(); //월정산내역
			// ========== BATCH MAIN ==================
