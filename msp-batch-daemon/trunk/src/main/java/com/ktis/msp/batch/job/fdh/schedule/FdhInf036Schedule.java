...
@Component
public class FdhInf036Schedule extends BaseSchedule {
   ...
   private FdhTransmitService fdhTransmitService;
	 ...
	 * @throws Exception
	 */
	@Scheduled(cron="${fdhInf036Schedule}")
	 ...
	 * 매각채권수납내역서 MSP_BOND_SALE_DTL 테이블 연동
	 * @throws MvnoServiceException 
	 * @throws Exception
	 */
	@Override
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			// ========== BATCH MAIN ==================
			fdhTransmitService.getFdhInf036(); //매각채권수납내역서
			// ========== BATCH MAIN ==================
