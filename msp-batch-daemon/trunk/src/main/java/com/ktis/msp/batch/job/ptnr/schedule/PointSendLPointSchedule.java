...
@Component
public class PointSendLPointSchedule extends BaseSchedule {
	 ...
	 * @throws Exception
	 */
	@Scheduled(cron="${pointSendLPointSchedule}")
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			// ========== BATCH MAIN ==================
			LOGGER.info("--- 롯데멤버스 -- 포인트정산파일 저장 및 업로드 시작 ---");
			
			// 정산요청 포인트 파일 저장
			pointService.savePointFile(PointConstants.STR_LPOINT);
			
			// 저장된 파일 업로드
			ftpService.uploadPointFile(PointConstants.STR_LPOINT, "");
			// ========== BATCH MAIN ==================
