 ...
 */
@Component
public class PointResultLPointPrmSchedule extends BaseSchedule {
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			// 결과 파일 다운로드
			ftpService.downloadPointFile(PointConstants.STR_LPOINT_PRM, "");
			
			//  파일 읽기
			pointService.readFile(PointConstants.STR_LPOINT_PRM, "");
			// ========== BATCH MAIN ==================
