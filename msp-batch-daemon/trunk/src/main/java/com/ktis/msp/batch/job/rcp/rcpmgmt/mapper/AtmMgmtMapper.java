...
@Mapper("AtmMgmtMapper")
public interface AtmMgmtMapper {
	
	/**
	 * 신청정보 미생성 ATM 개통정보 조회
	 */
	List<RcpDetailVO> selectNonAtmRcpList();
	...
	public void updateAtmRcpCrYn(RcpDetailVO rcpDetailVO);
	
	public void updateAtmJueSubInfo(RcpDetailVO rcpDetailVO);
	public void updateAtmRequestDtl(RcpDetailVO rcpDetailVO);
