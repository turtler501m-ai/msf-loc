...
@Component
public class PointSendGooglePlaySchedule extends BaseSchedule {
	 ...
	 * @throws Exception
	 */
	@Scheduled(cron="${pointSendGooglePlaySchedule}")
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			// ========== BATCH MAIN ==================
			LOGGER.info("--- 구글Play -- 포인트정산파일 저장 및 업로드 시작 ---");
			
			// 구글Play 포인트 파일 저장
			pointService.savePointFile(PointConstants.STR_GOOGLEPLAY);
			
			// 저장된 파일 업로드
			ftpService.uploadPointFile(PointConstants.STR_GOOGLEPLAY,"");
			// ========== BATCH MAIN ==================
