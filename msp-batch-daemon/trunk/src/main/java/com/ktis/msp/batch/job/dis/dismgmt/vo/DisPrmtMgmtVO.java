...
public class DisPrmtMgmtVO extends BaseVo  {
	...
	private String orgnListExl;			//대상 조직ID
    private String socListExl;			//대상 요금제코드
    private String addListExl;			//대상 부가서비스코드
    ...
    private String modEndDt;			//변경하려는 종료일
    ...
    public void parseEngg() {
		...
		if(enggSrl.isEmpty() || ((enggSrl.length() / enggLength) < 1)) {
			return;
		}
		...
		for(String engg : enggArray) {
				...
				int enggCnt = Integer.parseInt(engg);
		...
		if(enggCnt0==null || "".equals(enggCnt0)) {
			enggCnt0 = "N";
		}
		if(enggCnt12==null || "".equals(enggCnt12)) {
			enggCnt12 = "N";
		}
		if(enggCnt18==null || "".equals(enggCnt18)) {
			enggCnt18 = "N";
		}
		if(enggCnt24==null || "".equals(enggCnt24)) {
			enggCnt24 = "N";
		}
		if(enggCnt30==null || "".equals(enggCnt30)) {
			enggCnt30 = "N";
		}
		if(enggCnt36==null || "".equals(enggCnt36)) {
			enggCnt36 = "N";
		}
    }
    ...
    /* enggCnt -> enggSrl 변환 excel 입력값  */
    public void serialDupEngg() {
	...
	public String getOrgnListExl() {
		return orgnListExl;
	}

	public void setOrgnListExl(String orgnListExl) {
		this.orgnListExl = orgnListExl;
	}

	public String getSocListExl() {
		return socListExl;
	}

	public void setSocListExl(String socListExl) {
		this.socListExl = socListExl;
	}

	public String getAddListExl() {
		return addListExl;
	}

	public void setAddListExl(String addListExl) {
