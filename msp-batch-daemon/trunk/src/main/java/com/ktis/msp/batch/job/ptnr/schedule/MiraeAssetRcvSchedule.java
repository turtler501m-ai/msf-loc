...
/**
 * 미래에셋 광고 제휴 가입 계약건 수신 스케줄러
 */

@Component
public class MiraeAssetRcvSchedule extends BaseSchedule {
	 ...
	 * @throws Exception
	 */
	@Scheduled(cron="${miraeAssetRcvSchedule}")
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			PointFileVO pointFileVO = assetService.regPointFileInfo(PointConstants.MIRAE_IF_01, PointConstants.TRADE_CODE01, PointConstants.RCV_BIZ_CD);
