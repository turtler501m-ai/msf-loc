...
public class RcpDetailVO extends BaseVo {
	...
	private String clausePriCollectFlag = "Y";
	private String clausePriOfferFlag = "Y";
	private String clauseEssCollectFlag= "Y";
	private String clausePriTrustFlag= "Y";
	private String clausePriAdFlag= "N";
	private String clauseConfidenceFlag = "Y";
	...
	// ATM개통건 서식지 생성
	private String niceCertKey;
	private String atmOrderSeq;
	private String rcpCrYn;

	// TOSS개통건 서식지 생성
	private String tossOrderSeq;
	
	// OSST개통건 orderSeq
	private String osstOrderSeq;
	private String reqBuyTypeNm;
	private String moveCompanyNm;
	private String openMarketReferer;
	private String recommendFlagCd;
	private String recommendFlagNm;
	private String recommendInfo;
	private String minorAgentRelNm;
	private String joinPayMthdNm;
	private String usimPayMthdNm;
	private String shopUsimId;
	...
	/* 2025-03-04 요금제에 따른 제휴처, 제휴사 제공 동의 추가 */
	private String jehuProdType;				/* 요금제에 따른 제휴처 */
	private String clausePartnerOfferFlag;		/* 제휴사 제동 동의 */
	
	/* 2025-06-10 MCP_REQUEST_DTL */
	...
	public String getNiceCertKey() {
		return niceCertKey;
	}
	public void setNiceCertKey(String niceCertKey) {
		this.niceCertKey = niceCertKey;
	}
	public String getAtmOrderSeq() {
		return atmOrderSeq;
	}
	public void setAtmOrderSeq(String atmOrderSeq) {
		this.atmOrderSeq = atmOrderSeq;
	}
	public String getRcpCrYn() {
		return rcpCrYn;
	}
	public void setRcpCrYn(String rcpCrYn) {
		this.rcpCrYn = rcpCrYn;
	}
	public String getTossOrderSeq() {
		return tossOrderSeq;
	}
	public void setTossOrderSeq(String tossOrderSeq) {
		this.tossOrderSeq = tossOrderSeq;
	}
	public String getOsstOrderSeq() {
		return osstOrderSeq;
	}
	public void setOsstOrderSeq(String osstOrderSeq) {
		this.osstOrderSeq = osstOrderSeq;
	}
	...
	public String getMinorAgentRelNm() {
		return minorAgentRelNm;
	}
	public void setMinorAgentRelNm(String minorAgentRelNm) {
		this.minorAgentRelNm = minorAgentRelNm;
	}
	...
	public String getShopUsimId() {
		return shopUsimId;
	}
	public void setShopUsimId(String shopUsimId) {
		this.shopUsimId = shopUsimId;
	}
