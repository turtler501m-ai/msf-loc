package com.ktis.msp.batch.job.rcp.custmgmt.vo;

import com.ktis.msp.base.BaseVo;

public class CustGiftVO extends BaseVo {
	...
	private String menuId;					/** 메뉴ID 신청관리: MSP1000015, 개통관리: MSP1000099 */
