...
/**
 * 미래에셋 광고 제휴 정산 수신 스케줄러
 */

@Component
public class MiraeAssetPointRcvSchedule extends BaseSchedule {
	 ...
	 * @throws Exception
	 */
	@Scheduled(cron="${miraeAssetPointRcvSchedule}")
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			PointFileVO pointFileVO = assetService.regPointFileInfo(PointConstants.MIRAE_IF_03, PointConstants.TRADE_CODE03, PointConstants.RCV_BIZ_CD);
