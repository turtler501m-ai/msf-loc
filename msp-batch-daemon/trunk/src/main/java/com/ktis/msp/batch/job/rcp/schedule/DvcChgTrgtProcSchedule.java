 ...
 */
@Component
public class DvcChgTrgtProcSchedule extends BaseSchedule {
	
	@Autowired
	private RcpMgmtService rcpService;
	 ...
	 * @throws Exception
	 */
	@Scheduled(cron="${dvcChgTrgtProcSchedule}")
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			rcpService.setDvcChgTrgtMst(param);
			// ========== BATCH MAIN ==================
			
			LOGGER.debug("프로시져 오류메세지 처리 param=" + param);
			
			batchCommonVO.setExecCount((Integer) param.get("O_PROC_CNT"));
