 ...
 */
@Component
public class PointResultGooglePlaySchedule extends BaseSchedule {
     ...
     * 생성자
     */
	public PointResultGooglePlaySchedule() {
//		LOGGER.debug("Modified Date: " + MODDATE + ", Desc: " + MODDESC);
	 ...
	 * @throws Exception
	 */
	@Scheduled(cron="${pointResultGooglePlaySchedule}")
	...
	public String execute(BatchCommonVO batchCommonVO) throws MvnoServiceException {
		...
		try {
			...
			// 결과 파일 다운로드
			ftpService.downloadPointFile(PointConstants.STR_GOOGLEPLAY, "");
			
			//  파일 읽기
			pointService.readFile(PointConstants.STR_GOOGLEPLAY, "");
			// ========== BATCH MAIN ==================
