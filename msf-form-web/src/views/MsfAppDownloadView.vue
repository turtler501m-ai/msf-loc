  ...
  <div class="app-download-wrap">
    ...
    <div class="app-download-layout">
      <MsfBox variant="outline" align="center" class="app-download-box">
        ...
        <MsfButton variant="primary" @click="downloadIpad">ipad 다운로드</MsfButton>
      </MsfBox>
      <MsfBox variant="outline" align="center" class="app-download-box">
        <div class="app-icon">
          <p class="app-icon-img">
        ...
        <MsfButton variant="primary" @click="downloadAndroid">Android 다운로드</MsfButton>
      </MsfBox>
    </div>
    <MsfBox class="infoBox">
      <MsfTextList
        type="dash"
        :items="[
          'App 설치 전 OS 는 최신 OS 버전으로 업데이트 해주세요.<br/>* 최소 권장사항 : IOS 13.0이상 / Android 12.0 이상',
...
const downloadIpad = () => {
  ...
  link.href = 'http://localhost:7080/appBridge/appcallback.js'
  link.download = 'ios.app'
  link.click()
}
