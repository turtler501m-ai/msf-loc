<template>
  <div class="pagination-root" v-if="totalPages > 0">
    <button
...
.page-btn {
  ...
  min-width: rem(40px);
  height: rem(40px);
  padding-inline: var(--spacing-x1);
  white-space: nowrap;
  font-size: var(--font-size-16);
  color: var(--color-gray-600);
}

.page-btn:hover:not(.active):not(.nav-btn):not(:disabled) {
