...
//   {
//     zipNo: '06627',
//     roadAddress: '서울특별시 서초구 강남대로 321(서초동, 서초동 대우디오빌프라임)',
//     jibunAddress:
...
//     jibunAddress: '서울특별시 서초구 서초동 123-45',
//   },
//   {
//     zipNo: '06629',
//     roadAddress: '서울특별시 서초구 효령로 789',
//     jibunAddress: '서울특별시 서초구 서초동 987-65',
//   },
//   {
//     zipNo: '04524',
...
const onChangePage = async () => {
  const resData = await post('/api/shared/common/address/list', {
  ...
  totalCount.value = resData.data.totalCount
