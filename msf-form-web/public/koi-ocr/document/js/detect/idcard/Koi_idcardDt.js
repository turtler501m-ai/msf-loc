var IdDetectModule = (() => {
  ...
  return function (IdDetectModule) {
    ...
    var f;
    f || (f = typeof IdDetectModule !== "undefined" ? IdDetectModule : {});
    var aa, ba;
      ...
      (function (a) {
        ...
        function d() {
          ...
          function p(t) {
            ...
            f.removeRunDependency("datafile_Koi_idcardDt.data");
          }
          ...
          f.addRunDependency("datafile_Koi_idcardDt.data");
          f.za || (f.za = {});
          f.za["Koi_idcardDt.data"] = { Xa: !1 };
          n ? (p(n), (n = null)) : (k = p);
        }
        ...
        var e = f.locateFile ? f.locateFile("Koi_idcardDt.data", "") : "../../detect/idcard/Koi_idcardDt.data",
        ...
        files: [
          { filename: "/assets/20250422_micro.onnx", start: 0, end: 2249316 },
          { filename: "/assets/FaceDetector.onnx", start: 2249316, end: 3978603 },
        ],
        remote_package_size: 3978603,
      });
    ...
    var J;
    J = "../../detect/idcard/Koi_idcardDt.wasm";
    if (!wa()) {
      var xa = J;
    ...
    f._loadONNXModel = function () {
      return (f._loadONNXModel = f.asm.s).apply(null, arguments);
    };
    f._detectObjects = function () {
      return (f._detectObjects = f.asm.t).apply(null, arguments);
    };
    var Ob = (f._malloc = function () {
      return (Ob = f._malloc = f.asm.v).apply(null, arguments);
    });
    f._free = function () {
