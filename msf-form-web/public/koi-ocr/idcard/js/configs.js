...
const KOI_OPTIONS = {
  ...
  default: {
    cameraOptions: {
      ...
      useCapOcr: RTC_TYPE_DATA.AUTO, // 촬영모드(1:자동촬영, 2:수동촬영)
      rtcRetryDelay: 50, // 캡처 대기시간
      rtcStartDelay: 50, // 시작 대기시간
      rtcDetectTime: 60000, // 촬영시간(60초)
      useDetect: true, // 탐지모듈 사용여부
      accessMode: false, // 웹접근성
      regisClassType: 0,
      albumImage: false,
      // isreloadBtn: true, // 카메라 재로드 버튼 유무
      // isreloadMsg: "카메라를 재로드하는 버튼입니다.", // 카메라 재로드 버튼 가이드 문구
      recogTryLimit: 5,
      document: {
