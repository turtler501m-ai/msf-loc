...
public enum ResTermMessage {
    ...
    APPLY_AGENT_REQUIRED("4201", "대리점코드(agentCd)를 입력해 주세요"),
    APPLY_MANAGER_REQUIRED("4202", "매니저코드(managerCd)를 입력해 주세요"),
    APPLY_CUSTOMER_TYPE_REQUIRED("4203", "고객유형(customerType)을 입력해 주세요"),
    APPLY_POST_METHOD_REQUIRED("4204", "우편방식(postMethod) 입력해 주세요"),
