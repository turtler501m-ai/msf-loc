...
public class AppformSvcImpl implements AppformSvc {
    ...
    public FormDtlDTO getFormDesc(FormDtlDTO formDtlDTO) {
        throw new UnsupportedOperationException("[ASIS] getFormDesc");
    }

    @Override
    public AppformReqDto getAppFormTempById(String userId) {
        throw new UnsupportedOperationException("[ASIS] getAppFormTempById");
    }
    ...
    public AppformReqDto saveAppform(AppformReqDto appformReqDto, CustPointDto custPoint, List<GiftPromotionBas> giftPromotionBasList) {
        throw new UnsupportedOperationException("[ASIS] saveAppform");
    }

    @Override
    public AppformReqDto saveSimpleAppform(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] saveSimpleAppform");
    }

    @Override
    public String saveSimpleAppformUpdate(AppformReqDto appformReqDto, List<GiftPromotionBas> giftPromotionBasList) {
        throw new UnsupportedOperationException("[ASIS] saveSimpleAppformUpdate");
    }

    @Override
    public McpRequestDto getMcpRequest(long requestKey) {
        throw new UnsupportedOperationException("[ASIS] getMcpRequest");
    }

    @Override
    public McpRequestCstmrDto getMcpRequestCstmr(long requestKey) {
        throw new UnsupportedOperationException("[ASIS] getMcpRequestCstmr");
    }

    @Override
    public McpRequestDlvryDto getMcpRequestDlvry(long requestKey) {
        throw new UnsupportedOperationException("[ASIS] getMcpRequestDlvry");
    }

    @Override
    public McpRequestSaleinfoDto getMcpRequestSaleinfo(long requestKey) {
        throw new UnsupportedOperationException("[ASIS] getMcpRequestSaleinfo");
    }

    @Override
    public JuoSubInfoDto selRMemberAjax(JuoSubInfoDto juoSubInfoDto) {
        throw new UnsupportedOperationException("[ASIS] selRMemberAjax");
    }

    @Override
    public List<McpRequestAdditionDto> getMcpAdditionList(McpRequestAdditionDto mcpRequestAdditionDto) {
        throw new UnsupportedOperationException("[ASIS] getMcpAdditionList");
    }

    @Override
    public int isOwnerCount(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] isOwnerCount");
    }

    @Override
    public long generateRequestKey() {
        throw new UnsupportedOperationException("[ASIS] generateRequestKey");
    }

    @Override
    public int checkClauseJehuRatecd(String rateCd) {
        throw new UnsupportedOperationException("[ASIS] checkClauseJehuRatecd");
    }

    @Override
    public String selPrdtcolCd(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] selPrdtcolCd");
    }

    @Override
    public String getAtribVal(HashMap<String, Object> hm) {
        throw new UnsupportedOperationException("[ASIS] getAtribVal");
    }

    @Override
    public AppformReqDto getMarketRequest(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] getMarketRequest");
    }

    @Override
    public List<AppformReqDto> selectModelMonthlyList(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] selectModelMonthlyList");
    }

    @Override
    public List<AppformReqDto> selectMonthlyListMarket(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] selectMonthlyListMarket");
    }

    @Override
    public List<AppformReqDto> selectPrdtColorList(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] selectPrdtColorList");
    }

    @Override
    public int getMcpRequestCount(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] getMcpRequestCount");
    }

    @Override
    public String getAgentCode(String cntpntShopId) {
        throw new UnsupportedOperationException("[ASIS] getAgentCode");
    }

    @Override
    public Map<String, String> getAgentInfoOjb(String cntpntShopId) {
        throw new UnsupportedOperationException("[ASIS] getAgentInfoOjb");
    }

    @Override
    public McpRequestOsstDto getRequestOsst(McpRequestOsstDto mcpRequestOsstDto) {
        throw new UnsupportedOperationException("[ASIS] getRequestOsst");
    }

    @Override
    public int requestOsstCount(McpRequestOsstDto mcpRequestOsstDto) {
        throw new UnsupportedOperationException("[ASIS] requestOsstCount");
    }

    @Override
    public boolean updateMcpRequest(McpRequestDto mcpRequestDto) {
        throw new UnsupportedOperationException("[ASIS] updateMcpRequest");
    }

    @Override
    public boolean insertMcpRequestOsst(McpRequestOsstDto mcpRequestOsstDto) {
        throw new UnsupportedOperationException("[ASIS] insertMcpRequestOsst");
    }

    @Override
    public boolean updateMcpRequestOsstOrdNo(McpRequestOsstDto mcpRequestOsstDto) {
        throw new UnsupportedOperationException("[ASIS] updateMcpRequestOsstOrdNo");
    }

    @Override
    public boolean updateMcpRequestMove(McpRequestMoveDto mcpRequestMoveDto) {
        throw new UnsupportedOperationException("[ASIS] updateMcpRequestMove");
    }

    @Override
    public List<AppformReqDto> getInsrCode() {
        throw new UnsupportedOperationException("[ASIS] getInsrCode");
    }

    @Override
    public List<IntmInsrRelDTO> getInsrProdList(IntmInsrRelDTO intmInsrRelDTO) {
        throw new UnsupportedOperationException("[ASIS] getInsrProdList");
    }

    @Override
    public Long saveSelfDlvryHist(McpRequestSelfDlvryDto reqSelfDlvry) {
        throw new UnsupportedOperationException("[ASIS] saveSelfDlvryHist");
    }

    @Override
    public Long insertRequestSelfDlvry(McpRequestSelfDlvryDto reqSelfDlvry) {
        throw new UnsupportedOperationException("[ASIS] insertRequestSelfDlvry");
    }

    @Override
    public List<McpRequestSelfDlvryDto> getMcpRequestSelfDlvry(McpRequestSelfDlvryDto reqSelfDlvry) {
        throw new UnsupportedOperationException("[ASIS] getMcpRequestSelfDlvry");
    }

    @Override
    public McpRequestSelfDlvryDto getMcpSelfDlvryDataHist(Long selfDlvryIdx) {
        throw new UnsupportedOperationException("[ASIS] getMcpSelfDlvryDataHist");
    }

    @Override
    public Long saveSelfDlvry(McpRequestSelfDlvryDto reqSelfDlvry) {
        throw new UnsupportedOperationException("[ASIS] saveSelfDlvry");
    }

    @Override
    public McpRequestSelfDlvryDto getMcpSelfDlvryData(Long selfDlvryIdx) {
        throw new UnsupportedOperationException("[ASIS] getMcpSelfDlvryData");
    }

    @Override
    public int deleteMcpRequestSelfDlvry(Long selfDlvryIdx) {
        throw new UnsupportedOperationException("[ASIS] deleteMcpRequestSelfDlvry");
    }

    @Override
    public McpRequestSelfDlvryDto getMcpNowDlvryData(Long selfDlvryIdx) {
        throw new UnsupportedOperationException("[ASIS] getMcpNowDlvryData");
    }

    @Override
    public Long saveNowDlvryHist(McpRequestSelfDlvryDto reqSelfDlvry) {
        throw new UnsupportedOperationException("[ASIS] saveNowDlvryHist");
    }

    @Override
    public int deleteMcpRequestNowDlvry(Long selfDlvryIdx) {
        throw new UnsupportedOperationException("[ASIS] deleteMcpRequestNowDlvry");
    }

    @Override
    public Long saveNowDlvry(McpRequestSelfDlvryDto reqSelfDlvry) {
        throw new UnsupportedOperationException("[ASIS] saveNowDlvry");
    }

    @Override
    public boolean updateNowDlvry(McpRequestSelfDlvryDto mcpRequestSelfDlvryDto) {
        throw new UnsupportedOperationException("[ASIS] updateNowDlvry");
    }

    @Override
    public Map<String, Object> nowDlvryComplete(Long selfDlvryIdx) {
        throw new UnsupportedOperationException("[ASIS] nowDlvryComplete");
    }

    @Override
    public boolean updatePayCdNowDlvry(McpRequestSelfDlvryDto reqSelfDlvry) {
        throw new UnsupportedOperationException("[ASIS] updatePayCdNowDlvry");
    }

    @Override
    public McpRequestSelfDlvryDto getMcpNowDlvryDataHist(Long selfDlvryIdx) {
        throw new UnsupportedOperationException("[ASIS] getMcpNowDlvryDataHist");
    }

    @Override
    public int updateSelfViewYn(Long selfDlvryIdx) {
        throw new UnsupportedOperationException("[ASIS] updateSelfViewYn");
    }

    @Override
    public int updateNowViewYn(Long selfDlvryIdx) {
        throw new UnsupportedOperationException("[ASIS] updateNowViewYn");
    }

    @Override
    public int checkLimitFormCount(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] checkLimitFormCount");
    }
    ...
    public MSimpleOsstXmlVO sendOsstService(String resNo, String eventCd) throws SelfServiceException, SocketTimeoutException, McpMplatFormException {
        throw new UnsupportedOperationException("[ASIS] sendOsstService(String,String)");
    }
    ...
    public MSimpleOsstXmlVO sendOsstService(Map<String, String> osstParam, String eventCd) throws SelfServiceException, SocketTimeoutException, McpMplatFormException {
        throw new UnsupportedOperationException("[ASIS] sendOsstService(Map,String)");
    }
    ...
    public MSimpleOsstXmlVO sendOsstAddBillService(String resNo, String eventCd, String billAcntNo) throws SelfServiceException, SocketTimeoutException, McpMplatFormException {
        throw new UnsupportedOperationException("[ASIS] sendOsstAddBillService");
    }
    ...
    public MSimpleOsstXmlVO sendOsstService(String resNo, String eventCd, String gubun) throws SelfServiceException, SocketTimeoutException {
        throw new UnsupportedOperationException("[ASIS] sendOsstService(String,String,String)");
    }
    ...
    public MSimpleOsstXmlVO sendOsstService(OsstReqDto osstReqDto, String eventCd) throws SelfServiceException, SocketTimeoutException {
        throw new UnsupportedOperationException("[ASIS] sendOsstService(OsstReqDto,String)");
    }

    @Override
    public MPhoneNoListXmlVO getPhoneNoList(String resNo, String eventCd) throws SelfServiceException, SocketTimeoutException {
        throw new UnsupportedOperationException("[ASIS] getPhoneNoList(String,String)");
    }
    ...
    public MPhoneNoListXmlVO getPhoneNoList(Map<String, String> osstParam, String eventCd) throws SelfServiceException, SocketTimeoutException {
        throw new UnsupportedOperationException("[ASIS] getPhoneNoList(Map,String)");
    }

    @Override
    public AppformReqDto getLimitForm(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] getLimitForm");
    }

    @Override
    public boolean updateAppForPstate(long requestKey) {
        throw new UnsupportedOperationException("[ASIS] updateAppForPstate");
    }

    @Override
    public List<AppformReqDto> getFormDlveyList(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] getFormDlveyList");
    }

    @Override
    public boolean updateFormDlveyUsim(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] updateFormDlveyUsim");
    }

    @Override
    public long getTempRequestKey() {
        throw new UnsupportedOperationException("[ASIS] getTempRequestKey");
    }

    @Override
    public int insertAppFormTempSave(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] insertAppFormTempSave");
    }

    @Override
    public int insertSaleinfoTempSave(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] insertSaleinfoTempSave");
    }

    @Override
    public int insertAppFormApdTempSave(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] insertAppFormApdTempSave");
    }

    @Override
    public int insertSaleinfoApdTempSave(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] insertSaleinfoApdTempSave");
    }

    @Override
    public AppformReqDto getAppFormTemp(long requestKey) {
        throw new UnsupportedOperationException("[ASIS] getAppFormTemp");
    }

    @Override
    public AppformReqDto getAppForm(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] getAppForm");
    }

    @Override
    public boolean updateRequestTempStep1(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] updateRequestTempStep1");
    }

    @Override
    public boolean updateRequestTempStep3(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] updateRequestTempStep3");
    }

    @Override
    public boolean updateRequestTempStep4(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] updateRequestTempStep4");
    }

    @Override
    public boolean updateRequestTempStep5(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] updateRequestTempStep5");
    }

    @Override
    public List<String> getAdditionTempList(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] getAdditionTempList");
    }

    @Override
    public UsimBasDto getUsimBasInfo(UsimBasDto usimBasObj) {
        throw new UnsupportedOperationException("[ASIS] getUsimBasInfo");
    }

    @Override
    public AppformReqDto getNmcpRequestApdSaleinfo(Long selfDlvryIdx) {
        throw new UnsupportedOperationException("[ASIS] getNmcpRequestApdSaleinfo");
    }

    @Override
    public boolean useSelfFormSufPay(Long requestKey) {
        throw new UnsupportedOperationException("[ASIS] useSelfFormSufPay");
    }

    @Override
    public AppformReqDto getCopyMcpRequest(AppformReqDto appformReq) {
        throw new UnsupportedOperationException("[ASIS] getCopyMcpRequest");
    }

    @Override
    public int insertNmcpUsimBuyTxn(AppformReqDto appformReq) {
        throw new UnsupportedOperationException("[ASIS] insertNmcpUsimBuyTxn");
    }

    @Override
    public String getUsimOrgnId(String usimNo) {
        throw new UnsupportedOperationException("[ASIS] getUsimOrgnId");
    }

    @Override
    public MSimpleOsstXmlUc0VO sendOsstUc0Service(OsstUc0ReqDto osstUc0ReqDto, String eventCd) throws SelfServiceException, SocketTimeoutException, McpMplatFormException {
        throw new UnsupportedOperationException("[ASIS] sendOsstUc0Service");
    }

    @Override
    public String usimChgChk(OsstUc0ReqDto osstUc0ReqDto) {
        throw new UnsupportedOperationException("[ASIS] usimChgChk");
    }

    @Override
    public int checkUploadPhoneInfoCount(String uploadPhoneSrlNo) {
        throw new UnsupportedOperationException("[ASIS] checkUploadPhoneInfoCount");
    }

    @Override
    public McpUploadPhoneInfoDto getUploadPhoneInfo(long uploadPhoneSrlNo) {
        throw new UnsupportedOperationException("[ASIS] getUploadPhoneInfo");
    }

    @Override
    public int selectStolenIp(String customer) {
        throw new UnsupportedOperationException("[ASIS] selectStolenIp");
    }

    @Override
    public boolean crtSaveAppFormStep(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] crtSaveAppFormStep");
    }

    @Override
    public Map<String, String> crtSaveAppFormInfo(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] crtSaveAppFormInfo");
    }

    @Override
    public Map<String, String> crtSaveSimpleAppFormInfo(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] crtSaveSimpleAppFormInfo");
    }

    @Override
    public boolean crtUpdateSimpleAppFormStep(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] crtUpdateSimpleAppFormStep");
    }

    @Override
    public Map<String, String> crtUpdateSimpleAppFormInfo(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] crtUpdateSimpleAppFormInfo");
    }

    @Override
    public String getChrgPrmtId(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] getChrgPrmtId");
    }

    @Override
    public int insertDisPrmtApd(AppformReqDto appformReqDto, String evntCd) {
        throw new UnsupportedOperationException("[ASIS] insertDisPrmtApd");
    }

    @Override
    public String getDisPrmtId(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] getDisPrmtId");
    }
    ...
    public MSimpleOsstXmlSt1VO sendOsstSt1Service(String resNo, String eventCd) throws SelfServiceException, SocketTimeoutException, McpMplatFormException {
        throw new UnsupportedOperationException("[ASIS] sendOsstSt1Service(String,String)");
    }
    ...
    public MSimpleOsstXmlSt1VO sendOsstSt1Service(Map<String, String> osstParam, String eventCd) throws SelfServiceException, SocketTimeoutException, McpMplatFormException {
        throw new UnsupportedOperationException("[ASIS] sendOsstSt1Service(Map,String)");
    }

    @Override
    public Map<String, String> chkRealPc2Result(String resNo, String contractNum) {
        throw new UnsupportedOperationException("[ASIS] chkRealPc2Result");
    }

    @Override
    public Map<String, String> isSimpleApplyPlatform(String operType) {
        throw new UnsupportedOperationException("[ASIS] isSimpleApplyPlatform");
    }

    @Override
    public boolean updateDirectPhone(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] updateDirectPhone");
    }
    ...
    public Map<String, String> checkDupReq(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] checkDupReq");
    }

    @Override
    public List<MspSalePlcyMstDto> getSalePlcyInfo(AppformReqDto appformReqDto) {
        throw new UnsupportedOperationException("[ASIS] getSalePlcyInfo");
    }

    @Override
    public boolean chkAcenReqCondition(McpRequestDto mcpRequestDto, Map<String, String> etcParam) {
        throw new UnsupportedOperationException("[ASIS] chkAcenReqCondition");
    }

    @Override
    public void insertAcenReqTrg(McpRequestDto mcpRequestDto) {
        throw new UnsupportedOperationException("[ASIS] insertAcenReqTrg");
    }

    @Override
    public void containsGoldNumbers(List<String> reqWantNumbers) {
        throw new UnsupportedOperationException("[ASIS] containsGoldNumbers");
    }

    @Override
    public Map<String, Object> isSimpleApplyObj() {
        throw new UnsupportedOperationException("[ASIS] isSimpleApplyObj");
    }

    @Override
    public AppformReqDto getJehuUsimlessByResNo(String resNo) {
        throw new UnsupportedOperationException("[ASIS] getJehuUsimlessByResNo");
    }

    @Override
    public HashMap<String, Object> processOsstFt0Service(OsstFathReqDto osstFathReqDto) {
        throw new UnsupportedOperationException("[ASIS] processOsstFt0Service");
    }

    @Override
    public HashMap<String, Object> processOsstFs8Service(OsstFathReqDto osstFathReqDto) {
        throw new UnsupportedOperationException("[ASIS] processOsstFs8Service");
    }

    @Override
    public HashMap<String, Object> processOsstFs9Service(OsstFathReqDto osstFathReqDto, String resltCd) {
        throw new UnsupportedOperationException("[ASIS] processOsstFs9Service");
    }

    @Override
    public HashMap<String, Object> processOsstFt1Service(OsstFathReqDto osstFathReqDto) {
        throw new UnsupportedOperationException("[ASIS] processOsstFt1Service");
    }

    @Override
    public boolean isEnabledFT1() {
        throw new UnsupportedOperationException("[ASIS] isEnabledFT1");
    }

    // ====================== END: [ASIS] stub 메서드 ======================

    // ASIS 소스 >> 필요시 확인후 주석제거 필요
    ...
    //     mplatFormOsstServerAdapter.callService(param, simpleOsstXmlVO,100000);
    //
    //     if(StringUtils.hasText(simpleOsstXmlVO.getOsstOrdNo())){
    ...
    //
    //     if(!StringUtils.hasText(resultCd)){ // 미응답
    //         resultCd = "9999";
    //     }
    //
    //     return resultCd;
    ...
    //      */
    //     //가입비  기본값 설정
    //     if (!StringUtils.hasText(appformReqDto.getUsimPriceType())) {
    //         appformReqDto.setUsimPriceType(USIM_PRICE_TYPE_BASE);
    //     }
    //
    //     //유심비 기본값 설정
    //     if (!StringUtils.hasText(appformReqDto.getJoinPriceType())) {
    ...
    //     if (StringUtils.hasText(appformReqDto.getKtInterSvcNo())  ) {
    ...
    //      *
    //      */
    //     if (StringUtils.hasText(appformReqDto.getCommendId()) && 0 < coEventSvc.duplicateChk(appformReqDto.getCommendId()) ) {
    ...
    //
    //     // 유입 제휴 코드
    //     if (StringUtils.hasLength(SessionUtils.getCoalitionInflow())) {
    ...
    //     if (StringUtils.hasText(appformReqDto.getMinorAgentName())) {
    //         appformDao.updateRequestAgentTemp(appformReqDto);
    //     }
    //
    //     if ( StringUtils.hasText(appformReqDto.getDlvryName()) ) {
    ...
    // public boolean updateRequestTempStep3(AppformReqDto appformReqDto) {
    //     appformDao.updateRequestTemp(appformReqDto);
    //     if (StringUtils.hasText(appformReqDto.getMoveCompany())) {
    ...
    // public boolean updateRequestTempStep4(AppformReqDto appformReqDto) {
    //     appformDao.updateRequestTemp(appformReqDto);
    //     if (StringUtils.hasText(appformReqDto.getRecommendInfo())) {
    //         appformDao.updateRequestCstmrTemp(appformReqDto);
    //     }
    //
    //     String[] additionKeyList = appformReqDto.getAdditionKeyList() ;
    ...
    //             if(!CSTMR_TYPE_NM.equals(appformReqDto.getCstmrType()) &&
    //                 ("D".equals(appformReqDto.getReqPayType()) || "C".equals(appformReqDto.getReqPayType()) || StringUtils.hasText(appformReqDto.getReqUsimSn()))){
    //                 certStep++;
    //             }
    //         }
    //
    ...
    //
    //         // 2-2. 안심보험
    //         if(StringUtils.hasText(appformReqDto.getInsrProdCd())) certStep+=2;
    //
    //         // 2-3. 자급제 보상서비스
    //         if(StringUtils.hasText(appformReqDto.getRwdProdCd())) certStep+=2;
    //
    //         // 2-4. 유심번호
    ...
    //
    //         if("Y".equals(selfYn) || StringUtils.hasText(appformReqDto.getReqUsimSn())){
    //             certKeyList.add("reqUsimSn");
    //             certValueList.add(appformReqDto.getReqUsimSn());
    //         }
    //     }
    ...
    //     if (StringUtils.hasText(prmtId)) disApdParam.setPrmtId(prmtId);
    //
    //     RestTemplate restTemplate = new RestTemplate();
    ...
    //
    //     if(StringUtils.hasLength(ncn)){  // 모회선 계약번호와 고객아이디 함께 전달 (데이터쉐어링 케이스)
    //
    ...
    //     if(nacSelfLimit == null || !StringUtils.hasText(nacSelfLimit.getExpnsnStrVal1())){
    //         return 0;  // 제한을 두지 않음
    //     }
    //
    //     // 제한 예외 IP 확인
    ...
    //         // 7. esimWatch 제외
    //         if(StringUtils.hasText(mcpRequestDto.getPrntsContractNo())){
    //             return false;
    //         }
    //
    //         // 8. esim 공통코드에 따라 처리
    ...
    //
    //     // esim인 경우 유심있음 처리
    //     boolean isNoSim = !StringUtils.hasText(mcpRequestDto.getReqUsimSn())
    ...
    //     param.put("asgnAgncId", osstFathReqDto.getAsgnAgncId());
    //
    //     if(StringUtils.hasLength(osstFathReqDto.getResNo())) {
    //         param.put("resNo", osstFathReqDto.getResNo());
    //     }
    //
    ...
    //         if(!StringUtils.hasLength(osstFathReqDto.getOperType())){
