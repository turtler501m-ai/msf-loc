...
import com.ktmmobile.msf.domains.form.common.mplatform.dto.MoscFarPriceChgDto.M_messageDto;
...
import static com.ktmmobile.msf.domains.form.common.exception.msg.ExceptionMsgConstant.INVALID_PARAMATER_EXCEPTION;
...
import static com.ktmmobile.msf.domains.form.common.exception.msg.ExceptionMsgConstant.NO_SESSION_EXCEPTION;
...
//    RateAdsvcGdncService rateAdsvcGdncService;
    ...
    public String doRegServicePop(
        ...
        // RateAdsvc benefit guide blocked.
    ...
    public HashMap<String, Object> farPricePlanResChgAjax(
        ...
        try {
            MoscFarPriceChgDto resOut = farPricePlanService.doFarPricePlanRsrvChg(searchVO,
                soc,
                ftrNewParam,
                ip,
                userId,
...
//        if (rateAdsvcGdncService.getProdCount(rateAdsvcCtgBasDTO) == 0) { // blocked
