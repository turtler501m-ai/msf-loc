...
import com.ktmmobile.msf.domains.form.common.mplatform.vo.MpEtcVO;
...
public class MpFarMonDetailInfoDto extends CommonXmlVO {
...
//		this.allOfBillSeqNo = XmlParse.getChildValue(monDetailInfo, "allOfBillSeqNo");
	...
	public List<MpEtcVO> getItemList() {
		return itemList;
	}
	public void setItemList(List<MpEtcVO> itemList) {
