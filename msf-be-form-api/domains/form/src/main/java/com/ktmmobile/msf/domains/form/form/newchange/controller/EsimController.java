...
//import com.ktmmobile.msf.domains.form.form.newchange.service.EsimSvc;
...
//        if (autEsim == null || !StringUtils.hasText(autEsim.getSvcCntrNo()) || !autEsim.getSvcCntrNo().equals(contractNum)) {
...
//
//        //인자값 확인
//        if (!StringUtils.hasText(esimDto.getCstmrName())
//            || !StringUtils.hasText(esimDto.getCstmrMobile())
//            || !StringUtils.hasText(esimDto.getCstmrNativeRrn01())) {
...
//            if (autEsim == null || !StringUtils.hasText(autEsim.getSvcCntrNo()) || !prntsContractNo.equals(autEsim.getSvcCntrNo())) {
...
//
//        /** 계약 번호 하고 검증  */
//        if (StringUtils.hasText(temCustomerNm) || StringUtils.hasText(temCustomerSsn) ) {
//            //데이터 쉐어링 인증값 검증
