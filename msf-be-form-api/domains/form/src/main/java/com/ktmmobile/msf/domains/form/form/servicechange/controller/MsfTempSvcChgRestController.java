...
import com.ktmmobile.msf.domains.form.form.servicechange.service.MsfTempSvcChgRestSvc;

@RestController
@RequestMapping("/api/form")
@RequiredArgsConstructor
public class MsfTempSvcChgRestController {

    private final MsfTempSvcChgRestSvc svcChgRestSvc;
