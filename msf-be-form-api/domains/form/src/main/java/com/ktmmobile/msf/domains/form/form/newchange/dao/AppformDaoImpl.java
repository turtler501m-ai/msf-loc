...
public class AppformDaoImpl implements AppformDao {
    ...
    public Map<String, String> getAppFormData(long requestKey) {
        ...
        return restTemplate.postForObject(apiInterfaceServer + "/appform/requestJoinDataByRjoinKeyNew",
            requestKey,
            Map.class); // Appform_Query.getRequestJoinDataByRjoinKeyNew
    }
    ...
    public int insertMcpRequestAdditionPromotion(AppformReqDto appformReqDto) {
        RestTemplate restTemplate = new RestTemplate();
        return restTemplate.postForObject(apiInterfaceServer + "/appform/mcpRequestAdditionPromotion",
            appformReqDto,
            Integer.class); // Appform_Query.insertMcpRequestAdditionPromotion
    }
    ...
    public JuoSubInfoDto selRMemberAjax(JuoSubInfoDto juoSubInfoDto) {
        RestTemplate restTemplate = new RestTemplate();
        return restTemplate.postForObject(apiInterfaceServer + "/appform/selRMemberAjax",
            juoSubInfoDto,
            JuoSubInfoDto.class); // Appform_Query.selRMemberAjax
    }
    ...
    public int getMcpRequestCount(AppformReqDto appformReqDto) {
        ...
        if (resultObj instanceof Number) {
            ...
            throw new IllegalArgumentException(String.format(
                "Wrong  resultClass type(%s) with queryId:%s, resultClass must be subclass of java.lang.Number",
                resultObj.getClass().getName(),
                "Appform_Query.getMcpRequestCount"));
        }
    }
    ...
    public int checkJejuCodeCount(String rateCd) {
        ...
        Object resultObj = restTemplate.postForObject(apiInterfaceServer + "/appform/checkJejuCodeCount",
            params,
            Integer.class); // Appform_Query.checkJejuCodeCount
        ...
        if (resultObj instanceof Number) {
            ...
            throw new IllegalArgumentException(String.format(
                "Wrong  resultClass type(%s) with queryId:%s, resultClass must be subclass of java.lang.Number",
                resultObj.getClass().getName(),
                apiInterfaceServer + "/appform/checkJejuCodeCount")); // Appform_Query.checkJejuCodeCount
        }
    }
    ...
    public int checkClauseJehuRatecd(String rateCd) {
        ...
        if (resultObj instanceof Number) {
            ...
            throw new IllegalArgumentException(String.format(
                "Wrong  resultClass type(%s) with queryId:%s, resultClass must be subclass of java.lang.Number",
                resultObj.getClass().getName(),
                "Appform_Query.checkClauseJehuRatecd"));
        }
    }
    ...
    public McpRequestDto getMspPrdtCode(AppformReqDto appformReqDto) {
        RestTemplate restTemplate = new RestTemplate();
        return restTemplate.postForObject(apiInterfaceServer + "/appform/mspPrdtCode",
            appformReqDto,
            McpRequestDto.class); // Appform_Query.getMspPrdtCode
    }
    ...
    public AppformReqDto getMarketRequest(AppformReqDto appformReqDto) {
        RestTemplate restTemplate = new RestTemplate();
        return restTemplate.postForObject(apiInterfaceServer + "/appform/marketRequest",
            appformReqDto,
            AppformReqDto.class); // Appform_Query.getMarketRequest
    }

    @Override
    public List<AppformReqDto> selectModelMonthlyList(AppformReqDto appformReqDto) {
        RestTemplate restTemplate = new RestTemplate();
        return restTemplate.postForObject(apiInterfaceServer + "/appform/modelMonthlyList",
            appformReqDto,
            List.class); // Appform_Query.selectModelMonthlyList
    }

    @Override
    public List<AppformReqDto> selectMonthlyListMarket(AppformReqDto appformReqDto) {
        RestTemplate restTemplate = new RestTemplate();
        return restTemplate.postForObject(apiInterfaceServer + "/appform/monthlyListMarket",
            appformReqDto,
            List.class); // Appform_Query.selectMonthlyListMarket
    }

    @Override
    public List<AppformReqDto> selectPrdtColorList(AppformReqDto appformReqDto) {
        RestTemplate restTemplate = new RestTemplate();
        return restTemplate.postForObject(apiInterfaceServer + "/appform/prdtColorList",
            appformReqDto,
            List.class); // Appform_Query.selectPrdtColorList
    }
    ...
    public int requestOsstCount(McpRequestOsstDto mcpRequestOsstDto) {
        ...
        if (resultObj instanceof Number) {
            ...
            throw new IllegalArgumentException(String.format(
                "Wrong  resultClass type(%s) with queryId:%s, resultClass must be subclass of java.lang.Number",
                resultObj.getClass().getName(),
                "AppFormMapper.requestOsstCount"));
        }
    }
    ...
    public int checkLimitFormCount(AppformReqDto appformReqDto) {
        ...
        if (resultObj instanceof Number) {
            ...
            throw new IllegalArgumentException(String.format(
                "Wrong  resultClass type(%s) with queryId:%s, resultClass must be subclass of java.lang.Number",
                resultObj.getClass().getName(),
                "AppFormMapper.checkLimitFormCount"));
        }
    }
    ...
    public int checkUploadPhoneInfoCount(long uploadPhoneSrlNo) {
        ...
        if (resultObj instanceof Number) {
            ...
            throw new IllegalArgumentException(String.format(
                "Wrong  resultClass type(%s) with queryId:%s, resultClass must be subclass of java.lang.Number",
                resultObj.getClass().getName(),
                "AppFormMapper.checkUploadPhoneInfoCount"));
        }
    }
