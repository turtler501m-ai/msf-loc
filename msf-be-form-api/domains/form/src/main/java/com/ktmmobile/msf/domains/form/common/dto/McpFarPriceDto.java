...
public class McpFarPriceDto implements Serializable {
    ...
    /** 예약 상품요금제코드 */
    private String rsrvPrdcCd;
    /** 예약 상품요금제명 */
    private String rsrvPrdcNm;
    /** 예약 요금제변경 대상기본료 */
    private String rsrvBasicAmt;
    /** 예약요금제 변경 신청일자 */
    private String rsrvAplyDate;
    /** 예약요금제 변경 적용일자 */
    private String rsrvEfctStDate;
    ...
    public String getRsrvPrdcCd() { return rsrvPrdcCd; }
    public void setRsrvPrdcCd(String rsrvPrdcCd) { this.rsrvPrdcCd = rsrvPrdcCd; }

    public String getRsrvPrdcNm() { return rsrvPrdcNm; }
    public void setRsrvPrdcNm(String rsrvPrdcNm) { this.rsrvPrdcNm = rsrvPrdcNm; }

    public String getRsrvBasicAmt() { return rsrvBasicAmt; }
    public void setRsrvBasicAmt(String rsrvBasicAmt) { this.rsrvBasicAmt = rsrvBasicAmt; }

    public String getRsrvAplyDate() { return rsrvAplyDate; }
    public void setRsrvAplyDate(String rsrvAplyDate) { this.rsrvAplyDate = rsrvAplyDate; }

    public String getRsrvEfctStDate() { return rsrvEfctStDate; }
    public void setRsrvEfctStDate(String rsrvEfctStDate) { this.rsrvEfctStDate = rsrvEfctStDate; }
