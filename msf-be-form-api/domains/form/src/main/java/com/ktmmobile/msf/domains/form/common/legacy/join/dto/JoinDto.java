package com.ktmmobile.msf.domains.form.common.legacy.join.dto;
...
public class JoinDto implements Serializable {
    ...
    /**
     * 위변조 체크를 하고 정상시 JoinDto에 값을 할당한다
     * @param niceResDto
    ...
    public int getLoginCnt() { return loginCnt; }
    public void setLoginCnt(int loginCnt) { this.loginCnt = loginCnt; }
    public String getStatus() { return status; }
    public void setStatus(String status) { this.status = status; }
    public String getUserDivision() { return userDivision; }
    public void setUserDivision(String userDivision) { this.userDivision = userDivision; }
    public String getAgreeEmail() { return agreeEmail; }
    public void setAgreeEmail(String agreeEmail) { this.agreeEmail = agreeEmail; }
    public String getAgreeSMS() { return agreeSMS; }
    public void setAgreeSMS(String agreeSMS) { this.agreeSMS = agreeSMS; }
    public String getPasswordChk() { return passwordChk; }
    public void setPasswordChk(String passwordChk) { this.passwordChk = passwordChk; }
    public String getSnsCd() { return snsCd; }
    public void setSnsCd(String snsCd) { this.snsCd = snsCd; }
    public String getSnsId() { return snsId; }
    public void setSnsId(String snsId) { this.snsId = snsId; }
    public String getDiVal() { return diVal; }
    public void setDiVal(String diVal) { this.diVal = diVal; }
    public String getSnsAddYn() { return snsAddYn; }
    public void setSnsAddYn(String snsAddYn) { this.snsAddYn = snsAddYn; }
    ...
    public long getNiceHistSeq() { return niceHistSeq; }
    public void setNiceHistSeq(long niceHistSeq) { this.niceHistSeq = niceHistSeq; }
    public long getNiceAgentHistSeq() { return niceAgentHistSeq; }
    public void setNiceAgentHistSeq(long niceAgentHistSeq) { this.niceAgentHistSeq = niceAgentHistSeq; }
    ...
    public String getChkInterest() { return chkInterest; }
    public void setChkInterest(String chkInterest) { this.chkInterest = chkInterest; }
    public String getAuthTelCode() { return authTelCode; }
    public void setAuthTelCode(String authTelCode) { this.authTelCode = authTelCode; }
    public String getMinorAgentAgree() { return minorAgentAgree; }
    public void setMinorAgentAgree(String minorAgentAgree) { this.minorAgentAgree = minorAgentAgree; }
    ...
    public String getMtkAgrReferer() { return mtkAgrReferer; }
    public void setMtkAgrReferer(String mtkAgrReferer) { this.mtkAgrReferer = mtkAgrReferer; }
}
