...
import com.ktmmobile.msf.domains.form.common.mplatform.dto.MoscCombChkRes.MoscCombPreChkListOut;
...
import com.ktmmobile.msf.domains.form.form.servicechange.service.MsfMyCombinationSvc;
    ...
    public Map<String, Object> childCertify(
        ...
        */
        ...
        if (mspSmsTemplateMstDto != null) {
            ...
            String[] certValue = {"reqChildSmsAuthNum", "1", "smsChild", childAutSms.getPhoneNum(), childAutSms.getContractNum(), childAutSms.getSubLinkName(), EncryptUtil.ace256Enc(
                childAutSms.getUnSSn())};
            certService.vdlCertInfo("C", certKey, certValue);
            // ============ STEP END ============
            ...
            if (moscCombInfoResDTO.getMoscSrchCombInfoList() != null) {
                ...
                for (MoscMvnoComInfo item: moscCombInfoResDTO.getMoscSrchCombInfoList()) {
                    ...
                    if ("Y".equals(childCobun) && "Y".equals(parentObj.getCombYn())) {
                        ...
                        try {
                            combSvcInfo = mplatFormService.moscCombSvcInfoList(pareSession.getCustId(),
                                pareSession.getSvcCntrNo(),
                                pareSession.getCtn());
