...
import com.ktmmobile.msf.domains.form.common.dto.RoleMenuDto;
...
public class SessionUtils {
    ...
    public static boolean authSmsBeanCheck(AuthSmsDto authSmsDto) {
        ...
        if (null != sessionAuthSmsDto.getSendTime() && !"".equals(sessionAuthSmsDto.getSendTime())) {
            Long resultTime = Long.parseLong(new SimpleDateFormat("yyyyMMddHHmmss", Locale.KOREA).format(new Date())) - Long.parseLong(
                sessionAuthSmsDto.getSendTime());
    ...
    public static void saveCurrentMenuDto(SiteMenuDto siteMenuDto) {
        ...
        if (siteMenuDto != null) {
            logger.debug("saveCurrentMenuDto siteMenuDto:{}/{}/{}/{}",
                siteMenuDto.getUrlAdr(),
                siteMenuDto.getMenuNm(),
                siteMenuDto.getMenuSeq(),
                siteMenuDto.getMenuCode());
        }
