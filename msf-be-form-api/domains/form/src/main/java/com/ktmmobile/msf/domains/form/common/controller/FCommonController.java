...
public class FCommonController {
    ...
    @ResponseBody
    public List<PopupDto> getPopupListAjax(
    ...
    @ResponseBody
    public List<PopupDto> getMobilePopupListAjax(
        HttpServletRequest request, ModelMap model,
        PopupDto popupDto
    ) {
        List<PopupDto> popupList = null;
    ...
    public String clauseDetailView(
        FormDtlDTO oFormDtlDTO
        , Model model
    ) {
    ...
    @ResponseBody
    public Map<String, String> getJehuInfo(
        @RequestParam(value = "rateCd") String rateCd,
