...
import com.ktmmobile.msf.domains.form.common.util.XmlBindUtil;
// import com.ktmmobile.msf.domains.form.form.servicechange.RateAdsvcGdncService;
import com.ktmmobile.msf.domains.form.form.servicechange.dto.FarPricePlanResDto;
import com.ktmmobile.msf.domains.form.form.servicechange.dto.ListXmlWrapper;
...
import com.ktmmobile.msf.domains.form.form.servicechange.dto.RateAdsvcGdncProdXML;

import static com.ktmmobile.msf.domains.form.common.constants.Constants.AJAX_SUCCESS;
import static com.ktmmobile.msf.domains.form.common.constants.Constants.GROUP_CODE_EXCEPTION_LIST_SOC_CODE;
import static com.ktmmobile.msf.domains.form.common.constants.Constants.KAKAO_SENDER_KEY;
...
@Service
public class MsfFarPricePlanServiceImpl implements MsfFarPricePlanService {

    private static Logger logger = LoggerFactory.getLogger(MsfFarPricePlanService.class);
...
//    private RateAdsvcGdncService rateAdsvcGdncService;
    ...
    public FarPricePlanResDto getFarPricePlanWrapper(McpFarPriceDto mcpFarPriceDto) {
        ...
        try {
            ...
            // [ASIS] RateAdsvcGdncProdRelXML / XmlBindUtil.bindListFromXml 미구현
            ...
            // [ASIS] for (RateAdsvcGdncProdRelXML item: rateAdsvcGdncProdRelList) { ... }

            // 요금제부가서비스안내일련번호 세팅 (일련번호 없으면 0)
            farPricePlanResDto.setRateAdsvcGdncSeq(rateAdsvcGdncSeq);

            // RateAdsvc benefit detail XML blocked.
    ...
    public MapWrapper getCtgMapWrapper() {
        ...
        try {
            ...
            // [ASIS] mapWrapper = XmlBindUtil.bindFromXml(MapWrapper.class, realFilePath) — 미구현
        } catch (Exception e) {
            throw new McpCommonException(e.getMessage());
        }
    ...
    public List<RateAdsvcCtgBasDTO> selectFarPricePlanList(RateAdsvcCtgBasDTO rateAdsvcCtgBasDTO, String rateCd) throws JAXBException, IOException {
        ...
        // [ASIS] prodXmlList 항상 empty, RateAdsvcGdncProdRelXML 미구현 — 블록 전체 주석 처리
    ...
    @Override
    public Map<String, Object> getAddSvcInfoDto(
        MyPageSearchDto searchVO, String toSocCode, String nowPriceSocCode
        , McpServiceAlterTraceDto paraAlterTrace
    ) throws InterruptedException {
    ...
    @Override
    public List<RateAdsvcCtgBasDTO> getStrCtgXmlList(RateAdsvcCtgBasDTO outDto, List<RateAdsvcCtgBasDTO> list, String rateCd)
    ...
    public HashMap<String, Object> batchResChangeAddPrdCall(McpIpStatisticDto ipStatistic, int instMnthAmtPric) throws InterruptedException {
        ...
        McpUserCntrMngDto mcpUserCntrMngDto = restTemplate.postForObject(apiInterfaceServer + "/mypage/cntrListNoLogin",
            userCntrMngDto,
            McpUserCntrMngDto.class);
