...
public class MspSaleSubsdMstDto implements Serializable {
    ...
    public void setRateBenefitTxt(String rateBenefitTxt) {
        this.rateBenefitTxt = rateBenefitTxt;
    }
    ...
    public String getPhoneBuyPhrase() { return phoneBuyPhrase; }
    public void setPhoneBuyPhrase(String phoneBuyPhrase) { this.phoneBuyPhrase = phoneBuyPhrase; }

    public String getMaxDataDelivery() { return maxDataDelivery; }
    public void setMaxDataDelivery(String maxDataDelivery) { this.maxDataDelivery = maxDataDelivery; }
}
