 ...
 *  MSP 의 MSP_RATE_MST 테이블 (요금제 마스트)
 * @author : ant
...
public class MspRateMstDto implements Serializable {
    ...
    /** 정책리스트 */
    private List<String> salePlcyCdList;
    ...
    public List<String> getSalePlcyCdList() {
        return salePlcyCdList;
    }

    public void setSalePlcyCdList(List<String> salePlcyCdList) {
        this.salePlcyCdList = salePlcyCdList;
    }
    ...
    public int getOnlineCanDay() { return onlineCanDay; }
    public void setOnlineCanDay(int onlineCanDay) { this.onlineCanDay = onlineCanDay; }

    public String getXmlDataCnt() { return xmlDataCnt; }
    public void setXmlDataCnt(String xmlDataCnt) { this.xmlDataCnt = xmlDataCnt; }

    public String getXmlQosCnt() { return xmlQosCnt; }
    public void setXmlQosCnt(String xmlQosCnt) { this.xmlQosCnt = xmlQosCnt; }

    public String getXmlCallCnt() { return xmlCallCnt; }
    public void setXmlCallCnt(String xmlCallCnt) { this.xmlCallCnt = xmlCallCnt; }
}
