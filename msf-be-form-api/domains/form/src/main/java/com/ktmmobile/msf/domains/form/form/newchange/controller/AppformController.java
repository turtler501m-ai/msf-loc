...
public class AppformController {
    ...
    //
    // @Value("${api.interface.serverNamever}")
    ...
    //
    //     if (!StringUtils.hasText(giftPromotionBas.getRateCd())) {
    ...
    //     if (userSession != null && StringUtils.hasLength(userSession.getUserId())) {
    ...
    //         int age = NmcpServiceUtils.getBirthDateToAmericanAge(sessNiceRes.getBirthDate(),
    ...
    //             }
    //
    //             int minorAgentAge = NmcpServiceUtils.getBirthDateToAmericanAge(sessAgentNiceRes.getBirthDate(),
    //                 new SimpleDateFormat("yyyyMMdd", Locale.KOREA).format(new Date()));
    ...
    //     //        if(StringUtils.hasLength(appformReqTemp.getEvntCdPrmt())){
    //     //            String recoUseYn = eventCodeSvc.getEventCodeRecoUseYnXML(appformReqTemp.getEvntCdPrmt());
    //     //            if(StringUtils.hasLength(recoUseYn)){
    ...
    //     if (OPER_TYPE_NEW.equals(appformReqTemp.getOperType())) {
    //         pageSb.append("Nac");
    //     } else if (OPER_TYPE_MOVE_NUM.equals(appformReqTemp.getOperType())) {
    //         pageSb.append("Mnp");
    //     } else if (OPER_TYPE_CHANGE.equals(appformReqTemp.getOperType())) {
    //         pageSb.append("Hcn");
    //     } else if (OPER_TYPE_EXCHANGE.equals(appformReqTemp.getOperType())) {
    //         pageSb.append("Hdn");
    //     }
    //
    //        /*
    ...
    //             if (uploadEPhone == null || !StringUtils.hasText(uploadEPhone.getEid()) || !StringUtils.hasText(uploadEPhone.getReqPhoneSn())) {
    //                 throw new McpCommonException(PHONE_EID_NULL_EXCEPTION);
    //             }
    //         }
    //
    ...
    //         if (StringUtils.hasText(appformReqTemp.getPrntsContractNo())) { // esimWatch > main step 4이상 삭제
    //             certService.delStepInfo(4);
    //
    //             if ("5".equals(appformReqTemp.getOnOffType()) || "7".equals(appformReqTemp.getOnOffType())) {
    //                 pageSb.append("EsimWatchSelfForm");
    //             } else {
    //                 pageSb.append("EsimWatchForm");
    //             }
    //
    ...
    //
    //             if ("5".equals(appformReqTemp.getOnOffType()) || "7".equals(appformReqTemp.getOnOffType())) {
    //                 pageSb.append("EsimSelfForm");
    //             } else {
    //                 pageSb.append("EsimForm");
    //             }
    //         }
    //
    ...
    //
    //     //CntpntShopId
    //     if (!StringUtils.hasText(appformReqTemp.getSocCode())
    //         || !StringUtils.hasText(appformReqTemp.getOnOffType())
    //         || !StringUtils.hasText(appformReqTemp.getOperType())) {
    ...
    //     //임시저장값 기본값 설정
    //     //유심 보유 설정 값 설정
    //     if (!StringUtils.hasText(appformReqTemp.getClauseMpps35Flag())) {
    //         appformReqTemp.setClauseMpps35Flag("N");
    //     }
    //
    //     //        if (!StringUtils.hasText(appformReqTemp.getSelfCertType())) {
    //     //            appformReqTemp.setSelfCertType("01");  //주민등록증 기본값
    //     //        }
    //
    //     if (!StringUtils.hasText(appformReqTemp.getMoveAuthType())) {
    //         appformReqTemp.setMoveAuthType("2");  //번호이동 인증유형 휴대폰 일련번호
    //     }
    //
    //     if (!StringUtils.hasText(appformReqTemp.getCstmrBillSendCode())) {
    //         appformReqTemp.setCstmrBillSendCode("CB");  //모바일<br>명세서(MMS)
    //     }
    //
    //     if (!StringUtils.hasText(appformReqTemp.getReqPayType())) {
    //         appformReqTemp.setReqPayType("D");  //자동이체
    //     }
    //
    //     if (!StringUtils.hasText(appformReqTemp.getModelMonthly())) {
    ...
    //
    //         //이름, 휴대폰 번호, 주소
    //         if (!StringUtils.hasText(appformReqTemp.getCstmrName())) {
    //             appformReqTemp.setCstmrName(userSession.getName());
    //         }
    //
    //         if (!StringUtils.hasText(appformReqTemp.getCstmrMobileFn()) && !StringUtils.hasText(appformReqTemp.getCstmrMobileMn())) {
    ...
    //         }
    //
    //         if (!StringUtils.hasText(appformReqTemp.getCstmrPost())) {
    ...
    //         }
    //
    //         if (!StringUtils.hasText(appformReqTemp.getCstmrMail())) {
    ...
    //     }
    //
    //     if (regiSiteOjb == null && !StringUtils.hasText(appformReqTemp.getModelSalePolicyCode())) {
    //         throw new McpCommonException(ExceptionMsgConstant.NO_EXSIST_SALE_PLCY_CD_EXCEPTION, redirectUrl);
    //     }
    //     //&& !StringUtils.hasText(appformReqDto.getModelSalePolicyCode())
    //
    //     //현재 대표 단말기 조회
    //     //현재 단품 ID 로 해당 대표모델ID를 조회한다.
    //     //TO_DO getModelId 확인 필요
    //     if (StringUtils.hasText(appformReqTemp.getModelId())) {
    //
    //         // 현재 단품 ID 로 해당 대표모델ID를 조회한다.
    ...
    //         */
    //     if ("09".equals(appformReqTemp.getUsimKindsCd()) && StringUtils.hasText(appformReqTemp.getPrntsContractNo())) {
     ...
     */
    // @RequestMapping(
    //     value = {"/appForm/appFormComplete.do", "/m/appForm/appFormComplete.do", "/eSimForm/appFormComplete.do", "/m/eSimForm/appFormComplete.do"})
    ...
    //
    //     if (StringUtils.hasText(appformReqTemp.getSelfCstmrCi())) {
    //         if (sessNiceRes == null) {
    //             throw new McpCommonException(ExceptionMsgConstant.F_BIND_EXCEPTION);
    //         }
    //
    ...
    //         PhoneMspDto phoneMspDto = restTemplate.postForObject(apiInterfaceServer + "/msp/mspPhoneInfo",
    //             appformReqTemp.getModelId(),
    //             PhoneMspDto.class);
    //         appformReqTemp.setRprsPrdtId(phoneMspDto.getRprsPrdtId());
    //         appformReqTemp.setPrdtId(appformReqTemp.getModelId());
    //     }
    ...
    //
    //             mspSmsTemplateMstDto.setText(mspSmsTemplateMstDto.getText()
    //                 .replace("#{mobileNo}", "010-" + appformReqTemp.getReqWantNumber2() + "-" + appformReqTemp.getReqWantNumber3()));
    ...
    //
    //     if (!StringUtils.hasText(mcpRequestAdditionDto.getChargeFlag())) {
    ...
    //     if (!StringUtils.hasText(intmInsrRelDTO.getReqBuyType())) {
    //         throw new McpCommonJsonException("0001", INVALID_PARAMATER_EXCEPTION);
    //     }
    //     RestTemplate restTemplate = new RestTemplate();
    //     IntmInsrRelDTO[] insrProdList = restTemplate.postForObject(apiInterfaceServer + "/appform/selectInsrProdList",
    //         intmInsrRelDTO,
    //         IntmInsrRelDTO[].class);
    //     return insrProdList;
    // }
    ...
    // @ResponseBody
    // public Map<String, Object> saveAppformDb(
    ...
    //             && (StringUtils.hasLength(appformReqDto.getReqUsimSn()) || "09".equals(appformReqDto.getUsimKindsCd()))) {
    //
    ...
    //
    //         String temSsn = "FN".equals(appformReqDto.getCstmrType())
    //             ? appformReqDto.getCstmrForeignerRrnDesc()
    //             : appformReqDto.getDesCstmrNativeRrn();
    //
    ...
    //
    //     //        // 이벤트코드 검증
    //     //        if(StringUtils.hasText(appformReqDto.getEvntCdPrmt())){
    ...
    //     String orgnId = "";
    //     if (StringUtils.hasText(appformReqDto.getReqUsimSn()) && !"Y".equals(appformReqDto.getJehuRefererYn())) { //제휴위탁온라인의 경우 대리점코드로 사은품 정보를 입력한다.
    ...
    //         RestTemplate restTemplate = new RestTemplate();
    //         try {
    //             checkLimitOpenFormCount = restTemplate.postForObject(apiInterfaceServer + "/appform/checkLimitOpenFormCount",
    //                 appformReqDto,
    //                 Integer.class);
    //         } catch (Exception e) {
    ...
    //         //나이 확인
    //         int age = NmcpServiceUtils.getAge(appformReqDto.getDesCstmrNativeRrn(),
    //             new SimpleDateFormat("yyyyMMdd", Locale.KOREA).format(new Date()));
    //         if (19 <= age || 1 > age) {
    ...
    //         appformSvc.containsGoldNumbers(Arrays.asList(appformReqDto.getReqWantNumber(),
    //             appformReqDto.getReqWantNumber2(),
    //             appformReqDto.getReqWantNumber3()));
    //     }
    //
    //     //유심비 /  가입비 설정
    ...
    //         //금액 정보 설정
    //         if (!StringUtils.hasText(appformReqDto.getModelSalePolicyCode())
    //             || !StringUtils.hasText(appformReqDto.getRprsPrdtId())
    //             || !StringUtils.hasText(appformReqDto.getCntpntShopId())
    //             || !StringUtils.hasText(appformReqDto.getOperType())
    //             || !StringUtils.hasText(appformReqDto.getSocCode())
    ...
    //             }
    //         } else {
    //             if (!StringUtils.hasText(appformReqDto.getCntpntShopId())
    //                 || !StringUtils.hasText(appformReqDto.getOperType())
    //                 || !StringUtils.hasText(appformReqDto.getSocCode())
    //                 || "null".equals(appformReqDto.getSocCode())) {
    //                 throw new McpCommonJsonException("0006", BIDING_EXCEPTION);
    ...
    //
    //     //휴대폰 안심 서비스 처리 인증 확인
    //     if (StringUtils.hasText(appformReqDto.getInsrProdCd())) {
    ...
    //
    //     // 자급제 보상 서비스 처리 인증 확인
    //     if (StringUtils.hasText(appformReqDto.getRwdProdCd())) {
    ...
    //
    //         RestTemplate restTemplate = new RestTemplate();
    //         MspSaleSubsdMstDto[] chargeTemList = restTemplate.postForObject(apiInterfaceServer + "/msp/mspSaleSubsdMstList",
    //             mspSaleSubsdMstDto,
    ...
    //     if (StringUtils.hasText(appformReqDto.getProdId())) {
    ...
    //
    //         if (phoneProdBas != null && StringUtils.hasText(phoneProdBas.getProdNm())) {
    ...
    //             if (nmcpCdOnlineDto != null && StringUtils.hasText(nmcpCdOnlineDto.getExpnsnStrVal1())) {
    ...
    //              */
    //               /*if ( StringUtils.hasText(appformReqDto.getReqUsimSn()) && !"0000000000000000000".equals(appformReqDto.getReqUsimSn()) && "".equals(StringUtil.NVL(appformReqDto.getMarket(),"")) ) {
    ...
    //      */
    //     if (StringUtils.hasText(appformReqDto.getReqUsimSn())) {
    ...
    //         if (StringUtils.hasText(appformReqDto.getCardDcCd()) && !"".equals(appformReqDto.getCardTotDcAmt())) {
    ...
    //
    //
    //     if (StringUtils.hasText(appformReqDto.getUsePoint()) && StringUtils.hasText(appformReqDto.getUsePointSvcCntrNo()) && userSessionDto == null) {
    //         McpIpStatisticDto mcpIpStatisticDto = new McpIpStatisticDto();
    ...
    //     //                && StringUtils.hasText(appformReqDto.getUsePoint()) && StringUtils.hasText(appformReqDto.getUsePointSvcCntrNo())) {
    //     //
    ...
    //
    //     if (!StringUtils.hasText(appformReqDto.getAgentCode())) {
    //         appformReqDto.setAgentCode(AGENT_DEFALUT_CODE);
    //     }
    //
    //     if (!StringUtils.hasText(appformReqDto.getShopCd())) {
    ...
    //     if (!StringUtils.hasLength(cpntId)) {
    ...
    //             appformReqDto.setPrmtId(disPrmtId);
    //         }
    //
    //         // ============ STEP START ============
    //         // 1. 번호이동인 경우, 번호이동 전화번호가 KT MMOBILE 회선인지 다시체크
    //         // ** esimWatch는 신규가입만 가능 > 이어하기 시 번호이동도 선택할 수 있으나 신청폼은 신규가입폼... 임시로 번호이동 검사에서 제외처리
    //         String esimWatchYn = ("09".equals(appformReqDto.getUsimKindsCd()) && !StringUtil.isBlank(appformReqDto.getPrntsContractNo()))
    //             ? "Y"
    //             : "N"; //esimWatch
    //         if (OPER_TYPE_MOVE_NUM.equals(appformReqDto.getOperType()) && !"Y".equals(esimWatchYn)) {
    //             if (!StringUtils.hasText(appformReqDto.getMoveMobileFn())
    //                 || !StringUtils.hasText(appformReqDto.getMoveMobileMn())
    //                 || !StringUtils.hasText(appformReqDto.getMoveMobileRn())) {
    //                 throw new McpCommonJsonException("AUTH01", BIDING_EXCEPTION);
    //             }
    //
    //             RestTemplate restTemplate = new RestTemplate();
    //             int rtnInt = restTemplate.postForObject(apiInterfaceServer + "/msp/juoSubIngoCount",
    //                 appformReqDto.getMoveMobileFn() + appformReqDto.getMoveMobileMn() + appformReqDto.getMoveMobileRn(),
    //                 Integer.class);
    //             if (rtnInt >= 1) {
    //                 throw new McpCommonJsonException("AUTH01", STEP_AUTH_MOVE_EXCEPTION);
    //             }
    //         }
    //
    ...
    //             if (OPER_TYPE_NEW.equals(appformReqDto.getOperType())) {
    //                 pageSb.append("Nac");
    //             } else if (OPER_TYPE_MOVE_NUM.equals(appformReqDto.getOperType())) {
    //                 pageSb.append("Mnp");
    //             } else if (OPER_TYPE_CHANGE.equals(appformReqDto.getOperType())) {
    //                 pageSb.append("Hcn");
    //             } else if (OPER_TYPE_EXCHANGE.equals(appformReqDto.getOperType())) {
    //                 pageSb.append("Hdn");
    //             }
    //
    ...
    //
    //         if (StringUtils.hasText(pageNm) && pageNm.contains("Self") && !"Y".equals(appformReqDto.getTelAdvice())) {
    ...
    //
    //         //CPA이벤트 -S-
    //         if (StringUtils.hasLength(appformReqDto.getOhvalue())) {
    ...
    //                 mcpIpStatisticDto.setPrcsSbst("9996[org.springframework.web.client.RestClientException] ");
    //                 ipstatisticService.insertAdminAccessTrace(mcpIpStatisticDto);
    //
    //                 throw new McpCommonJsonException("9996", "API연동 오류 /appform/checkLimitOpenFormCount");
    //             } catch (Exception e) {
    ...
    //                 McpIpStatisticDto mcpIpStatisticDto = new McpIpStatisticDto();
    //                 mcpIpStatisticDto.setPrcsMdlInd("PC0_ERROR");
    //                 mcpIpStatisticDto.setPrcsSbst("9996[java.lang.Exception] ");
    //                 ipstatisticService.insertAdminAccessTrace(mcpIpStatisticDto);
    //
    //                 throw new McpCommonJsonException("9996", "API연동 오류 /appform/checkLimitOpenFormCount");
    //             }
    ...
    //         if (!StringUtils.hasText(appformReqDto.getPrntsContractNo())
    //             && Constants.OPER_TYPE_NEW.equals(appformReqDto.getOperType())) {
    //
    //             // sms 인증 DB 조회
    //             if (!StringUtils.hasText(appformReqDto.getReqSeq()) || !StringUtils.hasText(appformReqDto.getResSeq())) {
    //                 throw new McpCommonJsonException("0004", NICE_CERT_EXCEPTION);
    //             }
    //
    ...
    //             MspSaleSubsdMstDto[] chargeTemList = restTemplate2.postForObject(apiInterfaceServer + "/msp/mspSaleSubsdMstList",
    //                 mspSaleSubsdMstDto,
    //                 MspSaleSubsdMstDto[].class);
    //             List<MspSaleSubsdMstDto> chargeList = Arrays.asList(chargeTemList);
    //
    ...
    //         mcpIpStatisticDto.setPrcsMdlInd("PC0_ERROR");
    //         mcpIpStatisticDto.setTrtmRsltSmst(rtnAppformReqDto.getResNo());
    //         mcpIpStatisticDto.setPrcsSbst("Exception[com.ktmmobile.msf.domains.form.common.exception.McpMplatFormException] ");
    ...
    //         mcpIpStatisticDto.setPrcsMdlInd("PC0_ERROR");
    //         mcpIpStatisticDto.setTrtmRsltSmst(rtnAppformReqDto.getResNo());
    //         mcpIpStatisticDto.setPrcsSbst("Exception[java.net.SocketTimeoutException] ");
    //         mcpIpStatisticDto.setParameter("RES_NO[" + rtnAppformReqDto.getResNo() + "]");
    //         ipstatisticService.insertAdminAccessTrace(mcpIpStatisticDto);
    //         return rtnMap;
    ...
    //         mcpIpStatisticDto.setPrcsMdlInd("PC0_ERROR");
    //         mcpIpStatisticDto.setTrtmRsltSmst(rtnAppformReqDto.getResNo());
    //         mcpIpStatisticDto.setPrcsSbst("Exception[java.lang.Exception] ");
    //         mcpIpStatisticDto.setParameter("RES_NO[" + rtnAppformReqDto.getResNo() + "]");
    //         ipstatisticService.insertAdminAccessTrace(mcpIpStatisticDto);
    //
    //
    ...
    //
    //     //테스트 계정 만 처리
    //     if (userSessionDto != null && StringUtils.hasText(userSessionDto.getUserId())) {
    ...
    //         Thread.sleep(3000);
    //         // 타인납부를 위한 처리
    //         if (!StringUtils.hasText(appformReqDto.getPrntsBillNo())) {
    //             simpleOsstXmlVO = appformSvc.sendOsstService(sessAppformReqDto.getResNo(), EVENT_CODE_REQ_OPEN);
    //         } else {
    //             simpleOsstXmlVO = appformSvc.sendOsstAddBillService(sessAppformReqDto.getResNo(),
    //                 Constants.EVENT_CODE_REQ_OPEN,
    //                 appformReqDto.getPrntsBillNo());
    //         }
    //
    //         if (simpleOsstXmlVO.isSuccess()) {
    //
    ...
    //     HashMap<String, Object> rtnMap = new HashMap<String, Object>();
    //
    //     if (!StringUtils.hasText(appformReqDto.getResNo())) {
    ...
    //                     NiceResDto sessNiceRes = SessionUtils.getNiceResCookieBean();
    //                     if (sessNiceRes != null && StringUtils.hasText(sessNiceRes.getConnInfo())) {
    ...
    //         if (mcpRequestDto.getPrntsContractNo() != null) {
    //             osstParam.put("prntsContractNo", mcpRequestDto.getPrntsContractNo());
    //         }
    //         if (mcpRequestDto.getCustomerId() != null) {
    //             osstParam.put("custNo", mcpRequestDto.getCustomerId());
    //         }
    //
    ...
    //     //        }
    //
    //     if (!StringUtils.hasText(appformReqDto.getSocCode()) || appformReqDto.getRequestKeyTemp() <= 0) {
    //         rtnMap.put("RESULT_CODE", "-2");
    ...
    //     // =============== START: 본인인증 리턴처리 변경 ===============
    //     // 1. 인자값 확인
    //     if (!StringUtils.hasText(appformReqDto.getReqSeq())
    //         || !StringUtils.hasText(appformReqDto.getResSeq())) {
    //         throw new McpCommonJsonException("AUTH01", BIDING_EXCEPTION);
    //     }
    //
    //     // 2. 인증정보 조회
    ...
    //     }
    //
    //     if (!StringUtils.hasText(niceLogRtn.getConnInfo()) || !StringUtils.hasText(niceLogRtn.getName())) {
    //         throw new McpCommonJsonException("AUTH02", NICE_CERT_EXCEPTION_INSR);
    //     }
    //
    ...
    //
    //
    //     if (StringUtils.hasText(saleSubsdMstDto.getSalePlcyCd())) {
    //            /*
    //             * getSalePlcyCd정책
    //             * getPrdtId 대표상품 아이디
    //             * getOrgnId 접점 코드
    ...
    //
    //             */
    //         if (!StringUtils.hasText(saleSubsdMstDto.getPrdtId())
    //             || !StringUtils.hasText(saleSubsdMstDto.getOrgnId())
    //             || !StringUtils.hasText(saleSubsdMstDto.getOperType())) {
    //             throw new McpCommonJsonException("0006", BIDING_EXCEPTION);
    //         }
    //
    //         RestTemplate restTemplate = new RestTemplate();
    ...
    //         }
    //
    //         if (!StringUtils.hasText(saleSubsdMstDto.getOperType())) {
    //             throw new McpCommonJsonException("0006", BIDING_EXCEPTION);
    //         }
    //
    //         if (!StringUtils.hasText(nmcpCdDtlDto.getExpnsnStrVal3())) {
    ...
    //
    //         RestTemplate restTemplate = new RestTemplate();
    //         MspSaleSubsdMstDto[] chargeTemList = restTemplate.postForObject(apiInterfaceServer + "/prepia/rateList",
    //             inputMap,
    //             MspSaleSubsdMstDto[].class);
    //         List<MspSaleSubsdMstDto> chargeList = Arrays.asList(chargeTemList);
    //         return chargeList;
    ...
    // @ResponseBody
    // public Map<String, Object> saveDataSharingSimple(
    //     AppformReqDto appformReqDto
    //     , @RequestParam(value = "menuType", required = false) String menuType
    // ) {
    //     HashMap<String, Object> rtnMap = new HashMap<String, Object>();
    //     //TO_DO
    //     if (!StringUtils.hasText(appformReqDto.getContractNum()) || !StringUtils.hasText(appformReqDto.getReqUsimSn())) {
    //         throw new McpCommonJsonException("0001", F_BIND_EXCEPTION);
    //     }
    //
    ...
    //
    //         //다시 암호화 처리
    //         if (StringUtils.hasText(appformReqResult.getReqAccountNumber())) {
    //             appformReqResult.setReqAccountNumber(appformReqResult.getReqAccountNumber());
    //         }
    //         if (StringUtils.hasText(appformReqResult.getReqCardRrn())) {
    //             appformReqResult.setReqCardRrn(appformReqResult.getReqCardRrn());
    //         }
    //         if (StringUtils.hasText(appformReqResult.getReqAccountRrn())) {
    //             appformReqResult.setReqAccountRrn(appformReqResult.getReqAccountRrn());
    //         }
    //         if (StringUtils.hasText(appformReqResult.getReqCardNo())) {
    ...
    //         if (StringUtils.hasText(prmtId)) {
    //             appformReqResult.setPrmtId(prmtId);
    //         }
    //
    //         String cpntId = SessionUtils.getFathSession().getCpntId();
    //         if (!StringUtils.hasLength(cpntId)) {
    ...
    //
    //     if (!StringUtils.hasText(salePlcyMst.getOrgnId())) {
    //         throw new McpCommonJsonException("0006", BIDING_EXCEPTION);
    //     }
    //
    //     RestTemplate restTemplate = new RestTemplate();
    //     MspSalePlcyMstDto[] salePlcyMstList = restTemplate.postForObject(apiInterfaceServer + "/msp/salePlcyMstList",
    //         salePlcyMst,
    //         MspSalePlcyMstDto[].class);
    //
    ...
    //     HashMap<String, Object> rtnMap = new HashMap<String, Object>();
    //
    //     if (!StringUtils.hasText(juoSubInfo.getIccId())) {
    //         rtnMap.put("RESULT_CODE", "9998");
    ...
    //
    //         if (!ObjectUtils.isEmpty(sessionDto) && StringUtils.hasLength(sessionDto.getUserId())) {
    ...
    //
    //             if (StringUtils.hasText(reqSeq) && StringUtils.hasText(resSeq)) {
    //                 NiceLogDto niceLogDto = new NiceLogDto();
    ...
    //                 if (smsNiceLogDto != null && StringUtils.hasText(smsNiceLogDto.getsMobileNo())) {
    ...
    //     if (!StringUtils.hasText(rrnShort)) {
    //         rtnMap.put("RESULT_CODE", "-1");
    ...
    //             rtnMap.put("RESULT_CODE", "0004");
    //             rtnMap.put("RESULT_DESC",
    //                 "약정기간이 6개월 이상 남아있어 온라인으로 기기변경 신청이 불가합니다.<br>기기변경을 원하실 경우 고객센터(1899-5000)로 신청을 부탁드립니다. <br>확인버튼을 누르실 경우 휴대폰 화면으로 이동합니다.");
    //         } else {
    //             rtnMap.put("RESULT_CODE", "0003");
    ...
    // ) {
    //     if (!StringUtils.hasText(usimBasObj.getPrdtId())) {
    //         return null;
    //     }
    ...
    // public String appformDesignView(
    //     NmcpProdCommendDto prodCommendDto, BindingResult bind, PhoneProdBasDto phoneProdBasDto,
    ...
    //
    //
    //     if (!StringUtils.hasText(prodCommendDto.getPrdtSctnCd())) {
    //         prodCommendDto.setPrdtSctnCd("LTE");
    //     }
    //
    //     if (StringUtils.hasText(prodCommendDto.getRateCd())) {
    ...
    //
    //             if ("09".equals(appformReqTemp.getUsimKindsCd()) && !StringUtils.hasLength(appformReqTemp.getPrntsContractNo())) {
    //                 temPrdtIndCd = "10";
    //                 // ============ STEP START ============
    //                 // step 초기화 및 메뉴명 세팅
    //                 SessionUtils.removeCertSession();
    ...
    //         if (!StringUtils.hasText(temUploadPhoneSrlNo) || 1 > appformSvc.checkUploadPhoneInfoCount(temUploadPhoneSrlNo)) {
    //             throw new McpCommonException(PHONE_EID_NULL_EXCEPTION);
    //         }
    ...
    //             if (!StringUtils.hasLength(uploadEPhone.getPrntsContractNo())) { // ESIM
    //                 // esimSeq
    //                 certKey = new String[] {"urlType", "uploadPhoneSrlNo"};
    ...
    // ) {
    //     if (!StringUtils.hasText(phoneProdBas.getProdId())) {
    //         return null;
    //     }
    ...
    //     StringBuilder pageSb = new StringBuilder();
    //
    //     if (OPER_TYPE_NEW.equals(pOperTypeTem)) {
    //         pageSb.append("Nac");
    //     } else if (OPER_TYPE_MOVE_NUM.equals(pOperTypeTem)) {
    //         pageSb.append("Mnp");
    //     } else if (OPER_TYPE_CHANGE.equals(pOperTypeTem)) {
    //         pageSb.append("Hcn");
    //     } else if (OPER_TYPE_EXCHANGE.equals(pOperTypeTem)) {
    //         pageSb.append("Hdn");
    //     }
    //
    //     pageSb.append("AgentForm");
    ...
    //
    //     if (!StringUtils.hasText(pSocCode)) {
    ...
    //
    //     //제휴 위탁온라인 유심미보유건
    //     if (StringUtils.hasLength(resNo)) {
    //         //대리점코드, 요금제코드 조회
    ...
    //     if (!StringUtils.hasLength(resNo)) { // 바로배송(파라미터에 예약번호 미존재)
    ...
    //     if (rtnAppformReqDto != null && StringUtils.hasLength(rtnAppformReqDto.getReqUsimSn())) { //이미 유심등록한경우(유심번호존재)
    ...
    //     if (!StringUtils.hasText(commendId)) {
    //         return -99;
    //     }
    ...
    //     }
    //
    //     if (!StringUtils.hasText(uploadEPhone.getPrntsContractNo())) {
    //         //일반 eSIM
    //         //eSIM 정보 설정
    ...
    //             if (StringUtils.hasText(moscBilEmailInfo.getEmail())) {
    ...
    //         }
    //
    //         if (StringUtils.hasText(cstmrMail)) {
    ...
    //
    //        UserSessionDto userSession = SessionUtils.getUserCookieBean();
    //        if (userSession != null && StringUtils.hasText(userSession.getUserId() ) ) {
    ...
    // public String appAgentFormDesignView(
    //     HttpServletRequest request
    //     , @RequestParam(value = "a", required = false, defaultValue = "") String pCntpntShopId          // 조직ID
    //     , @RequestParam(value = "o", required = false, defaultValue = "") String pOperType              // 가입유형
    //     , @RequestParam(value = "s", required = false, defaultValue = "") String pModelSalePolicyCode   // 판매정책id
    ...
    //     // 10. 판매정책 정보 상세조회
    //     RestTemplate restTemplate = new RestTemplate();
    //     MspSalePlcyMstDto mspSalePlcyMstDto = restTemplate.postForObject(apiInterfaceServer + "/msp/mspSalePlcyMst",
    //         pModelSalePolicyCode,
    //         MspSalePlcyMstDto.class);
    ...
    //     if (StringUtils.hasLength(openMarketReferer)) {
    ...
    // @ResponseBody
    // public Map<String, Object> containsGoldNumbersAjax(
    //     @RequestParam(name = "reqWantNumber") String reqWantNumber
    ...
    // public String appJehuFormDesignView(
    //     HttpServletRequest request
    //     , @RequestParam(value = "a", required = false, defaultValue = "") String pCntpntShopId          // 조직ID
    //     , @RequestParam(value = "r", required = false, defaultValue = "") String pSocCode               // 요금상품
    //     , @RequestParam(value = "u", required = false, defaultValue = "") String openMarketReferer      // 오픈마켓 입점지
    ...
    //         if ("N".equals(selfOpenYn) && "Y".equals(rtn.getSelfOpenYn())) {
    //             selfOpenYn = "Y";
    //         }
    //         if ("N".equals(nac3Yn) && "NAC3".equals(rtn.getOperType())) {
    //             nac3Yn = "Y";
    //         }
    //         if ("N".equals(mnp3Yn) && "MNP3".equals(rtn.getOperType())) {
    //             mnp3Yn = "Y";
    //         }
    //     }
    ...
    //
    //     if (0 < "|5|7|".indexOf(appformReqTemp.getOnOffType())) {
    //         pageSb.append("JehuSelfForm");
    //     } else {
    //         pageSb.append("JehuForm");
    //     }
    //
    //     SessionUtils.setPageSession(pageSb.toString());
    //
    ...
    //     String resultCode = AJAX_SUCCESS;
    //
    //     if (!StringUtils.hasLength(appformReqDto.getCntpntShopId()) || !StringUtils.hasLength(appformReqDto.getPlcySctnCd())) {
    //         throw new McpCommonException(F_BIND_EXCEPTION, "/main.do");
    //     }
    //
    //     List<MspSalePlcyMstDto> mspSalePlcyMstDtoList = appformSvc.getSalePlcyInfo(appformReqDto);
    ...
    //
    //     if (!StringUtils.hasLength(osstFathReqDto.getOnlineOfflnDivCd()) ||
    //         !StringUtils.hasLength(osstFathReqDto.getOrgId()) ||
    //         !StringUtils.hasLength(osstFathReqDto.getSelfCertType())) {
    ...
    //     if (StringUtils.hasText(SessionUtils.getFathSession().getCmpltNtfyDt())) {
    ...
    //     //이미 안면인증 완료를 하여 세션에 안면인증 완료일이 들어가있는경우
    //     if (StringUtils.hasText(fathSessionDto.getCmpltNtfyDt())) {
    ...
    //         if (!StringUtils.hasLength(osstFathReqDto.getOnlineOfflnDivCd()) || !StringUtils.hasLength(osstFathReqDto.getOperType())) {
    ...
    //         if (!StringUtils.hasLength(tempResNo)) {
    //             throw new McpCommonJsonException("1009", FATH_CERT_EXPIR_EXCEPTION);
    //         }
    //         osstFathReqDto.setResNo(tempResNo);
    //     }
    //
    //     if (StringUtils.hasLength(osstFathReqDto.getContractNum())) { //ESIM WATCH, 데이터쉐어링
    //         // 계약번호로 이전 신청서 조회
    ...
    //     if (!StringUtils.hasLength(osstFathReqDto.getOnlineOfflnDivCd()) ||
    //         !StringUtils.hasLength(osstFathReqDto.getOrgId()) ||
    //         !StringUtils.hasLength(osstFathReqDto.getCpntId()) ||
    //         !StringUtils.hasLength(osstFathReqDto.getSmsRcvTelNo()) ||
    //         !StringUtils.hasLength(osstFathReqDto.getOperType())) {
    ...
    //     if (!StringUtils.hasLength(fathTransacId)) {
    ...
    //         if ("1100011741".equals(reqTemp.getCntpntShopId()) && "NAC3".equals(reqTemp.getOperType()) && Arrays.asList("0", "3")
    //             .contains(reqTemp.getOnOffType())) {
    //
    //             //신규개통 이력 체크
