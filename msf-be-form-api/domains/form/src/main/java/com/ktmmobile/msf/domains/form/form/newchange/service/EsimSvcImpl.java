...
import com.ktmmobile.msf.domains.form.common.mplatform.vo.MoscRetvIntmMdlSpecInfoVO.SpecSbstDto;
...
public class EsimSvcImpl implements EsimSvc {
    ...
    public EsimDto eSimWatch(EsimDto reqDto) {
        ...
        if (prntsAut == null || !StringUtils.hasText(prntsAut.getSvcCntrNo())) {
