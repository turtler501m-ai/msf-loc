...
public enum RequestFormCstmrType implements CommonEnum {
    NATIVEADULT("NA", "내국인"),
    ...
    public static RequestFormCstmrType getInvalidValue() {
        return UNDEFINED;
    }

    @JsonCreator
    public static RequestFormCstmrType valueOfCode(String code) {
        return CommonEnum.valueOfCode(RequestFormCstmrType.class, code, getInvalidValue());
    }
