...
public class AppController {
    ...
    @PostMapping({"/api/n/app/intro", "/api/app/intro"})
    ...
    @PostMapping({"/api/n/app/login/init", "/api/app/login/init"})
    ...
    @PostMapping("/api/n/app/model/register")
    ...
    @PostMapping("/api/n/app/model/remove")
    ...
    @PostMapping("/api/n/app/download")
    public CommonResponse<List<IntroResponse>> appDownlaod(@RequestBody @Validated(OnSelect.class) AppDownloadRequest request) {
        return ResponseUtils.ok(appIntroReader.appDownload(request));
    }
