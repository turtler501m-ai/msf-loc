...
public interface LoginBiometricChallengeManager {
     ...
     * @return 랜덤 키 정보
     */
    LoginBiometricChallenge createChallenge(String deviceUuid);
     ...
     */
    void verifyEncryptedChallenge(String deviceUuid, String bioKey, String encryptedNonce);
}
